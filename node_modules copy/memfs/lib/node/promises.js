...
function createPromisesApi(vol) {
  ...
  return {
    ...
    appendFile(path, data, options) {
      return (0, util_1.promisify)(vol, "appendFile")(
        path instanceof FileHandle_1.FileHandle ? path.fd : path,
        data,
        options
      );
    },
    ...
    open(path, flags, mode) {
      return (0, util_1.promisify)(
        vol,
        "open",
        (fd) => new FileHandle_1.FileHandle(vol, fd)
      )(path, flags, mode);
    },
    ...
    readFile(id, options) {
      return (0, util_1.promisify)(vol, "readFile")(
        id instanceof FileHandle_1.FileHandle ? id.fd : id,
        options
      );
    },
    ...
    writeFile(id, data, options) {
      return (0, util_1.promisify)(vol, "writeFile")(
        id instanceof FileHandle_1.FileHandle ? id.fd : id,
        data,
        options
      );
