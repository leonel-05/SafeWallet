  ...
  static async createSnapshot(compilation, startTime, dependency) {
    ...
    return new Promise((resolve, reject) => {
      compilation.fileSystemInfo.createSnapshot(
        startTime,
        [dependency], // eslint-disable-next-line no-undefined
  ...
  static async runPattern(
    ...
    pattern.context =
      typeof pattern.context === "undefined"
        ? compiler.context
        : _path.default.isAbsolute(pattern.context)
        ? pattern.context
        : _path.default.join(compiler.context, pattern.context);
    logger.log(
    ...
    switch (pattern.fromType) {
      case "dir":
        ...
        pattern.glob = _path.default.posix.join(
          _fastGlob.default.escapePath(
            (0, _normalizePath.default)(
              _path.default.resolve(pattern.absoluteFrom)
            )
          ),
          "**/*"
        );
      ...
      case "file":
        ...
        pattern.glob = _fastGlob.default.escapePath(
          (0, _normalizePath.default)(
            _path.default.resolve(pattern.absoluteFrom)
          )
        );
      ...
      default: {
        const contextDependencies = _path.default.normalize(
          (0, _globParent.default)(pattern.absoluteFrom)
        );
        ...
        pattern.glob = _path.default.isAbsolute(pattern.fromOrigin)
          ? pattern.fromOrigin
          : _path.default.posix.join(
              _fastGlob.default.escapePath(
                (0, _normalizePath.default)(
                  _path.default.resolve(pattern.context)
                )
              ),
              pattern.fromOrigin
            );
    ...
    const files = await Promise.all(
      filteredPaths.map(async (item) => {
        ...
        const relativeFrom = _path.default.relative(
          pattern.context,
          absoluteFilename
        );
        ...
        let filename =
          toType === "dir"
            ? _path.default.join(pattern.to, relativeFrom)
            : pattern.to;
        ...
        const sourceFilename = (0, _normalizePath.default)(
          _path.default.relative(compiler.context, absoluteFilename)
        );
        return {
          absoluteFilename,
          sourceFilename,
      ...
      assets = await Promise.all(
        files.map(async (file) => {
              ...
              if (transform.cache) {
                ...
                const hasher =
                  ...
                  compiler.webpack.util.createHash
                    ? compiler.webpack.util.createHash("xxhash64") // eslint-disable-next-line global-require
          ...
          if (toType === "template") {
            ...
            const data = {
              filename: (0, _normalizePath.default)(
                _path.default.relative(pattern.context, absoluteFilename)
              ),
              contentHash,
              chunk: {
                name,
            ...
            const { path: interpolatedFilename, info: assetInfo } =
              compilation.getPathWithInfo(
                (0, _normalizePath.default)(result.filename),
                data
              );
            ...
            scheduledTasks.push(async () => {
              ...
              if (assets && assets.length > 0) {
                if (item.transformAll) {
                  ...
                  const cacheKeys = `transformAll|${(0,
                  _serializeJavascript.default)({
                    version: _package.version,
                    from: item.from,
                    to: item.to,
                  ...
                  if (!transformedAsset) {
                    ...
                    if (template.test(item.to)) {
                      ...
                      const { path: interpolatedFilename, info: assetInfo } =
                        compilation.getPathWithInfo(
                          (0, _normalizePath.default)(item.to),
                          {
                            contentHash,
                            chunk: {
                              hash: contentHash,
