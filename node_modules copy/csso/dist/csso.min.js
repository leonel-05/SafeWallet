!(function (e, t) {
  ...
  var t = (function (e, t) {
      ...
      e.exports = (function () {
          ...
          return (
            null !== r
              ? ((a = r),
                ...
                (a.next = n),
                (a.cursor = e.cursor))
              : (a = { prev: t, next: n, cursor: e.cursor }),
            (e.cursor = a),
            a
          );
        }
        ...
        (a.createItem = e),
          (a.prototype.createItem = e),
          (a.prototype.updateCursors = function (e, t, n, r) {
          ...
          (a.prototype.fromArray = function (t) {
            var n = null;
            this.head = null;
            for (var r = 0; r < t.length; r++) {
              var a = e(t[r]);
              null !== n ? (n.next = a) : (this.head = a),
                (a.prev = n),
                (n = a);
            }
          ...
          (a.prototype.each = function (e, r) {
            var a;
            void 0 === r && (r = this);
            for (var i = t(this, null, this.head); null !== i.next; )
              (a = i.next), (i.next = a.next), e.call(r, a.data, a, this);
            n(this);
          }),
          (a.prototype.forEach = a.prototype.each),
          (a.prototype.eachRight = function (e, r) {
            var a;
            void 0 === r && (r = this);
            for (var i = t(this, this.tail, null); null !== i.prev; )
              (a = i.prev), (i.prev = a.prev), e.call(r, a.data, a, this);
            n(this);
          }),
          (a.prototype.forEachRight = a.prototype.eachRight),
          (a.prototype.reduce = function (e, r, a) {
            var i;
            void 0 === a && (a = this);
            for (var o = t(this, null, this.head), s = r; null !== o.next; )
              (i = o.next),
                (o.next = i.next),
                (s = e.call(a, s, i.data, i, this));
            return n(this), s;
          }),
          (a.prototype.reduceRight = function (e, r, a) {
            var i;
            void 0 === a && (a = this);
          ...
          (a.prototype.nextUntil = function (e, r, a) {
            if (null !== e) {
              var i;
              void 0 === a && (a = this);
              for (
                var o = t(this, null, e);
                null !== o.next &&
                ((i = o.next), (o.next = i.next), !r.call(a, i.data, i, this));

              );
              n(this);
            }
          }),
          (a.prototype.prevUntil = function (e, r, a) {
            if (null !== e) {
              var i;
              void 0 === a && (a = this);
              for (
                var o = t(this, e, null);
                null !== o.prev &&
                ((i = o.prev), (o.prev = i.prev), !r.call(a, i.data, i, this));
          ...
          (a.prototype.copy = function () {
            for (var t = new a(), n = this.head; null !== n; )
          ...
          (a.prototype.prependData = function (t) {
          ...
          (a.prototype.insertData = function (t, n) {
          ...
          (a.prototype.prependList = function (e) {
            return this.insertList(e, this.head);
          }),
          (a.prototype.appendList = function (e) {
            return this.insertList(e);
          }),
          (a.prototype.insertList = function (e, t) {
            return (
              null === e.head ||
                (null != t
        ...
        function s(e, t) {
          ...
          (i +=
            ("    ".length - 1) *
            (r[a - 1].substr(0, i - 1).match(/\t/g) || []).length) > 100 &&
            ((c = i - 60 + 3), (i = 58));
          for (var u = o; u <= s; u++)
            u >= 0 &&
              u < r.length &&
              ...
              (r[u] =
                ...
                r[u].substr(c, 98) +
                (r[u].length > c + 100 - 1 ? "…" : "")));
          return [n(o, a), new Array(i + l + 2).join("-") + "^", n(a, s)]
            .filter(Boolean)
            .join("\n");
        }
        var l = function (e, t, n, r, a) {
            var i = o("SyntaxError", e);
            return (
              (i.source = t),
              (i.offset = n),
              (i.line = r),
        ...
        function N(e, t) {
          for (; t < e.length && z(e.charCodeAt(t)); t++);
          return t;
        }
        function B(e, t) {
          if (P(D(e, (t += 2) - 1))) {
            for (var n = Math.min(e.length, t + 5); t < n && P(D(e, t)); t++);
            var r = D(e, t);
            E(r) && (t += I(e, t, r));
          }
          return t;
        ...
        var M = {
            ...
            consumeNumber: function (e, t) {
              ...
              if (
                ...
                z(n) && ((t = N(e, t + 1)), (n = e.charCodeAt(t))),
                46 === n &&
                  z(e.charCodeAt(t + 1)) &&
        ...
        Y.prototype = {
            ...
            e: for (; r < this.tokenCount && !((n = this.balance[r]) < e); r++)
              switch (t(this.offsetAndType[r] >> 24, this.source, a)) {
                ...
                case 2:
                  ...
                  break e;
                default:
                  (a = 16777215 & this.offsetAndType[r]),
          ...
          skipWS: function () {
            for (
              ...
              e < this.tokenCount && this.offsetAndType[e] >> 24 === F;
              e++, t++
            );
            t > 0 && this.skip(t);
          },
        ...
        const G = { offset: 0, line: 1, column: 1 };
        function $(e, t) {
          const n = e && e.loc && e.loc[t];
          return n ? ("line" in n ? Q(n) : n) : null;
        }
        function Q({ offset: e, line: t, column: n }, r) {
          ...
          if (r) {
            ...
            (a.offset += r.length),
              (a.line += e.length - 1),
              (a.column =
                1 === e.length ? a.column + r.length : e.pop().length + 1);
          }
          return a;
        }
        ...
        var ne = {
            keyword: function (e) {
              if (X.call(Z, e)) return Z[e];
              var t = e.toLowerCase();
              if (X.call(Z, t)) return (Z[e] = Z[t]);
              var n = ee(t, 0),
                r = n ? "" : te(t, 0);
              return (Z[e] = Object.freeze({
            ...
            property: function (e) {
              ...
              "/" === n
                ...
                : "_" !== n &&
                  ...
                  (n = "");
              var r = ee(t, n.length);
              if (!r && ((t = t.toLowerCase()), X.call(J, t)))
                return (J[e] = J[t]);
              var a = r ? "" : te(t, n.length),
          ...
          re = "undefined" != typeof Uint32Array ? Uint32Array : Array,
          ae = function (e, t) {
            return null === e || e.length < t
              ? new re(Math.max(t + 1024, 16384))
              : e;
          },
          ie = h.TYPE,
          oe = A.isNewline,
          ...
          le = A.isValidEscape,
          ce = A.isNumberStart,
          ue = A.isIdentifierStart,
          he = A.charCodeCategory,
          de = A.isBOM,
          pe = M.cmpStr,
          me = M.getNewlineLength,
          fe = M.findWhiteSpaceEnd,
          ge = M.consumeEscaped,
          be = M.consumeName,
          ye = M.consumeNumber,
          ve = M.consumeBadUrlRemnants;
        function ke(e, t) {
          function n(t) {
          ...
          function r() {
            return (
              (h = ye(e, h)),
              ue(n(h), n(h + 1), n(h + 2))
                ? ((g = ie.Dimension), void (h = be(e, h)))
                : 37 === n(h)
                ? ((g = ie.Percentage), void h++)
                : void (g = ie.Number)
            );
          }
          function a() {
            ...
            return (
              (h = be(e, h)),
              pe(e, t, h, "url") && 40 === n(h)
                ? 34 === n((h = fe(e, h + 1))) || 39 === n(h)
                  ? ((g = ie.Function), void (h = t + 4))
                  : void (function () {
                      for (g = ie.Url, h = fe(e, h); h < e.length; h++) {
                        ...
                        switch (he(t)) {
                          ...
                          case he.Eof:
                            return;
                          case he.WhiteSpace:
                            return 41 === n((h = fe(e, h))) || h >= e.length
                              ? void (h < e.length && h++)
                              : ((h = ve(e, h)), void (g = ie.BadUrl));
                          case 34:
                          case 39:
                          case 40:
                          case he.NonPrintable:
                            return (h = ve(e, h)), void (g = ie.BadUrl);
                          case 92:
                            if (le(t, n(h + 1))) {
                              h = ge(e, h) - 1;
                              break;
                ...
                : 40 === n(h)
                ? ((g = ie.Function), void h++)
                : void (g = ie.Ident)
            );
          }
          function i(t) {
            for (t || (t = n(h++)), g = ie.String; h < e.length; h++) {
              ...
              switch (he(r)) {
                ...
                case he.Eof:
                  return;
                case he.WhiteSpace:
                  if (oe(r)) return (h += me(e, h, r)), void (g = ie.BadString);
                  break;
                case 92:
          ...
          for (
            ...
            switch (((l[c] = o), he(f))) {
              case he.WhiteSpace:
                (g = ie.WhiteSpace), (h = fe(e, h + 1));
                break;
              case 34:
                i();
                break;
              case 35:
                se(n(h + 1)) || le(n(h + 1), n(h + 2))
                  ? ((g = ie.Hash), (h = be(e, h + 1)))
                  : ((g = ie.Delim), h++);
                break;
              case 39:
                i();
                break;
              case 40:
                (g = ie.LeftParenthesis), h++;
                break;
              case 41:
                (g = ie.RightParenthesis), h++;
                break;
              case 43:
                ce(f, n(h + 1), n(h + 2)) ? r() : ((g = ie.Delim), h++);
                break;
              case 44:
                (g = ie.Comma), h++;
                break;
              ...
              case 60:
                ...
                break;
              case 64:
                ue(n(h + 1), n(h + 2), n(h + 3))
                  ? ((g = ie.AtKeyword), (h = be(e, h + 1)))
                  : ((g = ie.Delim), h++);
                break;
              case 91:
                (g = ie.LeftSquareBracket), h++;
                break;
              case 92:
                le(f, n(h + 1)) ? a() : ((g = ie.Delim), h++);
                break;
              case 93:
                (g = ie.RightSquareBracket), h++;
                break;
              case 123:
                (g = ie.LeftCurlyBracket), h++;
                break;
              case 125:
                (g = ie.RightCurlyBracket), h++;
                break;
              case he.Digit:
                r();
                break;
            ...
            switch (g) {
              case d:
                for (
                  d = (p = l[(m = 16777215 & p)]) >> 24, l[c] = m, l[m++] = c;
                  m < c;
                  m++
                )
                  l[m] === o && (l[m] = c);
                break;
              case ie.LeftParenthesis:
              case ie.Function:
                (l[c] = p), (p = ((d = ie.RightParenthesis) << 24) | c);
                break;
              case ie.LeftSquareBracket:
                (l[c] = p), (p = ((d = ie.RightSquareBracket) << 24) | c);
                break;
              case ie.LeftCurlyBracket:
                (l[c] = p), (p = ((d = ie.RightCurlyBracket) << 24) | c);
            }
            s[c++] = (g << 24) | h;
          }
          for (s[c] = (ie.EOF << 24) | h, l[c] = o, l[o] = o; 0 !== p; )
            (p = l[(m = 16777215 & p)]), (l[m] = o);
          return (
            (t.source = e),
            (t.firstCharOffset = u),
            (t.offsetAndType = s),
        ...
        var we = ke,
          ...
          Ee = Ce.Dimension;
        function Oe(e, t) {
          return null !== e && e.type === Ae && e.value.charCodeAt(0) === t;
        }
        function De(e, t, n) {
          for (; null !== e && (e.type === ze || e.type === Pe); ) e = n(++t);
          return t;
        }
        function Ie(e, t, n, r) {
          if (!e) return 0;
          ...
          for (; t < e.value.length; t++)
            if (!xe(e.value.charCodeAt(t))) return 0;
          return r + 1;
        }
        function Re(e, t, n) {
          var r = !1,
          ...
          if (e.type !== Te) {
            if (!Oe(e, 43) && !Oe(e, 45)) return t;
            if (
              ((r = !0),
              (a = De(n(++a), a, n)),
              null === (e = n(a)) && e.type !== Te)
            )
              return 0;
          }
          if (!r) {
          ...
          return Ie(e, r ? 0 : 1, r, a);
        }
        var Ne = we.isHexDigit,
          Be = we.cmpChar,
          Me = we.TYPE,
          je = Me.Ident,
          _e = Me.Delim,
          ...
          We = Me.Dimension;
        function Fe(e, t) {
          return null !== e && e.type === _e && e.value.charCodeAt(0) === t;
        }
        function Ue(e, t) {
        ...
        var Ve = we.isIdentifierStart,
          Ke = we.isHexDigit,
          Ge = we.isDigit,
          $e = we.cmpStr,
          Qe = we.consumeNumber,
          Xe = we.TYPE,
          Ze = ["unset", "initial", "inherit"],
          Je = ["calc(", "-moz-calc(", "-webkit-calc("];
        function et(e, t) {
          return t < e.length ? e.charCodeAt(t) : 0;
        }
        function tt(e, t) {
        ...
        function nt(e, t) {
          for (var n = 0; n < t.length; n++) if (tt(e, t[n])) return !0;
          return !1;
        }
        function rt(e, t) {
          return (
        ...
        function ot(e) {
          return function (t, n, r) {
            return null === t
              ? 0
              : t.type === Xe.Function && nt(t.value, Je)
              ? it(t, n)
              : e(t, n, r);
          };
        }
        ...
        function lt(e) {
          return function (t, n, r) {
            if (null === t || t.type !== Xe.Dimension) return 0;
            var a = Qe(t.value, 0);
            if (null !== e) {
              var i = t.value.indexOf("\\", a),
                o =
                  -1 !== i && rt(t.value, i)
                    ? t.value.substring(a, i)
                    : t.value.substr(a);
              if (!1 === e.hasOwnProperty(o.toLowerCase())) return 0;
            }
            return at(r, t.value, a) ? 0 : 1;
          };
        }
        function ct(e) {
          return (
            ...
            function (t, n, r) {
              return null !== t && t.type === Xe.Number && 0 === Number(t.value)
                ? 1
                : e(t, n, r);
            }
          );
        ...
        var ut = {
            "ident-token": st(Xe.Ident),
            "function-token": st(Xe.Function),
            "at-keyword-token": st(Xe.AtKeyword),
            "hash-token": st(Xe.Hash),
            "string-token": st(Xe.String),
            "bad-string-token": st(Xe.BadString),
            "url-token": st(Xe.Url),
            "bad-url-token": st(Xe.BadUrl),
            "delim-token": st(Xe.Delim),
            "number-token": st(Xe.Number),
            "percentage-token": st(Xe.Percentage),
            "dimension-token": st(Xe.Dimension),
            "whitespace-token": st(Xe.WhiteSpace),
            "CDO-token": st(Xe.CDO),
            "CDC-token": st(Xe.CDC),
            "colon-token": st(Xe.Colon),
            "semicolon-token": st(Xe.Semicolon),
            "comma-token": st(Xe.Comma),
            "[-token": st(Xe.LeftSquareBracket),
            "]-token": st(Xe.RightSquareBracket),
            "(-token": st(Xe.LeftParenthesis),
            ")-token": st(Xe.RightParenthesis),
            "{-token": st(Xe.LeftCurlyBracket),
            "}-token": st(Xe.RightCurlyBracket),
            string: st(Xe.String),
            ident: st(Xe.Ident),
            "custom-ident": function (e) {
              if (null === e || e.type !== Xe.Ident) return 0;
              var t = e.value.toLowerCase();
              return nt(t, Ze) || tt(t, "default") ? 0 : 1;
            },
            ...
            "hex-color": function (e) {
              if (null === e || e.type !== Xe.Hash) return 0;
              var t = e.value.length;
              if (4 !== t && 5 !== t && 7 !== t && 9 !== t) return 0;
              for (var n = 1; n < t; n++)
                if (!Ke(e.value.charCodeAt(n))) return 0;
              return 1;
            },
            "id-selector": function (e) {
              return null === e || e.type !== Xe.Hash
                ? 0
                : Ve(et(e.value, 1), et(e.value, 2), et(e.value, 3))
                ? 1
                : 0;
            },
            "an-plus-b": function (e, t) {
              var n = 0;
              if (!e) return 0;
              if (e.type === Te) return Ie(e, 0, !1, n);
              if (e.type === Le && 45 === e.value.charCodeAt(0)) {
                if (!Se(e.value, 1, 110)) return 0;
                switch (e.value.length) {
                  ...
                  case 3:
                    return 45 !== e.value.charCodeAt(2)
                      ? 0
                      : ((n = De(t(++n), n, t)), Ie((e = t(n)), 0, !0, n));
                  default:
                    return 45 !== e.value.charCodeAt(2) ? 0 : Ie(e, 3, !0, n);
                }
              } else if (e.type === Le || (Oe(e, 43) && t(n + 1).type === Le)) {
                if (
                  (e.type !== Le && (e = t(++n)),
                  null === e || !Se(e.value, 0, 110))
                )
                  return 0;
                switch (e.value.length) {
                  case 1:
                  ...
                  case 2:
                    return 45 !== e.value.charCodeAt(1)
                      ...
                      : ((n = De(t(++n), n, t)), Ie((e = t(n)), 0, !0, n));
                  default:
                    return 45 !== e.value.charCodeAt(1) ? 0 : Ie(e, 2, !0, n);
                }
              } else if (e.type === Ee) {
                for (
                  var r = e.value.charCodeAt(0),
                    a = 43 === r || 45 === r ? 1 : 0,
                    i = a;
                  i < e.value.length && xe(e.value.charCodeAt(i));
                  i++
                );
                return i === a
                  ? 0
            ...
            urange: function (e, t) {
              var n = 0;
              if (null === e || e.type !== je || !Be(e.value, 0, 117)) return 0;
              ...
              return e.type === We && Ue(e, 43) ? He(Ye(e, 1, !0), ++n, t) : 0;
            },
            "declaration-value": function (e, t) {
              ...
              e: do {
                switch (e.type) {
                  ...
                  case Xe.BadUrl:
                    break e;
                  case Xe.RightCurlyBracket:
                  case Xe.RightParenthesis:
                  case Xe.RightSquareBracket:
                  ...
                  case Xe.Delim:
                    ...
                    break;
                  case Xe.Function:
                  case Xe.LeftParenthesis:
                  case Xe.LeftSquareBracket:
                  case Xe.LeftCurlyBracket:
                    r++;
                }
            ...
            dimension: ot(lt(null)),
            angle: ot(lt({ deg: !0, grad: !0, rad: !0, turn: !0 })),
            decibel: ot(lt({ db: !0 })),
            frequency: ot(lt({ hz: !0, khz: !0 })),
            flex: ot(lt({ fr: !0 })),
            length: ot(
              ct(
                lt({
            ...
            resolution: ot(lt({ dpi: !0, dpcm: !0, dppx: !0, x: !0 })),
            semitones: ot(lt({ st: !0 })),
            time: ot(lt({ s: !0, ms: !0 })),
            percentage: ot(function (e, t, n) {
              return null === e ||
                e.type !== Xe.Percentage ||
                at(n, e.value, e.value.length - 1)
                ? 0
                : 1;
            }),
            zero: ct(),
            number: ot(function (e, t, n) {
              if (null === e) return 0;
              var r = Qe(e.value, 0);
              return r === e.value.length || rt(e.value, r)
                ? at(n, e.value, r)
                  ? 0
                  : 1
                : 0;
            }),
            integer: ot(function (e, t, n) {
              if (null === e || e.type !== Xe.Number) return 0;
              for (
                var r =
                ...
                if (!Ge(e.value.charCodeAt(r))) return 0;
              return at(n, e.value, r) ? 0 : 1;
            }),
            "-ms-legacy-expression": function (e, t) {
              return null !== e && tt(e.value, "expression(") ? it(e, t) : 0;
            },
          },
          ht = function (e, t, n) {
        ...
        dt.prototype = {
          ...
          error: function (e) {
            throw new ht(e, this.str, this.pos);
          },
        };
        var pt = dt,
          mt = (function (e) {
          ...
          var n = (function (e) {
            ...
            switch (e.charCode()) {
              ...
              case 35:
                e.pos++,
                  (n = !0),
                  (t = 123 === e.charCode() ? kt(e) : { min: 1, max: 0 });
                break;
              case 123:
                t = kt(e);
                break;
        ...
        function Ct(e) {
          for (var t, n = [], r = {}, a = null, i = e.pos; (t = At(e)); )
            "Spaces" !== t.type &&
              ("Combinator" === t.type
        ...
        function At(e) {
          ...
          switch (t) {
            ...
            case 39:
              return wt(e, { type: "String", value: vt(e) });
            case 32:
            case 9:
            case 10:
            case 13:
            ...
            case 64:
              return (t = e.nextCharCode()) < 128 && 1 === mt[t]
                ? (e.pos++, { type: "AtKeyword", name: bt(e) })
                : xt(e);
            case 42:
            case 43:
            case 63:
            ...
            case 33:
              break;
            case 123:
              if ((t = e.nextCharCode()) < 48 || t > 57) return xt(e);
              break;
            default:
              return xt(e);
          }
        ...
        function zt(e) {
          ...
          return (
            ...
            1 === n.terms.length &&
              "Group" === n.terms[0].type &&
              (n = n.terms[0]),
            n
          );
        }
        zt("[a&&<b>#|<'c'>*||e() f{2} /,(% g#{1,2} h{2,})]!");
        var Pt = zt,
          Lt = function () {};
        function Tt(e) {
          return "function" == typeof e ? e : Lt;
        }
        ...
        function It(e, t) {
          ...
          for (we(e, Ot); !Ot.eof; ) {
            if (t)
              for (; a < t.length && r + t[a].len <= Ot.tokenStart; )
                (r += t[a++].len), (i = t[a].node);
            n.push({
              type: Ot.tokenType,
              value: Ot.getTokenValue(),
              index: Ot.tokenIndex,
              balance: Ot.balance[Ot.tokenIndex],
              node: i,
            }),
              Ot.next();
          }
        ...
        var Rt = { type: "Match" },
          Nt = { type: "Mismatch" },
          Bt = { type: "DisallowEmpty" };
        function Mt(e, t, n) {
          return (t === Rt && n === Nt) || (e === Rt && t === Rt && n === Rt)
            ? e
            : ("If" === e.type &&
                e.else === Nt &&
                t === Rt &&
          ...
          switch (e.type) {
            case "Group":
              var t = (function e(t, n, r) {
                switch (t) {
                  case " ":
                    for (var a = Rt, i = n.length - 1; i >= 0; i--)
                      a = Mt((l = n[i]), a, Nt);
                    return a;
                  case "|":
                    a = Nt;
                    ...
                    for (i = n.length - 1; i >= 0; i--) {
                      if (
                        ...
                        var s = (
                          jt(l.name) ? l.name.slice(0, -1) : l.name
                        ).toLowerCase();
                        if (s in o == 0) {
                          o[s] = l;
                          continue;
                  ...
                  case "||":
                    ...
                    for (a = r ? Rt : Nt, i = n.length - 1; i >= 0; i--) {
                      var c;
                      (l = n[i]),
                        (c =
                          n.length > 1
              ...
              })(e.combinator, e.terms.map(qt), !1);
              return e.disallowEmpty && (t = Mt(t, Bt, Nt)), t;
            case "Multiplier":
              return (function (e) {
                var t = Rt,
                  n = qt(e.term);
                if (0 === e.max)
                  (n = Mt(n, Bt, Nt)),
                    ((t = Mt(n, null, Nt)).then = Mt(Rt, Rt, t)),
                    e.comma &&
                      (t.then.else = Mt({ type: "Comma", syntax: e }, t, Nt));
                else
                  for (var r = e.min || 1; r <= e.max; r++)
                    e.comma &&
                      t !== Rt &&
                      (t = Mt({ type: "Comma", syntax: e }, t, Nt)),
                      (t = Mt(n, Mt(Rt, Rt, t), Nt));
                if (0 === e.min) t = Mt(Rt, Rt, t);
                else
                  for (r = 0; r < e.min - 1; r++)
                    e.comma &&
                      t !== Rt &&
        ...
        function Qt(e) {
          return (
            ...
            e.type === Gt.Comma ||
            e.type === Gt.Function ||
            e.type === Gt.LeftParenthesis ||
            e.type === Gt.LeftSquareBracket ||
            e.type === Gt.LeftCurlyBracket ||
            (function (e) {
              return e.type === Gt.Delim && "?" !== e.value;
            })(e)
          );
        }
        function Xt(e) {
          return (
            null === e ||
            e.type === Gt.RightParenthesis ||
            e.type === Gt.RightSquareBracket ||
            e.type === Gt.RightCurlyBracket ||
            e.type === Gt.Delim
          );
        }
        function Zt(e) {
        ...
        function an(e) {
          return Boolean(e) && rn(e.offset) && rn(e.line) && rn(e.column);
        }
        function on(e, t) {
          return function (n, r) {
              ...
              if (!1 !== nn.call(n, a)) {
                if ("type" === a)
                  ...
                  if (n.loc && n.loc.constructor === Object)
                    ...
                    else if (an(n.loc.start)) {
                      if (an(n.loc.end)) continue;
                      a += ".end";
                    } else a += ".start";
                  o = !1;
                } else if (t.hasOwnProperty(a)) {
                  var s = 0;
                  for (o = !1; !o && s < t[a].length; s++) {
                    var l = t[a][s];
                    switch (l) {
                      case String:
                        o = "string" == typeof n[a];
                      ...
                      default:
                        "string" == typeof l
                          ? (o = n[a] && n[a].type === l)
                          : Array.isArray(l) && (o = n[a] instanceof i);
                    }
                  }
                } else
                  r(n, "Unknown field `" + a + "` for " + e + " node type");
        ...
        function sn(e, t) {
          ...
          for (var i in n)
            if (!1 !== nn.call(n, i)) {
              for (
                var o = [],
                  s = (r[i] = Array.isArray(n[i]) ? n[i].slice() : [n[i]]),
                  l = 0;
                l < s.length;
                l++
              ) {
        ...
        var ln = function (e, t) {
            ...
            const a = o("SyntaxMatchError", e),
              {
                ...
                return (
                  r === n.length || u > 1
                    ? ((o = $(i || t, "end") || Q(G, h)), (s = Q(o)))
                    : ((o =
                        $(i, "start") || Q($(t, "start") || G, h.slice(0, l))),
                      (s = $(i, "end") || Q(o, h.substr(l, c)))),
                  {
                    css: h,
                    mismatchOffset: l,
                    mismatchLength: c,
          ...
          un = function (e, t) {
            return (
              "string" == typeof e && (e = Pt(e)),
              { type: "MatchGraph", match: qt(e), syntax: t || null, source: e }
            );
          },
          hn = function (e, t, n) {
            var r = (function (e, t, n) {
              function r() {
                do {
                  ...
                  null !== g &&
                  (g.type === Gt.WhiteSpace || g.type === Gt.Comment)
                );
              }
              function a(t) {
                var n = b + t;
              ...
              function o(e) {
                h = { nextState: e, matchStack: v, syntaxStack: u, prev: h };
              }
              function s(e) {
                d = i(e, d);
              }
              function l() {
                (v = { type: 1, syntax: t.syntax, token: g, prev: v }),
                  r(),
                  (p = null),
                  b > y && (y = b);
              }
              function c() {
                (v =
                  2 === v.type
                    ? v.prev
                    : { type: 3, syntax: u.syntax, token: v.token, prev: v }),
                  (u = u.prev);
              }
              var u = null,
                h = null,
                ...
                b = -1,
                y = 0,
                v = { type: 0, syntax: null, token: null, prev: null };
              for (r(); null === f && ++m < 15e3; )
                switch (t.type) {
                  case "Match":
                    if (null === h) {
                  ...
                  case "MatchOnceBuffer":
                    ...
                    if (t.mask === (1 << k.length) - 1) {
                      t = Ht;
                      break;
                    }
                    for (; t.index < k.length; t.index++) {
                      var w = 1 << t.index;
                      if (0 == (t.mask & w)) {
                        s(t),
                          o({
                  ...
                  case "Enum":
                    if (
                      null !== g &&
                      (-1 !== (z = g.value.toLowerCase()).indexOf("\\") &&
                        (z = z.replace(/\\[09].*$/, "")),
                      Yt.call(t.map, z))
                    ) {
                      t = t.map[z];
                  ...
                  case "Property":
                    ...
                    if (
                      ...
                      null !== g &&
                      "Type" === t.type &&
                      (("custom-ident" === t.name && g.type === Gt.Ident) ||
                  ...
                  case "Token":
                    ...
                    break;
                  case "Comma":
                    null !== g && g.type === Gt.Comma
                      ? Qt(v.token)
                        ? (t = Vt)
                        : (l(), (t = Xt(g) ? Vt : Ht))
                      : (t = Qt(v.token) || Xt(g) ? Ht : Vt);
                    break;
                  case "String":
                    var L = "";
            ...
            for (
              ...
              switch (a.type) {
                case 2:
                  i.match.push((i = { syntax: a.syntax, match: [] })),
                    o.push(i);
                  break;
                case 3:
          ...
          dn = un("inherit | initial | unset"),
          pn = un("inherit | initial | unset | <-ms-legacy-expression>");
        function mn(e, t, n) {
          var r = {};
          for (var a in e)
            e[a].syntax &&
              (r[a] = n ? e[a].syntax : K(e[a].syntax, { compact: t }));
          return r;
        }
        function fn(e, t, n) {
          const r = {};
          for (const [a, i] of Object.entries(e))
            r[a] = {
              prelude:
                i.prelude &&
                (n ? i.prelude.syntax : K(i.prelude.syntax, { compact: t })),
              descriptors: i.descriptors && mn(i.descriptors, t, n),
            };
          return r;
        }
        function gn(e, t, n) {
          return {
            ...
            iterations: n,
            error: t,
            getTrace: en.getTrace,
            isType: en.isType,
            isProperty: en.isProperty,
            isKeyword: en.isKeyword,
          };
        }
        function bn(e, t, n, r) {
          var a,
            i = (function (e, t) {
              return "string" == typeof e ? It(e, null) : t.generate(e, Dt);
            })(n, e.syntax);
          return (function (e) {
            ...
            : (r && (a = hn(i, e.valueCommonSyntax, e)),
              (r && a.match) || (a = hn(i, t.match, e)).match
                ? gn(a.match, null, a.iterations)
                : gn(null, new cn(a.reason, t.syntax, n, a), a.iterations));
        }
        var yn = function (e, t, n) {
          if (
            ((this.valueCommonSyntax = dn),
            (this.syntax = t),
            (this.generic = !1),
            (this.atrules = {}),
            (this.properties = {}),
            ...
            if (e.generic)
              for (var r in ((this.generic = !0), ut)) this.addType_(r, ut[r]);
            if (e.atrules)
        ...
        yn.prototype = {
          ...
          addType_: function (e, t) {
            t &&
              ...
              t === ut["-ms-legacy-expression"] &&
                (this.valueCommonSyntax = pn));
          },
          checkAtruleName: function (e) {
            if (!this.getAtrule(e)) return new ln("Unknown at-rule", "@" + e);
          },
          ...
          matchDeclaration: function (e) {
            return "Declaration" !== e.type
              ? gn(null, new Error("Not a Declaration node"))
              : this.matchProperty(e.property, e.value);
          },
          matchProperty: function (e, t) {
            var n = this.checkPropertyName(e);
            return n ? gn(null, n) : bn(this, this.getProperty(e), t, !0);
          },
          matchType: function (e, t) {
            var n = this.getType(e);
            return n ? bn(this, n, t, !1) : gn(null, new ln("Unknown type", e));
          },
          match: function (e, t) {
            return "string" == typeof e || (e && e.type)
              ? (("string" != typeof e && e.match) ||
                ...
                bn(this, e, t, !1))
              : gn(null, new ln("Bad syntax"));
          },
          findValueFragments: function (e, t, n, r) {
            return tn(this, t, this.matchProperty(e, t), n, r);
          },
          findDeclarationValueFragments: function (e, t, n) {
            return tn(this, e.value, this.matchDeclaration(e), t, n);
          },
          ...
          dump: function (e, t) {
            return {
              ...
              types: mn(this.types, !t, e),
              properties: mn(this.properties, !t, e),
              atrules: fn(this.atrules, !t, e),
            };
          },
          toString: function () {
        ...
        var vn = yn,
          kn = { SyntaxError: ht, parse: Pt, generate: K, walk: Et },
          wn = we.isBOM,
          xn = function () {
            (this.lines = null),
              (this.columns = null),
              ...
              ((function (e, t) {
                for (
                  var n = t.length,
                    ...
                    i = ae(e.columns, n),
                    o = e.startColumn,
                    s = t.length > 0 ? wn(t.charCodeAt(0)) : 0;
                  s < n;
                  s++
                ) {
        ...
        var Sn = xn,
          ...
          { findWhiteSpaceStart: Ln, cmpStr: Tn } = M,
          En = function () {},
          On = h.TYPE,
          Dn = h.NAME,
          In = On.WhiteSpace,
        ...
        var Fn =
          ...
          Un = function (e) {
            if (0 <= e && e < Fn.length) return Fn[e];
          ...
          Vn =
            ...
            Hn.toSetString,
            Hn.fromSetString,
            Hn.compareByOriginalPositions,
            Hn.compareByGeneratedPositionsDeflated,
            Hn.compareByGeneratedPositionsInflated,
            Hn.parseSourceMapInput,
            Hn.computeSourceURL,
            Object.prototype.hasOwnProperty),
          Kn = "undefined" != typeof Map;
        function Gn() {
          (this._array = []),
            (this._set = Kn ? new Map() : Object.create(null));
        }
        (Gn.fromArray = function (e, t) {
          for (var n = new Gn(), r = 0, a = e.length; r < a; r++)
            n.add(e[r], t);
          return n;
        }),
          ...
          (Gn.prototype.add = function (e, t) {
            var n = Kn ? e : Hn.toSetString(e),
              r = Kn ? this.has(e) : Vn.call(this._set, n),
              a = this._array.length;
            (r && !t) || this._array.push(e),
              r || (Kn ? this._set.set(e, a) : (this._set[n] = a));
          }),
          (Gn.prototype.has = function (e) {
            if (Kn) return this._set.has(e);
            var t = Hn.toSetString(e);
            return Vn.call(this._set, t);
          }),
          (Gn.prototype.indexOf = function (e) {
            if (Kn) {
              ...
              var n = Hn.toSetString(e);
              if (Vn.call(this._set, n)) return this._set[n];
            }
            throw new Error('"' + e + '" is not in the set.');
          }),
          (Gn.prototype.at = function (e) {
        ...
        (Qn.prototype.unsortedForEach = function (e, t) {
          ...
          (Qn.prototype.add = function (e) {
            ...
            (n = e),
              ...
              a > r ||
              (a == r && o >= i) ||
              Hn.compareByGeneratedPositionsInflated(t, n) <= 0
          ...
          (Qn.prototype.toArray = function () {
            return (
              this._sorted ||
                (this._array.sort(Hn.compareByGeneratedPositionsInflated),
                (this._sorted = !0)),
              this._array
            );
          });
        var Xn = $n,
          Zn = { MappingList: Qn }.MappingList;
        function Jn(e) {
          e || (e = {}),
            (this._file = Hn.getArg(e, "file", null)),
            (this._sourceRoot = Hn.getArg(e, "sourceRoot", null)),
            (this._skipValidation = Hn.getArg(e, "skipValidation", !1)),
            (this._sources = new Xn()),
            (this._names = new Xn()),
            (this._mappings = new Zn()),
            (this._sourcesContents = null);
        }
        (Jn.prototype._version = 3),
          (Jn.fromSourceMap = function (e) {
            var t = e.sourceRoot,
              n = new Jn({ file: e.file, sourceRoot: t });
            return (
              e.eachMapping(function (e) {
                ...
                null != e.source &&
                  ((r.source = e.source),
                  null != t && (r.source = Hn.relative(t, r.source)),
                  (r.original = {
                    line: e.originalLine,
          ...
          (Jn.prototype.addMapping = function (e) {
            var t = Hn.getArg(e, "generated"),
              n = Hn.getArg(e, "original", null),
              r = Hn.getArg(e, "source", null),
              a = Hn.getArg(e, "name", null);
          ...
          (Jn.prototype.setSourceContent = function (e, t) {
            var n = e;
            null != this._sourceRoot && (n = Hn.relative(this._sourceRoot, n)),
              null != t
                ? (this._sourcesContents ||
                    (this._sourcesContents = Object.create(null)),
                  (this._sourcesContents[Hn.toSetString(n)] = t))
                : this._sourcesContents &&
                  (delete this._sourcesContents[Hn.toSetString(n)],
                  0 === Object.keys(this._sourcesContents).length &&
                    (this._sourcesContents = null));
          }),
          (Jn.prototype.applySourceMap = function (e, t, n) {
            var r = t;
            if (null == t) {
              if (null == e.file)
                throw new Error(
            ...
            this._mappings.unsortedForEach(function (t) {
              if (t.source === r && null != t.originalLine) {
                ...
                null != s.source &&
                  ((t.source = s.source),
                  null != n && (t.source = Hn.join(n, t.source)),
                  null != a && (t.source = Hn.relative(a, t.source)),
              ...
              e.sources.forEach(function (t) {
                ...
                null != r &&
                  (null != n && (t = Hn.join(n, t)),
                  null != a && (t = Hn.relative(a, t)),
                  this.setSourceContent(t, r));
              }, this);
          }),
          (Jn.prototype._validateMapping = function (e, t, n, r) {
          ...
          (Jn.prototype._serializeMappings = function () {
            for (
              var e,
                t,
                n,
              ...
              if (((e = ""), (t = h[d]).generatedLine !== i))
                for (a = 0; t.generatedLine !== i; ) (e += ";"), i++;
              else if (d > 0) {
                if (!Hn.compareByGeneratedPositionsInflated(t, h[d - 1]))
                  continue;
                e += ",";
              }
              (e += Yn(t.generatedColumn - a)),
                (a = t.generatedColumn),
                null != t.source &&
                  ((r = this._sources.indexOf(t.source)),
                  (e += Yn(r - c)),
                  (c = r),
                  (e += Yn(t.originalLine - 1 - s)),
                  (s = t.originalLine - 1),
                  (e += Yn(t.originalColumn - o)),
                  (o = t.originalColumn),
                  null != t.name &&
          ...
          (Jn.prototype._generateSourcesContent = function (e, t) {
            return e.map(function (e) {
              if (!this._sourcesContents) return null;
              null != t && (e = Hn.relative(t, e));
              var n = Hn.toSetString(e);
        ...
        var er = { SourceMapGenerator: Jn }.SourceMapGenerator,
          tr = { Atrule: !0, Selector: !0, Declaration: !0 },
        ...
        var hr = function e(t) {
          ...
          for (var r in t) {
            var a = t[r];
            a &&
              (Array.isArray(a) || a instanceof i
                ? (a = a.map(e))
        ...
        const dr = Object.prototype.hasOwnProperty,
          pr = {
            generic: !0,
            types: br,
            atrules: { prelude: yr, descriptors: yr },
            properties: br,
            ...
            scope: function e(t, n) {
              for (const r in n)
                dr.call(n, r) &&
                  (mr(t[r]) ? e(t[r], fr(n[r])) : (t[r] = fr(n[r])));
              return t;
            },
            atrule: ["parse"],
            pseudo: ["parse"],
        ...
        function br(e, t) {
          if ("string" == typeof t) return gr(e, t);
          const n = Object.assign({}, e);
          for (let r in t)
            dr.call(t, r) && (n[r] = gr(dr.call(e, r) ? e[r] : void 0, t[r]));
          return n;
        }
        function yr(e, t) {
          const n = br(e, t);
          return !mr(n) || Object.keys(n).length ? n : null;
        }
        var vr = (e, t) =>
          (function e(t, n, r) {
            for (const a in r)
              if (!1 !== dr.call(r, a))
                if (!0 === r[a]) a in n && dr.call(n, a) && (t[a] = fr(n[a]));
                else if (r[a])
                  if ("function" == typeof r[a]) {
                    const e = r[a];
                    (t[a] = e({}, t[a])), (t[a] = e(t[a] || {}, n[a]));
                  } else if (mr(r[a])) {
                    const i = {};
                    for (let n in t[a]) i[n] = e({}, t[a][n], r[a]);
                    for (let t in n[a]) i[t] = e(i[t] || {}, n[a][t], r[a]);
                    t[a] = i;
                    ...
                    for (const [n, r] of Object.entries(t[a] || {}))
                      (i[n] = {}), r && e(i[n], r, o);
                    for (const t in n[a])
                      dr.call(n[a], t) &&
                        (i[t] || (i[t] = {}),
                        n[a] && n[a][t] && e(i[t], n[a][t], o));
                    t[a] = i;
                  }
            return t;
          })(e, t, pr);
          ...
          var t = (function (e) {
              var t = {
                ...
                eat: function (e) {
                  if (this.scanner.tokenType !== e) {
                    ...
                    switch (e) {
                      case Nn:
                        this.scanner.tokenType === Bn ||
                        this.scanner.tokenType === Mn
                  ...
                  for (var n in e.parseContext)
                    switch (typeof e.parseContext[n]) {
                      case "function":
                        ...
                        break;
                      case "string":
                        t.context[n] = Wn(e.parseContext[n]);
                    }
                ...
                c = function (e, o) {
                  function c(e, t, n) {
                    ...
                    return (
                      ...
                      (r !== i &&
                        (!(
                          !p.hasOwnProperty(e.type) || !p[e.type](e, m, c, u)
                        ) ||
                          d.call(m, e, t, n) === a))
                    );
                  }
                  ...
                  if ("function" == typeof o) h = o;
                    ...
                    if (s.hasOwnProperty(o.visit))
                      p = o.reverse ? l[o.visit] : s[o.visit];
            ...
            r = (function (e) {
              ...
              return function (e, n) {
                ...
                return (
                  n &&
                    ("function" == typeof n.decorator && (a = n.decorator(a)),
                    n.sourceMap &&
                      (a = (function (e) {
                        var t = new er(),
                          n = 1,
                ...
                fromPlainObject: function (t) {
                  return (
                    e(t, {
                      enter: function (e) {
                        e.children &&
                          e.children instanceof i == 0 &&
                          (e.children = new i().fromArray(e.children));
                      },
                    }),
                    t
                  );
            ...
            o = {
              ...
              TokenStream: H,
              Lexer: vn,
              vendorPrefix: ne.vendorPrefix,
              keyword: ne.keyword,
              property: ne.property,
              isCustomProperty: ne.isCustomProperty,
              definitionSyntax: kn,
              lexer: null,
              createLexer: function (e) {
                return new vn(e, o, o.lexer.structure);
              },
              tokenize: we,
              parse: t,
              walk: n,
              ...
              fork: function (t) {
                var n = vr({}, e);
                return kr(
                  "function" == typeof t ? t(n, Object.assign) : vr(n, t)
                );
              },
            };
          return (
        ...
        function Er(e, t) {
          ...
          for (
            ...
            Sr(this.scanner.source.charCodeAt(n)) ||
        ...
        function Dr(e, t) {
          if (!xr(this.scanner.source, this.scanner.tokenStart + e, t)) {
            var n = "";
            switch (t) {
              case 110:
                n = "N is expected";
        ...
        function Ir() {
          ...
          if (n !== Lr) {
            ...
            n !== Lr && (this.scanner.skip(e), Or.call(this, !0));
          }
          return (
            ...
            Or.call(this, 0 !== t),
            45 === t ? "-" + this.consume(Lr) : this.consume(Lr)
          );
        }
        var Rr = {
            name: "AnPlusB",
            ...
            parse: function () {
              var e = this.scanner.tokenStart,
                t = null,
                n = null;
              if (this.scanner.tokenType === Lr)
                Or.call(this, !1), (n = this.consume(Lr));
              else if (
                this.scanner.tokenType === Pr &&
                xr(this.scanner.source, this.scanner.tokenStart, 45)
              )
                switch (
                  ((t = "-1"),
                  Dr.call(this, 1, 110),
                  ...
                  case 2:
                    this.scanner.next(), (n = Ir.call(this));
                    break;
                  case 3:
                    Dr.call(this, 2, 45),
                      this.scanner.next(),
                ...
                this.scanner.tokenType === Pr ||
                (this.scanner.isDelim(43) && this.scanner.lookupType(1) === Pr)
              ) {
                var r = 0;
                switch (
                  ((t = "1"),
              ...
              } else if (this.scanner.tokenType === Tr) {
                for (
                  var a = this.scanner.source.charCodeAt(
                      this.scanner.tokenStart
                    ),
                    i =
                      ((r = 43 === a || 45 === a), this.scanner.tokenStart + r);
                  i < this.scanner.tokenEnd &&
                  Sr(this.scanner.source.charCodeAt(i));
                  i++
                );
                i === this.scanner.tokenStart + r &&
                  ...
                  Dr.call(this, i - this.scanner.tokenStart, 110),
                  (t = this.scanner.source.substring(e, i)),
                  i + 1 === this.scanner.tokenEnd
                    ? (this.scanner.next(), (n = Ir.call(this)))
                    : (Dr.call(this, i - this.scanner.tokenStart + 1, 45),
                      i + 2 === this.scanner.tokenEnd
                        ? (this.scanner.next(),
                          this.scanner.skipSC(),
                          Or.call(this, !0),
                          (n = "-" + this.consume(Lr)))
                        : (Er.call(this, i - this.scanner.tokenStart + 2, !0),
                          this.scanner.next(),
          ...
          Br = Nr.WhiteSpace,
          Mr = Nr.Semicolon,
          jr = Nr.LeftCurlyBracket,
          _r = Nr.Delim;
        function qr() {
          return this.scanner.tokenIndex > 0 &&
            this.scanner.lookupType(-1) === Br
        ...
        var Fr = {
            ...
            parse: function (e, t, n) {
              ...
              return (
                this.scanner.skip(this.scanner.getRawLength(e, t || Wr)),
                (r =
                  n && this.scanner.tokenStart > a
                    ? qr.call(this)
                    : this.scanner.tokenStart),
                {
                  type: "Raw",
            ...
            mode: {
              ...
              leftCurlyBracketOrSemicolon: function (e) {
                return e === jr || e === Mr ? 1 : 0;
              },
              exclamationMarkOrSemicolon: function (e, t, n) {
                return (e === _r && 33 === t.charCodeAt(n)) || e === Mr ? 1 : 0;
              },
          ...
          Hr = Ur.AtKeyword,
          Vr = Ur.Semicolon,
          Kr = Ur.LeftCurlyBracket,
          Gr = Ur.RightCurlyBracket;
        function $r(e) {
          return this.Raw(e, Yr.leftCurlyBracketOrSemicolon, !0);
        }
        function Qr() {
          for (var e, t = 1; (e = this.scanner.lookupType(t)); t++) {
            if (e === Gr) return !0;
            if (e === Kr || e === Hr) return !1;
          }
          return !1;
        }
        var Xr = {
            ...
            parse: function () {
              ...
              switch (
                ...
                this.scanner.skipSC(),
                !1 === this.scanner.eof &&
                  this.scanner.tokenType !== Kr &&
                  this.scanner.tokenType !== Vr &&
                  (this.parseAtrulePrelude
                    ? "AtrulePrelude" ===
                      ...
                      (r = null)
                    : (r = $r.call(this, this.scanner.tokenIndex)),
                  this.scanner.skipSC()),
          ...
          ta = {
            ...
            parse: function (e) {
              ...
              return (
                ...
                this.scanner.skipSC(),
                !0 !== this.scanner.eof &&
                  this.scanner.tokenType !== ea &&
                  this.scanner.tokenType !== Jr &&
          ...
          aa = na.String,
          ia = na.Colon,
          oa = na.LeftSquareBracket,
          sa = na.RightSquareBracket;
        function la() {
        ...
        var ua = {
            ...
            parse: function () {
              ...
              return (
                ...
                (e = la.call(this)),
                this.scanner.skipSC(),
                this.scanner.tokenType !== sa &&
                  (this.scanner.tokenType !== ra &&
                    ((n = ca.call(this)),
                    this.scanner.skipSC(),
                    (r =
                      this.scanner.tokenType === aa
                        ? this.String()
                        : this.Identifier()),
                    this.scanner.skipSC()),
                  this.scanner.tokenType === ra &&
          ...
          fa = ha.Semicolon,
          ga = ha.AtKeyword,
          ba = ha.LeftCurlyBracket,
          ya = ha.RightCurlyBracket;
        function va(e) {
          return this.Raw(e, null, !0);
        }
        function ka() {
          return this.parseWithFallback(this.Rule, va);
        }
        function wa(e) {
          return this.Raw(e, da.semicolonIncluded, !0);
        }
        function xa() {
          if (this.scanner.tokenType === fa)
            return wa.call(this, this.scanner.tokenIndex);
          var e = this.parseWithFallback(this.Declaration, wa);
          return this.scanner.tokenType === fa && this.scanner.next(), e;
        }
        var Sa = {
            name: "Block",
              ...
              e: for (; !this.scanner.eof; )
                switch (this.scanner.tokenType) {
                  ...
                  case ma:
                    ...
                    break;
                  case ga:
                    r.push(this.parseWithFallback(this.Atrule, va));
                    break;
                  default:
                    r.push(t.call(this));
                }
              return (
                this.scanner.eof || this.eat(ya),
                {
                  type: "Block",
                  loc: this.getLocation(n, this.scanner.tokenStart),
                  children: r,
          ...
          Ca = we.TYPE,
          Aa = Ca.LeftSquareBracket,
          za = Ca.RightSquareBracket,
          Pa = {
            name: "Brackets",
            structure: { children: [[]] },
            parse: function (e, t) {
          ...
          Va = _a.WhiteSpace;
        function Ka(e) {
          return this.Raw(e, qa.exclamationMarkOrSemicolon, !0);
        }
        function Ga(e) {
          return this.Raw(e, qa.exclamationMarkOrSemicolon, !1);
        }
        function $a() {
          ...
          parse: function () {
            ...
            return (
              this.scanner.isDelim(33) &&
                ((s = Za.call(this)), this.scanner.skipSC()),
              !1 === this.scanner.eof &&
                this.scanner.tokenType !== Ya &&
        ...
        function Xa() {
          ...
          return (
            this.scanner.tokenType === Fa ? this.eat(Fa) : this.eat(Wa),
            this.scanner.substrToCursor(e)
          );
        }
        function Za() {
          this.eat(Ha), this.scanner.skipSC();
          var e = this.consume(Wa);
        ...
        var Ja = we.TYPE,
          ...
          ri = Ja.Semicolon;
        function ai(e) {
          return this.Raw(e, ei.semicolonIncluded, !0);
        }
        var ii = {
              ...
              for (var e = this.createList(); !this.scanner.eof; )
                switch (this.scanner.tokenType) {
                  ...
                  case ri:
                    ...
                    break;
                  default:
                    e.push(this.parseWithFallback(this.Declaration, ai));
                }
              return {
          ...
          oi = M.consumeNumber,
          si = we.TYPE.Dimension,
          li = {
            name: "Dimension",
            structure: { value: String, unit: String },
            parse: function () {
              var e = this.scanner.tokenStart,
                t = oi(this.scanner.source, e);
              return (
                this.eat(si),
                {
                  type: "Dimension",
          ...
          Ai = {
            ...
            parse: function () {
              ...
              if (
                ...
                switch (
                  (this.eat(Si), this.scanner.skipSC(), this.scanner.tokenType)
                ) {
                  case vi:
                    n =
                      this.lookupNonWSType(1) === Ci
                        ? this.Ratio()
                        : this.Number();
                    break;
                  case ki:
          ...
          Ii = {
            ...
            parse: function (e) {
              ...
              for (
                this.scanner.skipSC();
                !this.scanner.eof &&
                (t.push(this.MediaQuery(e)), this.scanner.tokenType === Di);
          ...
          Mi = we.TYPE,
          ji = Mi.LeftParenthesis,
          _i = Mi.RightParenthesis,
          qi = {
            name: "Parentheses",
            structure: { children: [[]] },
            parse: function (e, t) {
          ...
          Wi = M.consumeNumber,
          Fi = we.TYPE.Percentage,
          Ui = {
            name: "Percentage",
            structure: { value: String },
            parse: function () {
              var e = this.scanner.tokenStart,
                t = Wi(this.scanner.source, e);
              return (
                this.eat(Fi),
                {
                  type: "Percentage",
        ...
        function oo() {
          this.scanner.skipWS();
          for (var e = this.consume(ao), t = 0; t < e.length; t++) {
            var n = e.charCodeAt(t);
            no(n) ||
              46 === n ||
              this.error(
          ...
          go = {
            ...
            parse: function () {
              for (
                var e = this.createList();
                !this.scanner.eof &&
                (e.push(this.Selector()), this.scanner.tokenType === fo);
              ...
              for (
                ...
                switch (this.scanner.tokenType) {
                  ...
                  case Co:
                    ...
                    break;
                  case xo:
                    e = this.parseWithFallback(this.Atrule, Ao);
                    break;
                  default:
                    e = this.parseWithFallback(this.Rule, Ao);
                }
                n.push(e);
              }
              return {
        ...
        var To = {
            ...
            parse: function () {
              ...
              return (
                this.scanner.isDelim(124)
                  ? (this.scanner.next(), Lo.call(this))
                  : (Lo.call(this),
                    this.scanner.isDelim(124) &&
                      (this.scanner.next(), Lo.call(this))),
                {
        ...
        function Mo(e, t) {
          for (
            ...
            if (45 === a && t && 0 !== r)
              return 0 === Mo.call(this, e + r + 1, !1) && this.error(), -1;
            Eo(a) ||
              this.error(
                t && 0 !== r
                  ? "HyphenMinus" +
        ...
        function _o(e) {
          this.scanner.source.charCodeAt(this.scanner.tokenStart) !== e &&
            this.error(Io[e] + " is expected");
        }
        function qo() {
          var e = 0;
          return this.scanner.isDelim(43)
            ? (this.scanner.next(),
              this.scanner.tokenType === Ro
                ? void ((e = Mo.call(this, 0, !0)) > 0 && jo.call(this, 6 - e))
                : this.scanner.isDelim(63)
                ? (this.scanner.next(), void jo.call(this, 5))
                : void this.error("Hex digit or question mark is expected"))
            : this.scanner.tokenType === No
            ? (_o.call(this, 43),
              (e = Mo.call(this, 1, !0)),
              this.scanner.isDelim(63)
                ? void jo.call(this, 6 - e)
                : this.scanner.tokenType === Bo || this.scanner.tokenType === No
                ? (_o.call(this, 45), void Mo.call(this, 1, !1))
                : void 0)
            : this.scanner.tokenType === Bo
            ? (_o.call(this, 43),
              void ((e = Mo.call(this, 1, !0)) > 0 && jo.call(this, 6 - e)))
            : void this.error();
        }
        var Wo = {
            name: "UnicodeRange",
            ...
            parse: function () {
              var e = this.scanner.tokenStart;
              return (
                Oo(this.scanner.source, e, 117) || this.error("U is expected"),
                Oo(this.scanner.source, e + 1, 43) ||
              ...
              switch (this.scanner.tokenType) {
                case Vo:
                  for (
                    ...
                    n < r && Fo(this.scanner.source.charCodeAt(n));

                  )
                    n++;
                  for (; n < r && Fo(this.scanner.source.charCodeAt(r - 1)); )
                    r--;
                  (e = {
                    type: "Raw",
          ...
          $o = we.TYPE.WhiteSpace,
          Qo = Object.freeze({ type: "WhiteSpace", loc: null, value: " " }),
          Xo = {
            AnPlusB: Rr,
            Atrule: Xr,
            AtrulePrelude: ta,
            AttributeSelector: ua,
            Block: Sa,
            Brackets: Pa,
            CDC: Ta,
            CDO: Oa,
                ...
                return (
                  ...
                  e && this.scanner.lookupValue(0, "of")
                    ? (this.scanner.next(),
                      (a = this.SelectorList()),
                      this.needPositions &&
                        (r = this.getLastListNode(a.children).loc.end.offset))
          ...
          ls = ts.Dimension,
          cs = ts.Percentage,
          us = ts.LeftParenthesis,
          hs = ts.LeftSquareBracket,
          ds = ts.Comma,
          ps = ts.Delim,
          ms = function (e) {
            switch (this.scanner.tokenType) {
              ...
              case os:
                return this.Url();
              case ns:
                return Jo(this.scanner.source, this.scanner.tokenStart, 117) &&
                  Jo(this.scanner.source, this.scanner.tokenStart + 1, 43)
                  ? this.UnicodeRange()
                  : this.Identifier();
              case ps:
          ...
          As = {
            getNode: function (e) {
              switch (this.scanner.tokenType) {
                ...
                case Ss:
                  return this.scanner.lookupType(1) === Ss
          ...
          Ms = {
            parse: {
              prelude: function () {
                ...
                return (
                  (this.lookupNonWSType(0) !== Is &&
                    this.lookupNonWSType(0) !== Bs) ||
        ...
        function Vs() {
          return (
            this.scanner.skipSC(),
            this.scanner.tokenType === Ws && this.lookupNonWSType(1) === Us
          ...
          e: for (; !this.scanner.eof; ) {
            switch (this.scanner.tokenType) {
              ...
              case qs:
                ...
                continue;
              case Fs:
                e = this.Function(Hs, this.scope.AtrulePrelude);
                break;
              case Ws:
                e = this.Identifier();
                break;
              case Ys:
                e = this.Parentheses(Vs, this.scope.AtrulePrelude);
                break;
              default:
                break e;
            }
  ...
  var i = {
      buildIndex: function (e) {
        ...
        return { whitelist: a(e), blacklist: a(e.blacklist), scopes: t };
      },
    },
    o = {
      hasNoChildren: function (e) {
        return !e || !e.children || e.children.isEmpty();
      },
      isNodeChildrenList: function (e, t) {
    ...
    { hasNoChildren: l } = o,
    c = t.property,
    { isNodeChildrenList: u } = o,
    h = Object.prototype.hasOwnProperty,
    d = t.walk,
    { hasNoChildren: p } = o;
  var { isNodeChildrenList: m } = o;
  function f(e) {
  ...
  var g = t.walk,
    b = {
      Atrule: function (e, t, n) {
        if (
          e.block &&
          (null !== this.stylesheet &&
            (this.stylesheet.firstAtrulesAllowed = !1),
          l(e.block))
        )
          n.remove(t);
        else
          switch (e.name) {
            case "charset":
              if (l(e.prelude)) return void n.remove(t);
            ...
            case "import":
              if (
                ...
                return void n.remove(t);
              n.prevUntil(
                t.prev,
                function (e) {
                  if (
                    "Atrule" !== e.type ||
                    ("import" !== e.name && "charset" !== e.name)
                  )
                    return (
                      (this.root.firstAtrulesAllowed = !1), n.remove(t), !0
                    );
                },
                this
              );
              break;
            default:
              var r = s(e.name).basename;
              ("keyframes" !== r && "media" !== r && "supports" !== r) ||
                ((l(e.prelude) || l(e.block)) && n.remove(t));
          }
      },
      ...
      Declaration: function (e, t, n) {
        e.value.children && e.value.children.isEmpty()
          ? n.remove(t)
          : c(e.property).custom &&
      ...
      Raw: function (e, t, n) {
        (u(this.stylesheet, n) || u(this.block, n)) && n.remove(t);
      },
      Rule: function (e, t, n, r) {
        if (p(e.prelude) || p(e.block)) n.remove(t);
        else {
          var a = r.usage;
          !a ||
            (null === a.whitelist && null === a.blacklist) ||
            ((function e(t, n) {
              return (
                t.children.each(function (r, a, i) {
                  var o = !1;
                  d(r, function (r) {
                    if (null === this.selector || this.selector === t)
                      switch (r.type) {
                        case "SelectorList":
                          (null !== this.function &&
                            "not" === this.function.name.toLowerCase()) ||
                            (e(r, n) && (o = !0));
                          break;
                        case "ClassSelector":
                          null === n.whitelist ||
                            null === n.whitelist.classes ||
                            h.call(n.whitelist.classes, r.name) ||
                            (o = !0),
                            null !== n.blacklist &&
                              null !== n.blacklist.classes &&
                              h.call(n.blacklist.classes, r.name) &&
                              (o = !0);
                          break;
                        case "IdSelector":
                          null === n.whitelist ||
                            null === n.whitelist.ids ||
                            h.call(n.whitelist.ids, r.name) ||
                            (o = !0),
                            null !== n.blacklist &&
                              null !== n.blacklist.ids &&
                              h.call(n.blacklist.ids, r.name) &&
                              (o = !0);
                          break;
                        case "TypeSelector":
                          "*" !== r.name.charAt(r.name.length - 1) &&
                            (null === n.whitelist ||
                              null === n.whitelist.tags ||
                              h.call(n.whitelist.tags, r.name.toLowerCase()) ||
                              (o = !0),
                            null !== n.blacklist &&
                              null !== n.blacklist.tags &&
                              h.call(n.blacklist.tags, r.name.toLowerCase()) &&
                              (o = !0));
                      }
                  }),
                    o && i.remove(a);
      ...
      TypeSelector: function (e, t, n) {
        if ("*" === t.data.name) {
          ...
          ("IdSelector" !== r &&
            "ClassSelector" !== r &&
            "AttributeSelector" !== r &&
            "PseudoClassSelector" !== r &&
            "PseudoElementSelector" !== r) ||
            n.remove(t);
        }
      },
      WhiteSpace: function (e, t, n) {
        null !== t.next && null !== t.prev
          ? m(this.stylesheet, n) || m(this.block, n)
            ? n.remove(t)
            : "WhiteSpace" !== t.next.data.type
            ? (f(t.prev.data) || f(t.next.data)) && n.remove(t)
            : n.remove(t)
          : n.remove(t);
      },
    },
  ...
  var x = function (e) {
      e.children.each(function (e, t, n) {
        "Identifier" === e.type &&
          "none" === e.name.toLowerCase() &&
          (n.head === n.tail
            ? (t.data = { type: "Number", loc: e.loc, value: "0" })
            : (function (e, t) {
                var n = t.prev,
                  r = t.next;
                null !== r
                  ? "WhiteSpace" !== r.data.type ||
                    (null !== n && "WhiteSpace" !== n.data.type) ||
                    e.remove(r)
                  : null !== n && "WhiteSpace" === n.data.type && e.remove(n),
                  e.remove(t);
              })(n, t));
      });
    },
      ...
      font: function (e) {
        ...
        t.eachRight(function (e, t) {
          if ("Identifier" === e.type)
            if ("bold" === e.name)
              t.data = { type: "Number", loc: e.loc, value: "700" };
          ...
          t.each(function (e, t) {
            "WhiteSpace" === e.type &&
              ((t.prev && t.next && "WhiteSpace" !== t.next.data.type) ||
                this.remove(t));
          }),
          t.isEmpty() &&
            t.insert(t.createItem({ type: "Identifier", name: "normal" }));
      },
      ...
      background: function (e) {
        ...
        e.children.each(function (e) {
          if ("Operator" === e.type && "," === e.value)
            return n(), void r.push(e);
          ("Identifier" !== e.type ||
            ("transparent" !== e.name &&
              "none" !== e.name &&
              "repeat" !== e.name &&
              "scroll" !== e.name)) &&
            ("WhiteSpace" !== e.type || (a.length && "WhiteSpace" !== t())) &&
            a.push(e);
        }),
          n(),
  ...
  function L(e, t) {
    var n = t && null !== t.prev && P.hasOwnProperty(t.prev.data.type) ? z : A;
    return (
      ("" !== (e = String(e).replace(n, "$1$2$3")) && "-" !== e) || (e = "0"), e
    );
  }
  var T = function (e, t) {
      e.value = L(e.value, t);
  ...
  function F(e, t, n, r) {
    ...
    if (0 === t) a = i = o = n;
      ...
      var s = n < 0.5 ? n * (1 + t) : n + t - n * t,
        l = 2 * n - s;
      (a = W(l, s, e + 1 / 3)), (i = W(l, s, e)), (o = W(l, s, e - 1 / 3));
    }
  ...
  function Y(e, t, n) {
    for (var r = e.head, a = [], i = !1; null !== r; ) {
      ...
      switch (s) {
        ...
        case "Percentage":
          if (i) return;
          (i = !0), a.push({ type: s, value: Number(o.value) });
          break;
        case "Operator":
          if ("," === o.value) {
            if (!i) return;
  ...
  function H(e, t) {
    ...
    6 === n.length &&
      ...
      (n = n[0] + n[2] + n[4]),
      q[n]
        ? (t.data = { type: "Identifier", loc: e.loc, name: q[n] })
        : (e.value = n);
  }
  var V = {
      compressFunction: function (e, t, n) {
        var r,
          a = e.name;
        if ("rgba" === a || "hsla" === a) {
          if (!(r = Y(e.children, 4, "rgba" === a))) return;
          if (
            ("hsla" === a && ((r = F.apply(null, r)), (e.name = "rgba")),
            0 === r[3])
          ) {
            var i = this.function && this.function.name;
            if (
              (0 === r[0] && 0 === r[1] && 0 === r[2]) ||
              !/^(?:to|from|color-stop)$|gradient$/i.test(i)
            )
              return void (t.data = {
                type: "Identifier",
                loc: e.loc,
          ...
          if (1 !== r[3])
            return void e.children.each(function (e, t, n) {
              "Operator" !== e.type
                ? (t.data = {
                    type: "Number",
                    loc: e.loc,
                    value: j(r.shift(), null),
                  })
                : "," !== e.value && n.remove(t);
            });
          a = "rgb";
        ...
        if ("hsl" === a) {
          if (!(r = r || Y(e.children, 3, !1))) return;
          (r = F.apply(null, r)), (a = "rgb");
        }
        if ("rgb" === a) {
          if (!(r = r || Y(e.children, 3, !0))) return;
          var o = t.next;
          o &&
            "WhiteSpace" !== o.data.type &&
            n.insert(n.createItem({ type: "WhiteSpace", value: " " }), o),
            (t.data = {
              type: "Hash",
              loc: e.loc,
              value: U(r[0]) + U(r[1]) + U(r[2]),
            }),
            H(t.data, t);
        }
      },
      compressIdent: function (e, t) {
        if (null !== this.declaration) {
          ...
          if (
            _.hasOwnProperty(n) &&
            M.matchDeclaration(this.declaration).isType(e, "color")
          ) {
            var r = _[n];
            r.length + 1 <= n.length
              ? (t.data = { type: "Hash", loc: e.loc, value: r })
    ...
    G = {
              ...
              e.prelude.children.each(function (e) {
                e.children.each(function (e, t) {
                  "Percentage" === e.type && "100" === e.value
                    ...
                    : "TypeSelector" === e.type &&
                      "from" === e.name &&
                      (t.data = { type: "Percentage", loc: e.loc, value: "0" });
                });
              });
            });
          })(e);
      ...
      AttributeSelector: function (e) {
        ...
        if (t && "String" === t.type) {
          ...
          (function (e) {
            if ("" !== e && "-" !== e)
              return (e = e.replace(v, "a")), !k.test(e);
          })(n) && (e.value = { type: "Identifier", loc: t.loc, name: n });
        }
      },
      Value: function (e) {
        if (this.declaration) {
          var t = S(this.declaration.property);
      ...
      Dimension: function (e, t) {
        ...
        if (
          ((e.value = n),
          "0" === n && null !== this.declaration && null === this.atrulePrelude)
        ) {
          var r = e.unit.toLowerCase();
          if (!D.hasOwnProperty(r)) return;
          if (
            "-ms-flex" === this.declaration.property ||
            "flex" === this.declaration.property
          )
            return;
          if (this.function && O.hasOwnProperty(this.function.name)) return;
          t.data = { type: "Number", loc: e.loc, value: n };
        }
      },
      Percentage: function (e, t) {
        (e.value = R(e.value, t)),
          "0" === e.value &&
            this.declaration &&
            !N.has(this.declaration.property) &&
            ((t.data = { type: "Number", loc: e.loc, value: e.value }),
            I.matchDeclaration(this.declaration).isType(t.data, "length") ||
              (t.data = e));
      },
      Number: T,
      String: function (e) {
      ...
      Url: function (e) {
        ...
        if ("String" === t.type) {
          ...
          (r = r.replace(/\\\\/g, "/")),
            B.test(r)
              ? (e.value = { type: "Raw", loc: e.value.loc, value: r })
              : (e.value.value =
                  -1 === r.indexOf('"') ? '"' + r + '"' : n + r + n);
        }
      },
      Hash: V.compressHex,
      Identifier: V.compressIdent,
      Function: V.compressFunction,
    },
    $ = t.generate;
  function Q() {
  ...
  var X = t.generate,
    Z = { "first-letter": !0, "first-line": !0, after: !0, before: !0 },
    J = {
      link: !0,
      visited: !0,
      hover: !0,
    ...
    re = function (e, t) {
      ...
      return (
                  ...
                  e.children.each(function (o) {
                    switch (o.type) {
                      ...
                      case "PseudoClassSelector":
                        ...
                        J.hasOwnProperty(l) || ((n[":" + l] = !0), (r = !0));
                        break;
                      case "PseudoElementSelector":
                        l = o.name.toLowerCase();
                        Z.hasOwnProperty(l) || ((n["::" + l] = !0), (r = !0));
                        break;
                      case "TypeSelector":
        ...
        te(e, {
          ...
          enter: function (e) {
            e.prelude &&
              ((e.prelude.id = null), (e.prelude.id = ne(e.prelude))),
              "keyframes" === ee(e.name).basename &&
                ((e.block.avoidRulesMerge = !0),
                e.block.children.each(function (e) {
                  e.prelude.children.each(function (e) {
  ...
  function le(e, t, n, r) {
    var a = t.data,
      i = ie(a.name).basename,
      o = a.name.toLowerCase() + "/" + (a.prelude ? a.prelude.id : null);
    oe.call(e, i) || (e[i] = Object.create(null)),
      r && delete e[i][o],
      oe.call(e[i], o) || (e[i][o] = new ae()),
      e[i][o].append(n.remove(t));
  }
  function ce(e) {
  ...
  function ue(e, t, n) {
    if (ce(e)) {
      ...
      r &&
        ...
        e.prelude &&
        r.prelude &&
        e.prelude.id === r.prelude.id &&
        (r.block.children.appendList(e.block.children), n.remove(t));
    }
  }
  var he = function (e, t) {
      !(function (e, t) {
        ...
        for (var a in (e.children.each(function (e, a, i) {
          if ("Atrule" === e.type) {
            var o = ie(e.name).basename;
            switch (o) {
              case "keyframes":
                return void le(n, a, i, !0);
              case "media":
                if (t.forceMediaMerge) return void le(n, a, i, !1);
            }
        ...
        se(e, { visit: "Atrule", reverse: !0, enter: ue });
    },
  ...
  var me = {
      isEqualSelectors: function (e, t) {
        for (
          var n = e.head, r = t.head;
          null !== n && null !== r && n.data.id === r.data.id;
      ...
      compareDeclarations: function (e, t) {
        ...
        for (i = e.head; i; i = i.next) {
          (o = i.data).fingerprint && (r[o.fingerprint] = o.important),
            a[o.id] ? ((a[o.id] = !1), n.eq.push(o)) : n.ne1.push(o);
        }
        for (i = t.head; i; i = i.next) {
          var o;
          a[(o = i.data).id] &&
            ((!de.call(r, o.fingerprint) ||
              (!r[o.fingerprint] && o.important)) &&
              n.ne2.push(o),
            n.ne2overrided.push(o));
        }
        return n;
      },
      ...
      hasSimilarSelectors: pe,
      unsafeToSkipNode: function e(t) {
        switch (t.type) {
          case "Rule":
            return pe(t.prelude.children, this);
          case "Atrule":
  ...
  function ge(e, t, n) {
    ...
    n.prevUntil(t.prev, function (i) {
      if ("Rule" !== i.type) return me.unsafeToSkipNode.call(r, i);
      var o = i.prelude.children,
        s = i.block.children;
      if (e.pseudoSignature === i.pseudoSignature) {
        if (me.isEqualSelectors(o, r)) return s.appendList(a), n.remove(t), !0;
        if (me.isEqualDeclarations(a, s))
          return me.addSelectors(o, r), n.remove(t), !0;
      }
      return me.hasSimilarSelectors(r, o);
    });
  }
  var be = t.List,
    ye = t.walk;
  function ve(e, t, n) {
    for (var r = e.prelude.children; r.head !== r.tail; ) {
      var a = new be();
      a.insert(r.remove(r.head)),
        n.insert(
          n.createItem({
            type: "Rule",
            loc: e.loc,
            prelude: { type: "SelectorList", loc: e.prelude.loc, children: a },
            block: {
              type: "Block",
              loc: e.block.loc,
  ...
  function Pe(e, t, n, r) {
    ...
    return (
      e.block.children.eachRight(function (e, o) {
        var s = e.property;
        if (Ae.hasOwnProperty(s)) {
          var l,
            c,
            u = Ae[s];
          (r && i !== r) || (u in t && ((c = 2), (l = t[u]))),
            (l && l.add(s, e)) || ((c = 1), (l = new ze(u)).add(s, e))
              ? ((t[u] = l),
                n.push({ operation: c, block: a, item: o, shorthand: l }),
                (r = i))
              : (r = null);
        }
      }),
  ...
  (ze.prototype.getValueSequence = function (e, t) {
    var n = [],
      r = "";
    return (
      !(
        "Value" !== e.value.type ||
        e.value.children.some(function (t) {
          var a = !1;
          switch (t.type) {
            case "Identifier":
              switch (t.name) {
      ...
      ("string" != typeof this.iehack || this.iehack === r) &&
      ((this.iehack = r), n)
    );
  }),
    (ze.prototype.canOverride = function (e, t) {
      var n = this.sides[e];
      ...
      return (
        !!function () {
          ...
          if (e === this.name) {
            ...
            for (o = 0; o < 4; o++)
              this.canOverride(Se[o], i[o]) && (n[Se[o]] = i[o]);
            return !0;
          }
        }.call(this) && (this.loc || (this.loc = t.loc), !0)
      );
    }),
    (ze.prototype.isOkToMinimize = function () {
    ...
    (ze.prototype.getValue = function () {
      ...
      r[3] === r[1] &&
        (n.pop(), r[2] === r[0] && (n.pop(), r[1] === r[0] && n.pop()));
      for (var a = 0; a < n.length; a++)
        a && e.appendData({ type: "WhiteSpace", value: " " }),
          e.appendData(n[a].node);
      return (
        this.iehack &&
          (e.appendData({ type: "WhiteSpace", value: " " }),
          e.appendData({ type: "Identifier", loc: null, name: this.iehack })),
        { type: "Value", loc: null, children: e }
      );
    }),
    (ze.prototype.getDeclaration = function () {
      return {
        type: "Declaration",
        loc: this.loc,
  ...
  var Le = function (e, t) {
      ...
      xe(e, {
        ...
        enter: function (e) {
          ...
          n.hasOwnProperty(i.id)
            ? (t = n[i.id])
            : ((t = { lastShortSelector: null }), (n[i.id] = t)),
            t.hasOwnProperty(o) ? (a = t[o]) : ((a = {}), (t[o] = a)),
            (t.lastShortSelector = Pe.call(this, e, a, r, t.lastShortSelector));
        },
      }),
        (function (e, t) {
          e.forEach(function (e) {
            ...
            n.isOkToMinimize() &&
              (1 === e.operation
                ? (e.item.data = t(n.getDeclaration()))
  ...
  function je(e, t, n) {
    var r = Te(e).basename;
    if ("background" === r) return e + ":" + De(t.value);
    var a = t.id,
      i = n[a];
    if (!i) {
      switch (t.value.type) {
          ...
          t.value.children.each(function e(t) {
            switch (t.type) {
              ...
              case "Identifier":
                var n = t.name;
                o || (o = Ee(n).vendor),
                  /\\[09]/.test(n) && (s = RegExp.lastMatch),
                  Be.hasOwnProperty(r)
                    ? -1 === Be[r].indexOf(n) && (l[n] = !0)
                    : Ne.hasOwnProperty(r) && Ne[r].test(n) && (l[n] = !0);
                break;
              case "Function":
                n = t.name;
                if ((o || (o = Ee(n).vendor), "rect" === n))
  ...
  function _e(e, t, n, r, a) {
    ...
    i.eachRight(function (e, t) {
      var n,
        o = e.property,
        s = je(o, e, a);
      (n = r[s]) && !Re.hasOwnProperty(o)
        ? e.important && !n.item.data.important
          ? ((r[s] = { block: i, item: t }), n.block.remove(n.item))
          : i.remove(t)
        : (n = (function (e, t, n) {
            var r = Te(t.property);
            if (Me.hasOwnProperty(r.basename))
              for (var a = Me[r.basename], i = 0; i < a.length; i++) {
                var o = je(r.prefix + a[i], t, n),
                  s = e.hasOwnProperty(o) ? e[o] : null;
                if (s && (!t.important || s.item.data.important)) return s;
              }
          })(r, e, a))
        ? i.remove(t)
        : ((e.fingerprint = s), (r[s] = { block: i, item: t }));
    }),
  ...
  function We(e, t, n) {
    ...
    n.nextUntil(t.next, function (t, s) {
      if ("Rule" !== t.type) return me.unsafeToSkipNode.call(r, t);
      ...
      if (r.head === r.tail && r.first().id === l.data.id)
        return a.appendList(c), void n.remove(s);
      if (me.isEqualDeclarations(a, c)) {
        var h = l.data.id;
        return (
          r.some(function (e, t) {
            var n = e.id;
  ...
  function Ve(e, t, n) {
    ...
    n.prevUntil(t.prev, function (c, u) {
      var h = c.block,
        d = c.type;
      if ("Rule" !== d) {
        var p = me.unsafeToSkipNode.call(a, c);
        return (
          !p &&
            "Atrule" === d &&
            h &&
      ...
      if (
        ...
        return !0;
      if (s && me.isEqualSelectors(m, a))
        return h.children.appendList(i.children), n.remove(t), !0;
      var f = me.compareDeclarations(i.children, h.children);
      if (f.eq.length) {
        if (!f.ne1.length && !f.ne2.length)
          return l && (me.addSelectors(a, m), n.remove(u)), !0;
        if (!r)
          if (f.ne1.length && !f.ne2.length) {
            var g = Ye(a),
              b = He(f.eq);
            s &&
              g < b &&
              (me.addSelectors(m, a), (i.children = new Fe().fromArray(f.ne1)));
          } else if (!f.ne1.length && f.ne2.length) {
            (g = Ye(m)), (b = He(f.eq));
            l &&
              g < b &&
              (me.addSelectors(a, m), (h.children = new Fe().fromArray(f.ne2)));
          } else {
            var y = {
                type: "SelectorList",
                loc: null,
                children: me.addSelectors(m.copy(), a),
              },
              v = Ye(y.children) + 2;
            if ((b = He(f.eq)) >= v) {
              var k = n.createItem({
                ...
                block: {
                  type: "Block",
                  loc: null,
                  children: new Fe().fromArray(f.eq),
                },
                pseudoSignature: e.pseudoSignature,
              });
              return (
                (i.children = new Fe().fromArray(f.ne1)),
                (h.children = new Fe().fromArray(f.ne2overrided)),
                s ? n.insert(k, u) : n.insert(k, t),
                !0
              );
            }
          }
  ...
  var Ke = function (e, t) {
      ...
      t.logger("prepare", e),
        ...
        (function (e) {
          fe(e, { visit: "Rule", enter: ge });
        })(e),
        t.logger("initialMergeRuleset", e),
        (function (e) {
          ye(e, { visit: "Rule", reverse: !0, enter: ve });
        })(e),
            ...
            enter: function (e, r, a) {
              var i,
                ...
                l =
                  (e.pseudoSignature || "") +
                  "|" +
                  e.prelude.children.first().id;
              t.hasOwnProperty(s.id)
                ? (i = t[s.id])
                : ((i = {}), (t[s.id] = i)),
                i.hasOwnProperty(l) ? (o = i[l]) : ((o = {}), (i[l] = o)),
                _e.call(this, e, r, a, o, n);
            },
          });
        })(e),
        t.logger("restructBlock", e),
        (function (e) {
          qe(e, { visit: "Rule", enter: We });
        })(e),
        t.logger("mergeRuleset", e),
        (function (e) {
          Ue(e, { visit: "Rule", reverse: !0, enter: Ve });
        })(e),
  ...
  function Xe(e, t) {
    var n,
      ...
      a = !1;
    return (
      e.nextUntil(e.head, function (e, i, o) {
        if ("Comment" === e.type)
          return t && "!" === e.value.charAt(0)
            ? !(!a && !n) || (o.remove(i), void (n = e))
            : void o.remove(i);
        "WhiteSpace" !== e.type && (a = !0), r.insert(o.remove(i));
      }),
      { comment: n, stylesheet: { type: "StyleSheet", loc: null, children: r } }
    );
  }
  function Ze(e, t, n, r) {
      ...
      (function (e, t) {
        g(e, {
          leave: function (e, n, r) {
            b.hasOwnProperty(e.type) && b[e.type].call(this, e, n, r, t);
          },
        });
      })(e, r),
      r.logger("clean", e),
      (function (e) {
        K(e, {
          leave: function (e, t, n) {
            G.hasOwnProperty(e.type) && G[e.type].call(this, e, t, n);
          },
        });
      })(e),
      r.logger("replace", e),
      r.restructuring && Ke(e, r),
      e
    );
  }
  function Je(e) {
    return "restructure" in e
      ? e.restructure
      : !("restructuring" in e) || e.restructuring;
  }
  var et,
    tt = function (e, t) {
      e = e || { type: "StyleSheet", loc: null, children: new Ge() };
      var n,
        r,
        a,
        o,
        s = {
          logger:
            "function" == typeof (t = t || {}).logger
              ? t.logger
              : function () {},
          restructuring: Je(t),
          forceMediaMerge: Boolean(t.forceMediaMerge),
          usage: !!t.usage && i.buildIndex(t.usage),
        },
        l = (function (e) {
          ...
          return (
            "boolean" == typeof t
              ? (t = !!t && "exclamation")
              : "exclamation" !== t && "first-exclamation" !== t && (t = !1),
            t
          );
        })(t),
        c = !0,
      ...
      do {
        if (
          (Ze((r = Xe(n, Boolean(l))).stylesheet, c, h++, s),
          (a = r.stylesheet.children),
          r.comment &&
            (u.isEmpty() ||
              u.insert(Ge.createItem({ type: "Raw", value: "\n" })),
            u.insert(Ge.createItem(r.comment)),
            a.isEmpty() ||
              u.insert(Ge.createItem({ type: "Raw", value: "\n" }))),
          c && !a.isEmpty())
        ) {
          var d = a.last();
          ("Atrule" !== d.type ||
            ("import" !== d.name && "charset" !== d.name)) &&
            (c = !1);
        }
        "exclamation" !== l && (l = !1), u.appendList(a);
      } while (!n.isEmpty());
      return { ast: e };
    },
    nt = { version: "4.2.0" },
      ...
      "function" !=
        ...
        (e.logger =
          ...
          function (e, r) {
            var a = e;
            if (
              (r && (a = "[" + ((Date.now() - n) / 1e3).toFixed(3) + "s] " + a),
              t > 1 && r)
            ) {
              var i = it(r);
  ...
  function ct(e, t, n) {
    var r = (n = n || {}).filename || "<unknown>",
      a = ot(
        ...
        n,
        Date.now(),
        at(t, { context: e, filename: r, positions: Boolean(n.sourceMap) })
      );
    n.beforeCompress &&
      ot("beforeCompress", n, Date.now(), lt(a, n, n.beforeCompress));
    var i,
      o = ot("compress", n, Date.now(), tt(a, st(n)));
    return (
      n.afterCompress &&
        ot("afterCompress", n, Date.now(), lt(o, n, n.afterCompress)),
      n.sourceMap
        ? ot(
            "generate(sourceMap: true)",
            n,
            Date.now(),
            (((i = it(o.ast, { sourceMap: !0 })).map._file = r),
            i.map.setSourceContent(r, t),
            i)
          )
        : ot("generate", n, Date.now(), { css: it(o.ast), map: null })
    );
  }
  var ut = {
      version: rt.version,
      minify: function (e, t) {
        return ct("stylesheet", e, t);
      },
      minifyBlock: function (e, t) {
        return ct("declarationList", e, t);
      },
      syntax: Object.assign({ compress: tt }, t),
    },
    ht = ut.version,
    dt = ut.minify,
    pt = ut.minifyBlock,
