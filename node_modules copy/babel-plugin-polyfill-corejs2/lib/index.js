...
var _corejs2BuiltIns = _interopRequireDefault(
  require("@babel/compat-data/corejs2-built-ins")
);
var _builtInDefinitions = require("./built-in-definitions");
var _addPlatformSpecificPolyfills = _interopRequireDefault(
  require("./add-platform-specific-polyfills")
);
...
var _default = (0, _helperDefinePolyfillProvider.default)(function (
  ...
  const polyfills = (0, _addPlatformSpecificPolyfills.default)(
    api.targets,
    method,
  ...
  function maybeInjectPure(desc, hint, utils) {
    ...
    if (
      ...
      !(0, _helpers.hasMinVersion)(
        meta && meta.minRuntimeVersion,
        runtimeVersion
      )
    ) {
      return;
