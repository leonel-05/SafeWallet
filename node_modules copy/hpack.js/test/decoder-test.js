...
describe("hpack/decoder", function () {
  ...
  describe("integer", function () {
    ...
    it("should throw on overflowing int", function () {
      decoder.push([
        0b11111111, 0b10011010, 0b10011010, 0b10011010, 0b10011010, 0b10011010,
      ]);
      decoder.skipBits(3);
      assert.throws(function () {
        decoder.decodeInt();
  ...
  describe("string", function () {
    ...
    it("should decode literal from (C.4.1)", function () {
      decoder.push(
        new Buffer(
          "8c" + "f1e3 c2e5 f23a 6ba0 ab90 f4ff".replace(/ /g, ""),
          "hex"
        )
      );

      assert.equal(
        new Buffer(decoder.decodeStr()).toString(),
        "www.example.com"
      );
    });
    ...
    it("should decode literal from (C.4.2)", function () {
      decoder.push(
        new Buffer("86" + "a8eb 1064 9cbf".replace(/ /g, ""), "hex")
      );
    ...
    it("should decode literal from (C.4.3) #1", function () {
      decoder.push(
        new Buffer("88" + "25a8 49e9 5ba9 7d7f".replace(/ /g, ""), "hex")
      );
    ...
    it("should decode literal from (C.4.3) #2", function () {
      decoder.push(
        new Buffer("89" + "25a8 49e9 5bb8 e8b4 bf".replace(/ /g, ""), "hex")
      );
    ...
    it("should decode literal from (C.6.1) #2", function () {
      decoder.push(
        new Buffer(
          ("91" + "9d29 ad17 1863 c78f 0b97 c8e9 ae82 ae43" + "d3").replace(
            / /g,
            ""
          ),
          "hex"
    ...
    it("should decode many multi-octet chars", function () {
      decoder.push(
        new Buffer("97ffffb1ffff63fffec7fffd8ffffb1ffff63fffec7fffd8", "hex")
      );
