exports.specExamples = [
  {
    id: "C.3.1",
    huffman: false,
    input: "8286 8441 0f77 7777 2e65 7861 6d70 6c65" + "2e63 6f6d",
    output: [
      [":method", "GET"],
      [":scheme", "http"],
      [":path", "/"],
    ...
    table: [[":authority", "www.example.com", 57]],
  },
  {
    id: "C.3.2",
    continuation: true,
  ...
  {
    id: "C.4.1",
    input: "8286 8441 8cf1 e3c2 e5f2 3a6b a0ab 90f4" + "ff",
    output: [
      [":method", "GET"],
      [":scheme", "http"],
      [":path", "/"],
  ...
  },
  {
    id: "C.4.3",
    continuation: true,
    input: "8287 85bf 4088 25a8 49e9 5ba9 7d7f 8925" + "a849 e95b b8e8 b4bf",
    output: [
      [":method", "GET"],
      [":scheme", "https"],
      [":path", "/index.html"],
