!(function (n, t) {
  ...
  function T(n) {
    if (!E(n)) return Ae(n);
    var t = [];
    for (var e in Object(n)) _e.call(n, e) && "constructor" != e && t.push(e);
    return t;
  }
  function _(n) {
    return d(n) ? x(n) : T(n);
  ...
  function I(n) {
    ...
    return function u() {
      var i = t[++e];
      return "__proto__" === i ? u() : e < r ? { value: n[i], key: i } : null;
    };
  }
  function M(n) {
    if (d(n)) return B(n);
    ...
    return function (t, e, r) {
      function u(n, t) {
        if (((f -= 1), n)) (c = !0), r(n);
          ...
          if (t === _t || (c && f <= 0)) return (c = !0), r(null);
          a || i();
        }
      }
      function i() {
  ...
  function Kn(n, t, e) {
    ...
    Ie(
      ...
      function (n, t) {
        return n ? e(n) : void e(null, K(t.sort(r), Bn("value")));
      }
    );
  }
  function Xn(n, t, e) {
