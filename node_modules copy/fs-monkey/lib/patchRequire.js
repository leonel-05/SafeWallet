...
var correctPath = isWin32
  ? require("./correctPath").correctPath
  : function (p) {
      return p;
    };
...
function patchRequire(vol) {
  ...
  function readPackage(requestPath) {
    ...
    try {
      ...
      pkg = packageMainCache[requestPath] =
        (pkgJson.exports && pkgJson.exports.require) || pkgJson.main;
    } catch (e) {
      e.path = jsonPath;
  ...
  Module._findPath = function (request, paths, isMain) {
    ...
    var exts;
    var trailingSlash =
      request.length > 0 && request.charCodeAt(request.length - 1) === 47;
