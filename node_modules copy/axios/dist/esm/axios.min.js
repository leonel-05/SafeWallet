...
const l = i("string"),
  ...
  g = s("FileList"),
  w = s("URLSearchParams"),
  [E, O, R, S] = ["ReadableStream", "Request", "Response", "Headers"].map(s);
...
const v =
  ...
  x = (e) => !c(e) && e !== v;
const C =
  ((N = "undefined" != typeof Uint8Array && n(Uint8Array)),
  (e) => N && e instanceof N);
var N;
...
const B = s("AsyncFunction"),
  D =
    ((k = "function" == typeof setImmediate),
    (q = f(v.postMessage)),
    k
      ? setImmediate
      : q
      ? ((I = `axios@${Math.random()}`),
        ...
        v.addEventListener(
          "message",
          ({ source: e, data: t }) => {
            e === v && t === I && M.length && M.shift()();
          },
          !1
        ),
        (e) => {
          M.push(e), v.postMessage(I, "*");
        })
      : (e) => setTimeout(e));
var k, q, I, M;
const z =
    "undefined" != typeof queueMicrotask
      ...
      : ("undefined" != typeof process && process.nextTick) || D,
  H = {
    isArray: a,
    isArrayBuffer: u,
    isBuffer: function (e) {
...
const X = H.toFlatObject(H, {}, null, function (e) {
        ...
        return (
          ...
          a.forEach(function (e, r) {
            !H.isUndefined(e) &&
              null !== e &&
              t.append(
                !0 === i ? G([n], r, s) : null === i ? n : n + "[]",
                c(e)
              );
          }),
          !1
        );
    return !!V(e) || (t.append(G(o, n, s), c(e)), !1);
  }
  const l = [],
    f = Object.assign(X, {
      defaultVisitor: u,
          ...
          H.forEach(n, function (n, s) {
            !0 ===
              (!(H.isUndefined(n) || null === n) &&
                o.call(t, n, H.isString(s) ? s.trim() : s, r, f)) &&
              e(n, r ? r.concat(s) : [s]);
          }),
          l.pop();
      }
...
function de(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (((s = !s && H.isArray(r) ? r.length : s), a))
      return H.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i;
...
class Ee {
  ...
  set(e, t, n) {
    ...
    else if (H.isHeaders(e)) for (const [t, r] of e.entries()) o(r, t, n);
    else null != e && o(t, e, n);
    return this;
  }
  get(e, t) {
...
Ee.accessor([
  ...
  H.reduceDescriptors(Ee.prototype, ({ value: e }, t) => {
...
const _e = (e) => (e instanceof Oe ? { ...e } : e);
function Fe(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n) {
...
const Le = (e) => {
    ...
    if (
      ...
      (t.url = ne(Pe(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        a.set(
          "Authorization",
          "Basic " +
    ...
    if (
      ...
      (o && H.isFunction(o) && (o = o(t)), o || (!1 !== o && Ne(t.url)))
    ) {
      const e = s && i && je.read(i);
      e && a.set(s, e);
    }
    return t;
  },
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        m.open(r.method.toUpperCase(), r.url, !0),
          ...
          h && (([c, l] = ve(h, !0)), m.addEventListener("progress", c)),
          d &&
            m.upload &&
            (([a, u] = ve(d)),
    ...
    if (t || n) {
      ...
      const o = function (e) {
        if (!n) {
          ...
          r.abort(
            t instanceof J ? t : new Te(t instanceof Error ? t.message : t)
          );
        }
      };
      let s =
  ...
  Me = Ie && "function" == typeof ReadableStream,
  ze =
    Ie &&
    ("function" == typeof TextEncoder
      ? ((He = new TextEncoder()), (e) => He.encode(e))
...
const Je = (e, ...t) => {
  ...
  Ke = Me && Je(() => H.isReadableStream(new Response("").body)),
  Ve = { stream: Ke && ((e) => e.body) };
var $e;
Ie &&
  (($e = new Response()),
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
    !Ve[e] &&
      (Ve[e] = H.isFunction($e[e])
        ? (t) => t[e]()
        : (t, n) => {
            throw new J(
    ...
    return null == n
      ? (async (e) => {
          ...
          if (H.isSpecCompliantForm(e)) {
            const t = new Request(fe.origin, { method: "POST", body: e });
            return (await t.arrayBuffer()).byteLength;
          }
          return H.isArrayBufferView(e) || H.isArrayBuffer(e)
            ? e.byteLength
            : (H.isURLSearchParams(e) && (e += ""),
              H.isString(e) ? (await ze(e)).byteLength : void 0);
        })(t)
      : n;
  },
  Xe = {
    ...
    fetch:
      ...
      (async (e) => {
        ...
        try {
          ...
          let s = await fetch(h);
          const i = Ke && ("stream" === u || "response" === u);
          if (Ke && (a || (i && m))) {
            const e = {};
            ["status", "statusText", "headers"].forEach((t) => {
              e[t] = s[t];
            });
            const t = H.toFiniteNumber(s.headers.get("content-length")),
              [n, r] = (a && xe(t, ve(Ce(a), !0))) || [];
            s = new Response(
              qe(s.body, 65536, n, () => {
                r && r(), m && m();
              }),
          ...
          u = u || "text";
          let b = await Ve[H.findKey(Ve, u) || "text"](s, e);
          return (
            !i && m && m(),
...
const Qe = (e) => `- ${e}`,
  Ze = (e) => H.isFunction(e) || null === e || !1 === e,
  Ye = (e) => {
    e = H.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let s = 0; s < t; s++) {
      ...
      if (
        ((n = e[s]),
        (r = n),
        !Ze(n) && ((r = Xe[(t = String(n)).toLowerCase()]), void 0 === r))
      )
...
function tt(e) {
  ...
  return Ye(e.adapter || pe.adapter)(e).then(
    function (t) {
      return (
        et(e),
...
nt.transitional = function (e, t, n) {
  function r(e, t) {
    return (
      "[Axios v1.7.7] Transitional option '" + e + "'" + t + (n ? ". " + n : "")
    );
  }
  return (n, o, s) => {
    if (!1 === e)
...
class it {
  ...
  getUri(e) {
    return ne(
      Pe((e = Fe(this.defaults, e)).baseURL, e.url),
      e.params,
      e.paramsSerializer
    );
  }
...
const dt = (function t(n) {
  const r = new at(n),
    o = e(at.prototype.request, r);
  return (
    H.extend(o, at.prototype, r, { allOwnKeys: !0 }),
...
(dt.Axios = at),
  ...
  (dt.mergeConfig = Fe),
  (dt.AxiosHeaders = Oe),
  (dt.formToJSON = (e) => de(H.isHTMLForm(e) ? new FormData(e) : e)),
  (dt.getAdapter = Ye),
  (dt.HttpStatusCode = ft),
  (dt.default = dt);
const ht = dt,
  {
    Axios: pt,
