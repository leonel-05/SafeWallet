...
// eslint-disable-next-line max-len
var hslColorWithSpacesRegex =
  /^hsl\(\s{0,31}[-.]?\d+(deg)?\s{1,31}\d*\.?\d+%\s{1,31}\d*\.?\d+%\s{0,31}\)|hsla\(\s{0,31}[-.]?\d+(deg)?\s{1,31}\d*\.?\d+%\s{1,31}\d*\.?\d+%\s{1,31}\/\s{1,31}\d*\.?\d+%?\s{0,31}\)$/;
...
// eslint-disable-next-line max-len
var rgbColorWithSpacesRegex =
  /^rgb\(\s{0,31}[\d]{1,3}\s{1,31}[\d]{1,3}\s{1,31}[\d]{1,3}\s{0,31}\)|rgba\(\s{0,31}[\d]{1,3}\s{1,31}[\d]{1,3}\s{1,31}[\d]{1,3}\s{1,31}\/\s{1,31}[\d]*\.?[.\d]+%?\s{0,31}\)$/i;
...
function isUnit(validUnits, value) {
  ...
  return (
    (numberUpTo == value.length && parseInt(value) === 0) ||
    (numberUpTo > -1 &&
      validUnits.indexOf(value.slice(numberUpTo + 1).toLowerCase()) > -1) ||
    value == "auto" ||
    value == "inherit"
  );
}
