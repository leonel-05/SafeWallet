    ...
    traverseLoop: for (j = i - 1; j >= 0; j--) {
      ...
      if (right.shorthand && isComponentOf(right, left)) {
        ...
        for (k = overriddenComponents.length - 1; k >= 0; k--) {
          ...
          mayOverride =
            configuration[overriddenComponent.name].canOverride || sameValue;
        ...
        if (
          ...
          var nonMergeableValue =
            configuration[right.name].nonMergeableValue === right.value[0][1];
        ...
        for (k = left.components.length - 1; k >= 0; k--) {
          ...
          mayOverride =
            configuration[leftComponent.name].canOverride || sameValue;
          if (
            !everyValuesPair(
              mayOverride.bind(null, validator),
              leftComponent,
        ...
        var rightRestored = configuration[right.name].restore(
          right,
          configuration
        );
        ...
        if (right.shorthand) {
          for (k = right.components.length - 1; k >= 0 && overridable; k--) {
            ...
            mayOverride =
              configuration[overridingComponent.name].canOverride || sameValue;
