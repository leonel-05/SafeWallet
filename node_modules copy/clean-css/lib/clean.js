...
function minifyAll(input, options, maybeSourceMap, maybeCallback) {
  if (options.batch && Array.isArray(input)) {
    return minifyInBatchesFromArray(
      input,
      options,
      maybeSourceMap,
      maybeCallback
  ...
  if (options.batch && typeof input == "object") {
    return minifyInBatchesFromHash(
      input,
      options,
      maybeSourceMap,
      maybeCallback
...
function minifyInBatchesFromArray(
  input,
  options,
  maybeSourceMap,
  maybeCallback
...
function minifyInBatchesFromHash(
  input,
  options,
  maybeSourceMap,
  maybeCallback
  ...
  for (inputKey in input) {
    ...
    outputAsHash[inputKey] = minify(
      inputValue.styles,
      options,
      inputValue.sourceMap
    );
