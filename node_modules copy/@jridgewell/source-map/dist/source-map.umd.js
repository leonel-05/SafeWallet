(function (global, factory) {
  ...
  function encodedMappings(map) {
    var _a;
    var _b;
    return (_a = (_b = cast$2(map))._encoded) !== null && _a !== void 0
      ? _a
      : (_b._encoded = encode(cast$2(map)._decoded));
  }
  /**
  ...
  function decodedMappings(map) {
    var _a;
    return (
      (_a = cast$2(map))._decoded ||
      (_a._decoded = decode(cast$2(map)._encoded))
    );
  }
  /**
  ...
  function generatedPosition(map, source, line, column, bias, all) {
    ...
    const generated =
      (_a = cast$2(map))._bySources ||
      (_a._bySources = buildBySources(
        decodedMappings(map),
        (cast$2(map)._bySourceMemos = sources.map(memoizedState))
      ));
