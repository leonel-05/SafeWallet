!(function (e, t) {
  ...
  function Z({ offset: e, line: t, column: n }, r) {
    ...
    if (r) {
      ...
      (i.offset += r.length),
        (i.line += e.length - 1),
        (i.column = 1 === e.length ? i.column + r.length : e.pop().length + 1);
    }
    return i;
  }
  var $ = function (e, t) {
  ...
  function re(e, t) {
    return (
      (t = t || 0),
      e.length - t >= 2 && 45 === e.charCodeAt(t) && 45 === e.charCodeAt(t + 1)
    );
  }
  function ie(e, t) {
    if (
      ((t = t || 0),
      e.length - t >= 3 && 45 === e.charCodeAt(t) && 45 !== e.charCodeAt(t + 1))
    ) {
      var n = e.indexOf("-", t + 2);
    ...
    mt = {
      ...
      "an-plus-b": function (e, t) {
        ...
        if (e.type === De && 45 === e.value.charCodeAt(0)) {
          ...
          if (
            (e.type !== De && (e = t(++n)), null === e || !Ae(e.value, 0, 110))
          )
            return 0;
          switch (e.value.length) {
            case 1:
  ...
  function Cn(e, t, n) {
    var r = {};
    for (var i in e)
      e[i].syntax && (r[i] = n ? e[i].syntax : G(e[i].syntax, { compact: t }));
    return r;
  }
  function zn(e, t, n) {
    const r = {};
        ...
        "function" == typeof e
          ...
          : ("string" == typeof e
            ...
            Object.defineProperty(a, "match", {
              get: function () {
                return (
                  Object.defineProperty(a, "match", { value: kn(a.syntax, i) }),
                  a.match
                );
              },
            })),
        ...
        if (!1 !== zr.call(r, i))
          if (!0 === r[i]) i in n && zr.call(n, i) && (t[i] = Tr(n[i]));
            ...
            if ("function" == typeof r[i]) {
              ...
              for (const t in n[i])
                zr.call(n[i], t) &&
                  (a[t] || (a[t] = {}), n[i] && n[i][t] && e(a[t], n[i][t], o));
              t[i] = a;
            }
      return t;
    })(e, t, Ar);
  ...
  function Kr() {
    ...
    return (
      ...
      0 === t &&
        43 !== (n = this.scanner.source.charCodeAt(this.scanner.tokenStart)) &&
        45 !== n &&
      ...
      parse: function () {
        ...
        if (this.scanner.tokenType === qr)
          ...
          for (
            ...
            a < this.scanner.tokenEnd && Mr(this.scanner.source.charCodeAt(a));
            a++
          );
  ...
  function wi() {
    ...
    return (
      ...
      n && this.scanner.tokenType === ki && (this.scanner.next(), this.eat(bi)),
      {
        type: "Identifier",
        loc: this.getLocation(e, this.scanner.tokenStart),
  ...
  var ts = {
    ...
    hs = {
      ...
      Nth: {
        ...
        generate: function (e) {
          this.node(e.nth),
            null !== e.selector && (this.chunk(" of "), this.node(e.selector));
        },
      },
      Number: Qa,
      Operator: Xa,
