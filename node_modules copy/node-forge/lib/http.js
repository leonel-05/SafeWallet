...
http.createClient = function (options) {
  ...
  options.url =
    options.url || window.location.protocol + "//" + window.location.host;
  var url;
  try {
  ...
  var client = {
    ...
    persistCookies:
      typeof options.persistCookies === "undefined"
        ? true
        : options.persistCookies,
  };
  ...
  client.setCookie = function (cookie) {
    ...
    if (typeof cookie.name !== "undefined") {
      if (
        ...
        cookie.secure =
          typeof cookie.secure === "undefined" ? true : cookie.secure;
        ...
        if (cookie.secure !== client.secure) {
          var error = new Error(
            "Http client url scheme is incompatible " +
...
http.withinCookieDomain = function (url, cookie) {
  ...
  var domain =
    cookie === null || typeof cookie === "string" ? cookie : cookie.domain;
