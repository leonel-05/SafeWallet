...
const shorthandData = {
  ...
  "padding-block-end": ["padding-right", "padding-bottom", "padding-left"],
  "padding-inline": [
    "padding-inline-start",
    "padding-inline-end",
    "padding-top",
  ...
  "padding-inline-start": ["padding-top", "padding-right", "padding-left"],
  "padding-inline-end": ["padding-right", "padding-bottom", "padding-left"],
  margin: [
    "margin-block",
    "margin-block-start",
    "margin-block-end",
...
const cssDeclarationSorter = ({
  ...
  OnceExit(css) {
    ...
    return __variableDynamicImportRuntime0__(`../orders/${order}.mjs`).then(
      ({ properties }) =>
        processCss({
          css,
