  ...
  })(
    {
      ...
      3: [
        function (e, t, n) {
          ...
          function U(e, t) {
            for (
              var n, i, r = c.repeat(" ", t), o = 0, a = "", s = e.length;
              o < s;
              ...
              if (
                ...
                if (((e.tag = n ? r.tag : "?"), r.represent)) {
                  if (
                    ...
                    "[object Function]" === l.call(r.represent))
                  )
                    i = r.represent(t, o);
                  else {
          ...
          function ne(e, t) {
            t = new D((t = t || {}));
            return (
              t.noRefs || te(e, t), ee(t, 0, e, !0, !0) ? t.dump + "\n" : ""
            );
          }
          (t.exports.dump = ne),
      ...
      4: [
        function (e, t, n) {
          ...
          (((i.prototype = Object.create(Error.prototype)).constructor =
        ...
        function (e, t, n) {
          ...
          function R(e) {
            ...
            return (45 !== n && 46 !== n) ||
              ...
              ((t += 3), 0 !== (n = e.input.charCodeAt(t)) && !O(n))
              ? void 0
              : 1;
          }
          function B(e, t) {
            ...
            if (34 === u) {
              for (
                ...
                if (92 === u) {
                  if (
                    (L(e, n, e.position, !0),
                    S((u = e.input.charCodeAt(++e.position))))
                  )
                    Y(e, !1, t);
                  else if (u < 256 && p[u]) (e.result += f[u]), e.position++;
                  else if (
                    0 <
                    (a = 120 === (c = u) ? 2 : 117 === c ? 4 : 85 === c ? 8 : 0)
                  ) {
                    for (r = a, o = 0; 0 < r; r--)
                      (u = e.input.charCodeAt(++e.position)),
                        0 <=
          ...
          function K(e, t) {
            ...
            for (
              ...
              0 !== i && 45 === i && O(e.input.charCodeAt(e.position + 1));
          ...
          function P(e, t, n, i, r) {
            ...
            if (
                            ...
                            if (
                              ...
                              if (e.line === o) {
                                for (s = e.input.charCodeAt(e.position); I(s); )
                                  s = e.input.charCodeAt(++e.position);
                                if (58 === s)
                                  O((s = e.input.charCodeAt(++e.position))) ||
                                    N(
                                      e,
                    ...
                    : ((a &&
                        (function (e, t) {
                          ...
                          if (I(p)) {
                            for (
                              ;
                              (p = e.input.charCodeAt(++e.position)), I(p);
                          ...
                          for (; 0 !== p; ) {
                            for (
                              q(e),
                                e.lineIndent = 0,
                                p = e.input.charCodeAt(e.position);
                              (!s || e.lineIndent < c) && 32 === p;

                            )
                              e.lineIndent++,
                                (p = e.input.charCodeAt(++e.position));
                            if (
                              (!s && e.lineIndent > c && (c = e.lineIndent),
                              S(p))
                            )
                              u++;
                            else {
                      ...
                      W(e, i)
                        ...
                        ? (function (e, t, n) {
                            ...
                            if (
                              ...
                              ((63 !== f && 45 !== f) ||
                                !(
                                  O((i = e.input.charCodeAt(e.position + 1))) ||
                                  (n && E(i))
                                ))
                            ) {
                              for (
              ...
              if ("?" === e.tag) {
                ...
                m.call(e.typeMap[e.kind || "fallback"], e.tag)
          ...
          function $(e, t) {
            ...
            for (
              -1 !== e &&
                ((n.position = e), N(n, "null byte is not allowed in input")),
                n.input += "\0";
            ...
            (t.exports.safeLoadAll = function (e, t, n) {
              return (
                "object" == typeof t &&
                  ...
                  void 0 === n &&
                  ((n = t), (t = null)),
                H(e, t, h.extend({ schema: o }, n))
              );
            }),
            (t.exports.safeLoad = function (e, t) {
              return G(e, h.extend({ schema: o }, t));
            });
        },
        {
          "./common": 2,
        ...
        function (e, t, n) {
          ...
          (i.prototype.getSnippet = function (e, t) {
            ...
            (i.prototype.toString = function (e) {
              var t = "";
              return (
                this.name && (t += 'in "' + this.name + '" '),
                (t +=
                  "at line " +
                  (this.line + 1) +
                  ", column " +
                  (this.column + 1)),
                e || ((e = this.getSnippet()) && (t += ":\n" + e)),
                t
              );
            }),
            (t.exports = i);
          ...
          t.exports = new i("tag:yaml.org,2002:js/function", {
            ...
            construct: function (e) {
              ...
              return (
                ...
                (e = n.body[0].expression.body.range),
                "BlockStatement" === n.body[0].expression.body.type
                  ? new Function(i, t.slice(e[0] + 1, e[1] - 1))
                  : new Function(i, "return " + t.slice(e[0], e[1]))
              );
            },
            predicate: function (e) {
        ...
        function (e, t, n) {
          ...
          t.exports = new e("tag:yaml.org,2002:js/regexp", {
            ...
            construct: function (e) {
              ...
              return (
                "/" === t[0] &&
                  (n && (e = n[1]), (t = t.slice(1, t.length - e.length - 1))),
                new RegExp(t, e)
              );
            },
            predicate: function (e) {
          ...
          t.exports = new e("tag:yaml.org,2002:timestamp", {
            ...
            construct: function (e) {
              var t,
                ...
                s = null,
                c = u.exec(e);
              if ((null === c && (c = l.exec(e)), null === c))
                throw new Error("Date resolve error");
              if (((t = +c[1]), (n = +c[2] - 1), (i = +c[3]), !c[4]))
              ...
              return (
                c[9] &&
                  ((s = 6e4 * (60 * +c[10] + +(c[11] || 0))),
                  "-" === c[9] && (s = -s)),
                (e = new Date(Date.UTC(t, n, i, r, o, e, a))),
                s && e.setTime(e.getTime() - s),
                e
              );
            },
            instanceOf: Date,
