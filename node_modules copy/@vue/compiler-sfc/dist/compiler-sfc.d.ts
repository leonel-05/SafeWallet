 ...
 */
export declare function rewriteDefaultAST(
  ast: Statement[],
  s: MagicString,
  as: string
): void;

type PropsDestructureBindings = Record<
...
>;
export declare function extractRuntimeProps(
 ...
 */
export declare function resolveTypeElements(
  ctx: TypeResolveContext,
  node: Node &
    MaybeWithScope & {
...
export declare function inferRuntimeType(
  ctx: TypeResolveContext,
...
export declare function extractRuntimeEmits(
  ctx: TypeResolveContext
): Set<string>;
