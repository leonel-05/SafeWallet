...
module.exports = (api, options) => {
  if (options.lintOnSave) {
    ...
    api.chainWebpack((webpackConfig) => {
      ...
      const treatAllAsWarnings =
        lintOnSave === true || lintOnSave === "warning";
      ...
      const eslintWebpackPluginOptions = {
        ...
        cacheLocation: path.format({
          dir: cacheDirectory,
          name: process.env.VUE_CLI_TEST ? "cache" : cacheIdentifier,
          ext: ".json",
        }),
        // plugin options
        context: cwd,
      ...
      webpackConfig
        .plugin("eslint")
        .use(eslintWebpackPlugin, [eslintWebpackPluginOptions]);
    });
  }
  ...
  api.registerCommand(
    "lint",
    {
      ...
      options: {
        ...
        "--output-file [file_path]": "specify file to write report to",
      },
      details:
