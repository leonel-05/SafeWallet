...
export declare function defineProps<TypeProps>(): DefineProps<
...
export declare function defineEmits<T extends ComponentTypeEmits>(): T extends (
  ...args: any[]
) => any
  ? T
  : ShortEmits<T>;
...
export declare function defineSlots<
...
> = ComponentPublicInstance<
  ...
  TypeEl
>;
type ExposedKeys<T, Exposed extends string & keyof T> = "" extends Exposed
  ? T
  : Pick<T, Exposed>;
...
type CompatConfig = Partial<
  Record<DeprecationTypes$1, boolean | "suppress-warning">
> & {
...
export type DefineSetupFnComponent<
  ...
  PP = PublicProps
> = new (props: Props & PP) => CreateComponentPublicInstanceWithMixins<
  Props,
  {},
  {},
  {},
...
export declare function createBaseVNode(
...
export declare const hydrateOnInteraction: HydrationStrategyFactory<
...
export declare function useTemplateRef<
  T = unknown,
  Keys extends string = string
>(key: Keys): Readonly<ShallowRef<T | null>>;
