...
export declare function registerRuntimeHelpers(
  helpers: Record<symbol, string>
): void;
...
export declare function checkCompatEnabled(
  key: CompilerDeprecationTypes,
  context: MergedParserOptions | TransformContext,
  loc: SourceLocation | null,
  ...args: any[]
): boolean;
export declare function warnDeprecation(
  key: CompilerDeprecationTypes,
  context: MergedParserOptions | TransformContext,
  loc: SourceLocation | null,
  ...args: any[]
...
export declare function createTransformContext(
  root: RootNode,
  {
    filename,
    prefixIdentifiers,
...
export declare function createStructuralDirectiveTransform(
  name: string | RegExp,
  fn: StructuralDirectiveTransform
): NodeTransform;

export declare const transformElement: NodeTransform;
export declare function resolveComponentType(
  node: ComponentNode,
  context: TransformContext,
  ssr?: boolean
...
export type PropsExpression =
  ...
  | CallExpression
  | ExpressionNode;
export declare function buildProps(
  node: ElementNode,
  context: TransformContext,
  props: ElementNode["props"] | undefined,
  isComponent: boolean,
...
export declare function buildDirectiveArgs(
  dir: DirectiveNode,
  context: TransformContext
): ArrayExpression;
...
export declare function createVNodeCall(
...
export declare function createArrayExpression(
  elements: ArrayExpression["elements"],
  loc?: SourceLocation
): ArrayExpression;
export declare function createObjectExpression(
  properties: ObjectExpression["properties"],
  loc?: SourceLocation
): ObjectExpression;
export declare function createObjectProperty(
  key: Property["key"] | string,
  value: Property["value"]
): Property;
export declare function createSimpleExpression(
  content: SimpleExpressionNode["content"],
  isStatic?: SimpleExpressionNode["isStatic"],
  loc?: SourceLocation,
  constType?: ConstantTypes
): SimpleExpressionNode;
export declare function createInterpolation(
  content: InterpolationNode["content"] | string,
  loc: SourceLocation
): InterpolationNode;
export declare function createCompoundExpression(
...
type InferCodegenNodeType<T> = T extends typeof RENDER_SLOT
  ? RenderSlotCall
  : CallExpression;
export declare function createCallExpression<
  T extends CallExpression["callee"]
>(
  callee: T,
...
export declare function createConditionalExpression(
  test: ConditionalExpression["test"],
  consequent: ConditionalExpression["consequent"],
  alternate: ConditionalExpression["alternate"],
  newline?: boolean
): ConditionalExpression;
export declare function createCacheExpression(
  index: number,
  value: JSChildNode,
  needPauseTracking?: boolean
): CacheExpression;
export declare function createBlockStatement(
  body: BlockStatement["body"]
): BlockStatement;
export declare function createTemplateLiteral(
  elements: TemplateLiteral["elements"]
): TemplateLiteral;
export declare function createIfStatement(
  test: IfStatement["test"],
  consequent: IfStatement["consequent"],
  alternate?: IfStatement["alternate"]
): IfStatement;
export declare function createAssignmentExpression(
  left: AssignmentExpression["left"],
  right: AssignmentExpression["right"]
): AssignmentExpression;
export declare function createSequenceExpression(
  expressions: SequenceExpression["expressions"]
): SequenceExpression;
export declare function createReturnStatement(
  returns: ReturnStatement["returns"]
): ReturnStatement;
export declare function getVNodeHelper(
  ssr: boolean,
  isComponent: boolean
): typeof CREATE_VNODE | typeof CREATE_ELEMENT_VNODE;
export declare function getVNodeBlockHelper(
  ssr: boolean,
  isComponent: boolean
): typeof CREATE_BLOCK | typeof CREATE_ELEMENT_BLOCK;
export declare function convertToBlock(
  node: VNodeCall,
...
type InferCompilerError<T> = T extends ErrorCodes
  ? CoreCompilerError
  : CompilerError;
export declare function createCompilerError<T extends number>(
  code: T,
  loc?: SourceLocation,
  messages?: {
    [code: number]: string;
...
export declare function getBaseTransformPreset(
  prefixIdentifiers?: boolean
): TransformPreset;
export declare function baseCompile(
...
export declare const isFnExpressionNode: (
  exp: ExpressionNode,
  context: TransformContext
) => boolean;
export declare const isFnExpression: (
  exp: ExpressionNode,
  context: TransformContext
) => boolean;
...
export declare function advancePositionWithMutation(
  pos: Position,
  source: string,
  numberOfCharacters?: number
): Position;
...
export declare function findProp(
  node: ElementNode,
  name: string,
  dynamicOnly?: boolean,
  allowEmpty?: boolean
): ElementNode["props"][0] | undefined;
export declare function isStaticArgOf(
...
export declare function isTemplateNode(
  node: RootNode | TemplateChildNode
): node is TemplateNode;
export declare function isSlotOutlet(
  node: RootNode | TemplateChildNode
): node is SlotOutletNode;
export declare function injectProp(
  node: VNodeCall | RenderSlotCall,
  prop: Property,
  context: TransformContext
): void;
export declare function toValidAssetId(
  name: string,
  type: "component" | "directive" | "filter"
): string;
export declare function hasScopeRef(
  node:
    | TemplateChildNode
    | IfBranchNode
    | ExpressionNode
...
export declare function getMemoedVNodeCall(
 ...
 */
export declare function walkIdentifiers(
  root: Node$1,
  onIdentifier: (
    node: Identifier,
    parent: Node$1 | null,
...
export declare function isInDestructureAssignment(
  parent: Node$1,
  parentStack: Node$1[]
): boolean;
...
export declare function walkBlockDeclarations(
  block: BlockStatement$1 | Program,
  onIdent: (node: Identifier) => void
): void;
export declare function extractIdentifiers(
  param: Node$1,
  nodes?: Identifier[]
): Identifier[];
...
export declare const isStaticPropertyKey: (
  node: Node$1,
  parent: Node$1
) => boolean;
...
export declare function processIf(
  node: ElementNode,
  dir: DirectiveNode,
  context: TransformContext,
  processCodegen?: (
...
export declare function processFor(
  node: ElementNode,
  dir: DirectiveNode,
  context: TransformContext,
...
export declare function processExpression(
...
export declare function stringifyExpression(
...
export declare function processSlotOutlet(
  node: SlotOutletNode,
  context: TransformContext
): SlotOutletProcessResult;

export declare function getConstantType(
