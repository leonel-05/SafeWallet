...
const firstParamIsH = (e, n) => {
    const t = n.get("params");
...
var index = (e) => {
  ...
  return {
    ...
    visitor: {
      Program(e) {
        e.traverse({
          "ObjectMethod|ClassMethod"(e) {
            if (
              !firstParamIsH(n, e) &&
              hasJSX(n, e) &&
              !isInsideJSXExpression(n, e)
            ) {
              const t = "render" === e.node.key.name;
              e.get("body").unshiftContainer(
                ...
                n.variableDeclaration("const", [
                  n.variableDeclarator(
                    ...
                    t
                      ? n.memberExpression(
                          n.identifier("arguments"),
                          n.numericLiteral(0),
                          !0
                        )
                      : n.memberExpression(
                          n.thisExpression(),
                          n.identifier("$createElement")
                        )
                  ),
                ])
              );
