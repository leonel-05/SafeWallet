...
export declare function renderVNode(
  push: PushFn,
  vnode: VNode,
...
export declare function ssrRenderSlot(
...
export declare function ssrRenderSlotInner(
  slots: Slots | SSRSlots,
  slotName: string,
  slotProps: Props,
  fallbackRenderFn: (() => void) | null,
...
export declare function ssrRenderComponent(
  comp: Component,
  props?: Props | null,
...
export declare function ssrRenderTeleport(
  parentPush: PushFn,
...
export declare function ssrRenderAttrs(
  props: Record<string, unknown>,
  tag?: string
): string;
export declare function ssrRenderDynamicAttr(
  key: string,
  value: unknown,
  tag?: string
): string;
...
export declare function ssrRenderList(
  source: unknown,
  renderItem: (value: unknown, key: string | number, index?: number) => void
): void;

export declare function ssrRenderSuspense(
  push: PushFn,
...
export declare function ssrLooseContain(
  arr: unknown[],
  value: unknown
): boolean;
export declare function ssrRenderDynamicModel(
  type: unknown,
  model: unknown,
  value: unknown
): string;
export declare function ssrGetDynamicModelProps(
  existingProps: any,
  model: unknown
):
  | {
