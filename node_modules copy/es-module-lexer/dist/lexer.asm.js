    ...
    (a = new ArrayBuffer(i)),
      ...
      (e = (function (e, a, r) {
          ...
          do {
            if ((t | 0) == 19) {
                        ...
                        default: {
                          ...
                          r: do {
                            if ((t | 0) == 65) {
                              ...
                              if (
                                (t | 0) == 69 ? (0, (a << 16) >> 16 == 125) : 0
                              ) {
                                t = f[70] | 0;
                                r = r & 65535;
                                if (p(f[(t + (r << 3) + 4) >> 2] | 0) | 0)
                                  break;
              ...
              if ((t | 0) == 36) {
                ...
                e =
                  (i[802] | 0) == 0 ? ((s[399] | s[400]) << 16) >> 16 == 0 : 0;
                break;
              }
            }
          } while (0);
        ...
        function l() {
          ...
          e: do {
            if ((t << 16) >> 16 != 46)
              if (((t << 16) >> 16 == 115) & (a >>> 0 > r >>> 0))
                if (
                  (m((a + 2) | 0, 56, 10) | 0) == 0
                    ? ((e = (a + 12) | 0), V(s[e >> 1] | 0) | 0)
                    : 0
                )
                  n = 14;
                else {
  ...
  switch ((++n, e)) {
    ...
    case 117:
      return (function () {
        ...
        let a;
        123 === e
          ? (++n, (a = l(t.indexOf("}", n) - n)), ++n, a > 1114111 && o())
          : (a = l(4));
        return a <= 65535
...
function o() {
  throw Object.assign(
    Error(
      `Parse error ${c}:${t.slice(0, n).split("\n").length}:${
        n - t.lastIndexOf("\n", n - 1)
      }`
    ),
    { idx: n }
