            ...
            3: [
                function (require, module, exports) {
                        ...
                        parseValues = function parseQueryStringValues(e, t) {
                            ...
                            if (t.charsetSentinel)
                                for (i = 0; i < l.length; ++i)
                                    0 === l[i].indexOf('utf8=') &&
                                        (l[i] === charsetSentinel ? (n = 'utf-8') : l[i] === isoSentinel && (n = 'iso-8859-1'), (s = i), (i = l.length));
                            for (i = 0; i < l.length; ++i)
                                if (i !== s) {
                                    var p,
                                        c,
                                        ...
                                        f = -1 === u ? d.indexOf('=') : u + 1;
                                    -1 === f
                                        ? ((p = t.decoder(d, defaults.decoder, n, 'key')), (c = t.strictNullHandling ? null : ''))
                                        : ((p = t.decoder(d.slice(0, f), defaults.decoder, n, 'key')),
                                          (c = utils.maybeMap(parseArrayValue(d.slice(f + 1), t), function (e) {
                                              return t.decoder(e, defaults.decoder, n, 'value');
                                          }))),
                                        c && t.interpretNumericEntities && 'iso-8859-1' === n && (c = interpretNumericEntities(c)),
                        ...
                        parseObject = function (e, t, r, a) {
                            for (var i = a ? t : parseArrayValue(t, r), o = e.length - 1; o >= 0; --o) {
                                var l,
                                    s = e[o];
                                if ('[]' === s && r.parseArrays)
                                    l = r.allowEmptyArrays && ('' === i || (r.strictNullHandling && null === i)) ? [] : [].concat(i);
                                else {
                                    ...
                                    var n = '[' === s.charAt(0) && ']' === s.charAt(s.length - 1) ? s.slice(1, -1) : s,
                                        ...
                                        c = parseInt(p, 10);
                                    r.parseArrays || '' !== p
                                        ? !isNaN(c) && s !== p && String(c) === p && c >= 0 && r.parseArrays && c <= r.arrayLimit
                                            ? ((l = [])[c] = i)
                                            : '__proto__' !== p && (l[p] = i)
                                        : (l = { 0: i });
                                }
                        ...
                        normalizeParseOptions = function normalizeParseOptions(e) {
                            ...
                            return {
                                ...
                                interpretNumericEntities:
                                    'boolean' == typeof e.interpretNumericEntities ? e.interpretNumericEntities : defaults.interpretNumericEntities,
                    ...
                    module.exports = function (e, t) {
                        ...
                        for (
                            var a = 'string' == typeof e ? parseValues(e, r) : e, i = r.plainObjects ? Object.create(null) : {}, o = Object.keys(a), l = 0;
                            l < o.length;
                            ++l
                        ) {
                            var s = o[l],
                    ...
                    var getSideChannel = require(29),
                        ...
                        stringify = function stringify(e, r, t, o, a, n, i, l, s, f, u, d, y, c, p, m, h, v) {
                            ...
                            if (isNonNullishPrimitive(w) || utils.isBuffer(w))
                                return s
                                    ? [p(m ? r : s(r, defaults.encoder, h, 'key', c)) + '=' + p(s(w, defaults.encoder, h, 'value', c))]
                                    : [p(r) + '=' + p(String(w))];
                            var E,
                                N = [];
                            if (void 0 === w) return N;
                            if ('comma' === t && isArray(w))
                                m && s && (w = utils.maybeMap(w, s)), (E = [{ value: w.length > 0 ? w.join(',') || null : void 0 }]);
                            ...
                            for (var k = 0; k < E.length; ++k) {
                                ...
                                if (!i || null !== P) {
                                    ...
                                    K.set(sentinel, v),
                                        pushToArray(
                                            N,
                                            stringify(P, z, t, o, a, n, i, l, 'comma' === t && m && isArray(w) ? null : s, f, u, d, y, c, p, m, h, K)
                                        );
                                }
                            }
                            return N;
                ...
                function (require, module, exports) {
                    ...
                    var formats = require(1),
                        ...
                        encode = function encode(e, r, t, o, n) {
                            ...
                            var a = e;
                            if (('symbol' == typeof e ? (a = Symbol.prototype.toString.call(e)) : 'string' != typeof e && (a = String(e)), 'iso-8859-1' === t))
                            ...
                            for (var c = '', i = 0; i < a.length; i += limit) {
                                for (var u = a.length >= limit ? a.slice(i, i + limit) : a, p = [], s = 0; s < u.length; ++s) {
                                    ...
                                    (n === formats.RFC1738 && (40 === f || 41 === f))
                                        ...
                                        : f < 2048
                                        ? (p[p.length] = hexTable[192 | (f >> 6)] + hexTable[128 | (63 & f)])
                                        : f < 55296 || f >= 57344
                                        ? (p[p.length] = hexTable[224 | (f >> 12)] + hexTable[128 | ((f >> 6) & 63)] + hexTable[128 | (63 & f)])
                                        : ((s += 1),
            ...
            20: [
                function (require, module, exports) {
                    ...
                    var doEval = function doEval(r) {
                            var e;
                            if ('%AsyncFunction%' === r) e = getEvalledConstructor('async function () {}');
                            else if ('%GeneratorFunction%' === r) e = getEvalledConstructor('function* () {}');
                            else if ('%AsyncGeneratorFunction%' === r) e = getEvalledConstructor('async function* () {}');
                    ...
                    module.exports = function GetIntrinsic(r, e) {
                        ...
                        for (var d = 1, s = !0; d < t.length; d += 1) {
                            ...
                            if ((('constructor' !== f && s) || (i = !0), hasOwn(INTRINSICS, (a = '%' + (o += '.' + f) + '%')))) y = INTRINSICS[a];
                            else if (null != y) {
                                if (!(f in y)) {
                    ...
                    (function (global) {
                        (function () {
                            ...
                            module.exports = function inspect_(t, e, r, n) {
                                var o = e || {};
                                if (has(o, 'quoteStyle') && 'single' !== o.quoteStyle && 'double' !== o.quoteStyle)
                                    throw new TypeError('option "quoteStyle" must be "single" or "double"');
                                if (
                                    has(o, 'maxStringLength') &&
                                    ('number' == typeof o.maxStringLength ? o.maxStringLength < 0 && o.maxStringLength !== 1 / 0 : null !== o.maxStringLength)
                                )
                                    throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
                                var i = !has(o, 'customInspect') || o.customInspect;
                                if ('boolean' != typeof i && 'symbol' !== i)
                                    throw new TypeError('option "customInspect", if provided, must be `true`, `false`, or `\'symbol\'`');
                                if (has(o, 'indent') && null !== o.indent && '\t' !== o.indent && !(parseInt(o.indent, 10) === o.indent && o.indent > 0))
                                ...
                                if (isElement(t)) {
                                    ...
                                    return (
                                        (S += '>'), t.childNodes && t.childNodes.length && (S += '...'), S + '</' + $toLowerCase.call(String(t.nodeName)) + '>'
                                    );
                                }
                                if (isArray(t)) {
                                ...
                                if (isError(t)) {
                                    ...
                                    return 'cause' in Error.prototype || !('cause' in t) || isEnumerable.call(t, 'cause')
                                        ...
                                        : '{ [' + String(t) + '] ' + $join.call($concat.call('[cause]: ' + inspect(t.cause), h), ', ') + ' }';
                                }
                                ...
                                if (('undefined' != typeof globalThis && t === globalThis) || ('undefined' != typeof global && t === global))
                                ...
                                if (!isDate(t) && !isRegExp(t)) {
                                    var O = arrObjKeys(t, inspect),
                                        ...
                                        v =
                                            (w || 'function' != typeof t.constructor ? '' : t.constructor.name ? t.constructor.name + ' ' : '') +
                                            (k || $ ? '[' + $join.call($concat.call([], k || [], $ || []), ': ') + '] ' : '');
                                ...
                                for (var l in t)
                                    has(t, l) &&
                                        ((r && String(Number(l)) === l && l < t.length) ||
                                            ...
                                            ($test.call(/[^\w$]/, l) ? n.push(e(l, t) + ': ' + e(t[l], t)) : n.push(l + ': ' + e(t[l], t))));
                                if ('function' == typeof gOPS)
                                    for (var p = 0; p < a.length; p++) isEnumerable.call(t, a[p]) && n.push('[' + e(a[p]) + ']: ' + e(t[a[p]], t));
                                return n;
                            }
                        }).call(this);
