...
var require_logger = __commonJS2({
  "src/cli/logger.js"(exports2, module2) {
    ...
    var { default: stripAnsi2 } =
      (init_strip_ansi(), __toCommonJS(strip_ansi_exports));
    var { default: chalk2, chalkStderr: chalkStderr2 } =
    ...
    function createLogger2(logLevel = "log") {
      ...
      function createLogFunc(loggerName, color) {
        ...
        return (message, options) => {
          ...
          message =
            message.replace(/^/gm, prefix) + (options.newline ? "\n" : "");
    ...
    var options = {
      ...
      "cache-strategy": {
        choices: [
          {
            description:
              "Use the file metadata such as timestamps as cache keys",
            value: "metadata",
          },
          {
...
var require_get_context_options = __commonJS2({
  "src/cli/options/get-context-options.js"(exports2, module2) {
    ...
    var { normalizeDetailedOptionMap, createDetailedOptionMap } =
      require_option_map();
    function getContextOptions(plugins, pluginSearchDirs) {
      ...
      const detailedOptionMap = normalizeDetailedOptionMap(
        Object.assign(
          Object.assign({}, createDetailedOptionMap(supportOptions)),
          constant.options
        )
      );
...
var require_utils = __commonJS2({
  "src/cli/utils.js"(exports2, module2) {
    ...
    var { default: sdbm2 } = (init_sdbm(), __toCommonJS(sdbm_exports));
  ...
  "src/cli/options/create-minimist-options.js"(exports2, module2) {
    ...
    module2.exports = function createMinimistOptions(detailedOptions) {
      const [boolean, string] = partition(
        detailedOptions,
        ({ type }) => type === "boolean"
      ).map((detailedOptions2) =>
        detailedOptions2.flatMap(({ name, alias }) =>
...
var require_normalize_cli_options = __commonJS2({
  "src/cli/options/normalize-cli-options.js"(exports2, module2) {
    "use strict";
    var { default: chalk2 } = (init_source(), __toCommonJS(source_exports));
    var { default: leven2 } = (init_leven(), __toCommonJS(leven_exports));
...
var require_parse_cli_arguments = __commonJS2({
  "src/cli/options/parse-cli-arguments.js"(exports2, module2) {
    ...
    function parseArgv(rawArguments, detailedOptions, logger, keys) {
      ...
      if (keys) {
        if (
          keys.includes("plugin-search-dir") &&
          !keys.includes("plugin-search")
        ) {
        ...
        Object.assign(
          ...
          Object.fromEntries(
            Object.entries(normalized).map(([key, value]) => {
              const option =
                detailedOptions.find(({ name }) => name === key) || {};
    ...
    var detailedOptionsWithoutPlugins = getContextOptions(
      [],
      false
    ).detailedOptions;
...
var require_context = __commonJS2({
  "src/cli/context.js"(exports2, module2) {
    ...
    var getContextOptions = require_get_context_options();
    var { parseArgv, parseArgvWithoutPlugins: parseArgvWithoutPlugins2 } =
    ...
    var Context2 = class {
      constructor({ rawArguments, logger }) {
        ...
        this.logger = logger;
        this.stack = [];
        const { plugins, pluginSearchDirs } = parseArgvWithoutPlugins2(
          rawArguments,
          logger,
...
${" ".repeat(threshold)}`
    ...
    function createChoiceUsages(choices, margin, indentation) {
      ...
      const threshold =
        Math.max(0, ...activeChoices.map((choice) => choice.value.length)) +
        margin;
...
var require_find_cache_dir = __commonJS2({
  "node_modules/find-cache-dir/index.js"(exports2, module2) {
    ...
    module2.exports = (options = {}) => {
      if (
        env2.CACHE_DIR &&
        !["true", "false", "1", "0"].includes(env2.CACHE_DIR)
      ) {
...
var require_find_cache_file = __commonJS2({
  "src/cli/find-cache-file.js"(exports2, module2) {
    ...
    var { statSafe, isJson } = require_utils();
...
var require_common3 = __commonJS2({
  "node_modules/glob/common.js"(exports2) {
    ...
    function setopts(self2, pattern, options) {
      ...
      self2.statCache =
        options.statCache || /* @__PURE__ */ Object.create(null);
      ...
      self2.cwdAbs = isAbsolute(self2.cwd)
        ? self2.cwd
        : makeAbs(self2, self2.cwd);
      if (process.platform === "win32")
...
var require_format_results_cache = __commonJS2({
  "src/cli/format-results-cache.js"(exports2, module2) {
    ...
    var { version: prettierVersion } = require("./index.js");
    var { createHash } = require_utils();
    ...
    function getHashOfOptions(options) {
      ...
      const hash = createHash(
        `${prettierVersion}_${nodeVersion}_${stringify2(options)}`
      );
  ...
  "src/cli/format.js"(exports2, module2) {
    ...
    function format(context, input, opt) {
      ...
      if (context.argv.debugPrintComments) {
        return {
          formatted: prettier2.format(
            JSON.stringify(
              prettier2.formatWithCursor(input, opt).comments || []
            ),
            {
              parser: "json",
            }
      ...
      if (
        performanceTestFlag !== null &&
        performanceTestFlag !== void 0 &&
        performanceTestFlag.debugBenchmark
      ) {
        let benchmark;
        try {
        ...
        performanceTestFlag !== null &&
        performanceTestFlag !== void 0 &&
        performanceTestFlag.debugRepeat
      ) {
...
${error.message}`);
        ...
        const isCacheExists =
          (_formatResultsCache = formatResultsCache) === null ||
          _formatResultsCache === void 0
            ? void 0
            : _formatResultsCache.existsAvailableFormatResultsCache(
                filename,
                options
              );
        let result;
...
${error.message}`);
        ...
        if (shouldSetCache) {
          ...
          (_formatResultsCache2 = formatResultsCache) === null ||
          _formatResultsCache2 === void 0
            ? void 0
            : _formatResultsCache2.setFormatResultsCache(filename, options);
        } else {
          var _formatResultsCache3;
          (_formatResultsCache3 = formatResultsCache) === null ||
          _formatResultsCache3 === void 0
            ? void 0
            : _formatResultsCache3.removeFormatResultsCache(filename);
        }
        if (isDifferent) {
      ...
      (_formatResultsCache4 = formatResultsCache) === null ||
      _formatResultsCache4 === void 0
        ? void 0
        : _formatResultsCache4.reconcile();
      if (context.argv.check) {
...
var require_file_info = __commonJS2({
  "src/cli/file-info.js"(exports2, module2) {
    ...
    var stringify2 = require_fast_json_stable_stringify();
    var prettier2 = require("./index.js");
    var { printToScreen: printToScreen2 } = require_utils();
