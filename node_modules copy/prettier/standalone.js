(function (e) {
  ...
  var Fs = xe((j0, Es) => {
    ...
    Es.exports = function (e, r) {
      ...
      if (t) {
        if (
          (r === void 0 && (r = "default"), (s = Ml(t, e, r)), !vs(s) || Cs(s))
        )
          return s;
  ...
  var An = xe((Q0, Qs) => {
    var qc = Dt(),
      ...
      Hc =
        Fn &&
        !qc(function () {
          return Ar(function () {}, "length", { value: 8 }).length !== 8;
        }),
  ...
  var e0 = xe((Uy, jo) => {
    ...
    var FD = Object.create,
      ...
      Kt = (e, r) => {
        for (var t in r) _r(e, t, { get: r[t], enumerable: !0 });
      },
      Pa = (e, r, t, s) => {
      ...
      ft = (e) => Pa(_r({}, "__esModule", { value: !0 }), e),
      wt,
      ne = ht({
        "<define:process>"() {
          wt = { env: {}, argv: [] };
        ...
        "node_modules/diff/lib/diff/base.js"(e) {
          ...
          r.prototype = {
            ...
            extractCommon: function (n, u, i, l) {
              for (
                var p = u.length, y = i.length, h = n.newPos, g = h - l, c = 0;
    ...
    var La,
      ...
      Yt = te({
        "src/document/doc-utils.js"(e, r) {
          ...
          function p(o, d) {
            ...
            function b(B) {
              ...
              if (B.contents) {
                let k = S(B.contents);
                return d(
                  Object.assign(Object.assign({}, B), {}, { contents: k })
                );
              }
              return d(B);
            }
          ...
          var w = (o, d) =>
            o && o.type === "line" && o.hard && d && d.type === "break-parent";
          function E(o) {
            if (!o) return o;
            if (n(o) || o.type === "fill") {
              let d = u(o);
              ...
              return Array.isArray(o)
                ? d
                : Object.assign(Object.assign({}, o), {}, { parts: d });
            }
            switch (o.type) {
              case "align":
              case "indent":
              ...
              case "if-break": {
                ...
                return Object.assign(
                  Object.assign({}, o),
                  {},
                  { breakContents: d, flatContents: v }
                );
              }
            }
            return o;
          ...
          function $(o) {
            return p(o, (d) =>
              Array.isArray(d)
                ? P(d)
                : d.parts
                ? Object.assign(Object.assign({}, d), {}, { parts: P(d.parts) })
                : d
            );
          }
          function D(o) {
      ...
      qD = te({
        "src/document/doc-printer.js"(e, r) {
          ...
          var { convertEndOfLineToChars: t } = Jn(),
            s = lt(),
            a = Oa(),
            { fill: n, cursor: u, indent: i } = Un(),
            { isConcat: l, getDocParts: p } = Yt(),
            y,
            h = 1,
            g = 2;
          function c() {
    ...
    var $D = ht({
      ...
      VD = te({
        "node_modules/semver/internal/re.js"(e, r) {
          ne();
          var { MAX_SAFE_COMPONENT_LENGTH: t } = Ma(),
            s = qa();
          e = r.exports = {};
          var a = (e.re = []),
            n = (e.src = []),
      ...
      GD = te({
        "node_modules/semver/classes/semver.js"(e, r) {
          ne();
          var t = qa(),
            { MAX_LENGTH: s, MAX_SAFE_INTEGER: a } = Ma(),
            { re: n, t: u } = VD(),
            i = WD(),
            { compareIdentifiers: l } = HD(),
            p = class {
              constructor(y, h) {
    ...
    var Br,
          ...
          var s = class {
            ...
            _applyNormalization(a, n) {
              ...
              for (let p of i) {
                ...
                t.normalizeForwardResult(y.forward(h, this._utils), h).forEach(
                  c
                );
                let _ = t.normalizeRedirectResult(
        ...
        "src/main/options-normalizer.js"(e, r) {
          ...
          function i(g, c) {
            let {
              ...
              I = l(c, { isCLI: F, colorsModule: w, levenshteinDistance: E }),
          ...
          function l(g, c) {
            let { isCLI: f, colorsModule: F, levenshteinDistance: _ } = c,
              w = [];
            ...
            for (let E of g)
              w.push(
                ...
                E.alias &&
                  f &&
                  w.push(
                    t.AliasSchema.create({ name: E.alias, sourceName: E.name })
                  );
            return w;
          }
          function p(g, c) {
      ...
      Mm = te({
        "node_modules/@babel/code-frame/lib/index.js"(e) {
          ...
          var a = /\r\n|[\n\r\u2028\u2029]/;
          function n(l, p, y) {
            let h = Object.assign({ column: 0, line: -1 }, l.start),
              g = Object.assign({}, h, l.end),
              { linesAbove: c = 2, linesBelow: f = 3 } = y || {},
              F = h.line,
              _ = h.column,
              w = g.line,
              E = g.column,
          ...
          function u(l, p) {
            let y =
              ...
              f = ($, D) => (h ? $(D) : D),
              F = l.split(a),
              { start: _, end: w, markerLines: E } = n(p, F, y),
              N = p.start && typeof p.start.column == "number",
              x = String(w).length,
              P = (h ? (0, r.default)(l, y) : l)
                .split(a, w)
                .slice(_, w)
                .map(($, D) => {
                  let T = _ + 1 + D,
            ...
            for (let [W, K] of ce.entries()) {
              ...
              if (
                ...
                (de.placement = "ownLine"),
                  Y(...ge) || (z ? f(z, de) : ue ? _(ue, de) : F(Fe || se, de));
              else if (D(U, Z, ce, W))
        ...
        "src/main/core.js"(e, r) {
          ...
          function x(m, C) {
            let { ast: o, text: d } = c.parse(m, C),
              { rangeStart: v, rangeEnd: S } = F.calculateRange(d, C, o),
              b = d.slice(v, S),
              B = Math.min(
                v,
                d.lastIndexOf(
          ...
          function P(m, C) {
            ...
            return (
              ...
              Object.assign(
                Object.assign({}, C),
                {},
                { cursorOffset: o, rangeStart: d, rangeEnd: v }
              )
            );
          }
          function $(m, C) {
            ...
            return {
              ...
              options: P(
                ...
                Object.assign(
                  Object.assign({}, C),
                  {},
                  { cursorOffset: o, rangeStart: d, rangeEnd: v, endOfLine: S }
                )
              ),
            };
          }
                ...
                for (
                  ...
                  if (((w = f.charCodeAt(F)), 55296 <= w && w <= 56319)) {
                    if (
                      (++F,
                      F >= _ ||
                        ((E = f.charCodeAt(F)), !(56320 <= E && E <= 57343)))
                    )
                      return !1;
                    w = y(w, E);
                  }
      ...
      Ke = te({
        "src/language-js/utils/index.js"(e, r) {
          ...
          var t = Xm().keyword.isIdentifierNameES5,
            ...
            { locStart: p, locEnd: y, hasSameLocStart: h } = ut(),
            g = Pt(),
            c = Km(),
            f = "(?:(?=.)\\s)",
            F = new RegExp(`^${f}*:`),
          ...
          function $(O) {
            return (
              (O = new Set(O)), (me) => O.has(me == null ? void 0 : me.type)
            );
          }
          var D = $([
              "Line",
        ...
        "src/language-js/embed/css.js"(e, r) {
          ...
          function y(c, f, F) {
            let _ = c.getValue(),
              ...
              x = F(N, { parser: "scss" }, { stripTrailingHardline: !0 }),
              I = p(c, f);
            return h(x, _, I);
          }
          function h(c, f, F) {
      ...
      Zm = te({
        "src/language-js/embed/graphql.js"(e, r) {
          ...
          var {
            ...
            { escapeTemplateCharacters: n, printTemplateExpressions: u } = jt();
          function i(p, y, h) {
            let g = p.getValue(),
              c = g.quasis.length;
      ...
      ed = te({
        "src/language-js/embed/html.js"(e, r) {
          ...
          var {
            ...
            { printTemplateExpressions: i, uncookTemplateElementValue: l } =
              jt(),
            p = 0;
...
`);
      ...
      Co = te({
        "src/language-js/pragma.js"(e, r) {
          "use strict";
          ne();
          var { parseWithComments: t, strip: s, extract: a, print: n } = od(),
        ...
        "src/language-js/comments.js"(e, r) {
          ...
          function pe(De) {
            ...
            return (re == null ? void 0 : re.type) !== "TSMappedType"
              ...
              ? (i(ye.name, A), !0)
              : (G == null ? void 0 : G.type) === "TSTypeParameter" &&
                G.constraint
              ? (l(G.constraint, A), !0)
              : !1;
          }
      ...
      Dd = te({
        "src/language-js/print/jsx.js"(e, r) {
          ...
          function d(U, Z, se) {
            ...
            let Ee = le ? h(Ae) : l(Ae, { shouldBreak: !0 });
            if (Pe) return Ee;
          ...
          function k(U, Z, se) {
            ...
            if ((ge.push(se("name")), fe.value)) {
              ...
              if (I(fe.value)) {
                ...
                ke = ke.replace(Pe, Re);
                let { leading: oe, trailing: H } = U.call(
                  () => a(U, Z),
                  "value"
                );
                he = [oe, Ne, ke, Ne, H];
      ...
      Ao = te({
        "src/language-js/print/call-arguments.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { ArgExpansionBailout: o } = Qt(),
            { isConciselyPrintedArray: d } = er();
          function v(q, J, L) {
            let Q = q.getValue(),
      ...
      xo = te({
        "src/language-js/print/call-expression.js"(e, r) {
          ...
          var {
            ...
            c = md(),
            f = Ao(),
            { printOptionalToken: F, printFunctionTypeParameters: _ } = ct();
          function w(N, x, I) {
            let P = N.getValue(),
              $ = N.getParentNode(),
      ...
      tr = te({
        "src/language-js/print/assignment.js"(e, r) {
          ...
          var { isNonEmptyArray: t, getStringWidth: s } = Ue(),
            ...
            { shouldInlineLogicalExpression: D } = ru(),
            { printCallExpression: T } = xo();
      ...
      Or = te({
        "src/language-js/print/type-annotation.js"(e, r) {
          ...
          var { printComments: t, printDanglingComments: s } = et(),
            ...
            { printAssignment: N } = tr(),
            { printFunctionParameters: x, shouldGroupFunctionParameters: I } =
              Lr(),
            { printArrayItems: P } = er();
          function $(b) {
            if (f(b) || F(b)) return !0;
      ...
      jr = te({
        "src/language-js/print/type-parameters.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { createGroupIdMapper: E } = Ue(),
            { shouldHugType: N } = Or(),
            { isArrowFunctionVariableDeclarator: x } = tr(),
            I = E("typeParameters");
          function P(T, m, C, o) {
            let d = T.getValue();
            if (!d[o]) return "";
            ...
            if (
              ...
              (!b &&
                (S ||
                  (d[o].length === 1 &&
                    (d[o][0].type === "NullableTypeAnnotation" || N(d[o][0])))))
            )
        ...
        "src/language-js/print/property.js"(e, r) {
          ...
          function g(f, F, _) {
            ...
            if (F.quoteProps === "consistent" && !h.has(E)) {
              let x = (E.properties || E.body || E.members).some(
      ...
      qr = te({
        "src/language-js/print/function.js"(e, r) {
          ...
          var t = Zt(),
            ...
            { locEnd: M } = ut(),
            { printFunctionParameters: R, shouldGroupFunctionParameters: q } =
              Lr(),
            { printPropertyKey: J } = rr(),
          ...
          function de(U, Z, se) {
            ...
            fe.argument &&
              (z(Z, fe.argument)
                ...
                ? he.push(p([h(" (", " "), y([l, se("argument")]), l, h(")")]))
                : he.push(" ", se("argument")));
            let we = o(fe),
              ke = n(we),
              Re = ke && m(ke);
      ...
      nu = te({
        "src/language-js/print/decorators.js"(e, r) {
          ...
          var { isNonEmptyArray: t, hasNewline: s } = Ue(),
            ...
            { locStart: p, locEnd: y } = ut(),
            { getParentExportDeclaration: h } = Ke();
          function g(w, E, N) {
            let x = w.getValue();
      ...
      nr = te({
        "src/language-js/print/class.js"(e, r) {
          ...
          var { isNonEmptyArray: t, createGroupIdMapper: s } = Ue(),
            ...
            { printPropertyKey: x } = rr(),
            { printAssignment: I } = tr(),
            { printClassMemberDecorators: P } = nu();
          function $(b, B, k) {
            let M = b.getValue(),
              R = [];
      ...
      bo = te({
        "src/language-js/print/interface.js"(e, r) {
          ...
          var { isNonEmptyArray: t } = Ue(),
            ...
            { hasComment: l, identity: p, CommentCheckFlags: y } = Ke(),
            { getTypeParametersGroupId: h } = jr(),
      ...
      To = te({
        "src/language-js/print/module.js"(e, r) {
          ...
          var { isNonEmptyArray: t } = Ue(),
            ...
            { locStart: w, hasSameLoc: E } = ut(),
            { hasDecoratorsBeforeExport: N, printDecoratorsBeforeExport: x } =
              nu();
          function I(S, b, B) {
            let k = S.getValue(),
              M = b.semi ? ";" : "",
          ...
          function P(S, b, B) {
            ...
            return (
              ...
              (k.default || R === "ExportDefaultDeclaration") &&
                M.push(" default"),
              h(k, g.Dangling) && (M.push(" ", y(S, b, !0)), f(k) && M.push(p)),
              J
          ...
          function m(S, b, B) {
            ...
            if (t(k.specifiers)) {
              ...
              S.each(() => {
                ...
                q.length > 0 &&
                  (R.length > 0 && M.push(", "),
                  q.length > 1 || R.length > 0 || k.specifiers.some((L) => h(L))
                    ? M.push(
                        a([
                          "{",
      ...
      uu = te({
        "src/language-js/print/object.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { locStart: E, locEnd: N } = ut(),
            { printOptionalToken: x, printTypeAnnotation: I } = ct(),
            { shouldHugFunctionParameters: P } = Lr(),
            { shouldHugType: $ } = Or(),
            { printHardlineAfterHeritage: D } = nr();
          function T(m, C, o) {
            let d = C.semi ? ";" : "",
              v = m.getValue(),
              S;
      ...
      dd = te({
        "src/language-js/print/flow.js"(e, r) {
          ...
          var t = Zt(),
            ...
            { locStart: F, locEnd: _ } = ut(),
            { replaceTextEndOfLine: w } = Yt(),
            { printClass: E } = nr(),
            {
              printOpaqueType: N,
              printTypeAlias: x,
            ...
            { printInterface: m } = bo(),
            { printTypeParameter: C, printTypeParameters: o } = jr(),
            { printExportDeclaration: d, printExportAllDeclaration: v } = To(),
            { printArrayItems: S } = er(),
            { printObject: b } = uu(),
            { printPropertyKey: B } = rr(),
            {
      ...
      No = te({
        "src/language-js/print/statement.js"(e, r) {
          ...
          var {
            ...
            { shouldPrintParamsWithoutParens: h } = qr();
          function g(x, I, P, $) {
            let D = x.getValue(),
              T = [],
              m = D.type === "ClassBody",
      ...
      wo = te({
        "src/language-js/print/block.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { printHardlineAfterHeritage: p } = nr(),
            { printBody: y } = No();
          function h(c, f, F) {
            let _ = c.getValue(),
              w = [];
      ...
      yd = te({
        "src/language-js/print/typescript.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { printTernary: P } = Bo(),
            { printFunctionParameters: $, shouldGroupFunctionParameters: D } =
              Lr(),
            { printTemplateLiteral: T } = jt(),
            { printArrayItems: m } = er(),
            { printObject: C } = uu(),
            { printClassProperty: o, printClassMethod: d } = nr(),
            { printTypeParameter: v, printTypeParameters: S } = jr(),
            { printPropertyKey: b } = rr(),
            { printFunction: B, printMethodInternal: k } = qr(),
            { printInterface: M } = bo(),
            { printBlock: R } = wo(),
            {
              printTypeAlias: q,
        ...
        "src/language-js/print/comment.js"(e, r) {
          ...
          function y(c, f) {
            ...
            if (p(F)) {
              if (h(F)) {
                let E = g(F);
                return F.trailing && !t(f.originalText, i(F), { backwards: !0 })
                  ? [a, E]
                  : E;
              }
              let _ = l(F),
      ...
      Cd = te({
        "src/language-js/printer-estree.js"(e, r) {
          ...
          var { printDanglingComments: t } = et(),
            ...
            { locStart: o, locEnd: d } = ut(),
            v = Pt(),
            { printHtmlBinding: S, isVueEventBindingExpression: b } = pd(),
            { printAngular: B } = fd(),
            { printJsx: k, hasJsxIgnoreComment: M } = Dd(),
            { printFlow: R } = dd(),
            { printTypescript: q } = yd(),
            {
            ...
            { printCallExpression: Ne } = xo(),
            { printVariableDeclarator: Pe, printAssignmentExpression: oe } =
              tr(),
            { printBinaryishExpression: H } = ru(),
            { printSwitchCaseConsequent: pe } = No(),
            { printMemberExpression: X } = So(),
            { printBlock: le, printBlockBody: Ae } = wo(),
            { printComment: Ee } = hd(),
            { printLiteral: De } = vd(),
            { printDecorators: A } = nu();
          ...
          function re(Ce, Be, ve, ze) {
            ...
            switch (be.type) {
              ...
              case "DoWhileStatement": {
                ...
                return (
                  (Se = [l(["do", Ie])]),
                  be.body.type === "BlockStatement" ? Se.push(" ") : Se.push(u),
...
` ||
      ...
      Yd = te({
        "src/language-handlebars/printer-glimmer.js"(e, r) {
          ...
          function S(H, pe) {
            let X = H.getValue(),
              le = ["attributes", "modifiers", "comments"].filter((Ee) =>
                f(X[Ee])
              ),
      ...
      ng = te({
        "src/language-graphql/printer-graphql.js"(e, r) {
          ...
          var {
            ...
            { isNextLineEmpty: p, isNonEmptyArray: y } = Ue(),
            { insertPragma: h } = tg(),
            { locStart: g, locEnd: c } = rg();
          function f(P, $, D) {
            let T = P.getValue();
            if (!T) return "";
...
`) &&
      ...
      iu = te({
        "src/language-markdown/utils.js"(e, r) {
          ...
          ne();
          var { getLast: t } = Ue(),
            { locStart: s, locEnd: a } = Io(),
            { cjkPattern: n, kPattern: u, punctuationPattern: i } = og(),
            l = [
              "liquidNode",
              "inlineCode",
              "emphasis",
...
${u.content}`;
      ...
      cg = te({
        "src/language-markdown/print-preprocess.js"(e, r) {
          ...
          ne();
          var t = lt(),
            { getOrderedListItemInfo: s, mapAst: a, splitText: n } = iu(),
            u = /^.$/su;
          function i(w, E) {
            return (
              (w = y(w, E)),
          ...
          function h(w) {
            return g(
              w,
              (E, N) => E.type === "importExport" && N.type === "importExport",
              (E, N) => ({
                type: "importExport",
                value:
                  E.value +
...
`,
          ...
          function we(A) {
            return (
              (A.type === "element" && (!A.namespace || c(A)) && h[A.name]) || g
            );
          }
          function ke(A) {
      ...
      Bg = te({
        "src/language-html/syntax-vue.js"(e, r) {
          ...
          function a(i) {
            ...
            if (
              !F.some((_, w) => !_ && (w === 0 || F.slice(w + 1).some(Boolean)))
            )
              return {
      ...
      Ng = te({
        "src/language-html/embed.js"(e, r) {
          ...
          var {
            ...
            { printImgSrcset: w, printClassNames: E } = Tg(),
            {
              printVueFor: N,
              printVueBindings: x,
      ...
      Mr = te({
        "src/language-yaml/print/misc.js"(e, r) {
          ...
          var {
            ...
            { hasEndComments: a, isNextLineEmpty: n, isNode: u } = $t(),
            i = new WeakMap();
          function l(h, g) {
            let c = h.getValue(),
              f = h.stack[0],
      ...
      Rg = te({
        "src/language-yaml/print/flow-mapping-sequence.js"(e, r) {
          ...
          var {
            ...
            { isEmptyNode: i, getLast: l, hasEndComments: p } = $t(),
            { printNextEmptyLine: y, alignWithSpaces: h } = Mr();
          function g(f, F, _) {
            let w = f.getValue(),
      ...
      Wg = te({
        "src/language-yaml/printer-yaml.js"(e, r) {
          ...
          var {
            ...
            { printFlowMapping: S, printFlowSequence: b } = Rg(),
            B = $g(),
            k = Vg();
          function M(j, Y, ie) {
            let ee = j.getValue(),
