  ...
  var require_doc_js_umd = __commonJS({
    "dist/_doc.js.umd.js"(exports, module) {
      ...
      var __esm = (fn, res) =>
        function __init() {
          return (
            fn && (res = (0, fn[__getOwnPropNames2(fn)[0]])((fn = 0))), res
          );
        };
      ...
      var require_get_string_width = __commonJS2({
        "src/utils/get-string-width.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var stringWidth2 = (init_string_width(),
          __toCommonJS(string_width_exports)).default;
              ...
              if (!onEnter || onEnter(doc2) !== false) {
                if (isConcat(doc2) || doc2.type === "fill") {
                  ...
                  if (shouldTraverseConditionalGroups) {
                    for (
                      let ic = doc2.expandedStates.length, i = ic - 1;
                      i >= 0;
                      --i
                    ) {
          ...
          function mapDoc(doc, cb) {
            ...
            function process2(doc2) {
              ...
              if (doc2.type === "if-break") {
                const breakContents =
                  doc2.breakContents && rec(doc2.breakContents);
                const flatContents =
                  doc2.flatContents && rec(doc2.flatContents);
                return cb(
                  Object.assign(
                    Object.assign({}, doc2),
                    {},
          ...
          function stripDocTrailingHardlineFromDoc(doc) {
            ...
            switch (doc.type) {
              ...
              case "if-break": {
                ...
                const flatContents = stripDocTrailingHardlineFromDoc(
                  doc.flatContents
                );
                return Object.assign(
                  Object.assign({}, doc),
                  ...
                  case "group":
                    switch (mode) {
                      ...
                      case MODE_BREAK: {
                        ...
                        if (
                          !doc2.break &&
                          fits(next, cmds, rem, hasLineSuffix)
                        ) {
                          cmds.push(next);
                        } else {
                          if (doc2.expandedStates) {
                            ...
                            if (doc2.break) {
                              ...
                              for (
                                let i = 1;
                                i < doc2.expandedStates.length + 1;
                                i++
                              ) {
            ...
            if (doc.type === "group") {
              return Object.assign(
                ...
                {},
                {
                  ...
                  expandedStates:
                    doc.expandedStates && doc.expandedStates.map(flattenDoc),
                }
              );
            }
            if (doc.type === "fill") {
            ...
            function printDoc(doc2, index, parentParts) {
              ...
              if (doc2.type === "align") {
                return doc2.n === Number.NEGATIVE_INFINITY
                  ...
                  : "align(" +
                    JSON.stringify(doc2.n) +
                    ", " +
                    printDoc(doc2.contents) +
                    ")";
              }
              if (doc2.type === "if-break") {
                return (
                  ...
                  (doc2.flatContents
                    ? ", " + printDoc(doc2.flatContents)
                    : "") +
                  (doc2.groupId
                    ? (!doc2.flatContents ? ', ""' : "") +
                      `, { groupId: ${printGroupId(doc2.groupId)} }`
                    : "") +
                  ")"
                );
              }
              ...
              if (doc2.type === "group") {
                ...
                const options =
                  optionsParts.length > 0
                    ...
                    : "";
                if (doc2.expandedStates) {
                  return `conditionalGroup([${doc2.expandedStates
              ...
              if (doc2.type === "label") {
                return `label(${JSON.stringify(doc2.label)}, ${printDoc(
                  doc2.contents
                )})`;
              }
            ...
            function printGroupId(id) {
              ...
              for (let counter = 0; ; counter++) {
                ...
                if (!usedKeysForSymbols.has(key)) {
                  ...
                  return (printedSymbols[id] = `Symbol.for(${JSON.stringify(
                    key
                  )})`);
                }
              }
