...
var pt = Te((Vg, ou) => {
  ...
  ou.exports =
    ur(typeof globalThis == "object" && globalThis) ||
    ur(typeof window == "object" && window) ||
    ur(typeof self == "object" && self) ||
    ur(typeof global == "object" && global) ||
    (function () {
      return this;
    })() ||
...
var Gr = Te((t0, Bu) => {
  var Hr = typeof document == "object" && document.all,
    Go = typeof Hr > "u" && Hr !== void 0;
  Bu.exports = { all: Hr, IS_HTMLDDA: Go };
});
var ot = Te((r0, wu) => {
  var Nu = Gr(),
    Uo = Nu.all;
  wu.exports = Nu.IS_HTMLDDA
    ? function (e) {
...
var Hu = Te((a0, Wu) => {
  var Vu = pt(),
    ...
    qu = Vu.process,
    Mu = Vu.Deno,
    Ru = (qu && qu.versions) || (Mu && Mu.version),
    $u = Ru && Ru.v8,
    dt,
    cr;
  $u &&
    ((dt = $u.split(".")),
    (cr = dt[0] > 0 && dt[0] < 4 ? 1 : +(dt[0] + dt[1])));
  !cr &&
    zr &&
    ((dt = zr.match(/Edge\/(\d+)/)),
    (!dt || dt[1] >= 74) &&
      ((dt = zr.match(/Chrome\/(\d+)/)), dt && (cr = +dt[1])));
  Wu.exports = cr;
});
var Xr = Te((o0, Uu) => {
  var Gu = Hu(),
...
var Zu = Te((m0, Qu) => {
  ...
  Qu.exports = function (e, r) {
    var t, s;
    if (
      (r === "string" && Zr((t = e.toString)) && !en((s = Qr(t, e)))) ||
      (Zr((t = e.valueOf)) && !en((s = Qr(t, e)))) ||
      (r !== "string" && Zr((t = e.toString)) && !en((s = Qr(t, e))))
    )
      return s;
...
var bt = Te((F0, ds) => {
  var bl = pt(),
    ...
    xt = bl.Symbol,
    Ds = xt && xt.for,
    Nl = ms ? xt : (xt && xt.withoutSetter) || Bl;
...
var Ls = Te((P0, ks) => {
  var fn = yt(),
    ...
    pc = fn && Object.getOwnPropertyDescriptor,
    Dn = cc(Is, "name"),
    fc = Dn && function () {}.name === "something",
    Dc = Dn && (!fn || (fn && pc(Is, "name").configurable));
...
var dn = Te((I0, Os) => {
  var mc = mt(),
    dc = ot(),
    mn = mr(),
    gc = mc(Function.toString);
  dc(mn.inspectSource) ||
    (mn.inspectSource = function (e) {
      return gc(e);
    });
...
var En = Te((q0, Xs) => {
  var Nc = Dt(),
    ...
    Lc =
      Cn &&
      !Nc(function () {
        return Er(function () {}, "length", { value: 8 }).length !== 8;
      }),
    Oc = String(String).split("String"),
    jc = (Xs.exports = function (e, r, t) {
      String(r).slice(0, 7) === "Symbol(" &&
        (r = "[" + String(r).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
        t && t.getter && (r = "get " + r),
        t && t.setter && (r = "set " + r),
        (!Cr(e, "name") || (_c && e.name !== r)) &&
          (Cn ? Er(e, "name", { value: r, configurable: !0 }) : (e.name = r)),
        Lc &&
          t &&
          Cr(t, "arity") &&
          e.length !== t.arity &&
          Er(e, "length", { value: t.arity });
      try {
        t && Cr(t, "constructor") && t.constructor
          ? Cn && Er(e, "prototype", { writable: !1 })
          : e.prototype && (e.prototype = void 0);
      } catch {}
      var s = Ic(e);
      return (
        Cr(s, "source") || (s.source = Oc.join(typeof r == "string" ? r : "")),
        e
      );
    });
  ...
  xi.exports = function (e, r) {
    ...
    if (
      ...
      for (i in r) {
        if (
          ((p = r[i]),
          e.dontCallGetSet ? ((d = Ap(u, i)), (l = d && d.value)) : (l = u[i]),
          (n = Bp(s ? i : t + (a ? "." : "#") + i, e.forced)),
          !n && l !== void 0)
        ) {
...
var bn = Te((uy, ki) => {
  ...
  var jp = Sn(),
    ...
    Mp = Bi(),
    Rp = xn(),
    Ii = function (e, r, t, s, a, n, u, i) {
      for (var l = a, p = 0, d = u ? Rp(u, i) : !1, y, g; p < s; )
        p in t &&
          ((y = d ? d(t[p], p, r) : t[p]),
          n > 0 && jp(y)
            ? ((g = qp(y)), (l = Ii(e, r, y, g, l, n - 1) - 1))
            : (Mp(l + 1), (e[l] = y)),
          l++),
          p++;
      return l;
  ...
  qi.exports = Wp
    ...
    : function (e) {
        ...
        return e === void 0
          ...
          : e === null
          ? "Null"
          : typeof (t = Xp((r = Jp(e)), Up)) == "string"
          ? t
          : zp
          ? Ar(r)
          : (s = Ar(r)) == "Object" && Hp(r.callee)
          ? "Arguments"
          : s;
      };
});
...
var zi = Te((oy, Ji) => {
  ...
  Ji.exports = function (e) {
    ...
    return (
      Gi(e) &&
        ((r = e.constructor),
        uf(r) && (r === Ui || Gi(r.prototype))
          ? (r = void 0)
          : sf(r) && ((r = r[of]), r === null && (r = void 0))),
      r === void 0 ? Ui : r
    );
  };
});
...
var da = Te((yy, ma) => {
  ...
  ma.exports = function (e, r, t) {
    return (
      t.get && Da(t.get, r, { getter: !0 }),
      t.set && Da(t.set, r, { setter: !0 }),
      zf.f(e, r, t)
    );
  };
});
...
var DD = Object.create,
  ...
  yD = (e, r, t) => (
    ...
    Sa(
      r || !e || !e.__esModule
        ? Nr(t, "default", { value: e, enumerable: !0 })
        : t,
      e
    )
  ),
  ft = (e) => Sa(Nr({}, "__esModule", { value: !0 }), e),
  Nt,
  ne = ht({
    "<define:process>"() {
      Nt = { env: {}, argv: [] };
      ...
      r.prototype = {
            ...
            for (var N = -1 * c; N <= c; N += 2) {
              ...
              if (
                (!D || (T && I.newPos < P.newPos)
                  ? ((x = s(P)), p.pushComponent(x.components, void 0, !0))
                  : ((x = I),
                    x.newPos++,
        ...
        pushComponent: function (n, u, i) {
          ...
          l && l.added === u && l.removed === i
            ? (n[n.length - 1] = { count: l.count + 1, added: u, removed: i })
            : n.push({ count: 1, added: u, removed: i });
        },
        extractCommon: function (n, u, i, l) {
          for (
            var p = u.length, d = i.length, y = n.newPos, g = y - l, c = 0;
            y + 1 < p && g + 1 < d && this.equals(u[y + 1], i[g + 1]);
  ...
  Wn = te({
    "src/document/doc-builders.js"(e, r) {
      ...
      function p(C, o) {
        return n(
          C[0],
          Object.assign(Object.assign({}, o), {}, { expandedStates: C })
        );
      }
      function d(C) {
...
var Ta,
  ...
  Xt = te({
    "src/document/doc-utils.js"(e, r) {
          ...
          if (B.type === "if-break") {
            ...
            return h(
              Object.assign(
                Object.assign({}, B),
                {},
                { breakContents: k, flatContents: M }
              )
            );
          }
      ...
      var w = (o, h) =>
        o && o.type === "line" && o.hard && h && h.type === "break-parent";
      function F(o) {
        if (!o) return o;
        if (n(o) || o.type === "fill") {
          let h = u(o);
          ...
          return Array.isArray(o)
            ? h
            : Object.assign(Object.assign({}, o), {}, { parts: h });
        }
        switch (o.type) {
          case "align":
          case "indent":
          ...
          case "if-break": {
            let h = F(o.breakContents),
              v = F(o.flatContents);
            return Object.assign(
              Object.assign({}, o),
              {},
              { breakContents: h, flatContents: v }
            );
          }
        }
        return o;
      ...
      function x(o) {
        ...
        for (let v of u(o)) {
          if (!v) continue;
          let [S, ...b] = n(v) ? u(v) : [v];
          typeof S == "string" && typeof t(h) == "string"
            ? (h[h.length - 1] += S)
            : h.push(S),
            h.push(...b);
        }
      ...
      function $(o) {
        return p(o, (h) =>
          Array.isArray(h)
            ? P(h)
            : h.parts
            ? Object.assign(Object.assign({}, h), {}, { parts: P(h.parts) })
            : h
        );
      }
      function D(o) {
...
`)
  ...
  ND = te({
    "src/document/doc-printer.js"(e, r) {
      "use strict";
      ne();
      var { convertEndOfLineToChars: t } = Hn(),
        s = lt(),
        a = Ba(),
        { fill: n, cursor: u, indent: i } = Wn(),
        { isConcat: l, getDocParts: p } = Xt(),
        d,
        y = 1,
        g = 2;
      function c() {
      ...
      function w(x) {
        ...
        for (
          ;
          x.length > 0 && typeof s(x) == "string" && /^[\t ]*$/.test(s(x));
...
`
            ...
            switch (b.type) {
              ...
              case "group":
                switch (S) {
                  ...
                  case y: {
                    C = !1;
                    let B = { ind: v, mode: g, doc: b.contents },
                      k = P - D,
                      M = o.length > 0;
              ...
              case "fill": {
                ...
                if (k.length === 0) break;
                let [M, R] = k,
                  q = { ind: v, mode: g, doc: M },
                  J = { ind: v, mode: y, doc: M },
                  L = F(q, [], B, o.length > 0, !0);
                if (k.length === 1) {
                  L ? T.push(q) : T.push(J);
                  break;
                }
                let Q = { ind: v, mode: g, doc: R },
                  V = { ind: v, mode: y, doc: R };
                if (k.length === 2) {
                  L ? T.push(Q, q) : T.push(V, J);
                  break;
                }
                k.splice(0, 2);
                let j = { ind: v, mode: S, doc: n(k) },
                  Y = k[0];
                F({ ind: v, mode: g, doc: [M, R, Y] }, [], B, o.length > 0, !0)
                  ? T.push(j, Q, q)
                  : L
                  ? T.push(j, V, q)
                  : T.push(j, V, J);
              ...
              case "line-suffix-boundary":
                o.length > 0 &&
                  T.push({ ind: v, mode: S, doc: { type: "line", hard: !0 } });
                break;
              case "line":
                switch (S) {
                  case g:
                  ...
                  case y:
                    ...
                    b.literal
                      ? v.root
                        ...
                        : (m.push($), (D = 0))
                      : ((D -= w(m)), m.push($ + v.value), (D = v.length));
                    break;
                }
                break;
              case "label":
        ...
        if (h !== -1) {
          let v = m.indexOf(u.placeholder, h + 1),
            S = m.slice(0, h).join(""),
            b = m.slice(h + 1, v).join(""),
            B = m.slice(v + 1).join("");
          return {
            formatted: S + b + B,
    ...
    "src/document/doc-debug.js"(e, r) {
      ...
      function n(u) {
        ...
        function p(y, g, c) {
          ...
          if (y.type === "line") {
            let f =
              Array.isArray(c) && c[g + 1] && c[g + 1].type === "break-parent";
            return y.literal
              ? f
                ? "literalline"
          ...
          if (y.type === "align")
            return y.n === Number.NEGATIVE_INFINITY
              ? "dedentToRoot(" + p(y.contents) + ")"
              : y.n < 0
              ? "dedent(" + p(y.contents) + ")"
              : y.n.type === "root"
              ? "markAsRoot(" + p(y.contents) + ")"
              : "align(" + JSON.stringify(y.n) + ", " + p(y.contents) + ")";
          if (y.type === "if-break")
            return (
              "ifBreak(" +
              p(y.breakContents) +
              (y.flatContents ? ", " + p(y.flatContents) : "") +
              (y.groupId
                ? (y.flatContents ? "" : ', ""') +
                  `, { groupId: ${d(y.groupId)} }`
                : "") +
          ...
          if (y.type === "indent-if-break") {
            let f = [];
            y.negate && f.push("negate: true"),
              y.groupId && f.push(`groupId: ${d(y.groupId)}`);
            let E = f.length > 0 ? `, { ${f.join(", ")} }` : "";
            return `indentIfBreak(${p(y.contents)}${E})`;
          }
          if (y.type === "group") {
            let f = [];
            y.break && y.break !== "propagated" && f.push("shouldBreak: true"),
              y.id && f.push(`id: ${d(y.id)}`);
            let E = f.length > 0 ? `, { ${f.join(", ")} }` : "";
            return y.expandedStates
              ? `conditionalGroup([${y.expandedStates
                  .map((_) => p(_))
                  .join(",")}]${E})`
              : `group(${p(y.contents)}${E})`;
          }
          if (y.type === "fill")
...
var PD = ht({
  ...
  wa = te({
    "node_modules/semver/internal/debug.js"(e, r) {
      ...
      var t =
        ...
        Nt.env &&
        Nt.env.NODE_DEBUG &&
        /\bsemver\b/i.test(Nt.env.NODE_DEBUG)
          ? function () {
              for (
  ...
  ID = te({
    "node_modules/semver/internal/re.js"(e, r) {
      ne();
      var { MAX_SAFE_COMPONENT_LENGTH: t } = _a(),
        s = wa();
      e = r.exports = {};
      var a = (e.re = []),
        n = (e.src = []),
      ...
      l("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
        ...
        l("GTLT", "((?:<|>)?=?)"),
        l("XRANGEIDENTIFIERLOOSE", `${n[u.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),
        ...
        l(
          ...
          })(?:\\.(${n[u.XRANGEIDENTIFIERLOOSE]})(?:${n[u.PRERELEASELOOSE]})?${
            n[u.BUILD]
          }?)?)?`
        ),
  ...
  OD = te({
    "node_modules/semver/classes/semver.js"(e, r) {
      ne();
      var t = wa(),
        { MAX_LENGTH: s, MAX_SAFE_INTEGER: a } = _a(),
        { re: n, t: u } = ID(),
        i = kD(),
        { compareIdentifiers: l } = LD(),
        p = class {
          constructor(d, y) {
            if (((y = i(y)), d instanceof p)) {
              if (
                d.loose === !!y.loose &&
                d.includePrerelease === !!y.includePrerelease
              )
                return d;
              d = d.version;
          ...
          compare(d) {
            if (
              (t("SemVer.compare", this.version, this.options, d),
              !(d instanceof p))
            ) {
              if (typeof d == "string" && d === this.version) return 0;
              d = new p(d, this.options);
            }
            return d.version === this.version
              ? 0
          ...
          compareMain(d) {
            return (
              ...
              l(this.major, d.major) ||
                l(this.minor, d.minor) ||
                l(this.patch, d.patch)
            );
          }
          comparePre(d) {
            if (
            ...
            let y = 0;
            do {
              let g = this.prerelease[y],
                c = d.prerelease[y];
              if (
                (t("prerelease compare", y, g, c), g === void 0 && c === void 0)
              )
                return 0;
          ...
          inc(d, y) {
            switch (d) {
              ...
              case "prepatch":
                ...
                break;
              case "prerelease":
                this.prerelease.length === 0 && this.inc("patch", y),
                  this.inc("pre", y);
                break;
              case "major":
                (this.minor !== 0 ||
              ...
              case "pre":
                ...
                y &&
                  (l(this.prerelease[0], y) === 0
                    ? isNaN(this.prerelease[1]) && (this.prerelease = [y, 0])
                    : (this.prerelease = [y, 0]));
                break;
              default:
    ...
    "node_modules/outdent/lib/index.js"(e, r) {
      ...
      function c(F, N, x) {
        ...
        var T = x.newline,
          ...
          o = typeof T == "string",
          h = F.length,
          v = F.map(function (S, b) {
            return (
              (S = S.replace(D, "$1")),
              b === 0 && m && (S = S.replace(l, "")),
              b === h - 1 && C && (S = S.replace(p, "")),
              o &&
                (S = S.replace(/\r\n|\n|\r/g, function (B) {
                  return T;
                })),
      ...
      function _(F) {
        ...
        function I($) {
          ...
          if (E($)) {
            var m = $,
              C = (D[0] === I || D[0] === w) && g.test(m[0]) && d.test(m[1]),
              o = C ? x : N,
              h = o.get(m);
    ...
    "src/main/support.js"(e, r) {
      ...
      function u() {
        let {
            ...
            : {},
          g = a.split("-", 1)[0],
          c = l.flatMap((F) => F.languages || []).filter(E),
          f = s(
            Object.assign(
              {},
              ...l.map((F) => {
            ...
            .filter((F) => E(F) && _(F))
            .sort((F, N) => (F.name === N.name ? 0 : F.name < N.name ? -1 : 1))
            .map(w)
            .map((F) => {
              (F = Object.assign({}, F)),
                ...
                Array.isArray(F.choices) &&
                  ((F.choices = F.choices.filter((x) => E(x) && _(x))),
                  F.name === "parser" && i(F, c, l));
              let N = Object.fromEntries(
                l
                  .filter(
                    (x) =>
                      x.defaultOptions && x.defaultOptions[F.name] !== void 0
                  )
                  .map((x) => [x.name, x.defaultOptions[F.name]])
              );
              return Object.assign(
                Object.assign({}, F),
                {},
        ...
        function _(F) {
          return (
            d || !("deprecated" in F) || (F.deprecated && t.lt(g, F.deprecated))
          );
        }
        function w(F) {
          if (y) return F;
        ...
        for (let g of p)
          if (g.parsers) {
            for (let c of g.parsers)
              if (!y.has(c)) {
                y.add(c);
                let f = d.find((_) => _.parsers && _.parsers[c]),
                  E = g.name;
                f && f.name && (E += ` (plugin: ${f.name})`),
                  l.choices.push({ value: c, description: E });
              }
          }
      }
...
`);
      ...
      function C(V, j) {
        let Y = { quote: '"', regex: /"/g, escaped: "&quot;" },
          ie = { quote: "'", regex: /'/g, escaped: "&apos;" },
          ee = j === "'" ? ie : Y,
          ce = ee === ie ? Y : ie,
          W = ee;
...
function JD(e, r, t, s) {
  var a = arguments.length,
    n =
      a < 3 ? r : s === null ? (s = Object.getOwnPropertyDescriptor(r, t)) : s,
    u;
...
function rm(e, r, t) {
  ...
  function l(g) {
    g.value instanceof Jt
      ? Promise.resolve(g.value.v).then(p, d)
      : y(n[0][2], g);
  }
  function p(g) {
    i("next", g);
...
function um(e) {
  ...
  return r
    ? r.call(e)
    : ((e = typeof jn == "function" ? jn(e) : e[Symbol.iterator]()),
      (t = {}),
      s("next"),
      s("throw"),
      s("return"),
...
var br,
      ...
      e.levenUnknownHandler = (s, a, n) => {
        let { descriptor: u, logger: i, schemas: l } = n,
          ...
          d = Object.keys(l)
            .sort()
            .find((y) => t(s, y) < 3);
        d && p.push(`Did you mean ${r.default.blue(u.key(d))}?`),
          i.warn(p.join(" "));
      };
    },
  }),
    ...
    "node_modules/vnopts/lib/schema.js"(e) {
      ...
      function a(n, u, i) {
        return typeof n == "function"
          ? function () {
              for (
                var l = arguments.length, p = new Array(l), d = 0;
                d < l;
                d++
              )
                p[d] = arguments[d];
    ...
    "node_modules/vnopts/lib/schemas/array.js"(e) {
      ...
      var r = (Et(), ft(vt)),
        ...
        s = class extends t.Schema {
          constructor(n) {
            var { valueSchema: u, name: i = u.name } = n,
          ...
          validate(n, u) {
            ...
            let i = [];
            for (let l of n) {
              let p = u.normalizeValidateResult(
          ...
          deprecated(n, u) {
            let i = [];
            for (let l of n) {
              let p = u.normalizeDeprecatedResult(
          ...
          forward(n, u) {
            let i = [];
            for (let l of n) {
              let p = u.normalizeForwardResult(
          ...
          redirect(n, u) {
            let i = [],
              l = [];
            for (let p of n) {
              let d = u.normalizeRedirectResult(
    ...
    "node_modules/vnopts/lib/normalize.js"(e) {
      ...
      var s = class {
        ...
        _applyNormalization(a, n) {
          ...
          for (let p of i) {
            let d = this._utils.schemas[p],
              y = d.preprocess(a[p], this._utils),
              g = t.normalizeValidateResult(d.validate(y, this._utils), y);
            if (g !== !0) {
              let { value: w } = g,
                F = this._invalidHandler(p, w, this._utils);
              throw typeof F == "string" ? new Error(F) : F;
            }
            let c = (w) => {
                let { from: F, to: N } = w;
                u.push(
                  typeof N == "string" ? { [N]: F } : { [N.key]: N.value }
                );
              },
              f = (w) => {
                let { value: F, redirectTo: N } = w,
                  x = t.normalizeDeprecatedResult(
                    d.deprecated(F, this._utils),
                    y,
                    !0
                  );
                if (x !== !1)
            ...
            if ((_.redirect.forEach(c), "remain" in _)) {
              let w = _.remain;
              (n[p] = p in n ? d.overlap(n[p], w, this._utils) : w),
                f({ value: w });
            }
          ...
          for (let p of l) {
            let d = a[p],
              y = this._unknownHandler(p, d, this._utils);
            if (y)
                  ...
                  return (
                    w.logger.warn(
                      [
                        ...
                        `did you mean ${c.blue(w.descriptor.value(F))}?`,
                      ].join(" ")
                    ),
                    F
                  );
          ...
          N = _
            ...
            : (T, m, C) => {
                ...
                return t.levenUnknownHandler(
                  T,
                  m,
                  Object.assign(Object.assign({}, C), {}, { schemas: v })
                );
              },
          x = E ? a : t.apiDescriptor,
          I = l(c, { isCLI: E, colorsModule: w, levenshteinDistance: F }),
          P = new t.Normalizer(I, { logger: f, unknown: N, descriptor: x }),
          $ = f !== !1;
        $ && u && (P._hasDeprecationWarned = u);
        let D = P.normalize(g);
        return (
          $ && (u = P._hasDeprecationWarned),
          E && D["plugin-search"] === !1 && (D["plugin-search-dir"] = !1),
          D
        );
      }
      function l(g, c) {
        let { isCLI: f, colorsModule: E, levenshteinDistance: _ } = c,
          w = [];
        ...
        for (let F of g)
          w.push(
            ...
            F.alias &&
              f &&
              w.push(
                t.AliasSchema.create({ name: F.alias, sourceName: F.name })
              );
        return w;
      }
      function p(g, c) {
        ...
        if (
          (g.exception
            ? (N.validate = (P, $, D) => g.exception(P) || $.validate(P, D))
            : (N.validate = (P, $, D) => P === void 0 || $.validate(P, D)),
          g.redirect &&
            (I.redirect = (P) =>
              P
                ? { to: { key: g.redirect.option, value: g.redirect.value } }
                : void 0),
          ...
          ? t.ArraySchema.create(
              Object.assign(
                Object.assign(
                  Object.assign(
                    {},
                    f ? { preprocess: (P) => (Array.isArray(P) ? P : [P]) } : {}
                  ),
                  I
                ),
                {},
    ...
    "src/language-js/loc.js"(e, r) {
      ...
      function s(l) {
        ...
        let y = l.range ? l.range[0] : l.start,
          g =
            (p =
              (d = l.declaration) === null || d === void 0
                ? void 0
                : d.decorators) !== null && p !== void 0
              ? p
              : l.decorators;
  ...
  wm = te({
    "node_modules/@babel/code-frame/lib/index.js"(e) {
      ...
      var a = /\r\n|[\n\r\u2028\u2029]/;
      function n(l, p, d) {
        let y = Object.assign({ column: 0, line: -1 }, l.start),
          g = Object.assign({}, y, l.end),
          { linesAbove: c = 2, linesBelow: f = 3 } = d || {},
          E = y.line,
          _ = y.column,
          w = g.line,
          F = g.column,
        ...
        if (I)
          ...
          _ === F ? (_ ? (P[E] = [_, 0]) : (P[E] = !0)) : (P[E] = [_, F - _]);
        return { start: N, end: x, markerLines: P };
      }
      function u(l, p) {
        let d =
            arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
          y = (d.highlightCode || d.forceColor) && (0, r.shouldHighlight)(d),
          g = (0, r.getChalk)(d),
          c = s(g),
          f = ($, D) => (y ? $(D) : D),
          E = l.split(a),
          { start: _, end: w, markerLines: F } = n(p, E, d),
          N = p.start && typeof p.start.column == "number",
          x = String(w).length,
          P = (y ? (0, r.default)(l, d) : l)
            .split(a, w)
            .slice(_, w)
            .map(($, D) => {
              let T = _ + 1 + D,
              ...
              if (o) {
                let v = "";
                if (Array.isArray(o)) {
                  let S = $.slice(0, Math.max(o[0] - 1, 0)).replace(
                      /[^\t]/g,
                      " "
                    ),
                    b = o[1] || 1;
 ...
 `,
                    ...
                    h && d.message && (v += " " + f(c.message, d.message));
                }
                return [
                  f(c.marker, ">"),
                  f(c.gutter, C),
...
${P}`),
  ...
  Qn = te({
    "src/main/parser.js"(e, r) {
      "use strict";
      ne();
      var { ConfigError: t } = Kt(),
        s = ut(),
        a = Bm(),
        { locStart: n, locEnd: u } = s,
      ...
      function d(g) {
        let c =
          arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : p(g);
      ...
      function y(g, c) {
        ...
        try {
          ...
          if (F) {
            ...
            throw (
              ((w.codeFrame = N(g, F, { highlightCode: !0 })),
              (w.message +=
                `
` + w.codeFrame),
              w)
    ...
    "src/main/options.js"(e, r) {
      ...
      function l(y) {
        ...
        let F = Object.fromEntries(
            f
              .filter(
                (x) => x.pluginDefaults && x.pluginDefaults[w.name] !== void 0
              )
        ...
        return (
          ...
          n.normalizeApiOptions(
            c,
            f,
            Object.assign({ passThrough: Object.keys(i) }, g)
          )
        );
      }
      function p(y) {
          ...
          E = a({ plugins: g })
            ...
            .find(
              (_) =>
                ...
                (_.filenames && _.filenames.some((w) => w.toLowerCase() === c))
            );
  ...
  et = te({
    "src/main/comments.js"(e, r) {
        ...
        for (let [W, K] of ce.entries()) {
          ...
          if (
            ...
            (de.placement = "ownLine"),
              Y(...ge) || (z ? f(z, de) : ue ? _(ue, de) : E(Fe || se, de));
          else if (D(U, Z, ce, W))
            (de.placement = "endOfLine"),
              ie(...ge) || (ue ? _(ue, de) : z ? f(z, de) : E(Fe || se, de));
      ...
      var P = (k) => !/[\S\n\u2028\u2029]/.test(k);
      function $(k, M, R, q) {
        let { comment: J, precedingNode: L } = R[q],
          { locStart: Q, locEnd: V } = M,
          j = Q(J);
        if (L)
          for (let Y = q - 1; Y >= 0; Y--) {
      ...
      function D(k, M, R, q) {
        let { comment: J, followingNode: L } = R[q],
          { locStart: Q, locEnd: V } = M,
          j = V(J);
        if (L)
      ...
      function o(k, M) {
        let R = k.getValue(),
          q = [m(k, M)],
          { printer: J, originalText: L, locStart: Q, locEnd: V } = M;
      ...
      function h(k, M) {
        let R = k.getValue(),
          q = m(k, M),
          { printer: J, originalText: L, locStart: Q } = M,
      ...
      var n = class {
        ...
        call(u) {
          let { stack: i } = this,
            ...
            p = t(i);
          for (
            var d = arguments.length, y = new Array(d > 1 ? d - 1 : 0), g = 1;
            g < d;
            g++
          )
            y[g - 1] = arguments[g];
        ...
        map(u) {
          let i = [];
          for (
            var l = arguments.length, p = new Array(l > 1 ? l - 1 : 0), d = 1;
            d < l;
            d++
          )
            p[d - 1] = arguments[d];
        ...
        findAncestor(u) {
          ...
          for (; p; ) {
            ...
            if (
              (typeof l == "number" &&
                ((d = l), (l = this.stack[i--]), (p = this.stack[i--])),
              l !== null && u(p, l, d))
            )
              return p;
  ...
  Im = te({
    "src/main/multiparser.js"(e, r) {
      ...
      function u(i, l, p, d) {
        let { stripTrailingHardline: y = !1 } =
            arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {},
          g = s(
            Object.assign(
              Object.assign(Object.assign({}, p), l),
              {},
              { parentParser: p.parser, originalText: i }
            ),
            { passThrough: !0 }
          ),
          c = Qn().parse(i, g),
        ...
        delete f.comments,
          a.attach(E, f, i, g),
          (g[Symbol.for("comments")] = E || []),
          (g[Symbol.for("tokens")] = f.tokens || []);
        let _ = d(f, g);
        return (
          a.ensureAllCommentsPrinted(E),
          y ? (typeof _ == "string" ? _.replace(/(?:\r?\n)*$/, "") : t(_)) : _
        );
      }
  ...
  km = te({
    "src/main/ast-to-doc.js"(e, r) {
      ...
      function d(y, g, c, f) {
        ...
        return (
          (!_.willPrintOwnComments || !_.willPrintOwnComments(y, g)) &&
            (w = u(y, w, g, F)),
          w
        );
      }
    ...
    "src/main/range-util.js"(e, r) {
      ...
      function n(f, E) {
        let _ = [f.node, ...f.parentNodes],
          w = new Set([E.node, ...E.parentNodes]);
      ...
      function u(f) {
        ...
        for (;;) {
          let _ = f[E];
          if (_ && (_.type === "Program" || _.type === "File")) E--;
          else break;
        }
        return f.slice(0, E + 1);
      }
      function i(f, E, _) {
        let { locStart: w, locEnd: F } = _,
          N = f.node,
          x = E.node;
  ...
  Om = te({
    "src/main/core.js"(e, r) {
      ...
      function F(m, C, o) {
        let h = C.comments;
        return (
          h && (delete C.comments, g.attach(h, C, m, o)),
          (o[Symbol.for("comments")] = h || []),
      ...
      function x(m, C) {
        let { ast: o, text: h } = c.parse(m, C),
          { rangeStart: v, rangeEnd: S } = E.calculateRange(h, C, o),
          b = h.slice(v, S),
          B = Math.min(
            v,
            h.lastIndexOf(
...
`
      ...
      function I(m, C, o) {
        return typeof C != "number" || Number.isNaN(C) || C < 0 || C > m.length
          ? o
          : C;
      }
      function P(m, C) {
        ...
        return (
          ...
          Object.assign(
            Object.assign({}, C),
            {},
            { cursorOffset: o, rangeStart: h, rangeEnd: v }
          )
        );
      }
      function $(m, C) {
...
`
        ...
        return {
          ...
          options: P(
            ...
            Object.assign(
              Object.assign({}, C),
              {},
              { cursorOffset: o, rangeStart: h, rangeEnd: v, endOfLine: S }
            )
          ),
        };
      }
      ...
      function T(m, C) {
        ...
        if (
          (v.rangeStart >= v.rangeEnd && h !== "") ||
          (v.requirePragma && !D(h, v))
        )
          return { formatted: m, cursorOffset: C.cursorOffset, comments: [] };
        let S;
        return (
          v.rangeStart > 0 || v.rangeEnd < h.length
            ? (S = x(h, v))
            : (!v.requirePragma &&
                v.insertPragma &&
                v.printer.insertPragma &&
                !D(h, v) &&
                (h = v.printer.insertPragma(h)),
              (S = N(h, v))),
          o &&
      ...
      ne(),
        (r.exports = function (t, s) {
          let { languageId: a } = t,
            n = $n(t, pD);
          return Object.assign(
            Object.assign({ linguistLanguageId: a }, n),
            s(t)
          );
        });
    },
        ...
        (function () {
          ...
          function p(f) {
            ...
            for (E = 1, _ = f.length; E < _; ++E)
              if (((w = f.charCodeAt(E)), !t.isIdentifierPartES5(w))) return !1;
            return !0;
          }
          function d(f, E) {
            ...
            for (N = t.isIdentifierStartES6, E = 0, _ = f.length; E < _; ++E) {
              if (((w = f.charCodeAt(E)), 55296 <= w && w <= 56319)) {
                if (
                  (++E,
                  E >= _ ||
                    ((F = f.charCodeAt(E)), !(56320 <= F && F <= 57343)))
                )
                  return !1;
                w = d(w, F);
              }
  ...
  Ke = te({
    "src/language-js/utils/index.js"(e, r) {
      ...
      var t = Rm().keyword.isIdentifierNameES5,
        ...
        { locStart: p, locEnd: d, hasSameLocStart: y } = ut(),
        g = _t(),
        c = $m(),
        f = "(?:(?=.)\\s)",
        E = new RegExp(`^${f}*:`),
      ...
      function w(O) {
        ...
        return (
          ((me = O.extra) === null || me === void 0
            ...
            : me.parenthesized) &&
          g(
            (_e = O.trailingComments) === null || _e === void 0 ? void 0 : _e[0]
          ) &&
          E.test(O.trailingComments[0].value)
        );
      }
      function F(O) {
          ...
          : (me =
              (_e =
                (He =
                  (Ge =
                    (it =
                      (Qe = O.left) !== null && Qe !== void 0 ? Qe : O.test) !==
                      null && it !== void 0
                      ? it
        ...
        return (
          ...
          ((t(O.key.value) &&
            !(
              ...
              (me.parser === "typescript" && O.type === "PropertyDefinition")
            )) ||
            (fe(O.key.value) &&
...
`)
        ...
        if (O.type === "ObjectExpression")
          return O.properties.every(
            (Qe) => !Qe.computed && (Qe.shorthand || (Qe.value && _e(Qe.value)))
          );
      ...
      var be = {
        ...
        je = (O, me) => {
          if ((typeof O == "function" && ((me = O), (O = 0)), O || me))
            return (_e, He, Ge) =>
              !(
                (O & be.Leading && !_e.leading) ||
                (O & be.Trailing && !_e.trailing) ||
                (O & be.Dangling && (_e.leading || _e.trailing)) ||
                (O & be.Block && !g(_e)) ||
                (O & be.Line && !D(_e)) ||
                (O & be.First && He !== 0) ||
                (O & be.Last && He !== Ge.length - 1) ||
                (O & be.PrettierIgnore && !Ie(_e)) ||
                (me && !me(_e))
              );
        };
      function Me(O, me, _e) {
      ...
      function tt(O) {
        return (
          de(O) || O.type === "NewExpression" || O.type === "ImportExpression"
        );
      }
      function Ve(O) {
        return (
      ...
      function st(O) {
        return (
          O.type === "TSAsExpression" || O.type === "TSSatisfiesExpression"
        );
      }
      r.exports = {
...
`) && M.push({ hasLineBreak: !1, cells: [] });
  ...
  Vm = te({
    "src/language-js/embed/markdown.js"(e, r) {
      ...
      ne();
      var {
          builders: { indent: t, softline: s, literalline: a, dedentToRoot: n },
        } = qe(),
    ...
    "src/language-js/embed/css.js"(e, r) {
      ...
      function d(c, f, E) {
        let _ = c.getValue(),
          ...
          N = w.reduce(
            (P, $, D) =>
              D === 0 ? $ : P + "@prettier-placeholder-" + F++ + "-id" + $,
            ""
          ),
          x = E(N, { parser: "scss" }, { stripTrailingHardline: !0 }),
          I = p(c, f);
        return y(x, _, I);
      }
      function y(c, f, E) {
  ...
  Hm = te({
    "src/language-js/embed/graphql.js"(e, r) {
      ...
      var {
        ...
        { escapeTemplateCharacters: n, printTemplateExpressions: u } = Lt();
      function i(p, d, y) {
        let g = p.getValue(),
          c = g.quasis.length;
...
`),
          ...
          m
            ? (C = l(I))
            : (C = y(x, { parser: "graphql" }, { stripTrailingHardline: !0 })),
            C
              ? ((C = n(C, !1)),
                !F && D && E.push(""),
                E.push(C),
      ...
      function l(p) {
        ...
        for (let [c, f] of g.entries())
          f !== "" &&
            (g[c - 1] === "" && y ? d.push([a, f]) : d.push(f), (y = !0));
  ...
  Gm = te({
    "src/language-js/embed/html.js"(e, r) {
      ...
      var {
        ...
        { printTemplateExpressions: i, uncookTemplateElementValue: l } = Lt(),
        p = 0;
      function d(y, g, c, f, E) {
        ...
        let N = (h) => `PRETTIER_HTML_PLACEHOLDER_${h}_${F}_IN_JS`,
          x = w.quasis
            .map((h, v, S) =>
              v === S.length - 1 ? h.value.cooked : h.value.cooked + N(v)
            )
            .join(""),
          I = i(y, g);
  ...
  Um = te({
    "src/language-js/embed.js"(e, r) {
      ...
      function g(D) {
        ...
        return (
          (C &&
            ...
            C.openingElement.attributes.some((o) => o.name.name === "jsx")) ||
          (m &&
            m.type === "TaggedTemplateExpression" &&
            m.tag.type === "Identifier" &&
            m.tag.name === "css") ||
      ...
      function _(D) {
        ...
        let m =
          T.tag.type === "ParenthesizedExpression" ? T.tag.expression : T.tag;
        switch (m.type) {
          case "MemberExpression":
            ...
            return (
              ...
              (m.callee.type === "MemberExpression" &&
                ((m.callee.object.type === "MemberExpression" &&
                  (F(m.callee.object.object) || N(m.callee.object))) ||
                  (m.callee.object.type === "CallExpression" &&
                    F(m.callee.object.callee))))
            );
          case "Identifier":
            return m.name === "css";
          default:
      ...
      function n(u, i, l) {
        ...
        if (
          ...
          u.type === "JSXElement" &&
            ...
            u.openingElement.attributes.some((y) => y.name.name === "jsx"))
        )
          for (let { type: y, expression: g } of i.children)
            y === "JSXExpressionContainer" &&
        ...
        if (
          ...
          var d;
          (((d = u.leadingComments) === null || d === void 0
            ? void 0
            : d.some(
                (g) =>
                  t(g) && ["GraphQL", "HTML"].some((c) => g.value === ` ${c} `)
              )) ||
            (l.type === "CallExpression" && l.callee.name === "graphql") ||
            !u.leadingComments) &&
            a(i);
        }
        if (
    ...
    "node_modules/jest-docblock/build/index.js"(e) {
      ...
      function _(N) {
        ...
        let P = Object.create(null),
          $ = N.replace(d, "").replace(l, "").trimRight(),
          D;
        for (; (D = d.exec(N)); ) {
          let T = D[2].replace(i, "");
...
`);
  ...
  po = te({
    "src/language-js/pragma.js"(e, r) {
      "use strict";
      ne();
      var { parseWithComments: t, strip: s, extract: a, print: n } = Zm(),
        { normalizeEndOfLine: u } = Hn(),
        i = ed();
      function l(y) {
        let g = i(y);
        g && (y = y.slice(g.length + 1));
        let c = a(y),
          { pragmas: f, comments: E } = t(c);
      ...
      function d(y) {
        let { shebang: g, text: c, pragmas: f, comments: E } = l(y),
          _ = s(c),
          w = n({
            pragmas: Object.assign({ format: "" }, f),
            comments: E.trimStart(),
          });
        return (
          (g
            ? `${g}
...
`) +
  ...
  td = te({
    "src/language-js/utils/is-type-cast-comment.js"(e, r) {
      ...
      function s(a) {
        return (
          t(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/.test(a.value)
        );
      }
      r.exports = s;
    },
  ...
  fo = te({
    "src/language-js/comments.js"(e, r) {
      ...
      var {
        ...
        { locStart: C, locEnd: o } = ut(),
        h = _t(),
        v = td();
      function S(De) {
        return [H, Fe, Q, q, J, L, ie, he, se, ge, we, ke, ce, z, U].some((A) =>
          A(De)
        );
      }
      function b(De) {
        return [R, Fe, V, we, q, J, L, ie, z, Z, fe, ge, Pe, U, X].some((A) =>
          A(De)
        );
      }
      function B(De) {
      ...
      function q(De) {
        ...
        if (G === re.consequent && ye === re.alternate) {
          if (G.type === "BlockStatement") l(G, A);
            ...
            let ve =
                A.type === "SingleLine" || A.loc.start.line === A.loc.end.line,
      ...
      function J(De) {
        ...
        return (re == null ? void 0 : re.type) !== "WhileStatement" || !ye
          ? !1
          : n(Ce, A, o) === ")"
          ? (l(G, A), !0)
      ...
      function L(De) {
        ...
        return ((re == null ? void 0 : re.type) !== "TryStatement" &&
          (re == null ? void 0 : re.type) !== "CatchClause") ||
          !ye
          ? !1
      ...
      function Q(De) {
        ...
        return I(G) && (re == null ? void 0 : re.type) === "Identifier"
          ? (i(G, A), !0)
          : !1;
      }
      function V(De) {
        let {
          ...
          Be = G && !u(Ce, o(G), C(A));
        return (!G || !Be) &&
          ((re == null ? void 0 : re.type) === "ConditionalExpression" ||
            (re == null ? void 0 : re.type) === "TSConditionalType") &&
          ye
          ? (i(ye, A), !0)
          : !1;
      }
      ...
      function ce(De) {
        ...
        return (re &&
          ...
          re.key === G &&
          n(ye, G, o) !== ":") ||
          ((G == null ? void 0 : G.type) === "Decorator" &&
            ee.has(re == null ? void 0 : re.type))
          ? (l(G, A), !0)
          : !1;
      }
      var W = new Set([
      ...
      function K(De) {
        ...
        return n(ye, A, o) !== "("
          ? !1
          : G && W.has(re == null ? void 0 : re.type)
          ? (l(G, A), !0)
          : !1;
      }
      function de(De) {
      ...
      function ue(De) {
        ...
        return n(re, A, o) !== ")"
          ? !1
          : G && ((le(G) && g(G).length === 0) || (F(G) && N(G).length === 0))
          ? (p(G, A), !0)
          : ((G == null ? void 0 : G.type) === "MethodDefinition" ||
              (G == null ? void 0 : G.type) === "TSAbstractMethodDefinition") &&
            g(G.value).length === 0
          ? (p(G.value, A), !0)
          : !1;
      }
      function Fe(De) {
        ...
        if (
          ((G == null ? void 0 : G.type) === "FunctionTypeParam" &&
            (re == null ? void 0 : re.type) === "FunctionTypeAnnotation" &&
            (ye == null ? void 0 : ye.type) !== "FunctionTypeParam") ||
          (((G == null ? void 0 : G.type) === "Identifier" ||
            (G == null ? void 0 : G.type) === "AssignmentPattern") &&
            re &&
            le(re) &&
            n(Ce, A, o) === ")")
        )
          return l(G, A), !0;
        if (
          (re == null ? void 0 : re.type) === "FunctionDeclaration" &&
          (ye == null ? void 0 : ye.type) === "BlockStatement"
        ) {
          let Be = (() => {
            let ve = g(re);
      ...
      function z(De) {
        ...
        return (G == null ? void 0 : G.type) === "LabeledStatement"
          ? (i(G, A), !0)
          : !1;
      }
      function U(De) {
        let { comment: A, enclosingNode: G } = De;
        return ((G == null ? void 0 : G.type) === "ContinueStatement" ||
          (G == null ? void 0 : G.type) === "BreakStatement") &&
          !G.label
          ? (l(G, A), !0)
          : !1;
      }
      ...
      function se(De) {
        ...
        return (re == null ? void 0 : re.type) === "UnionTypeAnnotation" ||
          (re == null ? void 0 : re.type) === "TSUnionType"
          ? (c(A) && ((ye.prettierIgnore = !0), (A.unignore = !0)),
            G ? (l(G, A), !0) : !1)
          : (((ye == null ? void 0 : ye.type) === "UnionTypeAnnotation" ||
              (ye == null ? void 0 : ye.type) === "TSUnionType") &&
              c(A) &&
      ...
      function ge(De) {
        ...
        return ye && ye.body && ye.body.length === 0
          ? (Ce ? p(ye, A) : i(ye, A), !0)
          : (G == null ? void 0 : G.type) === "Program" &&
            (G == null ? void 0 : G.body.length) === 0 &&
            !y(G.directives)
          ? (Ce ? p(G, A) : i(G, A), !0)
          : (re == null ? void 0 : re.type) === "Program" &&
            (re == null ? void 0 : re.body.length) === 0 &&
            (G == null ? void 0 : G.type) === "ModuleExpression"
          ? (p(re, A), !0)
          : !1;
      }
      function he(De) {
        let { comment: A, enclosingNode: G } = De;
        return (G == null ? void 0 : G.type) === "ForInStatement" ||
          (G == null ? void 0 : G.type) === "ForOfStatement"
          ? (i(G, A), !0)
          : !1;
      }
      function we(De) {
        let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = De;
        if (
          (re == null ? void 0 : re.type) === "ImportSpecifier" ||
          (re == null ? void 0 : re.type) === "ExportSpecifier"
        )
          return i(re, A), !0;
        let Ce =
            (G == null ? void 0 : G.type) === "ImportSpecifier" &&
            (re == null ? void 0 : re.type) === "ImportDeclaration",
          Be =
            (G == null ? void 0 : G.type) === "ExportSpecifier" &&
            (re == null ? void 0 : re.type) === "ExportNamedDeclaration";
        return (Ce || Be) && s(ye, o(A)) ? (l(G, A), !0) : !1;
      }
      function ke(De) {
        let { comment: A, enclosingNode: G } = De;
        return (G == null ? void 0 : G.type) === "AssignmentPattern"
          ? (i(G, A), !0)
          : !1;
      }
      var Re = new Set([
      ...
      function Pe(De) {
        let { comment: A, enclosingNode: G, followingNode: re } = De;
        return Re.has(G == null ? void 0 : G.type) &&
          re &&
          (Ne.has(re.type) || h(A))
          ? (i(re, A), !0)
          : !1;
      ...
      function oe(De) {
        ...
        return !re &&
          ((G == null ? void 0 : G.type) === "TSMethodSignature" ||
            (G == null ? void 0 : G.type) === "TSDeclareFunction" ||
            (G == null ? void 0 : G.type) === "TSAbstractMethodDefinition") &&
          n(ye, A, o) === ";"
          ? (l(G, A), !0)
          : !1;
      ...
      function H(De) {
        ...
        if (
          c(A) &&
          (G == null ? void 0 : G.type) === "TSMappedType" &&
          (re == null ? void 0 : re.type) === "TSTypeParameter" &&
          re.constraint
        )
      ...
      function pe(De) {
        ...
        return (re == null ? void 0 : re.type) !== "TSMappedType"
          ? !1
          : (ye == null ? void 0 : ye.type) === "TSTypeParameter" && ye.name
          ? (i(ye.name, A), !0)
          : (G == null ? void 0 : G.type) === "TSTypeParameter" && G.constraint
          ? (l(G.constraint, A), !0)
          : !1;
      }
      function X(De) {
        ...
        return !G ||
          ...
          re !== G.consequent[0]
          ? !1
          : (re.type === "BlockStatement" && $(A) ? k(re, A) : p(G, A), !0);
      }
      function le(De) {
        return (
  ...
  Ot = te({
    "src/language-js/needs-parens.js"(e, r) {
      ...
      function w(D, T) {
        ...
        if (o.type === "Identifier") {
          ...
          if (o.name === "let") {
            var h;
            let S =
              (h = D.findAncestor((b) => b.type === "ForOfStatement")) ===
                null || h === void 0
                ? void 0
                : h.left;
        ...
        if (
          ...
          var v;
          let S =
            (v = D.findAncestor((b) => b.type === "ExpressionStatement")) ===
              null || v === void 0
              ? void 0
              : v.expression;
          if (S && d(S, (b) => b === o)) return !0;
        ...
        switch (o.type) {
          ...
          case "FunctionTypeAnnotation": {
            let S =
              m.type === "NullableTypeAnnotation" ? D.getParentNode(1) : m;
            return (
          ...
          case "AssignmentExpression": {
            ...
            return C === "body" && m.type === "ArrowFunctionExpression"
              ...
              : (C === "key" &&
                  ...
                  m.computed) ||
                ((C === "init" || C === "update") && m.type === "ForStatement")
              ? !1
              : m.type === "ExpressionStatement"
          ...
          case "ArrowFunctionExpression":
            switch (m.type) {
              case "BinaryExpression":
                return (
                  m.operator !== "|>" || (o.extra && o.extra.parenthesized)
                );
              case "NewExpression":
              case "CallExpression":
              case "OptionalCallExpression":
          ...
          case "OptionalCallExpression": {
            ...
            if (
              ...
              (C === "callee" &&
                (m.type === "CallExpression" || m.type === "NewExpression")) ||
              (m.type === "TSNonNullExpression" &&
          ...
          case "TypeAnnotation":
            return (
              C === "returnType" && m.type === "ArrowFunctionExpression" && x(o)
            );
        }
        return !1;
      }
        ...
        return l(
          ...
          (T) =>
            (T.type === "ObjectTypeAnnotation" &&
              l(T, (m) => m.type === "FunctionTypeAnnotation" || void 0)) ||
            void 0
        );
      }
      function I(D) {
      ...
      function $(D, T) {
        let m = D.getValue(),
          C = D.getParentNode();
        return m.type === "FunctionExpression" || m.type === "ClassExpression"
  ...
  rd = te({
    "src/language-js/print/html-binding.js"(e, r) {
      ...
      function i(p, d, y) {
        let g = p.getValue();
        if (
          (d.__onHtmlBindingRoot &&
            p.getName() === null &&
            d.__onHtmlBindingRoot(g, d),
          g.type === "File")
        ) {
          if (d.__isVueForBindingLeft)
            return p.call(
              (c) => {
                let f = t([",", s], c.map(y, "params")),
                  { params: E } = c.getValue();
    ...
    "src/language-js/print/binaryish.js"(e, r) {
      ...
      function T(o, h, v) {
        ...
        let q =
            ...
            (S.type !== "NGPipeExpression" &&
              ((b.type === "NGRoot" && h.parser === "__ng_binding") ||
        ...
        let Q = _(S.right),
          V = R.findIndex(
            (W) =>
              typeof W != "string" && !Array.isArray(W) && W.type === "group"
          ),
      ...
      function m(o, h, v, S, b) {
            ...
            B.type === "NGPipeExpression" && B.arguments.length > 0
              ? i(
                  l([
                    ...
                    a(
                      [n, ": "],
                      o.map(h, "arguments").map((Y) => p(2, i(Y)))
                    ),
                  ])
                )
              : "",
        ...
        if (M) L = [q, " ", h("right"), J];
          ...
          let ie =
            $(v) && q === "|>"
              ? o.call((ee) => m(ee, h, v, !0, b), "right")
              : h("right");
          L = [R ? n : "", q, R ? " " : n, ie, J];
        }
        let Q = o.getParentNode(),
          V = F(B.left, N.Trailing | N.Line),
          j =
            V ||
            (!(b && B.type === "LogicalExpression") &&
              ...
              B.right.type !== B.type);
        if (
          (k.push(R ? "" : " ", j ? i(L, { shouldBreak: V }) : L), S && F(B))
        ) {
          let Y = y(t(o, k, v));
  ...
  nd = te({
    "src/language-js/print/angular.js"(e, r) {
      ...
      var {
        ...
        { hasNode: n, hasComment: u, getComments: i } = Ke(),
        { printBinaryishExpression: l } = Zn();
      function p(g, c, f) {
        let E = g.getValue();
        if (E.type.startsWith("NG"))
          switch (E.type) {
            case "NGRoot":
              return [
                f("node"),
                u(E.node) ? " //" + i(E.node)[0].value.trimEnd() : "",
              ];
            case "NGPipeExpression":
              return l(g, c, f);
            ...
            case "NGMicrosyntax":
              return g.map(
                (_, w) => [
                  w === 0 ? "" : d(_.getValue(), w, E) ? " " : [";", s],
                  f(),
                ],
                "body"
              );
            case "NGMicrosyntaxKey":
              return /^[$_a-z][\w$]*(?:-[$_a-z][\w$])*$/i.test(E.name)
                ? E.name
                : JSON.stringify(E.name);
            case "NGMicrosyntaxExpression":
              return [
                f("expression"),
                E.alias === null ? "" : [" as ", f("alias")],
              ];
            case "NGMicrosyntaxKeyedExpression": {
              let _ = g.getName(),
                ...
                F =
                  d(E, _, w) ||
                  (((_ === 1 &&
                    (E.key.name === "then" || E.key.name === "else")) ||
                    (_ === 2 &&
                      E.key.name === "else" &&
                      w.body[_ - 1].type === "NGMicrosyntaxKeyedExpression" &&
            ...
            default:
              throw new Error(
                `Unknown Angular node type: ${JSON.stringify(E.type)}.`
              );
          }
      }
      function d(g, c, f) {
  ...
  ud = te({
    "src/language-js/print/jsx.js"(e, r) {
      ...
      var {
        ...
        { getLast: _, getPreferredQuote: w } = Ue(),
        {
          isJsxNode: F,
          rawText: N,
          isCallExpression: x,
      ...
      function h(U, Z, se) {
        ...
        let we = fe.children.some(F),
          ke =
            fe.children.filter((A) => A.type === "JSXExpressionContainer")
              .length > 1,
          Re =
            fe.type === "JSXElement" && fe.openingElement.attributes.length > 1,
          Ne = E(ge) || we || Re || ke,
          ...
          U.each((we, ke, Re) => {
            ...
            if (Ne.type === "JSXText") {
              ...
              if (ue(Ne)) {
                ...
                let H;
                if (
                  (_(oe) === "" && (oe.pop(), (H = oe.pop())), oe.length === 0)
                )
                  return;
...
\r	`,
        ...
        K = (U) =>
          U.replace(
            new RegExp("(?:^" + ce.source + "|" + ce.source + "$)"),
            ""
          );
      function de(U) {
      ...
      function l(_) {
        return _.getValue().definite ||
          _.match(
            void 0,
            (w, F) =>
              F === "id" && w.type === "VariableDeclarator" && w.definite
          )
          ? "!"
          : "";
      }
  ...
  Qt = te({
    "src/language-js/print/array.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { locStart: F } = ut(),
        { printOptionalToken: N, printTypeAnnotation: x } = ct();
      function I(T, m, C) {
        let o = T.getValue(),
          h = [],
          ...
          T.elements.every(
            (C) =>
              ...
              !c(
                C,
                f.Trailing | f.Line,
                (o) => !y(m.originalText, F(o), { backwards: !0 })
              )
          )
        );
      }
      function $(T, m, C, o) {
        ...
        return (
          T.each((S) => {
            h.push(v, u(o())),
              (v = [",", s]),
              S.getValue() && E(S.getValue(), m) && v.push(a);
          }, C),
          h
        );
      }
  ...
  mo = te({
    "src/language-js/print/call-arguments.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { ArgExpansionBailout: o } = Kt(),
        { isConciselyPrintedArray: h } = Qt();
      function v(q, J, L) {
        let Q = q.getValue(),
        ...
        let W =
          !(V || (Q.callee && Q.callee.type === "Import")) && y(J, "all")
            ? ","
            : "";
        function K() {
            ...
            q.try(() => {
              c(q, (U, Z) => {
                de &&
                  ...
                  ue &&
                    Z === ee &&
                    (z = [...ce.slice(0, -1), L([], { expandLastArg: !0 })]);
              });
            });
          } catch (U) {
          ...
          return [
            ...
            D([
              ...
              de
                ...
                : ["(", ...ce.slice(0, -1), P(s(z), { shouldBreak: !0 }), ")"],
              K(),
            ]),
          ];
        }
      ...
      function S(q) {
        ...
        return (
          ...
          (q.type === "ArrayExpression" && (q.elements.length > 0 || u(q))) ||
          ...
          (q.type === "ArrowFunctionExpression" &&
            ...
            (q.body.type === "BlockStatement" ||
              (q.body.type === "ArrowFunctionExpression" && S(q.body, !0)) ||
              q.body.type === "ObjectExpression" ||
              q.body.type === "ArrayExpression" ||
              (!J && (E(q.body) || q.body.type === "ConditionalExpression")) ||
              p(q.body))) ||
          q.type === "DoExpression" ||
      ...
      function b(q, J) {
        ...
        return (
          ...
          !(q.length > 1 && L.type === "ArrayExpression" && h(L, J))
        );
      }
      function B(q) {
      ...
      function M(q) {
        return (
          ...
          (q.body.some((J) => J.type !== "EmptyStatement") || u(q, i.Dangling))
        );
      }
      function R(q) {
        return (
  ...
  go = te({
    "src/language-js/print/member.js"(e, r) {
      ...
      var {
        ...
        { printOptionalToken: p } = ct();
      function d(g, c, f) {
        let E = g.getValue(),
          _ = g.getParentNode(),
          w,
          F = 0;
        do (w = g.getParentNode(F)), F++;
        ...
        let N = f("object"),
          ...
          I =
            ...
            ((_.type === "AssignmentExpression" ||
              ...
              ((l(E.object) && E.object.arguments.length > 0) ||
                (E.object.type === "TSNonNullExpression" &&
                  l(E.object.expression) &&
                  E.object.expression.arguments.length > 0) ||
    ...
    "src/language-js/print/member-chain.js"(e, r) {
      ...
      function S(b, B, k) {
        let M = b.getParentNode(),
          ...
          q = [];
        function J(Ne) {
          let { originalText: Pe } = B,
            oe = n(Pe, Ne, w);
          return Pe.charAt(oe) === ")" ? oe !== !1 && a(Pe, oe + 1) : _(Ne, B);
        }
        function L(Ne) {
          let Pe = Ne.getValue();
          i(Pe) && (y(Pe.callee) || i(Pe.callee))
            ? (q.unshift({
                node: Pe,
                printed: [
                  t(Ne, [o(Ne), h(Ne, B, k), m(Ne, B, k)], B),
                  J(Pe) ? N : "",
                ],
              }),
        ...
        let Q = b.getValue();
        q.unshift({ node: Q, printed: [o(b), h(b, B, k), m(b, B, k)] }),
        ...
        for (
          ...
          (q[Y].node.type === "TSNonNullExpression" ||
            i(q[Y].node) ||
            (l(q[Y].node) && q[Y].node.computed && g(q[Y].node.property)));
          ++Y
        )
          j.push(q[Y]);
        if (!i(q[0].node))
        ...
        for (; Y < q.length; ++Y) {
          ...
          (i(q[Y].node) || q[Y].node.type === "ImportExpression") && (ie = !0),
            j.push(q[Y]),
            f(q[Y].node, E.Trailing) && (V.push(j), (j = []), (ie = !1));
        }
        j.length > 0 && V.push(j);
        function ee(Ne) {
        ...
        let Fe = V.map(de),
          ...
          Z = V.flat(),
          se =
            Z.slice(1, -1).some((Ne) => f(Ne.node, E.Leading)) ||
            Z.slice(0, -1).some((Ne) => f(Ne.node, E.Trailing)) ||
            (V[U] && f(V[U][0].node, E.Leading));
        ...
        function ke() {
          let Ne = s(s(V)).node,
            Pe = s(Fe);
          return (
            i(Ne) && T(Pe) && we.slice(0, -1).some((oe) => oe.arguments.some(p))
          );
        }
        let Re;
        return (
  ...
  yo = te({
    "src/language-js/print/call-expression.js"(e, r) {
      ...
      var {
        ...
        c = sd(),
        f = mo(),
        { printOptionalToken: E, printFunctionTypeParameters: _ } = ct();
      function w(N, x, I) {
        let P = N.getValue(),
          $ = N.getParentNode(),
        ...
        if (
          C.length > 0 &&
          ((!T && !D && F(P, $)) ||
            (C.length === 1 && d(C[0], x.originalText)) ||
            (!D && y(P, $)))
        ) {
          let v = [];
          return (
        ...
        if (N.callee.name === "define") {
          ...
          return (
            ...
            (I.length === 1 ||
              ...
              (I.length === 3 && p(I[0]) && I[1].type === "ArrayExpression"))
          );
        }
        return !1;
      }
  ...
  Zt = te({
    "src/language-js/print/assignment.js"(e, r) {
      ...
      var { isNonEmptyArray: t, getStringWidth: s } = Ue(),
        ...
        { shouldInlineLogicalExpression: D } = Zn(),
        { printCallExpression: T } = yo();
      function m(W, K, de, ue, Fe, z) {
        let U = h(W, K, de, ue, z),
          Z = de(z, { assignmentLayout: U });
        switch (U) {
      ...
      function V(W, K, de) {
        ...
        return F(Fe)
          ? W.call(z, "object")
          : ue && (Fe.type === "Identifier" || Fe.type === "ThisExpression");
      }
      var j = 0.25;
      function Y(W, K) {
        let { printWidth: de } = K;
...
`)
  ...
  Ir = te({
    "src/language-js/print/function-parameters.js"(e, r) {
      ...
      var { getNextNonSpaceNonCommentCharacter: t } = Ue(),
        ...
        { locEnd: $ } = ut(),
        { ArgExpansionBailout: D } = Kt(),
        { printFunctionTypeParameters: T } = ct();
      function m(v, S, b, B, k) {
        ...
        if (
          (c(v, (ie, ee) => {
            ...
            ce && M.rest && V.push("..."),
              ...
              !ce &&
                (V.push(","),
                L || Q ? V.push(" ") : P(R[ee], b) ? V.push(n, n) : V.push(a));
          }),
          B)
        ) {
        ...
        return Q && j
          ...
          : (F(J) ||
              ...
              (J.type === "FunctionTypeAnnotation" && J.returnType === M)) &&
            R.length === 1 &&
            R[0].name === null &&
            M.this !== R[0] &&
            R[0].typeAnnotation &&
      ...
      function o(v) {
        ...
        return (
          v.returnType
            ? ((S = v.returnType), S.typeAnnotation && (S = S.typeAnnotation))
  ...
  kr = te({
    "src/language-js/print/type-annotation.js"(e, r) {
      ...
      var { printComments: t, printDanglingComments: s } = et(),
        ...
        { printAssignment: N } = Zt(),
        { printFunctionParameters: x, shouldGroupFunctionParameters: I } = Ir(),
        { printArrayItems: P } = Qt();
      function $(b) {
        if (f(b) || E(b)) return !0;
        if (b.type === "UnionTypeAnnotation" || b.type === "TSUnionType") {
          let B = b.types.filter(
              (M) =>
      ...
      function T(b, B, k) {
        ...
        let J =
          R.type === "TSTypeAliasDeclaration" ? "typeAnnotation" : "right";
      ...
      function o(b, B, k) {
        let M = b.getValue(),
          ...
          V =
            Q && (q.type === "TypeAnnotation" || q.type === "TSTypeAnnotation"),
          j =
            V &&
            Q &&
  ...
  Lr = te({
    "src/language-js/print/type-parameters.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { createGroupIdMapper: F } = Ue(),
        { shouldHugType: N } = kr(),
        { isArrowFunctionVariableDeclarator: x } = Zt(),
        I = F("typeParameters");
      function P(T, m, C, o) {
        let h = T.getValue();
        if (!h[o]) return "";
        ...
        if (
          ...
          (!b &&
            (S ||
              (h[o].length === 1 &&
                (h[o][0].type === "NullableTypeAnnotation" || N(h[o][0])))))
        )
      ...
      function D(T, m, C) {
        let o = T.getValue(),
          h = [o.type === "TSTypeParameter" && o.const ? "const " : ""],
          v = T.getParentNode();
        return v.type === "TSMappedType"
          ? (v.readonly && h.push(w(v.readonly, "readonly"), " "),
            h.push("[", C("name")),
            o.constraint && h.push(" in ", C("constraint")),
            v.nameType &&
              h.push(
                " as ",
            ...
            h.push("]"),
            h)
          : (o.variance && h.push(C("variance")),
            o.in && h.push("in "),
            o.out && h.push("out "),
            h.push(C("name")),
            o.bound && h.push(": ", C("bound")),
            o.constraint && h.push(" extends ", C("constraint")),
            o.default && h.push(" = ", C("default")),
            h);
      }
      r.exports = {
  ...
  er = te({
    "src/language-js/print/property.js"(e, r) {
      ...
      var { printComments: t } = et(),
        ...
        { printAssignment: d } = Zt(),
        y = new WeakMap();
      function g(f, E, _) {
        let w = f.getNode();
        if (w.computed) return ["[", _("key"), "]"];
        let F = f.getParentNode(),
          { key: N } = w;
        if (E.quoteProps === "consistent" && !y.has(F)) {
          let x = (F.properties || F.body || F.members).some(
            (I) => !I.computed && I.key && i(I.key) && !l(I, E)
          );
          y.set(F, x);
        }
        if (
          ...
          (E.parser === "json" || (E.quoteProps === "consistent" && y.get(F)))
        ) {
          let x = s(
            JSON.stringify(
        ...
        return l(w, E) &&
          (E.quoteProps === "as-needed" ||
            (E.quoteProps === "consistent" && !y.get(F)))
          ? f.call(
              (x) => t(x, /^\d/.test(N.value) ? a(N.value) : N.value, E),
              "key"
            )
          : _("key");
      }
  ...
  Or = te({
    "src/language-js/print/function.js"(e, r) {
      ...
      var t = Yt(),
        ...
        { locEnd: M } = ut(),
        { printFunctionParameters: R, shouldGroupFunctionParameters: q } = Ir(),
        { printPropertyKey: J } = er(),
      ...
      function Q(U, Z, se, fe) {
        ...
        let we = [];
        ge.type === "TSDeclareFunction" && ge.declare && we.push("declare "),
      ...
      function j(U, Z, se) {
        ...
        return (
          fe.body ? ke.push(" ", se("body")) : ke.push(Z.semi ? ";" : ""), ke
        );
      }
      ...
      function ie(U, Z, se, fe, ge, he) {
        ...
        return (
          ...
          p([
            p(
              d([Re || Ne ? l : "", p(c([" =>", i], se), { shouldBreak: fe })]),
              { id: H, shouldBreak: oe }
            ),
            " =>",
            f(Pe ? d([i, ge]) : [" ", ge], { groupId: H }),
            Re ? y(l, "", { groupId: H }) : "",
          ])
        );
      }
      function ee(U, Z, se, fe) {
        ...
        if (
          ((function H() {
            ...
            (ke =
              ke ||
              (ge.returnType && F(ge).length > 0) ||
              ge.typeParameters ||
              F(ge).some((X) => X.type !== "Identifier")),
      ...
      function K(U, Z, se) {
        ...
        let he = [ge];
        return (
          fe.returnType && fe.returnType.typeAnnotation && he.unshift(": "),
          fe.predicate && he.push(fe.returnType ? " " : ": ", Z("predicate")),
          he
        );
      }
      function de(U, Z, se) {
        ...
        fe.argument &&
          (z(Z, fe.argument)
            ? he.push([" (", d([g, se("argument")]), g, ")"])
            : T(fe.argument) || fe.argument.type === "SequenceExpression"
            ? he.push(p([y(" (", " "), d([l, se("argument")]), l, y(")")]))
            : he.push(" ", se("argument")));
        let we = o(fe),
          ke = n(we),
          Re = ke && m(ke);
        return (
          Re && he.push(ge),
          C(fe, h.Dangling) && he.push(" ", s(U, Z, !0)),
          Re || he.push(ge),
          he
        );
      }
  ...
  eu = te({
    "src/language-js/print/decorators.js"(e, r) {
      ...
      var { isNonEmptyArray: t, hasNewline: s } = Ue(),
        {
          builders: { line: a, hardline: n, join: u, breakParent: i, group: l },
        } = qe(),
        { locStart: p, locEnd: d } = ut(),
        { getParentExportDeclaration: y } = Ke();
      function g(w, F, N) {
        let x = w.getValue();
  ...
  tr = te({
    "src/language-js/print/class.js"(e, r) {
      ...
      var { isNonEmptyArray: t, createGroupIdMapper: s } = Ue(),
        { printComments: a, printDanglingComments: n } = et(),
        {
          builders: {
            join: u,
            line: i,
        ...
        { hasComment: c, CommentCheckFlags: f } = Ke(),
        { getTypeParametersGroupId: E } = Lr(),
        { printMethod: _ } = Or(),
        {
        ...
        { printPropertyKey: x } = er(),
        { printAssignment: I } = Zt(),
        { printClassMemberDecorators: P } = eu();
      function $(b, B, k) {
        let M = b.getValue(),
          R = [];
        ...
        if (
          ...
          let Q = [h(b, B, k), k("superTypeParameters")],
      ...
      function C(b) {
        return (
          b.typeParameters && !c(b.typeParameters, f.Trailing | f.Line) && !m(b)
        );
      }
      function o(b, B, k, M) {
        let R = b.getValue();
        ...
        return [
          C(R) ? g(" ", i, { groupId: E(R.typeParameters) }) : i,
          q,
          q && l,
          M,
          d(y([i, u([",", i], b.map(k, M))])),
      ...
      function S(b, B, k) {
        ...
        return (
          ...
          (M.type === "ClassAccessorProperty" ||
            ...
            M.type === "TSAbstractAccessorProperty") &&
            R.push("accessor "),
          R.push(x(b, B, k), w(b), N(b), F(b, B, k)),
          [I(b, B, k, R, " =", "value"), q]
        );
      }
      r.exports = {
  ...
  ho = te({
    "src/language-js/print/interface.js"(e, r) {
      ...
      var { isNonEmptyArray: t } = Ue(),
        ...
        { hasComment: l, identity: p, CommentCheckFlags: d } = Ke(),
        { getTypeParametersGroupId: y } = Lr(),
        { printTypeScriptModifiers: g } = ct();
      function c(f, E, _) {
        let w = f.getValue(),
          F = [];
        w.declare && F.push("declare "),
          w.type === "TSInterfaceDeclaration" &&
            F.push(w.abstract ? "abstract " : "", g(f, E, _)),
          F.push("interface");
        let N = [],
          x = [];
        ...
        return (
          t(w.extends) &&
            x.push(
              I ? i(" ", a, { groupId: y(w.typeParameters) }) : a,
              "extends ",
              (w.extends.length === 1 ? p : u)(s([",", a], f.map(_, "extends")))
            ),
          (w.id && l(w.id, d.Trailing)) || t(w.extends)
            ? I
              ? F.push(n([...N, u(x)]))
              : F.push(n(u([...N, ...x])))
            : F.push(...N, ...x),
  ...
  vo = te({
    "src/language-js/print/module.js"(e, r) {
      ...
      var { isNonEmptyArray: t } = Ue(),
        ...
        { locStart: w, hasSameLoc: F } = ut(),
        { hasDecoratorsBeforeExport: N, printDecoratorsBeforeExport: x } = eu();
      function I(S, b, B) {
        let k = S.getValue(),
          M = b.semi ? ";" : "",
          R = [],
      ...
      function P(S, b, B) {
        ...
        return (
          M.push("export"),
          (k.default || R === "ExportDefaultDeclaration") && M.push(" default"),
          y(k, g.Dangling) && (M.push(" ", d(S, b, !0)), f(k) && M.push(p)),
          J
      ...
      function m(S, b, B) {
        ...
        if (t(k.specifiers)) {
          ...
          S.each(() => {
            ...
            q.length > 0 &&
              (R.length > 0 && M.push(", "),
              q.length > 1 || R.length > 0 || k.specifiers.some((L) => y(L))
                ? M.push(
                    a([
                      "{",
  ...
  tu = te({
    "src/language-js/print/object.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { locStart: F, locEnd: N } = ut(),
        { printOptionalToken: x, printTypeAnnotation: I } = ct(),
        { shouldHugFunctionParameters: P } = Ir(),
        { shouldHugType: $ } = kr(),
        { printHardlineAfterHeritage: D } = tr();
      function T(m, C, o) {
        let h = C.semi ? ";" : "",
          v = m.getValue(),
          S;
        ...
        let k = B.map((W) => v[W][0]).sort((W, K) => F(W) - F(K))[0],
          M = m.getParentNode(0),
          R =
            b &&
            M &&
          ...
          q =
            ...
            (v.type !== "ObjectPattern" && k && d(C.originalText, F(v), F(k))),
          J = R
            ? ";"
        ...
        if (v.inexact) {
          ...
          if (f(v, _.Dangling)) {
            ...
            W = [
              t(m, C, !0),
              K || y(C.originalText, N(p(E(v)))) ? l : s,
              "...",
            ];
          } else W = ["..."];
          Y.push([...j, ...W]);
  ...
  id = te({
    "src/language-js/print/flow.js"(e, r) {
      ...
      var t = Yt(),
        { printDanglingComments: s } = et(),
        { printString: a, printNumber: n } = Ue(),
        {
        ...
        { locStart: E, locEnd: _ } = ut(),
        { replaceTextEndOfLine: w } = Xt(),
        { printClass: F } = tr(),
        {
          printOpaqueType: N,
          printTypeAlias: x,
        ...
        { printInterface: m } = ho(),
        { printTypeParameter: C, printTypeParameters: o } = Lr(),
        { printExportDeclaration: h, printExportAllDeclaration: v } = vo(),
        { printArrayItems: S } = Qt(),
        { printObject: b } = tu(),
        { printPropertyKey: B } = er(),
        {
      ...
      function P(D) {
        ...
        for (let o = 0; !m; o++) {
          ...
          if (
            (n(h) && h.callee === C) ||
            (u(h) && h.object === C) ||
            (h.type === "TSNonNullExpression" && h.expression === C)
          ) {
            C = h;
            continue;
          }
          (h.type === "NewExpression" && h.callee === C) ||
          (i(h) && h.expression === C)
            ? ((m = D.getParentNode(o + 1)), (C = h))
            : (m = h);
        }
        ...
        if (o && (s(C[S[0]]) || s(b) || s(B) || N(Y))) {
          ...
          k.push(
            R.type !== C.type || R[v] === C || q
              ...
              : T.useTabs
              ? w(f(ue))
              : E(Math.max(0, T.tabWidth - 2), ue)
          );
        }
        let ee = [...S.map((ue) => a(C[ue])), a(b), a(B)]
            .flat()
            .some((ue) => d(ue) && t(T.originalText, l(ue), p(ue))),
          ce = (ue) =>
            R === j ? c(ue, { shouldBreak: ee }) : ee ? [ue, F] : ue,
          W =
            !M &&
  ...
  Eo = te({
    "src/language-js/print/statement.js"(e, r) {
      ...
      var {
        ...
        { shouldPrintParamsWithoutParens: y } = Or();
      function g(x, I, P, $) {
        let D = x.getValue(),
          T = [],
          m = D.type === "ClassBody",
          ...
          x.each((o, h, v) => {
            ...
            !I.semi && !m && !i(I, o) && f(o, I)
              ? l(S, p.Leading)
                ...
                : T.push(";", b)
              : T.push(b),
              !I.semi && m && F(S) && N(S, v[h + 1]) && T.push(";"),
              S !== C && (T.push(t), d(S, I) && T.push(t));
          }, $),
          T
        );
      }
  ...
  Fo = te({
    "src/language-js/print/block.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { hasComment: u, CommentCheckFlags: i, isNextLineEmpty: l } = Ke(),
        { printHardlineAfterHeritage: p } = tr(),
        { printBody: d } = Eo();
      function y(c, f, E) {
        let _ = c.getValue(),
          w = [];
      ...
      function g(c, f, E) {
        let _ = c.getValue(),
          w = s(_.directives),
          F = _.body.some((I) => I.type !== "EmptyStatement"),
          N = u(_, i.Dangling);
        if (!w && !F && !N) return "";
        let x = [];
        if (
  ...
  od = te({
    "src/language-js/print/typescript.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        w = ad(),
        { locStart: F, locEnd: N } = ut(),
        { printOptionalToken: x, printTypeScriptModifiers: I } = ct(),
        { printTernary: P } = Co(),
        { printFunctionParameters: $, shouldGroupFunctionParameters: D } = Ir(),
        { printTemplateLiteral: T } = Lt(),
        { printArrayItems: m } = Qt(),
        { printObject: C } = tu(),
        { printClassProperty: o, printClassMethod: h } = tr(),
        { printTypeParameter: v, printTypeParameters: S } = Lr(),
        { printPropertyKey: b } = er(),
        { printFunction: B, printMethodInternal: k } = Or(),
        { printInterface: M } = ho(),
        { printBlock: R } = Fo(),
        {
          printTypeAlias: q,
      ...
      function ie(ee, ce, W) {
        ...
        switch (K.type) {
          ...
          case "TSAsExpression": {
            ...
            return (E(z) && z.callee === K) || (_(z) && z.object === K)
              ? l([p([i, ...ue]), i])
              : ue;
          }
          case "TSArrayType":
          ...
          case "TSIndexSignature": {
            let Fe = ee.getParentNode(),
              z = K.parameters.length > 1 ? y(f(ce) ? "," : "") : "",
            ...
            return (
              ...
              K.members.length === 0
                ...
                : ue.push(
                    l([
                      "{",
                      p([u, m(ee, ce, "members", W), f(ce, "es5") ? "," : ""]),
                      t(ee, ce, !0),
                      u,
                      "}",
                    ])
    ...
    "src/language-js/print/comment.js"(e, r) {
      ...
      function d(c, f) {
        ...
        if (p(E)) {
          if (y(E)) {
            let F = g(E);
            return E.trailing && !t(f.originalText, i(E), { backwards: !0 })
              ? [a, F]
              : F;
          }
          let _ = l(E),
...
`);
        return [
          ...
          s(
            ...
            f.map((E, _) =>
              _ === 0
                ? E.trimEnd()
                : " " + (_ < f.length - 1 ? E.trim() : E.trimStart())
            )
          ),
          "*/",
        ];
  ...
  pd = te({
    "src/language-js/printer-estree.js"(e, r) {
      ...
      var { printDanglingComments: t } = et(),
        ...
        { locStart: o, locEnd: h } = ut(),
        v = _t(),
        { printHtmlBinding: S, isVueEventBindingExpression: b } = rd(),
        { printAngular: B } = nd(),
        { printJsx: k, hasJsxIgnoreComment: M } = ud(),
        { printFlow: R } = id(),
        { printTypescript: q } = od(),
        {
        ...
        { printTernary: de } = Co(),
        { printTemplateLiteral: ue } = Lt(),
        { printArray: Fe } = Qt(),
        { printObject: z } = tu(),
        { printClass: U, printClassMethod: Z, printClassProperty: se } = tr(),
        { printProperty: fe } = er(),
        {
          printFunction: ge,
        ...
        { printCallExpression: Ne } = yo(),
        { printVariableDeclarator: Pe, printAssignmentExpression: oe } = Zt(),
        { printBinaryishExpression: H } = Zn(),
        { printSwitchCaseConsequent: pe } = Eo(),
        { printMemberExpression: X } = go(),
        { printBlock: le, printBlockBody: Ae } = Fo(),
        { printComment: Ee } = ld(),
        { printLiteral: De } = cd(),
        { printDecorators: A } = eu();
        ...
        switch (xe.type) {
          ...
          case "YieldExpression":
            return (
              Se.push("yield"),
              xe.delegate && Se.push("*"),
              xe.argument && Se.push(" ", ve("argument")),
              Se
            );
          case "AwaitExpression": {
          ...
          case "UpdateExpression":
            return (
              Se.push(ve("argument"), xe.operator),
              xe.prefix && Se.reverse(),
              Se
            );
          case "ConditionalExpression":
            return de(Ce, Be, ve);
          case "VariableDeclaration": {
            let Ie = Ce.map(ve, "declarations"),
              ...
              be = xe.declarations.some((Me) => Me.init),
              je;
            return (
              Ie.length === 1 && !F(xe.declarations[0])
                ? (je = Ie[0])
              ...
              (Se = [
                ...
                xe.kind,
                je ? [" ", je] : "",
                p(Ie.slice(1).map((Me) => [",", be && !Je ? u : n, Me])),
              ]),
              (Je && Oe.body !== xe) || Se.push(Ye),
              l(Se)
            );
          }
          case "WithStatement":
          ...
          case "IfStatement": {
            let Ie = V(xe.consequent, ve("consequent")),
            ...
            if ((Se.push(Oe), xe.alternate)) {
              ...
              Se.push(be ? " " : u),
                F(xe, N.Dangling) && Se.push(t(Ce, Be, !0), Je ? u : " "),
                Se.push(
                  "else",
                  l(
                    V(
          ...
          case "DoWhileStatement": {
            ...
            return (
              (Se = [l(["do", Ie])]),
              xe.body.type === "BlockStatement" ? Se.push(" ") : Se.push(u),
          ...
          case "TryStatement":
            return [
              "try ",
              ve("block"),
              xe.handler ? [" ", ve("handler")] : "",
              xe.finalizer ? [" finally ", ve("finalizer")] : "",
            ];
          case "CatchClause":
            if (xe.param) {
              let Ie = F(
                  ...
                  (Je) =>
                    !v(Je) ||
                    (Je.leading && s(Be.originalText, h(Je))) ||
                    (Je.trailing &&
          ...
          case "SwitchCase": {
            xe.test ? Se.push("case ", ve("test"), ":") : Se.push("default:"),
              F(xe, N.Dangling) && Se.push(" ", t(Ce, Be, !0));
  ...
  fd = te({
    "src/language-js/printer-estree-json.js"(e, r) {
      ...
      function i(d) {
        return (
          d.getName() === "key" && d.getParentNode().type === "ObjectProperty"
        );
      }
      var l = new Set([
        "start",
      ...
      function p(d, y) {
        ...
        if (g === "ObjectProperty") {
          let { key: c } = d;
          c.type === "Identifier"
            ? (y.key = { type: "StringLiteral", value: c.name })
            : c.type === "NumericLiteral" &&
              (y.key = { type: "StringLiteral", value: String(c.value) });
          return;
        }
    ...
    "src/language-css/clean.js"(e, r) {
      ...
      function n(i, l, p) {
        if (
          ...
          i.type === "css-comment" &&
            ...
            (((p.nodes[0] === i || (t(p.nodes[0]) && p.nodes[1] === i)) &&
              (delete l.text, /^\*\s*@(?:format|prettier)\s*$/.test(i.text))) ||
        ...
        if (
          ...
          i.type === "media-feature" && (l.value = l.value.replace(/ /g, "")),
          ((i.type === "value-word" &&
            ((i.isColor && i.isHex) ||
        ...
        if (
          ...
          let d = i.groups.findIndex(
            (y) => y.type === "value-number" && y.unit === "..."
          );
          d !== -1 &&
            ((l.groups[d].unit = ""),
            l.groups.splice(d + 1, 0, {
              type: "value-word",
              value: "...",
              isColor: !1,
              isHex: !1,
        ...
        if (
          ...
          i.groups.some(
            (d) =>
              (d.type === "value-atword" && d.value.endsWith("[")) ||
              (d.type === "value-word" && d.value.startsWith("]"))
          )
        )
          return {
            type: "value-atword",
  ...
  Ad = te({
    "src/language-css/utils/index.js"(e, r) {
      ...
      function E(z, U) {
        var Z;
        let se =
          (Z = z.getParentNode()) === null || Z === void 0 ? void 0 : Z.nodes;
      ...
      function F(z) {
        return (
          z.type === "value-word" && ["and", "or", "not"].includes(z.value)
        );
      }
      function N(z) {
      ...
      function C(z) {
        return (
          z.type === "value-word" && ["<", ">", "<=", ">="].includes(z.value)
        );
      }
      function o(z) {
        return (
      ...
      function b(z, U) {
        return (
          z.value === "$$" &&
          z.type === "value-func" &&
          (U == null ? void 0 : U.type) === "value-word" &&
          !U.raws.before
        );
      }
      function B(z) {
        ...
        return (
          ((U = z.value) === null || U === void 0 ? void 0 : U.type) ===
            "value-root" &&
          ((Z = z.value.group) === null || Z === void 0 ? void 0 : Z.type) ===
            "value-value" &&
      ...
      function de(z) {
        return (
          (z == null ? void 0 : z.type) === "value-atword" &&
      ...
      function ue(z, U) {
        ...
        if (
          ...
          ((se = z.close) === null || se === void 0 ? void 0 : se.value) !==
            ")" ||
        ...
        if (U.type === "value-comma_group") {
          let fe = U.groups.indexOf(z) - 1,
            ge = U.groups[fe];
          if (
            (ge == null ? void 0 : ge.type) === "value-word" &&
            ge.value === "with"
          )
            return !0;
        }
  ...
  xd = te({
    "src/language-css/loc.js"(e, r) {
      ...
      function u(c, f) {
        ...
        return (
          E && c.source && !c.source.end && (c = E),
          c.source && c.source.end ? a(c.source.end, f) : null
        );
      }
      function i(c, f) {
        c.source &&
          ((c.source.startOffset = n(c, f)), (c.source.endOffset = u(c, f)));
        for (let E in c) {
          let _ = c[E];
          E === "source" ||
            !_ ||
      ...
      function l(c, f, E) {
        c.source &&
          ((c.source.startOffset = n(c, E) + f),
          (c.source.endOffset = u(c, E) + f));
        for (let _ in c) {
          let w = c[_];
...
` ||
      ...
      r.exports = {
        ...
        locEnd: g,
        calculateLoc: i,
        replaceQuotesInInlineComments: d,
      };
    },
  }),
  bd = te({
    ...
    "src/language-css/printer-postcss.js"(e, r) {
      ...
      function ye(be, je, Me) {
        ...
        switch (ae.type) {
              ...
              ae.nodes
                ? [
                    ...
                    H(ae.selector.value)
                      ...
                      : " ",
                    "{",
                    ae.nodes.length > 0 ? E([y, Ce(be, je, Me)]) : "",
                    y,
                    "}",
                    M(ae) ? ";" : "",
                  ]
          ...
          case "css-decl": {
            ...
            return (
              ...
              [
                ...
                (Ve.type === "css-atrule" && Ve.variable) || o(be)
                  ? ae.prop
                  : m(ae.prop),
                Xe.startsWith("//") ? " " : "",
                Xe,
                ...
                ae.raws.important
                  ...
                  : "",
                ae.raws.scssDefault
                  ? ae.raws.scssDefault.replace(/\s*!default/i, " !default")
                  : ae.scssDefault
                  ? " !default"
                  : "",
                ae.raws.scssGlobal
                ...
                ae.nodes
                  ...
                  ? ""
                  : je.__isHTMLStyleAttribute && B(be, ae)
                  ? w(";")
                  : ";",
              ]
            );
          ...
          case "css-atrule": {
            ...
            if (De(je)) {
              ...
              if (ae.variable)
                return [
                  ...
                  ": ",
                  ae.value ? Me("value") : "",
                  ae.raws.between.trim() ? ae.raws.between.trim() + " " : "",
                  ae.nodes
                    ? [
                        "{",
                        E([ae.nodes.length > 0 ? g : "", Ce(be, je, Me)]),
                        g,
                        "}",
                      ]
                    : "",
            ...
            return [
              ...
              ae.params
                ...
                : "",
              ae.selector ? E([" ", Me("selector")]) : "",
              ae.value
                ? c([" ", Me("value"), k(ae) ? (K(ae) ? " " : d) : ""])
                : ae.name === "else"
                ? " "
                : "",
              ae.nodes
          ...
          case "media-url":
            return Se(
              ae.value.replace(/^url\(\s+/gi, "url(").replace(/\s+\)$/g, ")"),
              je
            );
          case "media-unknown":
            return ae.value;
          case "selector-root":
            return c([
              h(be, "custom-selector")
                ? [D(be, "css-atrule").customSelector, d]
                : "",
              p(
                [",", h(be, ["extend", "custom-selector", "nest"]) ? d : y],
                be.map(Me, "nodes")
              ),
            ]);
          ...
          case "selector-tag": {
            ...
            return [
              ...
              Xe.type === "selector-nesting"
                ? ae.value
                : Oe(S(be, ae.value) ? ae.value.toLowerCase() : ae.value),
            ];
          }
          case "selector-id":
            return ["#", ae.value];
          ...
          case "selector-combinator": {
            if (
              ...
              return [
                Xe.type === "selector-selector" && Xe.nodes[0] === ae ? "" : d,
                ae.value,
                B(be, ae) ? "" : " ",
              ];
            }
            let Ve = ae.value.trim().startsWith("(") ? d : "",
              We = Oe(Se(ae.value.trim(), je)) || d;
            return [Ve, We];
          }
          ...
          case "value-comma_group": {
            ...
            for (let at = 0; at < ae.groups.length; ++at) {
              ...
              if (
                (h(be, "forward") &&
                  ...
                  $e.value === "*") ||
                !$e ||
                (Le.type === "value-word" && Le.value.endsWith("-") && pe($e))
              )
                continue;
              if (Le.type === "value-string" && Le.quoted) {
                let Mr = Le.value.lastIndexOf("#{"),
                  Rr = Le.value.lastIndexOf("}");
                Mr !== -1 && Rr !== -1
                  ? (Qe = Mr > Rr)
                  : Mr !== -1
                  ? (Qe = !0)
              ...
              let qr = j(Le),
                su = j($e);
              if (
                (((qr && he($e)) || (su && ke(Le))) && de($e)) ||
                (!Ze && L(Le)) ||
                (C(be, "calc") && (Q(Le) || Q($e) || V(Le) || V($e)) && de($e))
              )
                continue;
              let No =
                  (Q(Le) || V(Le)) &&
            ...
            return (
              _e && Ge.push(F),
              rt && Ge.unshift(y),
              me ? c(E(Ge)) : v(be) ? c(f(Ge)) : c(E(f(Ge)))
            );
          }
          ...
          case "value-colon": {
            ...
            return [
              ae.value,
              (Xe && typeof Xe.value == "string" && t(Xe.value) === "\\") ||
              C(be, "url")
                ? ""
                : d,
            ];
          ...
          be.each((nt, tt, Ve) => {
            ...
            tt !== Ve.length - 1 &&
              ...
              (Ve[tt + 1].type === "css-atrule" &&
                ...
                ? ae.push(" ")
                : (ae.push(je.__isHTMLStyleAttribute ? d : y),
      ...
      var Be = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs,
        ...
        xe = /[$@]?[A-Z_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/g,
        Ye = new RegExp(
          Be.source + `|(${xe.source})?(${ve.source})(${ze.source})?`,
          "g"
        );
      function Se(be, je) {
      ...
      function Oe(be) {
        return be.replace(Ye, (je, Me, ae, nt, tt) =>
          !ae && nt ? Je(nt) + m(tt || "") : je
        );
      }
      function Je(be) {
    ...
    "src/language-handlebars/utils.js"(e, r) {
      ...
      function E(x, I) {
        ...
        let m = x.getValue(),
          ...
          o =
            ($ =
              (D = (T = C.children) !== null && T !== void 0 ? T : C.body) !==
                null && D !== void 0
                ? D
                : C.parts) !== null && $ !== void 0
              ? $
  ...
  Vd = te({
    "src/language-handlebars/printer-glimmer.js"(e, r) {
      ...
      var {
        ...
        { getPreferredQuote: c, isNonEmptyArray: f } = Ue(),
        { locStart: E, locEnd: _ } = qd(),
        w = Md(),
        {
          getNextNode: F,
          getPreviousNode: N,
          ...
          case "TextNode": {
            ...
            if (De) {
              if (De === "class") {
                ...
                return (
                  D(H, ["ConcatStatement"]) &&
                    (T(H, ["MustacheStatement"]) && /^\s/.test(Ee) && (Se = !0),
            ...
            if (pe.htmlWhitespaceSensitivity !== "ignore") {
              ...
              if (G) {
                ...
                let ae = [p],
                  nt = Z(Ee);
                return (
                  nt && (ae = ge(nt)), I(H) && (ae = ae.map((tt) => t(tt))), ae
                );
              }
              let [Je] = Ee.match(Ye),
                [be] = Ee.match(Se),
      ...
      function j(H, pe) {
        ...
        return (
          ...
          a([R(X), Ne(H, pe), le.length > 0 ? i([p, l(p, le)]) : "", d, q(X)])
        );
      }
      function Y(H, pe) {
        return [
  ...
  zd = te({
    "src/language-graphql/printer-graphql.js"(e, r) {
      ...
      var {
        ...
        { isNextLineEmpty: p, isNonEmptyArray: d } = Ue(),
        { insertPragma: y } = Ud(),
        { locStart: g, locEnd: c } = Jd();
      function f(P, $, D) {
        let T = P.getValue();
        if (!T) return "";
        ...
        switch (T.kind) {
          ...
          case "OperationDefinition": {
            ...
            return [
              m ? T.operation : "",
              m && C ? [" ", D("name")] : "",
              m && !C && d(T.variableDefinitions) ? " " : "",
              d(T.variableDefinitions)
                ? u([
                    "(",
                    i([
                      n,
                      t([l("", ", "), n], P.map(D, "variableDefinitions")),
                    ]),
                    n,
                    ")",
                  ])
...
`);
          ...
          case "ObjectTypeDefinition":
            return [
              ...
              "type ",
              D("name"),
              T.interfaces.length > 0 ? [" implements ", ...N(P, $, D)] : "",
              E(P, D, T),
              T.fields.length > 0
          ...
          case "SchemaExtension":
            return [
              ...
              ...(T.operationTypes.length > 0
                ? [" {", i([s, t(s, _(P, $, D, "operationTypes"))]), s, "}"]
                : []),
            ];
...
`) &&
  ...
  nu = te({
    "src/language-markdown/utils.js"(e, r) {
      ...
      ne();
      var { getLast: t } = Ue(),
        { locStart: s, locEnd: a } = xo(),
        { cjkPattern: n, kPattern: u, punctuationPattern: i } = Zd(),
        l = [
          "liquidNode",
          "inlineCode",
          "emphasis",
...
`
        ...
        function m(C) {
          ...
          o &&
            o.type === "word" &&
            ((o.kind === x && C.kind === I && !o.hasTrailingPunctuation) ||
          ...
          function h(v, S) {
            return (
              (o.kind === v && C.kind === S) || (o.kind === S && C.kind === v)
            );
          }
        }
      }
      ...
      function E(F, N) {
        let { value: x } = F;
        return F.position.end.offset === N.length &&
          x.endsWith(`
`) &&
          N.endsWith(`
`)
    ...
    "src/language-markdown/embed.js"(e, r) {
      ...
      function p(d, y, g, c) {
        ...
        switch (f.type) {
          ...
          case "importExport":
            return [
              g(f.value, { parser: "babel" }, { stripTrailingHardline: !0 }),
              a,
            ];
          case "jsx":
            return g(
...
${u.content}`;
  ...
  tg = te({
    "src/language-markdown/print-preprocess.js"(e, r) {
      ...
      ne();
      var t = lt(),
        { getOrderedListItemInfo: s, mapAst: a, splitText: n } = nu(),
        u = /^.$/su;
      function i(w, F) {
        return (
          (w = d(w, F)),
      ...
      function l(w) {
        return a(w, (F) =>
          F.type !== "import" && F.type !== "export"
            ? F
            : Object.assign(Object.assign({}, F), {}, { type: "importExport" })
        );
      }
      function p(w, F) {
        return a(w, (N) =>
          N.type !== "inlineCode" || F.proseWrap === "preserve"
            ? N
            : Object.assign(
                Object.assign({}, N),
                {},
      ...
      function y(w) {
        return g(
          w,
          (F, N) => F.type === "importExport" && N.type === "importExport",
          (F, N) => ({
            type: "importExport",
            value:
              F.value +
...
` +
      ...
      function f(w, F) {
        return a(w, (N, x, I) => {
          ...
          return (
            ...
            { type: "sentence", position: N.position, children: n($, F) }
          );
        });
      }
      function E(w, F) {
      ...
      function _(w, F) {
        ...
        function x(I) {
          ...
          return T !== m
            ...
            : T % F.tabWidth === 0
            ? !0
            : s($, F.originalText).leadingSpaces.length > 1;
        }
      }
      r.exports = i;
    },
  ...
  rg = te({
    "src/language-markdown/clean.js"(e, r) {
      ...
      ne();
      var t = So(),
        { isFrontMatterNode: s } = Ue(),
        { startWithPragma: a } = bo(),
      ...
      function Q(oe, H, pe) {
        ...
        switch (X.type) {
          ...
          case "word": {
            ...
            return (
              le !== X.value &&
                ...
                (le = le.replace(/^(\\?[*_])+/, (De) => De.replace(/\\/g, ""))),
              le
            );
          }
          case "whitespace": {
          ...
          case "thematicBreak": {
            ...
            return le === -1
              ? "---"
              : Y(oe.getParentNode(le), oe.getParentNode(le + 1)) % 2 === 0
              ? "***"
              : "---";
          }
          case "linkReference":
...
`
            ...
            (ye) =>
              ye.map((Ce, Be) => {
                let ve = $(pe(), H).formatted,
                  ze = u(ve);
                return (
                  (le[Be] = Math.max(le[Be] || 3, ze)), { text: ve, width: ze }
                );
              }, "children"),
            "children"
          ),
        ...
        if (oe.type === "html")
          ...
          oe.type === "esComment"
            ...
            : oe.type === "paragraph" &&
              ...
              oe.children[0].type === "esComment" &&
              (pe = oe.children[0]),
            pe && (H = pe.value.match(/^prettier-ignore(?:-(start|end))?$/));
        }
        return H ? H[1] || "next" : !1;
      }
      function Z(oe, H) {
      ...
      function se(oe, H) {
        ...
        let Ee = (H.prevNode && H.prevNode.type) === oe.type && L.has(oe.type),
          ...
          A =
            ((pe = H.prevNode) === null || pe === void 0 ? void 0 : pe.type) ===
              "listItem" && H.prevNode.loose,
          G = U(H.prevNode) === "next",
          re =
            oe.type === "html" &&
            ((X = H.prevNode) === null || X === void 0 ? void 0 : X.type) ===
              "html" &&
            H.prevNode.position.end.line + 1 === oe.position.start.line,
          ye =
            oe.type === "html" &&
            H.parentNode.type === "listItem" &&
            ((le = H.prevNode) === null || le === void 0 ? void 0 : le.type) ===
              "paragraph" &&
            H.prevNode.position.end.line + 1 === oe.position.start.line;
...
`,
      ...
      function q(A) {
        return (
          ...
          (["html", "head", "ul", "ol", "select"].includes(A.name) ||
            (A.cssDisplay.startsWith("table") && A.cssDisplay !== "table-cell"))
        );
      }
      function J(A) {
          ...
          (A.next
            ...
            : A.parent.type === "root" ||
              (A.parent.endSourceSpan &&
                A.parent.endSourceSpan.start.line > A.sourceSpan.end.line))
        );
      }
      function Y(A) {
        switch (A.type) {
      ...
      function he(A, G) {
        ...
        switch (G.htmlWhitespaceSensitivity) {
          ...
          case "ignore":
            return "block";
          default:
            return G.parser === "vue" && A.parent && A.parent.type === "root"
              ? "block"
              : (A.type === "element" &&
                  (!A.namespace || re || c(A)) &&
                  p[A.name]) ||
      ...
      function we(A) {
        return (
          (A.type === "element" && (!A.namespace || c(A)) && y[A.name]) || g
        );
      }
      function ke(A) {
...
`);
      ...
      function X(A, G) {
        return (
          pe(A, G) && (H(A, G) || (A.attrMap.lang && A.attrMap.lang !== "html"))
        );
      }
      function le(A) {
        let G = A.fullName;
    ...
    "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
      ...
      function u(o, h, v) {
        return Array.isArray(o)
          ? h.visitArray(o, v)
          : F(o)
          ? h.visitStringMap(o, v)
          : o == null ||
            typeof o == "string" ||
            typeof o == "number" ||
            typeof o == "boolean"
          ? h.visitPrimitive(o, v)
          : h.visitOther(o, v);
      }
      e.visitValue = u;
      function i(o) {
      ...
      function N(o) {
        ...
        for (let v = 0; v < o.length; v++) {
          ...
          S <= 127
            ...
            : S <= 2047
            ? (h += String.fromCharCode(((S >> 6) & 31) | 192, (S & 63) | 128))
            : S <= 65535
...
` && ++_ == y
      ...
      var i = class {
        ...
        contextualMessage() {
          ...
          return d
            ? `${this.msg} ("${d.before}[${u[this.level]} ->]${d.after}")`
            : this.msg;
        }
        toString() {
      ...
      function l(d, y) {
        let g = t.identifierModuleUrl(y),
          c =
            g != null
              ? `in ${d} ${t.identifierName(y)} in ${g}`
              : `in ${d} ${t.identifierName(y)}`,
          f = new a("", c);
    ...
    "src/language-html/print-preprocess.js"(e, r) {
      ...
      function _(o) {
        o.walk((h) => {
          if (
            h.type === "element" &&
            h.tagDefinition.ignoreFirstLf &&
            h.children.length > 0 &&
            h.children[0].type === "text" &&
            h.children[0].value[0] ===
              `
`
          ) {
            let v = h.children[0];
          ...
          if (S.children)
            for (let b = 0; b < S.children.length; b++) {
              ...
              !k ||
                k.type !== "text" ||
                ((k.value += B.value),
                (k.sourceSpan = new t(k.sourceSpan.start, B.sourceSpan.end)),
                S.removeChild(B),
                b--);
            }
        });
          ...
          if (v.children)
            for (let S = 0; S < v.children.length; S++) {
              ...
              (B.value +=
                ...
                `</${b.rawName}>` +
                k.value),
                (B.sourceSpan = new t(B.sourceSpan.start, k.sourceSpan.end)),
      ...
      function $(o) {
        o.walk((h) => {
          h.isSelfClosing =
            !h.children ||
            (h.type === "element" &&
              (h.tagDefinition.isVoid ||
                h.startSourceSpan === h.endSourceSpan));
        });
      }
      function D(o, h) {
        o.walk((v) => {
      ...
      function m(o, h) {
        o.walk((v) => {
          ...
          if (S) {
            ...
            for (let b of S)
              (b.isLeadingSpaceSensitive = d(b, h)),
                (b.isTrailingSpaceSensitive = y(b, h));
            for (let b = 0; b < S.length; b++) {
              let B = S[b];
              (B.isLeadingSpaceSensitive =
                ...
                (B.isTrailingSpaceSensitive =
                  (b === S.length - 1 || B.next.isLeadingSpaceSensitive) &&
                  B.isTrailingSpaceSensitive);
            }
          }
        });
      ...
      function C(o, h) {
        if (h.parser === "vue") {
          ...
          (S === "ts" || S === "typescript") &&
            (h.__should_parse_vue_template_with_ts = !0);
        }
      }
      r.exports = E;
    },
      ...
      function b(L, Q, V) {
        ...
        let Y = j.prev && j.prev.type === "comment" && v(j.prev.value),
          ...
          ce =
            ...
            j.children.length === 0,
          K =
            Q.singleAttributePerLine && j.attrs.length > 1 && !w(j, Q) ? l : u,
          de = [a([ce ? " " : u, n(K, ee)])];
        return (
    ...
    "src/language-html/syntax-attribute.js"(e, r) {
      ...
      function u(l) {
        ...
        let c = d ? "w" : y ? "h" : "d",
          ...
          E = (I) => Math.max(...I),
          _ = p.map((I) => I.url),
          w = E(_.map((I) => I.length)),
          F = p.map((I) => I[c]).map((I) => (I ? I.toString() : "")),
          N = F.map((I) => {
            let P = I.indexOf(".");
    ...
    "src/language-html/syntax-vue.js"(e, r) {
      ...
      function s(i, l) {
        ...
        return [
          ...
          d,
          " ",
          l(y, { parser: "__js_expression" }, { stripTrailingHardline: !0 }),
        ];
      }
      function a(i) {
        let l = /(.*?)\s+(in|of)\s+(.*)/s,
      ...
      function l(p, d) {
        ...
        return (
          p.lastChild && t(p.lastChild)
            ? (g += s(p, d).length)
            : a(p) && (g -= n(p.lastChild, d).length),
          d.originalText.slice(y, g)
        );
      }
      r.exports = l;
    },
  ...
  Cg = te({
    "src/language-html/embed.js"(e, r) {
      ...
      var {
        ...
        { printImgSrcset: w, printClassNames: F } = hg(),
        {
          printVueFor: N,
          printVueBindings: x,
        ...
        let q = (ee) => new RegExp(ee.join("|")).test(k.fullName),
          ...
          ie = (ee, ce) =>
            M(
              ee,
              Object.assign(
                { __onHtmlBindingRoot: Q, __embeddedInHtml: !0 },
                ce
              )
            );
        if (
          ...
          ? [
              ...
              ...l(
                C.originalText.slice(
                  p(h) + (h.prev && w(h.prev) ? F(h).length : 0),
                  d(h) - (h.next && N(h.next) ? x(h, C).length : 0)
                )
              ),
              I(h, C),
            ]
            ...
            (o.next ? I(o.next) : P(o.parent))
              ...
              : (o.lastChild.type === "comment" ||
                ...
                new RegExp(
                  `\\n[\\t ]{${
                    m.tabWidth *
                    E(T, (R) => R.parent && R.parent.type !== "root")
                  }}$`
          ...
          case "docType":
            return [
              s([
                P(h, C),
                " ",
                h.value.replace(/^html\b/i, "html").replace(/\s+/g, " "),
              ]),
              x(h, C),
            ];
          case "comment":
            return [
              I(h, C),
              ...p(C.originalText.slice(_(h), w(h)), n),
              N(h, C),
            ];
          case "attribute": {
    ...
    "src/language-yaml/embed.js"(e, r) {
      ...
      function t(s, a, n, u) {
        if (
          ...
          u.filepath &&
          /(?:[/\\]|^)\.(?:prettier|stylelint|lintstaged)rc$/.test(u.filepath)
        )
          return n(
            u.originalText,
...
`
  ...
  jr = te({
    "src/language-yaml/print/misc.js"(e, r) {
      ...
      var {
        ...
        { hasEndComments: a, isNextLineEmpty: n, isNode: u } = Mt(),
        i = new WeakMap();
      function l(y, g) {
        let c = y.getValue(),
          f = y.stack[0],
          E;
        return (
          i.has(f) ? (E = i.get(f)) : ((E = new Set()), i.set(f, E)),
          !E.has(c.position.end.line) &&
          (E.add(c.position.end.line), n(c, g) && !p(y.getParentNode()))
            ? t
            : ""
        );
      }
      function p(y) {
        return (
          a(y) &&
          !u(y, ["documentHead", "documentBody", "flowMapping", "flowSequence"])
        );
      }
      function d(y, g) {
        return s(" ".repeat(y), g);
  ...
  _g = te({
    "src/language-yaml/print/flow-mapping-sequence.js"(e, r) {
      ...
      ne();
      var {
          builders: { ifBreak: t, line: s, softline: a, hardline: n, join: u },
        } = qe(),
        { isEmptyNode: i, getLast: l, hasEndComments: p } = Mt(),
        { printNextEmptyLine: d, alignWithSpaces: y } = jr();
      function g(f, E, _) {
        let w = f.getValue(),
          F = w.type === "flowMapping",
          N = F ? "{" : "[",
          x = F ? "}" : "]",
          I = a;
    ...
    "src/language-yaml/print/mapping-item.js"(e, r) {
      ...
      function _(x, I, P, $, D) {
        ...
        let b = Symbol("mappingKey"),
          ...
          M = [v, ":"];
        l(m.content) ||
        (y(m) && m.content && !g(m.content, ["mapping", "sequence"])) ||
        (I.type === "mapping" && d(T.content) && f(m.content)) ||
        ...
        return w(T.content, D) && !l(T.content) && !p(T.content) && !y(T)
          ? t([[h, R]])
          : t([[B, n(k, R, { groupId: b })]]);
      }
      function w(x, I) {
        ...
        if (
          /\\$/m.test(
            I.originalText.slice(x.position.start.offset, x.position.end.offset)
          )
        )
          return !1;
        switch (I.proseWrap) {
  ...
  Ig = te({
    "src/language-yaml/print/block.js"(e, r) {
      ...
      var {
        ...
        { alignWithSpaces: _ } = jr();
      function w(F, N, x) {
        let I = F.getValue(),
          P = y(F, (C) => E(C, ["sequence", "mapping"])),
          $ = f(F),
          D = [I.type === "blockFolded" ? ">" : "|"];
        I.indent !== null && D.push(I.indent.toString()),
          I.chomping !== "clip" && D.push(I.chomping === "keep" ? "+" : "-"),
          c(I) && D.push(" ", N("indicatorComment"));
        let T = g(I, { parentIndent: P, isLastDescendant: $, options: x }),
          m = [];
        for (let [C, o] of T.entries())
          C === 0 && m.push(n),
            m.push(a(d(u(i, o)))),
            C !== T.length - 1
              ...
              : I.chomping === "keep" && $ && m.push(s(o.length === 0 ? n : l));
        return (
          I.indent === null
  ...
  kg = te({
    "src/language-yaml/printer-yaml.js"(e, r) {
      ...
      var {
        ...
        { isPreviousLineEmpty: g } = Ue(),
        { insertPragma: c, isPragma: f } = Tg(),
        { locStart: E } = Bg(),
        _ = Ng(),
        {
        ...
        { printFlowMapping: S, printFlowSequence: b } = _g(),
        B = Pg(),
        k = Ig();
      function M(j, Y, ie) {
        let ee = j.getValue(),
        ...
        return (
          $(j)
            ? ce.push(
                y(
                  Y.originalText
                    .slice(ee.position.start.offset, ee.position.end.offset)
                    .trimEnd(),
                  p
                )
              )
            ...
            ce.push(
              o(ee.type === "sequenceItem" ? 2 : 0, [
                ...
                u(
                  ...
                  j.map(
                    (Fe) => [
                      g(Y.originalText, Fe.getValue(), E) ? n : "",
                      ie(),
                    ],
                    "endComments"
                  )
      ...
      function R(j, Y, ie, ee, ce) {
        switch (j.type) {
          ...
          case "documentBody": {
            let { children: W, endComments: K } = j,
              de = "";
      ...
      function L(j, Y, ie, ee) {
        return (ie.children[0] === j &&
          /---(?:\s|$)/.test(ee.originalText.slice(E(j), E(j) + 4))) ||
          j.head.children.length > 0 ||
          P(j.head) ||
          I(j.head)
          ? "head"
        ...
        return function () {
          ...
          return (
            (c[y] = Object.assign(
              Object.assign({}, E),
              {},
              { plugins: [...u, ...(Array.isArray(_) ? _ : Object.values(_))] }
            )),
            d(...c)
          );
        };
