var De = Object.defineProperty,
  ...
  Ne = (e) => cr(De({}, "__esModule", { value: !0 }), e),
  L = Y({ "<define:process>"() {} }),
  ur = W({
          ...
          scanToken() {
            ...
            switch (r) {
              case H:
                return (
                  this.advance(),
                  Q(this.peek) ? this.scanNumber(s) : mt(s, this.index, H)
                );
              case Ee:
              case z:
              case Te:
          ...
          scanNumber(e) {
            ...
            for (this.advance(); ; ) {
              if (!Q(this.peek))
                ...
                else if (wr(this.peek)) {
                  if (
                    (this.advance(),
                    Pr(this.peek) && this.advance(),
                    !Q(this.peek))
                  )
            ...
            for (; this.peek != t; )
              if (this.peek == Ft) {
                ...
                if (((this.peek = this.peek), this.peek == Dt)) {
                  ...
                  else return this.error(`Invalid unicode escape [\\u${h}]`, 0);
      ...
      L(),
        ...
        (Qe = class {
          constructor(e) {
            (this._lexer = e),
              (this.errors = []),
              (this.simpleExpressionChecker = St);
          }
          parseAction(e, t, r) {
            let n =
          ...
          *_forEachUnquotedChar(e, t) {
            ...
            for (let s = t; s < e.length; s++) {
              let a = e[s];
              vt(e.charCodeAt(s)) && (r === null || r === a) && n % 2 === 0
                ? (r = r === null ? a : null)
                : r === null && (yield s),
                (n = a === "\\" ? n + 1 : 0);
            }
        ...
        (D = class {
          ...
          parsePrimary() {
            ...
            if (this.consumeOptionalCharacter(Ee)) {
              ...
              if (this.next.isKeywordNull())
                return (
                  this.advance(), new $(this.span(e), this.sourceSpan(e), null)
                );
              ...
              if (this.next.isKeywordTrue())
                return (
                  this.advance(), new $(this.span(e), this.sourceSpan(e), !0)
                );
              if (this.next.isKeywordFalse())
                return (
                  this.advance(), new $(this.span(e), this.sourceSpan(e), !1)
                );
              ...
              if (this.consumeOptionalCharacter(Ae)) {
                ...
                if (this.next.isNumber()) {
                  ...
                  return (
                    this.advance(), new $(this.span(e), this.sourceSpan(e), t)
                  );
          ...
          parseLiteralMap() {
            let e = [],
              ...
              r = this.inputIndex;
            if (
              (this.expectCharacter(Te), !this.consumeOptionalCharacter(_e))
            ) {
    ...
    "node_modules/angular-estree-parser/lib/utils.js"(e) {
      ...
      function b(o) {
        let d = h(),
          ...
          A = "{{",
          I = "}}",
          { ast: j, errors: ir } = d.parseInterpolation(A + y + I, ...i);
        R(ir);
        let ft = j.expressions[0],
          gt = new Set();
        return (
          _(ft, (ke) => {
            gt.has(ke) ||
              ((ke.start -= A.length), (ke.end -= A.length), gt.add(ke));
          }),
          { ast: ft, comments: E }
        );
      }
    ...
    "node_modules/angular-estree-parser/lib/transform.js"(e) {
        ...
        r = function (s, a) {
          ...
          switch (h) {
              ...
              let c = h === "SafeMethodCall",
                ...
                f =
                  C(
                    ...
                    C(
                      /\(/,
                      (m.length === 0 ? C(/\)/, s.span.end - 1) : O(m[0])) - 1
                    ) - 1
                  ) + 1,
                w = p(
                  "Identifier",
            ...
            case "Quote": {
              ...
              return p("NGQuotedExpression", { prefix: c, value: g }, s.span, {
                hasParentParens: i,
              });
            }
            default:
      ...
      function n(s, a) {
        ...
        return Object.assign(
          ...
          p && {
            extra: { parenthesized: !0, parenStart: l.start, parenEnd: l.end },
          }
        );
      }
      e.transformSpan = n;
    ...
    "node_modules/angular-estree-parser/lib/transform-microsyntax.js"(e) {
      ...
      function s(a, i) {
        ...
        let [h] = a,
          { key: l } = h,
          P =
            i.text.slice(h.sourceSpan.start, h.sourceSpan.end).trim().length ===
            0
              ? a.slice(1)
              : a,
          p = [],
        ...
        for (let u = 0; u < P.length; u++) {
          ...
          if (x && T(x) && O(v) && v.value && v.value.source === x.key.source) {
            ...
            if (o.type === "NGMicrosyntaxExpression") p.push(w(o));
              ...
              p.push(
                f(Object.assign(Object.assign({}, o), { expression: d }), d.end)
              );
