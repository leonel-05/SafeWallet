...
var ue = y((Gl, Wr) => {
  ...
  Wr.exports =
    qe(typeof globalThis == "object" && globalThis) ||
    qe(typeof window == "object" && window) ||
    qe(typeof self == "object" && self) ||
    qe(typeof global == "object" && global) ||
    (function () {
      return this;
    })() ||
...
var sr = y((uc, fu) => {
  var nr = typeof document == "object" && document.all,
    ks = typeof nr > "u" && nr !== void 0;
  fu.exports = { all: nr, IS_HTMLDDA: ks };
});
var ee = y((tc, Eu) => {
  var du = sr(),
    Ls = du.all;
  Eu.exports = du.IS_HTMLDDA
    ? function (e) {
...
var Nu = y((oc, wu) => {
  var bu = ue(),
    ...
    Su = bu.process,
    yu = bu.Deno,
    Tu = (Su && Su.versions) || (yu && yu.version),
    Bu = Tu && Tu.v8,
    ne,
    Le;
  Bu &&
    ((ne = Bu.split(".")),
    (Le = ne[0] > 0 && ne[0] < 4 ? 1 : +(ne[0] + ne[1])));
  !Le &&
    or &&
    ((ne = or.match(/Edge\/(\d+)/)),
    (!ne || ne[1] >= 74) &&
      ((ne = or.match(/Chrome\/(\d+)/)), ne && (Le = +ne[1])));
  wu.exports = Le;
});
var Dr = y((Dc, qu) => {
  var Ou = Nu(),
...
var $u = y((dc, Lu) => {
  ...
  Lu.exports = function (e, r) {
    var u, n;
    if (
      (r === "string" && pr((u = e.toString)) && !fr((n = hr(u, e)))) ||
      (pr((u = e.valueOf)) && !fr((n = hr(u, e)))) ||
      (r !== "string" && pr((u = e.toString)) && !fr((n = hr(u, e))))
    )
      return n;
...
var fe = y((_c, rt) => {
  var mi = ue(),
    ...
    pe = mi.Symbol,
    Zu = pe && pe.for,
    Ai = et ? pe : (pe && pe.withoutSetter) || Fi;
...
var At = y((Ic, Ft) => {
  var Tr = De(),
    ...
    ta = Tr && Object.getOwnPropertyDescriptor,
    Br = ua(gt, "name"),
    na = Br && function () {}.name === "something",
    sa = Br && (!Tr || (Tr && ta(gt, "name").configurable));
...
var Pt = y(($c, xt) => {
  var Aa = ae(),
    ...
    Ba =
      Rr &&
      !Aa(function () {
        return We(function () {}, "length", { value: 8 }).length !== 8;
      }),
    ba = String(String).split("String"),
    wa = (xt.exports = function (e, r, u) {
      String(r).slice(0, 7) === "Symbol(" &&
        (r = "[" + String(r).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
        u && u.getter && (r = "get " + r),
        u && u.setter && (r = "set " + r),
        (!ze(e, "name") || (_a && e.name !== r)) &&
          (Rr ? We(e, "name", { value: r, configurable: !0 }) : (e.name = r)),
        Ba &&
          u &&
          ze(u, "arity") &&
          e.length !== u.arity &&
          We(e, "length", { value: u.arity });
      try {
        u && ze(u, "constructor") && u.constructor
          ? Rr && We(e, "prototype", { writable: !1 })
          : e.prototype && (e.prototype = void 0);
      } catch {}
      var n = ya(e);
      return (
        ze(n, "source") || (n.source = ba.join(typeof r == "string" ? r : "")),
        e
      );
    });
...
var Lt = y((Mc, kt) => {
  ...
  kt.exports = function (e, r, u, n) {
    ...
    if ((Na(u) && qa(u, s, n), n.global)) D ? (e[r] = u) : Ia(r, u);
    else {
      try {
    ...
    zt = function (e) {
      return function (r, u, n) {
        ...
        if (e && u != u) {
          ...
          for (; s > a; a++)
            if ((e || a in D) && D[a] === u) return e || a || 0;
        return !e && -1;
      };
    };
  ...
  pn.exports = function (e, r) {
    ...
    if (
      ...
      for (f in r) {
        if (
          ((v = r[f]),
          e.dontCallGetSet ? ((i = Eo(a, f)), (c = i && i.value)) : (c = a[f]),
          (s = Ao(n ? f : u + (D ? "." : "#") + f, e.forced)),
          !s && c !== void 0)
        ) {
...
var Sn = y((a2, _n) => {
  ...
  var Oo = $r(),
    ...
    Io = Cn(),
    Ro = Mr(),
    vn = function (e, r, u, n, D, s, a, f) {
      for (var c = D, v = 0, i = a ? Ro(a, f) : !1, l, p; v < n; )
        v in u &&
          ((l = i ? i(u[v], v, r) : u[v]),
          s > 0 && Oo(l)
            ? ((p = qo(l)), (c = vn(e, r, l, p, c, s - 1) - 1))
            : (Io(c + 1), (e[c] = l)),
          c++),
          v++;
      return c;
  ...
  bn.exports = ko
    ...
    : function (e) {
        ...
        return e === void 0
          ...
          : e === null
          ? "Null"
          : typeof (u = Go((r = jo(e)), Mo)) == "string"
          ? u
          : Uo
          ? Qe(r)
          : (n = Qe(r)) == "Object" && Lo(r.callee)
          ? "Arguments"
          : n;
      };
});
...
var Ln = y((c2, kn) => {
  ...
  kn.exports = function (e) {
    ...
    return (
      xn(e) &&
        ((r = e.constructor),
        Jo(r) && (r === Pn || xn(r.prototype))
          ? (r = void 0)
          : Zo(r) && ((r = r[rD]), r === null && (r = void 0))),
      r === void 0 ? Pn : r
    );
  };
});
...
var VD = Object.create,
  ...
  os = (e) => as(Je({}, "__esModule", { value: !0 }), e),
  we,
  N = ge({
    "<define:process>"() {
      we = { env: {}, argv: [] };
  ...
  QD = I({
    "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
      ...
      function F(o) {
        return (
          typeof o == "object" && o !== null && Object.getPrototypeOf(o) === O
        );
      }
      function w(o) {
        let d = "";
        for (let h = 0; h < o.length; h++) {
          ...
          if (A >= 55296 && A <= 56319 && o.length > h + 1) {
            ...
            q >= 56320 &&
              q <= 57343 &&
              (h++, (A = ((A - 55296) << 10) + q - 56320 + 65536));
          }
          A <= 127
            ? (d += String.fromCharCode(A))
            : A <= 2047
            ? (d += String.fromCharCode(((A >> 6) & 31) | 192, (A & 63) | 128))
            : A <= 65535
  ...
  KD = I({
    "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
      ...
      function a(h) {
        ...
        return (
          q.indexOf("(") >= 0
            ? ((q = `anonymous_${s++}`), (A.__anonymousType = q))
            : (q = D(q)),
          q
        );
      }
      ...
      var B = class {
        constructor(h) {
          ...
          if (
            ...
            (this.styles = R(X)),
            (this.styleUrls = R(Q)),
            (this.externalStylesheets = R(H)),
            (this.animations = W ? k(W) : []),
      ...
      var b = class {
        constructor(h) {
          ...
          (this.type = A || null),
            ...
            (this.declaredPipes = R(X)),
            (this.exportedPipes = R(Q)),
            (this.providers = R(q)),
            (this.entryComponents = R(H)),
            (this.bootstrapComponents = R(W)),
            (this.importedModules = R(K)),
            (this.exportedModules = R(J)),
            (this.schemas = R(S)),
            (this.id = _ || null),
        ...
        return (
          q.isInline
            ? A.type.reference instanceof r.StaticSymbol
              ? (P = `${A.type.reference.filePath}.${A.type.reference.name}.html`)
              : (P = `${a(h)}/${a(A.type)}.html`)
            : (P = q.templateUrl),
          A.type.reference instanceof r.StaticSymbol ? P : j(P)
        );
      }
...
` && ++B == l
              ...
              return {
                before: p.substring(m, this.offset),
      ...
      var f = class {
        ...
        contextualMessage() {
          ...
          return i
            ? `${this.msg} ("${i.before}[${a[this.level]} ->]${i.after}")`
            : this.msg;
        }
        toString() {
      ...
      function c(i, l) {
        let p = u.identifierModuleUrl(l),
          m =
            p != null
              ? `in ${i} ${u.identifierName(l)} in ${p}`
              : `in ${i} ${u.identifierName(l)}`,
          C = new D("", m);
...
var rl = ge({
  ...
  hs = I({
    "node_modules/semver/internal/debug.js"(e, r) {
      ...
      var u =
        ...
        we.env &&
        we.env.NODE_DEBUG &&
        /\bsemver\b/i.test(we.env.NODE_DEBUG)
          ? function () {
              for (
  ...
  ul = I({
    "node_modules/semver/internal/re.js"(e, r) {
      N();
      var { MAX_SAFE_COMPONENT_LENGTH: u } = ps(),
        n = hs();
      e = r.exports = {};
      var D = (e.re = []),
        s = (e.src = []),
      ...
      var u = ["includePrerelease", "loose", "rtl"],
        n = (D) =>
          D
            ? typeof D != "object"
              ? { loose: !0 }
              : u.filter((s) => D[s]).reduce((s, a) => ((s[a] = !0), s), {})
            : {};
      r.exports = n;
    },
  }),
  ...
  sl = I({
    "node_modules/semver/classes/semver.js"(e, r) {
      N();
      var u = hs(),
        { MAX_LENGTH: n, MAX_SAFE_INTEGER: D } = ps(),
        { re: s, t: a } = ul(),
        f = tl(),
        { compareIdentifiers: c } = nl(),
        v = class {
          constructor(i, l) {
            ...
            p[4]
              ? (this.prerelease = p[4].split(".").map((m) => {
                  if (/^[0-9]+$/.test(m)) {
                    let C = +m;
                    if (C >= 0 && C < D) return C;
                  }
          ...
          compare(i) {
            if (
              (u("SemVer.compare", this.version, this.options, i),
              !(i instanceof v))
            ) {
          ...
          compareMain(i) {
            return (
              ...
              c(this.major, i.major) ||
                c(this.minor, i.minor) ||
                c(this.patch, i.patch)
            );
          }
          comparePre(i) {
            if (
            ...
            do {
              let p = this.prerelease[l],
                m = i.prerelease[l];
              if (
                (u("prerelease compare", l, p, m), p === void 0 && m === void 0)
              )
                return 0;
  ...
  Hr = I({
    "node_modules/semver/functions/compare.js"(e, r) {
      N();
      var u = sl(),
        n = (D, s, a) => new u(D, a).compare(new u(s, a));
      r.exports = n;
    },
  }),
  il = I({
    ...
    "node_modules/outdent/lib/index.js"(e, r) {
      ...
      function m(F, w, b) {
        ...
        var j = b.newline,
          ...
          t = b.trimTrailingNewline,
          o = typeof j == "string",
          d = F.length,
          h = F.map(function (A, q) {
            return (
              (A = A.replace(k, "$1")),
              q === 0 && L && (A = A.replace(c, "")),
              q === d - 1 && t && (A = A.replace(v, "")),
              o &&
                (A = A.replace(/\r\n|\n|\r/g, function (P) {
                  return j;
                })),
      ...
      function B(F) {
        ...
        function M(U) {
          ...
          if (g(U)) {
            var L = U,
              t = (k[0] === M || k[0] === O) && p.test(L[0]) && i.test(L[1]),
              o = t ? b : w,
              d = o.get(L);
    ...
    "src/main/support.js"(e, r) {
      ...
      function a() {
        let {
            ...
            : {},
          p = D.split("-", 1)[0],
          m = c.flatMap((F) => F.languages || []).filter(g),
          C = n(
            Object.assign(
              {},
              ...c.map((F) => {
            ...
            .filter((F) => g(F) && B(F))
            .sort((F, w) => (F.name === w.name ? 0 : F.name < w.name ? -1 : 1))
            .map(O)
            .map((F) => {
              (F = Object.assign({}, F)),
                Array.isArray(F.default) &&
                  (F.default =
                    F.default.length === 1
                      ...
                      : F.default
                          .filter(g)
                          .sort((b, M) => u.compare(M.since, b.since))[0]
                          .value),
                Array.isArray(F.choices) &&
                  ((F.choices = F.choices.filter((b) => g(b) && B(b))),
                  F.name === "parser" && f(F, m, c));
              let w = Object.fromEntries(
                c
                  .filter(
                    (b) =>
                      b.defaultOptions && b.defaultOptions[F.name] !== void 0
                  )
                  .map((b) => [b.name, b.defaultOptions[F.name]])
              );
        ...
        function B(F) {
          return (
            i || !("deprecated" in F) || (F.deprecated && u.lt(p, F.deprecated))
          );
        }
        function O(F) {
          if (l) return F;
        ...
        for (let p of v)
          if (p.parsers) {
            for (let m of p.parsers)
              if (!l.has(m)) {
                l.add(m);
                let C = i.find((B) => B.parsers && B.parsers[m]),
                  g = p.name;
                C && C.name && (g += ` (plugin: ${C.name})`),
                  c.choices.push({ value: m, description: g });
              }
          }
      }
      ...
      function u(n, D) {
        ...
        if (n.charAt(D) === "/" && n.charAt(D + 1) === "*") {
          for (let s = D + 2; s < n.length; ++s)
            if (n.charAt(s) === "*" && n.charAt(s + 1) === "/") return s + 2;
        }
        return D;
      }
      r.exports = u;
...
`);
      ...
      function t(S, E) {
        ...
        if (S.includes(x.quote) || S.includes($.quote)) {
          let z = (S.match(x.regex) || []).length,
            Y = (S.match($.regex) || []).length;
          V = z > Y ? $ : x;
        }
        return V;
      }
      ...
      function A(S, E) {
        ...
        return _ === null
          ? 0
          : _.reduce((T, x) => Math.max(T, x.length / E.length), 0);
      }
      function q(S, E) {
        let _ = S.match(new RegExp(`(${u(E)})+`, "g"));
        if (_ === null) return 0;
      ...
      function P(S, E) {
        (S.comments || (S.comments = [])).push(E),
          (E.printed = !1),
          (E.nodeDescription = J(S));
      }
      function G(S, E) {
      ...
      function H(S, E) {
        let { languages: _ } = D({ plugins: E.plugins }),
          T =
            _.find((x) => {
              let { name: $ } = x;
        ...
        let E = S.type || S.kind || "(unknown type)",
          _ = String(
            S.name ||
              ...
              (S.value &&
                (typeof S.value == "object" ? "" : String(S.value))) ||
              S.operator ||
              ""
          );
        return (
  ...
  Nl = I({
    "src/language-html/utils/html-elements-attributes.js"(e, r) {
      "use strict";
      N();
      var { htmlElementAttributes: u } = bl(),
        n = wl(),
        D = gs(),
        s = n(u, D);
      r.exports = s;
          ...
          constructor() {
            let a =
              arguments.length > 0 && arguments[0] !== void 0
                ? arguments[0]
                : {};
            for (let f of new Set([...n, ...Object.keys(a)]))
              this.setProperty(f, a[f]);
          }
          setProperty(a, f) {
            if (this[a] !== f) {
              if (
                (a in u && (f = f.map((c) => this.createChild(c))), !n.has(a))
              ) {
                this[a] = f;
                return;
              }
        ...
        let [, l, p, m] = i,
          ...
          [O, F] = (() => {
            try {
              ...
              return [
                !1,
                [{ type: "text", value: m, sourceSpan: new u(g, B) }],
              ];
            }
          })();
        return {
...
`,
  ...
  As = I({
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(e) {
      ...
      var f = class {
        constructor(C, g, B, O) {
          ...
          (this.name = C),
            ...
            (this.children = B),
            (this.sourceSpan = O),
            (this.startSourceSpan = F),
            (this.endSourceSpan = w),
            (this.nameSpan = b),
            (this.i18n = M),
            (this.type = "element");
        }
      ...
      function p(C) {
        let g = C.sourceSpan.start.offset,
        ...
        if (s != null) {
          ...
          u.forEach((c) => {
            if (c.test(a) || c.test(f))
              throw new Error(
                `['${a}', '${f}'] contains unusable interpolation symbol.`
              );
          });
        }
      }
    ...
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/lexer.js"(e) {
      ...
      (function (t) {
        (t[(t.TAG_OPEN_START = 0)] = "TAG_OPEN_START"),
          ...
          (t[(t.EXPANSION_CASE_EXP_START = 18)] = "EXPANSION_CASE_EXP_START"),
          (t[(t.EXPANSION_CASE_EXP_END = 19)] = "EXPANSION_CASE_EXP_END"),
          ...
          constructor(t, o, d) {
            (this._getTagContentType = o),
              ...
              (this._interpolationConfig =
                d.interpolationConfig || n.DEFAULT_INTERPOLATION_CONFIG),
              (this._leadingTriviaCodePoints =
                d.leadingTriviaChars &&
                d.leadingTriviaChars.map((A) => A.codePointAt(0) || 0)),
...
`
          ...
          tokenize() {
            ...
            return (
              ...
              this._endToken([]),
              new c(U(this.tokens), this.errors)
            );
          }
          ...
          handleError(t) {
            if (
              (t instanceof L &&
                (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))),
              t instanceof m)
            )
          ...
          _decodeEntity() {
            ...
            if ((this._cursor.advance(), this._attemptCharCode(r.$HASH))) {
              ...
              let o = this._cursor.clone();
              if (
                (this._attemptCharCodeUntilFn(w),
                this._cursor.peek() != r.$SEMICOLON)
              )
          ...
          _consumePrefixAndName() {
            ...
            for (
              ;
              this._cursor.peek() !== r.$COLON && !O(this._cursor.peek());
          ...
          _consumeAttributeValue() {
            ...
            if (
              ...
              (t = this._processCarriageReturns(d.join(""))),
                this._endToken([t]),
                this._beginToken(s.ATTR_QUOTE),
                this._cursor.advance(),
                this._endToken([String.fromCodePoint(o)]);
              ...
              this._requireCharCodeUntilFn(B, 1),
                (t = this._processCarriageReturns(this._cursor.getChars(o))),
                this._endToken([t]);
            }
            return t;
          }
          _consumeTagOpenEnd() {
            let t = this._attemptCharCode(r.$SLASH)
              ? s.TAG_OPEN_END_VOID
              : s.TAG_OPEN_END;
            this._beginToken(t),
      ...
      function U(t) {
        ...
        for (let h = 0; h < t.length; h++) {
          let A = t[h];
          d && d.type == s.TEXT && A.type == s.TEXT
            ? ((d.parts[0] += A.parts[0]),
              (d.sourceSpan.end = A.sourceSpan.end))
            : ((d = A), o.push(d));
        }
        return o;
      }
      var k = class {
          ...
          advanceState(t) {
            if (t.offset >= this.end)
              throw (
                ((this.state = t), new L('Unexpected character "EOF"', this))
              );
        ...
        j = class extends k {
          constructor(t, o) {
            t instanceof j
              ? (super(t),
                (this.internalState = Object.assign({}, t.internalState)))
          ...
          processEscapeSequence() {
            ...
            if (t() === r.$BACKSLASH)
              if (
                ...
                if (
                  (this.advanceState(this.internalState), t() === r.$LBRACE)
                ) {
                  this.advanceState(this.internalState);
                  let o = this.clone(),
                    d = 0;
          ...
          decodeHexDigits(t, o) {
            let d = this.input.substr(t.internalState.offset, o),
              h = parseInt(d, 16);
            if (isNaN(h))
              throw (
                ((t.state = t.internalState),
                new L("Invalid hexadecimal escape sequence", t))
              );
            return h;
          }
        },
      ...
      var f = class {
        ...
        parse(i, l, p) {
          let m =
            ...
            B = m ? this.getTagDefinition : g(this.getTagDefinition),
            O = (k) => B(k).contentType,
            F = m ? C : g(C),
            w = C
              ? (k, j, L, t) => {
              ...
              : O,
            b = n.tokenize(i, l, w, p),
            M = (p && p.canSelfClose) || !1,
            R = (p && p.allowHtmComponentClosingTags) || !1,
            U = new c(b.tokens, B, M, R, m).build();
      ...
      var c = class {
        constructor(i, l, p, m, C) {
          (this.tokens = i),
            ...
            (this.canSelfClose = p),
            (this.allowHtmComponentClosingTags = m),
        ...
        _consumeCdata(i) {
          let l = this._advance(),
            p = this._getText(l),
            m = this._advanceIf(n.TokenType.CDATA_END);
          this._addToParent(
            new u.CDATA(
              p,
              new r.ParseSourceSpan(i.sourceSpan.start, (m || l).sourceSpan.end)
            )
          );
        }
        _consumeComment(i) {
          let l = this._advanceIf(n.TokenType.RAW_TEXT),
            p = this._advanceIf(n.TokenType.COMMENT_END),
        ...
        _consumeDocType(i) {
          let l = this._advanceIf(n.TokenType.RAW_TEXT),
            p = this._advanceIf(n.TokenType.DOC_TYPE_END),
            m = l != null ? l.parts[0].trim() : null,
            C = new r.ParseSourceSpan(
              i.sourceSpan.start,
              (p || l || i).sourceSpan.end
        ...
        _consumeExpansion(i) {
          ...
          this._addToParent(
            new u.Expansion(l.parts[0], p.parts[0], m, C, l.sourceSpan)
          ),
            this._advance();
        }
        _parseExpansionCase() {
        ...
        _collectExpansionExpTokens(i) {
          let l = [],
            p = [n.TokenType.EXPANSION_CASE_EXP_START];
          for (;;) {
            if (
              ((this._peek.type === n.TokenType.EXPANSION_FORM_START ||
                this._peek.type === n.TokenType.EXPANSION_CASE_EXP_START) &&
            ...
            if (this._peek.type === n.TokenType.EXPANSION_FORM_END)
              if (v(p, n.TokenType.EXPANSION_FORM_START)) p.pop();
              else
                return (
                  this._errors.push(
                    s.create(
...
`
        ...
        _consumeStartTag(i) {
          ...
          if (this._peek.type === n.TokenType.TAG_OPEN_END_VOID) {
            ...
            this.canSelfClose ||
              b.canSelfClose ||
              D.getNsPrefix(C) !== null ||
              b.isVoid ||
              this._errors.push(
                s.create(
                  C,
                  i.sourceSpan,
                  `Only void and foreign elements can be self closed "${i.parts[1]}"`
                )
              );
          } else
          ...
          let B = this._peek.sourceSpan.start,
            O = new r.ParseSourceSpan(i.sourceSpan.start, B),
            F = new r.ParseSourceSpan(
              i.sourceSpan.start.moveBy(1),
              i.sourceSpan.end
            ),
            w = new u.Element(C, m, [], O, O, void 0, F);
          this._pushElement(w),
            g && (this._popElement(C), (w.endSourceSpan = O));
        }
        _pushElement(i) {
          ...
          if (
            ...
            this._errors.push(
              s.create(
                l,
                i.sourceSpan,
                `Void elements do not have end tags "${i.parts[1]}"`
              )
            );
        ...
        _consumeAttr(i) {
          let l = D.mergeNsAndName(i.parts[0], i.parts[1]),
            p = i.sourceSpan.end,
            m = "",
            C,
            g;
          if (
            (this._peek.type === n.TokenType.ATTR_QUOTE &&
              (g = this._advance().sourceSpan.start),
        ...
        _getElementFullName(i, l, p) {
          return (
            i === "" &&
              ...
              i === "" && p != null && (i = D.getNsPrefix(p.name))),
            D.mergeNsAndName(i, l)
          );
        }
      };
      function v(i, l) {
  ...
  jl = I({
    "src/language-html/parser-html.js"(e, r) {
      N();
      var { ParseSourceSpan: u, ParseLocation: n, ParseSourceFile: D } = Ne(),
        s = JD(),
        a = ls(),
        f = ZD(),
        { inferParserByLanguage: c } = yl(),
        v = Bl(),
        i = Nl(),
        l = Ol(),
        { hasPragma: p } = ql(),
        { Node: m } = Il(),
        { parseIeConditionalComment: C } = Rl(),
        { locStart: g, locEnd: B } = xl();
      function O(b, M, R) {
        let {
            canSelfClose: U,
            normalizeTagName: k,
          ...
          d = ss(),
          { RecursiveVisitor: h, visitAll: A } = As(),
          { ParseSourceSpan: q } = Ne(),
          { getHtmlTagDefinition: P } = Fs(),
          { rootNodes: G, errors: X } = d.parse(b, {
            canSelfClose: U,
            allowHtmComponentClosingTags: L,
            isTagNameCaseSensitive: t,
            getTagContentType: o,
          ...
          if (
            ...
            let _ = (T) => {
              if (!T || T.type !== "element" || T.name !== "template")
                return !1;
              let x = T.attrs.find((V) => V.name === "lang"),
                $ = x && x.value;
              return !$ || c($, R) === "html";
            };
            if (G.some(_)) {
              let T,
                ...
                V = (z) =>
                  $().rootNodes.find((Y) => {
                    ...
                    return (
                      ie && ie.start.offset === z.startSourceSpan.start.offset
                    );
                  });
              for (let z = 0; z < G.length; z++) {
                let Y = G[z],
                  { endSourceSpan: ie, startSourceSpan: Ee } = Y;
                if (ie === null) (X = $().errors), (G[z] = V(Y) || Y);
                else if (_(Y)) {
                  let Fe = $(),
                    Oe = Ee.end.offset,
                    Z = ie.start.offset;
        ...
        let Q = (E) => {
            let _ = E.name.startsWith(":")
                ? E.name.slice(1).split(":")[0]
                : null,
              T = E.nameSpan.toString(),
              x = _ !== null && T.startsWith(`${_}:`),
              $ = x ? T.slice(_.length + 1) : T;
          ...
          S = (E) => {
            if (E.type === "element") {
              ...
              !E.namespace || E.namespace === _.implicitNamespacePrefix || l(E)
                ? (E.tagDefinition = _)
                : (E.tagDefinition = P(""));
            }
          };
      ...
      function F(b, M, R) {
        let U =
          ...
          { frontMatter: k, content: j } = U
            ? s(b)
            : { frontMatter: null, content: b },
          L = new D(b, M.filepath),
          t = new n(L, 0, 0, 0),
          o = t.moveBy(b.length),
          d = { type: "root", sourceSpan: new u(t, o), children: O(j, R, M) };
        if (k) {
          let q = new n(L, 0, 0, 0),
          ...
          A = (q, P) => {
            ...
            return (
              W.length === G
                ? H.children.shift()
                : ((W.sourceSpan = new u(
                    W.sourceSpan.start.moveBy(G),
                    W.sourceSpan.end
                  )),
                  (W.value = W.value.slice(G))),
              H
            );
          };
        return (
