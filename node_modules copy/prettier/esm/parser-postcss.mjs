...
var Ar = K((Yf, sn) => {
  var qr = typeof document == "object" && document.all,
    wa = typeof qr > "u" && qr !== void 0;
  sn.exports = { all: qr, IS_HTMLDDA: wa };
});
var he = K((Xf, an) => {
  var on = Ar(),
    _a = on.all;
  an.exports = on.IS_HTMLDDA
    ? function (r) {
...
var xn = K((np, bn) => {
  ...
  wn &&
    ((de = wn.split(".")),
    (tr = de[0] > 0 && de[0] < 4 ? 1 : +(de[0] + de[1])));
  !tr &&
    Ir &&
    ((de = Ir.match(/Edge\/(\d+)/)),
    (!de || de[1] >= 74) &&
      ((de = Ir.match(/Chrome\/(\d+)/)), de && (tr = +de[1])));
  bn.exports = tr;
});
var Rr = K((ip, kn) => {
  var Sn = xn(),
...
var Nn = K((lp, Cn) => {
  ...
  Cn.exports = function (r, n) {
    var s, c;
    if (
      (n === "string" && Mr((s = r.toString)) && !Dr((c = jr(s, r)))) ||
      (Mr((s = r.valueOf)) && !Dr((c = jr(s, r)))) ||
      (n !== "string" && Mr((s = r.toString)) && !Dr((c = jr(s, r))))
    )
      return c;
...
var Xn = K((yp, Yn) => {
  var eu = pe(),
    ...
    Ee = eu.Symbol,
    Kn = Ee && Ee.for,
    nu = Qn ? Ee : (Ee && Ee.withoutSetter) || tu;
...
var ti = K((wp, ri) => {
  ...
  ri.exports = function (r, n) {
    ...
    var s = su(r, cu),
      c;
    if (s) {
      if ((n === void 0 && (n = "default"), (c = iu(s, r, n)), !Zn(c) || ei(c)))
        return c;
...
var yi = K((qp, gi) => {
  var Qr = Oe(),
    ...
    zu = Qr && Object.getOwnPropertyDescriptor,
    Yr = Lu(mi, "name"),
    Bu = Yr && function () {}.name === "something",
    Fu = Yr && (!Qr || (Qr && zu(mi, "name").configurable));
...
var _i = K((Ap, wi) => {
  var Uu = xe(),
    $u = he(),
    Xr = ir(),
    Wu = Uu(Function.toString);
  $u(Xr.inspectSource) ||
    (Xr.inspectSource = function (r) {
      return Wu(r);
    });
...
var Ni = K((Np, Ci) => {
  var nc = be(),
    ...
    cc =
      nt &&
      !nc(function () {
        return lr(function () {}, "length", { value: 8 }).length !== 8;
      }),
    lc = String(String).split("String"),
    fc = (Ci.exports = function (r, n, s) {
      String(n).slice(0, 7) === "Symbol(" &&
        (n = "[" + String(n).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
        s && s.getter && (n = "get " + n),
        s && s.setter && (n = "set " + n),
        (!cr(r, "name") || (sc && r.name !== n)) &&
          (nt ? lr(r, "name", { value: n, configurable: !0 }) : (r.name = n)),
        cc &&
          s &&
          cr(s, "arity") &&
          r.length !== s.arity &&
          lr(r, "length", { value: s.arity });
      try {
        s && cr(s, "constructor") && s.constructor
          ? nt && lr(r, "prototype", { writable: !1 })
          : r.prototype && (r.prototype = void 0);
      } catch {}
      var c = ac(r);
      return (
        cr(c, "source") || (c.source = lc.join(typeof n == "string" ? n : "")),
        r
      );
    });
...
var Mi = K((jp, ji) => {
  ...
  ji.exports = function (r, n, s, c) {
    c || (c = {});
    var o = c.enumerable,
      p = c.name !== void 0 ? c.name : n;
    if ((pc(s) && dc(s, p, c), c.global)) o ? (r[n] = s) : vc(n, s);
    else {
      try {
  ...
  fs.exports = function (r, n) {
    ...
    if (
      ...
      for (h in n) {
        if (
          ((l = n[h]),
          r.dontCallGetSet ? ((t = Yc(f, h)), (g = t && t.value)) : (g = f[h]),
          (p = tl(c ? h : s + (o ? "." : "#") + h, r.forced)),
          !p && g !== void 0)
        ) {
...
var yt = Object.defineProperty,
  ...
  bt = (r) => ol(yt({}, "__esModule", { value: !0 }), r),
  I = Me({ "<define:process>"() {} }),
  al = R({
...
function Ms() {
  if (typeof fr > "u") {
    var r = new ArrayBuffer(2),
      n = new Uint8Array(r),
      s = new Uint16Array(r);
    if (((n[0] = 1), (n[1] = 2), s[0] === 258)) fr = "BE";
    else if (s[0] === 513) fr = "LE";
    ...
    "node_modules/jest-docblock/build/index.js"(r) {
      ...
      function v(d) {
        ...
        let k = Object.create(null),
          D = d.replace(t, "").replace(g, "").trimRight(),
          P;
        for (; (P = t.exec(d)); ) {
          let $ = P[2].replace(h, "");
          typeof k[P[1]] == "string" || Array.isArray(k[P[1]])
            ? (k[P[1]] = a.concat(k[P[1]], $))
            : (k[P[1]] = $);
        }
      ...
      function y(d) {
        let { comments: _ = "", pragmas: O = {} } = d,
          k = (0, s().default)(_) || n().EOL,
          D = "/**",
          P = " *",
          $ = " */",
          G = Object.keys(O),
          Z = G.map((H) => w(H, O[H]))
            .reduce((H, U) => H.concat(U), [])
            .map((H) => `${P} ${H}${k}`)
            .join("");
        if (!_) {
...
`);
  ...
  ml = R({
    "src/language-js/pragma.js"(r, n) {
      "use strict";
      I();
      var { parseWithComments: s, strip: c, extract: o, print: p } = hl(),
        { normalizeEndOfLine: f } = dl(),
        h = vl();
      function g(e) {
        let a = h(e);
        a && (e = e.slice(a.length + 1));
        let i = o(e),
          { pragmas: u, comments: m } = s(i);
      ...
      function t(e) {
        let { shebang: a, text: i, pragmas: u, comments: m } = g(e),
          v = c(i),
          y = p({
...
`,
  ...
  ds = R({
    "src/language-css/loc.js"(r, n) {
      "use strict";
      I();
      var { skipEverythingButNewLine: s } = yl(),
        c = Cs(),
        o = wl();
      function p(i, u) {
        return typeof i.sourceIndex == "number"
          ? i.sourceIndex
          : i.source
          ? o(i.source.start, u) - 1
          : null;
      }
      function f(i, u) {
        ...
        return (
          m && i.source && !i.source.end && (i = m),
          i.source && i.source.end ? o(i.source.end, u) : null
        );
      }
      function h(i, u) {
        i.source &&
          ((i.source.startOffset = p(i, u)), (i.source.endOffset = f(i, u)));
        for (let m in i) {
          let v = i[m];
          m === "source" ||
            !v ||
            ...
            (v.type === "value-root" || v.type === "value-unknown"
              ? g(v, l(i), v.text || v.value)
              : h(v, u));
        }
      }
      function g(i, u, m) {
        i.source &&
          ((i.source.startOffset = p(i, m) + u),
          (i.source.endOffset = f(i, m) + u));
        for (let v in i) {
          let y = i[v];
      ...
      function l(i) {
        ...
        return (
          typeof i.prop == "string" && (u += i.prop.length),
          i.type === "css-atrule" &&
            typeof i.name == "string" &&
            (u +=
              1 +
              i.name.length +
              i.raws.afterName.match(/^\s*:?\s*/)[0].length),
          i.type !== "css-atrule" &&
            i.raws &&
            typeof i.raws.between == "string" &&
            (u += i.raws.between.length),
          u
        );
      }
      function t(i) {
...
` ||
        ...
        for (let [d, _] of w)
          i = i.slice(0, d) + i.slice(d, _).replace(/["'*]/g, " ") + i.slice(_);
        return i;
      }
      function e(i) {
  ...
  Tl = R({
    "src/language-css/utils/is-scss-variable.js"(r, n) {
      ...
      function s(c) {
        return Boolean(
          (c == null ? void 0 : c.type) === "word" && c.value.startsWith("$")
        );
      }
      n.exports = s;
    },
    ...
    "src/language-css/utils/stringify-node.js"(r, n) {
      ...
      function s(c) {
        ...
        if (c.groups) {
          var h, g, l;
          let y =
              ((h = c.open) === null || h === void 0 ? void 0 : h.value) || "",
            w = c.groups
              .map((_) => s(_))
              .join(
                ((g = c.groups[0]) === null || g === void 0
                  ? void 0
                  : g.type) === "comma_group"
                  ? ","
                  : ""
            ...
            d =
              ((l = c.close) === null || l === void 0 ? void 0 : l.value) || "";
          return y + w + d;
        }
        let t =
            ((o = c.raws) === null || o === void 0 ? void 0 : o.before) || "",
      ...
      n.exports = class {
        ...
        toJSON() {
          ...
          for (let p in this) {
            ...
            f instanceof Array
              ? (o[p] = f.map((h) =>
                  typeof h == "object" && h.toJSON ? h.toJSON() : h
                ))
        ...
        c = class extends s {
          ...
          cleanRaws(o) {
            if ((super.cleanRaws(o), this.nodes))
              for (let p of this.nodes) p.cleanRaws(o);
          }
          insertAfter(o, p) {
            let f = this.index(o),
              h;
            ...
            for (let g in this.indexes)
              (h = this.indexes[g]),
                f <= h && (this.indexes[g] = h + this.nodes.length);
            return this;
          }
          insertBefore(o, p) {
            let f = this.index(o),
...
function Il() {
  !Re ||
    !Ie ||
    ((Re = !1),
    Ie.length ? (me = Ie.concat(me)) : (Ue = -1),
    me.length && co());
}
function co() {
  if (!Re) {
...
function Dl(r) {
  var n = fo.call(Pe) * 0.001,
    s = Math.floor(n),
    c = Math.floor((n % 1) * 1e9);
  return (
    r && ((s = s - r[0]), (c = c - r[1]), c < 0 && (s--, (c += 1e9))), [s, c]
  );
}
function Ll() {
  var r = new Date(),
...
function vr(r) {
  ...
  for (
    var s = 1,
      c = arguments,
      o = c.length,
      p = String(r).replace(xo, function (h) {
        if (h === "%%") return "%";
        if (s >= o) return h;
        switch (h) {
          case "%s":
...
function pr(r, n, s) {
  ...
  var p = Object.keys(n),
    f = $l(p);
  if (
    (r.showHidden && (p = Object.getOwnPropertyNames(n)),
    Ve(n) && (p.indexOf("message") >= 0 || p.indexOf("description") >= 0))
  )
    return ct(n);
  if (p.length === 0) {
    if (Ge(n)) {
  ...
  if (
    (We(n) && (g = " " + RegExp.prototype.toString.call(n)),
    hr(n) && (g = " " + Date.prototype.toUTCString.call(n)),
    Ve(n) && (g = " " + ct(n)),
    p.length === 0 && (!l || n.length == 0))
  )
    return t[0] + g + t[1];
  if (s < 0)
    return We(n)
...
function Vl(r, n, s, c, o) {
  for (var p = [], f = 0, h = n.length; f < h; ++f)
    bo(n, String(f)) ? p.push(vt(r, n, s, c, String(f), !0)) : p.push("");
  return (
  ...
  if (
    ...
    h ||
      (r.seen.indexOf(g.value) < 0
        ? (He(s) ? (h = pr(r, g.value, null)) : (h = pr(r, g.value, s - 1)),
          h.indexOf(`
`) > -1 &&
            (p
              ? (h = h
...
function Hl() {
  var r = new Date(),
    n = [lt(r.getHours()), lt(r.getMinutes()), lt(r.getSeconds())].join(":");
        ...
        for (; x < Q; ) {
          switch (((A = C.charCodeAt(x)), A === y && ((M = x), (E += 1)), A)) {
            ...
            case d:
              q = x;
              do
                (q += 1), (A = C.charCodeAt(q)), A === y && ((M = q), (E += 1));
              while (A === w || A === y || A === _ || A === O || A === d);
              X.push(["space", C.slice(x, q), E, x - M, E, q - M, x]),
                (x = q - 1);
              break;
            case a:
              (q = x + 1),
                X.push(["colon", C.slice(x, q), E, x - M, E, q - M, x]),
                (x = q - 1);
              break;
            case e:
              (q = x + 1),
                X.push(["comma", C.slice(x, q), E, x - M, E, q - M, x]),
                (x = q - 1);
              break;
            case s:
            ...
            case h:
              ...
              do
                for (
                  ...
                  (oe -= 1), (ne = !ne);
              while (ne);
              X.push(["string", C.slice(x, q + 1), E, x - M, E, q - M, x]),
                (x = q);
              break;
            case k:
              (H.lastIndex = x + 1),
                H.test(C),
                H.lastIndex === 0 ? (q = C.length - 1) : (q = H.lastIndex - 2),
                X.push(["atword", C.slice(x, q + 1), E, x - M, E, q - M, x]),
                (x = q);
              break;
            case g:
              (q = x),
                ...
                ue &&
                  ...
                  A !== d &&
                  (q += 1),
                X.push(["word", C.slice(x, q + 1), E, x - M, E, q - M, x]),
                (x = q);
              break;
            case m:
            case u:
            case i:
              ...
              if (A === u && ie.charCodeAt(0) === u) {
                q++,
                  X.push(["word", C.slice(x, q), E, x - M, E, q - M, x]),
                  (x = q - 1);
                break;
              }
              X.push(["operator", C.slice(x, q), E, x - M, E, q - M, x]),
                (x = q - 1);
              break;
            default:
              if (
...
`)),
                  (ee = F.length - 1),
                  ee > 0
                    ? ((le = E + ee), (re = q - F[ee].length))
                    : ((le = E), (re = M)),
                  X.push(["comment", te, E, x - M, le, q - re, x]),
                  (M = re),
                  (E = le),
                  (x = q);
              } else if (A === v && !L.test(C.slice(x + 1, x + 2)))
                (q = x + 1),
                  X.push(["#", C.slice(x, q), E, x - M, E, q - M, x]),
                  (x = q - 1);
              else if ((A === Z || A === B) && C.charCodeAt(x + 1) === m) {
                q = x + 2;
                do (q += 1), (A = C.charCodeAt(q));
                while (q < Q && j.test(C.slice(q, q + 1)));
                X.push(["unicoderange", C.slice(x, q), E, x - M, E, q - M, x]),
                  (x = q - 1);
              } else if (A === l)
                (q = x + 1),
                  X.push(["operator", C.slice(x, q), E, x - M, E, q - M, x]),
  ...
  Eo = R({
    "node_modules/uniq/uniq.js"(r, n) {
      ...
      function c(p) {
        for (
          var f = 1, h = p.length, g = p[0], l = p[0], t = 1;
          t < h;
          ++t, l = g
        )
          if (((l = g), (g = p[t]), g !== l)) {
    ...
    "node_modules/postcss-values-parser/lib/parser.js"(r, n) {
      ...
      n.exports = class {
        constructor(k, D) {
          ...
          (this.cache = []),
            (this.input = k),
            (this.options = Object.assign({}, P, D)),
            (this.position = 0),
            (this.unbalanced = 0),
            (this.root = new s());
          let $ = new c();
        ...
        parenOpen() {
          ...
          if (
            (k && this.error("Expected closing parenthesis", P),
            ($ = this.current.last),
            $ &&
              $.type === "func" &&
              $.unbalanced < 0 &&
            ...
            this.newNode(
              new e({
                value: P[1],
                source: {
                  start: { line: P[2], column: P[3] },
                  end: { line: P[4], column: P[5] },
                },
                sourceIndex: P[6],
              })
            ),
          ...
          this.newNode(
            ...
            !(
              ...
              this.current.unbalanced < 0 &&
                this.error("Expected opening parenthesis", k),
              !this.current.unbalanced &&
                this.cache.length &&
        ...
        space() {
          ...
          this.nextToken[0] === "," ||
          this.nextToken[0] === ")"
            ? ((this.current.last.raws.after += k[1]), this.position++)
            : ((this.spaces = k[1]), this.position++);
        }
        unicodeRange() {
          let k = this.currToken;
          this.newNode(
        ...
        string() {
          let k = this.currToken,
            ...
            G = "",
            Z;
          $ && ((G = D.match(P)[0]), (D = D.slice(1, D.length - 1))),
            (Z = new a({
              value: D,
              source: {
                start: { line: k[2], column: k[3] },
        ...
        newNode(k) {
          return (
            this.spaces && ((k.raws.before += this.spaces), (this.spaces = "")),
        ...
        return (
          ...
          (u.prototype.split = function (v) {
            ...
            return this.reduce(function (d, _, O) {
              ...
              return (
                w.push(_),
                k ? (d.push(w), (w = [])) : O === y.length - 1 && d.push(w),
                d
              );
            }, []);
          }),
      ...
      var l = (function (t) {
        ...
        return (
          (e.prototype.toString = function () {
            ...
            return (
              this.operator && i.push(this.operator),
              this.value && i.push(this.value),
              this.raws.insensitive
                ? i.push(this.raws.insensitive)
                : this.insensitive && i.push(" i"),
              i.push("]"),
              i.concat(this.spaces.after).join("")
            );
          }),
          e
        );
      ...
      function Z(B) {
        for (
          var H = [],
            ...
            S = 0,
            z = function (q, V) {
              if (B.safe) (U += V), (L = U.length - 1);
              else throw B.error("Unclosed " + q, x, S - E, S);
            };
          S < M;
          ...
          switch (((T = U.charCodeAt(S)), T === f && ((E = S), (x += 1)), T)) {
            ...
            case g:
              L = S;
              do
                (L += 1), (T = U.charCodeAt(L)), T === f && ((E = L), (x += 1));
            ...
            case c:
              ...
              do
                for (
                  ...
                  (Q -= 1), (C = !C);
              while (C);
              H.push(["string", U.slice(S, L + 1), x, S - E, x, L - E, S]),
                (S = L);
              break;
            case P:
              ($.lastIndex = S + 1),
                $.test(U),
                $.lastIndex === 0 ? (L = U.length - 1) : (L = $.lastIndex - 2),
                H.push(["at-word", U.slice(S, L + 1), x, S - E, x, L - E, S]),
                (S = L);
              break;
            case o:
              for (L = S, J = !0; U.charCodeAt(L + 1) === o; )
                (L += 1), (J = !J);
              (T = U.charCodeAt(L + 1)),
                J &&
                  T !== p &&
                  ...
                  T !== g &&
                  (L += 1),
                H.push(["word", U.slice(S, L + 1), x, S - E, x, L - E, S]),
                (S = L);
              break;
            default:
              T === p && U.charCodeAt(S + 1) === O
                ? ((L = U.indexOf("*/", S + 2) + 1),
                  L === 0 && z("comment", "*/"),
                  (Y = U.slice(S, L + 1)),
                  (N = Y.split(`
`)),
                  (b = N.length - 1),
                  b > 0
                    ? ((W = x + b), (X = L - N[b].length))
                    : ((W = x), (X = E)),
                  H.push(["comment", Y, x, S - E, W, L - X, S]),
                  (E = X),
                  (x = W),
                  (S = L))
                : ((G.lastIndex = S + 1),
        ...
        return (
          (E.prototype.attribute = function () {
            ...
            if (
              (V.length > 1
                ? (V[0] === "" && (V[0] = !0),
                  (F.attribute = this.parseValue(V[2])),
                  (F.namespace = this.parseNamespace(V[0])))
                : (F.attribute = this.parseValue(q[0])),
              (z = new G.default(F)),
              q[2])
            ) {
              var ee = q[2].split(/(\s+i\s*?)$/),
                te = ee[0].trim();
              (z.value = this.lossy ? te : ee[0]),
                ee[1] &&
                  ((z.insensitive = !0),
                  this.lossy || (z.raws.insensitive = ee[1])),
                (z.quoted = te[0] === "'" || te[0] === '"'),
                (z.raws.unquoted = z.quoted ? te.slice(1, -1) : te);
            }
          ...
          (E.prototype.parentheses = function () {
            ...
            if (S && S.type === W.PSEUDO) {
              ...
              for (
                ...
                this.position < this.tokens.length && V;
          ...
          (E.prototype.splitWord = function (S, z) {
            for (
              var A = this, q = this.nextToken, V = this.currToken[1];
              q && q[0] === "word";
              ...
              if (((V += F), F.lastIndexOf("\\") === F.length - 1)) {
                ...
                ee &&
                  ee[0] === "space" &&
                  ((V += this.parseSpace(ee[1], " ")), this.position++);
              }
              q = this.nextToken;
            }
            var te = (0, f.default)(V, "."),
              ue = (0, f.default)(V, "#"),
              le = (0, f.default)(V, "#{");
            le.length &&
            ...
            var re = (0, N.default)(
              (0, g.default)((0, o.default)([[0], te, ue]))
            );
            re.forEach(function (ne, oe) {
              var ie = re[oe + 1] || V.length,
                ce = V.slice(ne, ie);
              ...
              ~te.indexOf(ne)
                ? (fe = new u.default({
                    ...
                    source: {
                      start: {
                        line: A.currToken[2],
                        column: A.currToken[3] + ne,
                      },
                      end: {
                        line: A.currToken[4],
                        column: A.currToken[3] + (ie - 1),
                      },
                    },
          ...
          (E.prototype.newNode = function (S, z) {
            return (
              z && (S.namespace = this.parseNamespace(z)),
              this.spaces &&
        ...
        (o.prototype.walk = function (f, h) {
          for (
            ...
            var a = this.nodes[e],
              i = g ? t.test(a.type) : !0;
            if (
              (i && l && l(a, e, this.nodes) === !1) ||
              (a.nodes && a.walk(f, h) === !1)
            )
              return !1;
          }
          return !0;
  ...
  af = R({
    "node_modules/postcss-media-query-parser/dist/parsers.js"(r) {
      ...
      function f(l) {
        ...
        l[0] === "(" &&
          l[l.length - 1] === ")" &&
          ((w = l.substring(1, l.length - 1)), y++);
        for (var d = 0; d < w.length; d++) {
          var _ = w[d];
          if (
            ((_ === "'" || _ === '"') &&
              (e[i].isCalculationEnabled === !0
                ? (e.push({
                    mode: "string",
          ...
          function v(w, d, _, O, k, D) {
            ...
            return (
              ...
              typeof d < "u" &&
                ...
                ((P.line = d), (P.column = _)),
              P.setMessage(),
              Error.captureStackTrace && Error.captureStackTrace(p(P), v),
              P
            );
          }
          var y = v.prototype;
          return (
            ...
            (y.showSourceCode = function (d) {
              ...
              c.default &&
                ...
                d && (O = (0, c.default)(O)));
              var k = O.split(/\r?\n/),
                D = Math.max(this.line - 3, 0),
                P = Math.min(this.line + 2, k.length),
                $ = String(P).length;
              function G(B) {
                return d && s.default.red
                  ? s.default.red(s.default.bold(B))
                  : B;
              }
              function Z(B) {
              ...
              return k.slice(D, P).map(function (B, H) {
                ...
                if (U === _.line) {
                  var L =
                    Z(T.replace(/\d/g, " ")) +
                    B.slice(0, _.column - 1).replace(/[^\t]/g, " ");
                  return (
                    G(">") +
                    Z(T) +
                    B +
        ...
        l = (function () {
          function e(i, u) {
            if (
              ...
              i === null ||
                typeof i > "u" ||
                (typeof i == "object" && !i.toString))
            )
              throw new Error(
                "PostCSS received " + i + " instead of CSS string"
              );
            (this.css = i.toString()),
          ...
          return (
            ...
            (h.rule = function (l) {
              this.block(l, this.rawValue(l, "selector")),
                l.raws.ownSemicolon &&
                  this.builder(l.raws.ownSemicolon, l, "end");
            }),
            (h.atrule = function (l, t) {
              var e = "@" + l.name,
                a = l.params ? this.rawValue(l, "params") : "";
              if (
                (typeof l.raws.afterName < "u"
                  ? (e += l.raws.afterName)
                  : a && (e += " "),
                l.nodes)
              )
            ...
            (h.body = function (l) {
              for (
                var t = l.nodes.length - 1;
                t > 0 && l.nodes[t].type === "comment";

              )
                t -= 1;
              for (
                var e = this.raw(l, "semicolon"), a = 0;
                a < l.nodes.length;
                a++
              ) {
                var i = l.nodes[a],
...
`);
                    return (
                      (t = i[i.length - 1]), (t = t.replace(/[^\s]/g, "")), !1
                    );
                  }
                }),
                t
...
`
            ...
            (t.positionBy = function (a) {
              ...
              if (a.index) i = this.positionInside(a.index);
              else if (a.word) {
      ...
      function $(G, Z) {
        ...
        function ue(re) {
          ...
          if (!(A >= x)) {
            ...
            switch (
              ((U = B.charCodeAt(A)),
              (U === f || U === g || (U === t && B.charCodeAt(A + 1) !== f)) &&
                ((S = A), (z += 1)),
              U)
            ) {
              case f:
              ...
              case i:
                if (
                  ...
                  (E = ["brackets", B.slice(A, T + 1), z, A - S, z, T - S]),
                    (A = T);
                } else
                  (T = B.indexOf(")", A + 1)),
                    (b = B.slice(A, T + 1)),
                    T === -1 || D.test(b)
                      ? (E = ["(", "(", z, A - S])
                      : ((E = ["brackets", b, z, A - S, z, T - S]), (A = T));
                break;
              case s:
              case c:
                (L = U === s ? "'" : '"'), (T = A);
                do {
                  if (((X = !1), (T = B.indexOf(L, T + 1)), T === -1))
                    if (H || ne) {
                      T = A + 1;
                      break;
                    } else ee("string");
...
`)),
                  (N = j.length - 1),
                  N > 0
                    ? ((J = z + N), (W = T - j[N].length))
                    : ((J = z), (W = S)),
                  (E = ["string", B.slice(A, T + 1), z, A - S, J, T - W]),
                  (S = W),
                  (z = J),
                  (A = T);
                break;
              case _:
                (O.lastIndex = A + 1),
                  ...
                  O.lastIndex === 0
                    ? (T = B.length - 1)
                    : (T = O.lastIndex - 2),
                  (E = ["at-word", B.slice(A, T + 1), z, A - S, z, T - S]),
                  (A = T);
                break;
              case o:
                for (T = A, Y = !0; B.charCodeAt(T + 1) === o; )
                  (T += 1), (Y = !Y);
                if (
                  ((U = B.charCodeAt(T + 1)),
                  Y &&
                ...
                break;
              default:
                U === p && B.charCodeAt(A + 1) === w
                  ? ((T = B.indexOf("*/", A + 2) + 1),
                    T === 0 && (H || ne ? (T = B.length) : ee("comment")),
                    (b = B.slice(A, T + 1)),
                    (j = b.split(`
`)),
                    (N = j.length - 1),
                  ...
                  : ((k.lastIndex = A + 1),
                    ...
                    k.lastIndex === 0
                      ? (T = B.length - 1)
                      : (T = k.lastIndex - 2),
                    (E = ["word", B.slice(A, T + 1), z, A - S, z, T - S]),
                    q.push(E),
                    (A = T));
                break;
            }
          ...
          return (
            ...
            (y.each = function (d) {
              ...
              if (((this.indexes[_] = 0), !!this.nodes)) {
                for (
                  ...
                  ((O = this.indexes[_]), (k = d(this.nodes[O], O)), k !== !1);
            ...
            (y.append = function () {
              ...
              for (var k = 0, D = _; k < D.length; k++)
                for (
                  var P = D[k], $ = this.normalize(P, this.last), G = f($), Z;
                  !(Z = G()).done;
            ...
            (y.prepend = function () {
              ...
              for (var k = f(_), D; !(D = k()).done; ) {
                for (
                  var P = D.value,
                    $ = this.normalize(P, this.first, "prepend").reverse(),
                    G = f($),
                    Z;
                  !(Z = G()).done;
                ...
                for (var H in this.indexes)
                  this.indexes[H] = this.indexes[H] + $.length;
              }
              return this;
            }),
            ...
            (y.insertBefore = function (d, _) {
              ...
              for (
                var O = d === 0 ? "prepend" : !1,
                  k = this.normalize(_, this.nodes[d], O).reverse(),
                  D = f(k),
                  P;
                !(P = D()).done;
              ...
              for (var Z in this.indexes)
                (G = this.indexes[Z]),
                  d <= G && (this.indexes[Z] = G + k.length);
              return this;
            }),
            (y.insertAfter = function (d, _) {
              d = this.index(d);
              for (
                var O = this.normalize(_, this.nodes[d]).reverse(), k = f(O), D;
                !(D = k()).done;
            ...
            (y.replaceValues = function (d, _, O) {
              return (
                O || ((O = _), (_ = {})),
                this.walkDecls(function (k) {
                  (_.props && _.props.indexOf(k.prop) === -1) ||
                    (_.fast && k.value.indexOf(_.fast) === -1) ||
                    (k.value = k.value.replace(d, O));
                }),
                this
              );
            }),
              ...
              var T = d.map(function (L) {
                return (
                  ...
                  typeof L.raws.before > "u" &&
                    ...
                    (L.raws.before = _.raws.before.replace(/[^\s]/g, "")),
                  (L.parent = O),
                  L
                );
              });
          ...
          return (
            ...
            (y.handleError = function (d, _) {
              try {
                ...
                else if (_.postcssVersion && !1) var O, k, D, P, $;
              } catch (G) {
            ...
            (y.asyncTick = function (d, _) {
              ...
              try {
                var k = this.processor.plugins[this.plugin],
                  D = this.run(k);
                (this.plugin += 1),
                  i(D)
                    ? D.then(function () {
            ...
            (y.stringify = function () {
              ...
              var O = new s.default(_, this.result.root, this.result.opts),
                k = O.generate();
              return (
                (this.result.css = k[0]), (this.result.map = k[1]), this.result
              );
            }),
            a(v, [
              {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function p(l, t) {
        if (l) {
          ...
          if (
            (e === "Object" && l.constructor && (e = l.constructor.name),
            e === "Map" || e === "Set")
          )
            return Array.from(l);
          if (
...
https://github.com/postcss/postcss/wiki/PostCSS-8-for-end-users`
                ...
                if (
                  ...
                  i = i.concat(v.plugins);
                else if (typeof v == "function") i.push(v);
      ...
      var l = (function () {
        ...
        return (
          ...
          (e.comment = function (i) {
            var u = new o.default();
            this.init(u, i[2], i[3]),
              (u.source.end = { line: i[4], column: i[5] });
            var m = i[1].slice(2, -2);
            if (/^\s*$/.test(m))
          ...
          (e.other = function (i) {
            for (
              var u = !1, m = null, v = !1, y = null, w = [], d = [], _ = i;
              _;
          ...
          (e.rule = function (i) {
            i.pop();
            var u = new h.default();
            this.init(u, i[0][2], i[0][3]),
              (u.raws.between = this.spacesAndCommentsFromEnd(i)),
              this.raw(u, "selector", i),
              (this.current = u);
          }),
          (e.decl = function (i) {
            var u = new s.default();
            ...
            for (
              ...
              i.length === 1 && this.unknownWord(i),
                (u.raws.before += i.shift()[1]);
            for (
              u.source.start = { line: i[0][2], column: i[0][3] }, u.prop = "";
              i.length;
            ...
            for (var w = i.length - 1; w > 0; w--) {
              if (((y = i[w]), y[1].toLowerCase() === "!important")) {
                ...
                O.trim().indexOf("!") === 0 &&
                  ((u.important = !0), (u.raws.important = O), (i = _));
              }
              if (y[0] !== "space" && y[0] !== "comment") break;
            }
            this.raw(u, "value", i),
              u.value.indexOf(":") !== -1 && this.checkMissedSemicolon(i);
          }),
          (e.atrule = function (i) {
            var u = new p.default();
            (u.name = i[1].slice(1)),
              u.name === "" && this.unnamedAtrule(u, i),
              this.init(u, i[2], i[3]);
            for (
              var m, v, y = !1, w = !1, d = [];
              ...
              if (((i = this.tokenizer.nextToken()), i[0] === ";")) {
                (u.source.end = { line: i[2], column: i[3] }),
                  (this.semicolon = !0);
                break;
              } else if (i[0] === "{") {
                w = !0;
          ...
          (e.init = function (i, u, m) {
            this.current.push(i),
              (i.source = { start: { line: u, column: m }, input: this.input }),
          ...
          (e.raw = function (i, u, m) {
            for (
              ...
              if (
                ((v = m[P]), (y = v[0]), y === "comment" && i.type === "rule")
              ) {
                (k = m[P - 1]),
                  (O = m[P + 1]),
                  k[0] !== "space" &&
          ...
          (e.spacesAndCommentsFromEnd = function (i) {
            for (
              var u, m = "";
              i.length &&
              ((u = i[i.length - 1][0]), !(u !== "space" && u !== "comment"));
          ...
          (e.spacesAndCommentsFromStart = function (i) {
            for (
              var u, m = "";
              i.length && ((u = i[0][0]), !(u !== "space" && u !== "comment"));
          ...
          (e.spacesFromEnd = function (i) {
            for (
              var u, m = "";
              i.length && ((u = i[i.length - 1][0]), u === "space");
  ...
  Tf = R({
    "node_modules/postcss-less/lib/LessParser.js"(r, n) {
      ...
      n.exports = class extends c {
        ...
        atrule(e) {
          p.bind(this)(e) ||
            (super.atrule(e), h(this.lastNode), g(this.lastNode));
        }
        decl() {
        ...
        each(e) {
          ...
          let a = e.findIndex((y) => y[0] === "("),
            i = e.reverse().find((y) => y[0] === ")"),
            u = e.reverse().indexOf(i),
            v = e
              .splice(a, u)
              .map((y) => y[1])
              .join("");
        ...
        mixin(e) {
          ...
          this.atrule(this.tokenizer.nextToken()),
            ...
            (this.lastNode.raws.identifier = i),
            v &&
        ...
        rule(e) {
          ...
          if (
            i[0] === "at-word" &&
            a[0] === "{" &&
            (this.tokenizer.back(a), p.bind(this)(i))
          ) {
          ...
          return (
            ...
            (h.decl = function (l, t) {
              if (!l.isNested) p.prototype.decl.call(this, l, t);
                ...
                var i;
                l.nodes && l.nodes.length
                  ? (this.body(l), (i = this.raw(l, "after")))
                  : (i = this.raw(l, "after", "emptyBody")),
                  i && this.builder(i),
                  this.builder("}", l, "end");
              }
            }),
      ...
      n.exports = function (H, U) {
        ...
        function ne() {
          ...
          if (!(F >= A)) {
            switch (
              ((j = T.charCodeAt(F)),
              (j === f || j === g || (j === t && T.charCodeAt(F + 1) !== f)) &&
                ((q = F), (V += 1)),
              j)
            ) {
              case f:
...
`)),
                    (J = Y.length - 1),
                    J > 0
                      ? ((C = V + J), (Q = N - Y[J].length))
                      : ((C = V), (Q = q)),
                    (S = ["brackets", W, V, F - q, C, N - Q]),
                    (q = Q),
                    (V = C),
                    (F = N);
                } else
...
`)),
                  ...
                  J > 0
                    ? ((C = V + J), (Q = N - Y[J].length))
                    : ((C = V), (Q = q)),
                  (S = ["string", T.slice(F, N + 1), V, F - q, C, N - Q]),
                  (q = Q),
                  (V = C),
                  (F = N);
                break;
              case _:
                (D.lastIndex = F + 1),
                  ...
                  D.lastIndex === 0
                    ? (N = T.length - 1)
                    : (N = D.lastIndex - 2),
                  (S = ["at-word", T.slice(F, N + 1), V, F - q, V, N - q]),
                  (F = N);
                break;
              case o:
                for (N = F, X = !0; T.charCodeAt(N + 1) === o; )
                  (N += 1), (X = !X);
                if (
                  ((j = T.charCodeAt(N + 1)),
                  X &&
...
`)),
                      ...
                      J > 0
                        ? ((C = V + J), (Q = N - Y[J].length))
                        : ((C = V), (Q = q)),
                      (S = ["word", W, V, F - q, C, N - Q]),
                      (q = Q),
                      (V = C),
                      (F = N))
                    : j === p && x === w
                    ? ((N = T.indexOf("*/", F + 2) + 1),
                      N === 0 && (L ? (N = T.length) : ue("comment")),
                      (W = T.slice(F, N + 1)),
                      (Y = W.split(`
`)),
                      (J = Y.length - 1),
                    ...
                    ? ((Z.lastIndex = F + 1),
                      ...
                      Z.lastIndex === 0
                        ...
                        : (N = Z.lastIndex - 2),
                      (W = T.slice(F, N + 1)),
                      (S = ["comment", W, V, F - q, V, N - q, "inline"]),
                      (F = N))
                    : ((P.lastIndex = F + 1),
                      P.test(T),
                      P.lastIndex === 0
                        ? (N = T.length - 1)
                        : (N = P.lastIndex - 2),
                      (S = ["word", T.slice(F, N + 1), V, F - q, V, N - q]),
                      ee.push(S),
                      (F = N));
                break;
            }
...
`) !== -1
              ...
              if (!i || m.trim() === "" || /^[a-zA-Z-:#]/.test(m))
                ...
                for (
                  k[4]
                    ? (O.source.end = { line: k[4], column: k[5] })
                    : (O.source.end = { line: k[2], column: k[3] });
                  a[0][0] !== "word";
                ...
                for (var $ = a.length - 1; $ > 0; $--) {
                  if (((P = a[$]), P[1] === "!important")) {
                    ...
                    (G = this.spacesFromEnd(a) + G),
                      G !== " !important" && (O.raws.important = G);
                    break;
                    ...
                    B.trim().indexOf("!") === 0 &&
                      ((O.important = !0), (O.raws.important = B), (a = Z));
                  }
            ...
            (t.comment = function (a) {
              if (a[6] === "inline") {
                ...
                this.init(i, a[2], a[3]),
                  (i.raws.inline = !0),
                  (i.source.end = { line: a[4], column: a[5] });
                var u = a[1].slice(2);
                if (/^\s*$/.test(u))
  ...
  Mf = R({
    "src/language-css/parser-postcss.js"(r, n) {
      ...
      var s = al(),
        ...
        o = Ns(),
        { hasPragma: p } = gl(),
        { locStart: f, locEnd: h } = ds(),
        { calculateLoc: g, replaceQuotesInInlineComments: l } = ds(),
        t = bl(),
        e = xl(),
        a = Sl(),
        i = kl(),
      ...
      function d(b, Y) {
        let { nodes: J } = b,
          W = { open: null, close: null, groups: [], type: "paren_group" },
          X = [W],
          C = W,
          Q = { groups: [], type: "comma_group" },
          M = [Q];
        for (let E = 0; E < J.length; ++E) {
          ...
          if (x.type === "paren" && x.value === "(")
            (W = { open: x, close: null, groups: [], type: "paren_group" }),
              X.push(W),
              (Q = { groups: [], type: "comma_group" }),
              M.push(Q);
          else if (x.type === "paren" && x.value === ")") {
            if (
              (Q.groups.length > 0 && W.groups.push(Q),
              (W.close = x),
              M.length === 1)
            )
      ...
      function D(b, Y) {
        if (b && typeof b == "object") {
          for (let J in b)
            J !== "parent" &&
              (D(b[J], Y),
              J === "nodes" && ((b.group = _(d(b, Y))), delete b[J]));
          delete b.parent;
        }
        return b;
      }
      ...
      function H(b, Y) {
        if (b && typeof b == "object") {
          ...
          if (typeof b.selector == "string") {
            var J;
            (C = b.raws.selector
              ? (J = b.raws.selector.scss) !== null && J !== void 0
                ? J
                : b.raws.selector.raw
              : b.selector),
              b.raws.between &&
          ...
          if (typeof b.value == "string") {
            var W;
            (Q = b.raws.value
              ? (W = b.raws.value.scss) !== null && W !== void 0
                ? W
                : b.raws.value.raw
              : b.value),
              (Q = Q.trim()),
          ...
          if (typeof b.params == "string") {
            var X;
            (M = b.raws.params
              ? (X = b.raws.params.scss) !== null && X !== void 0
                ? X
                : b.raws.params.raw
              : b.params),
              b.raws.afterName &&
                b.raws.afterName.trim().length > 0 &&
                (M = b.raws.afterName + M),
              b.raws.between &&
                b.raws.between.trim().length > 0 &&
                (M = M + b.raws.between),
              (M = M.trim()),
          ...
          if (C.trim().length > 0)
            return C.startsWith("@") && C.endsWith(":")
              ...
              : b.mixin
              ? ((b.selector = P(C, Y)), b)
              : (u(b) && (b.isSCSSNesterProperty = !0), (b.selector = $(C)), b);
          if (Q.length > 0) {
            let E = Q.match(Z);
            E &&
              ((Q = Q.slice(0, E.index)),
              (b.scssDefault = !0),
              E[0].trim() !== "!default" && (b.raws.scssDefault = E[0]));
            let x = Q.match(B);
            if (
              (x &&
                ((Q = Q.slice(0, x.index)),
                (b.scssGlobal = !0),
                x[0].trim() !== "!global" && (b.raws.scssGlobal = x[0])),
              Q.startsWith("progid:"))
            )
          ...
          if (
            (a(Y) &&
              ...
              b.extend &&
                !b.selector &&
                (delete b.value, (b.selector = $(Q.slice(7, -1))))),
            b.type === "css-atrule")
          ) {
            if (a(Y)) {
              if (b.mixin) {
            ...
            if (Y.parser === "css" && b.name === "custom-selector") {
              ...
              return (
                (b.customSelector = E),
                (b.selector = $(b.params.slice(E.length).trim())),
                delete b.params,
                b
              );
            }
          ...
          if (b.type === "css-atrule" && M.length > 0) {
            ...
            return E === "warn" || E === "error"
              ? ((b.params = { type: "media-unknown", value: M }), b)
              : E === "extend" || E === "nest"
              ? ((b.selector = $(M)), delete b.params, b)
              : E === "at-root"
              ? (/^\(\s*(?:without|with)\s*:.+\)$/s.test(M)
                  ? (b.params = P(M, Y))
                  : ((b.selector = $(M)), delete b.params),
                b)
              : y(x)
              ? ((b.import = !0), delete b.filename, (b.params = P(M, Y)), b)
              : [
                  "namespace",
                  "supports",
                  "if",
              ...
              ? ((M = M.replace(/(\$\S+?)(\s+)?\.{3}/, "$1...$2")),
                (M = M.replace(/^(?!if)(\S+)(\s+)\(/, "$1($2")),
                (b.value = P(M, Y)),
                delete b.params,
                b)
              : ["media", "custom-media"].includes(x)
              ? M.includes("#{")
                ? { type: "media-unknown", value: M }
                : ((b.params = G(M)), b)
              : ((b.params = M), b);
          }
        }
      ...
      function U(b, Y, J) {
        ...
        try {
          ...
          throw typeof x != "number"
            ? Q
            : s(`${M}: ${E}`, { start: { line: x, column: S } });
        }
        return (
          (C = H(O(C, "css-"), J)),
          g(C, Y),
          X &&
            ((X.source = { startOffset: 0, endOffset: X.raw.length }),
            C.nodes.unshift(X)),
          C
        );
      }
