...
var require_resolve_from = __commonJS({
  "node_modules/import-fresh/node_modules/resolve-from/index.js"(
    ...
    module2.exports.silent = (fromDir, moduleId) =>
      ...
      get strValue() {
        ...
        for (let i = start + 1; i < end - 1; ++i) {
          ...
          if (ch === "\n") {
            ...
            const { fold, offset, error } = PlainValue.Node.foldNewline(
              src,
              i,
              indent
            );
    ...
    var ParseContext = class {
      ...
      parseProps(offset) {
        ...
        if (
          lineHasProps &&
          ch === ":" &&
          PlainValue.Node.atBlank(src, offset + 1, true)
        )
          offset -= 1;
...
${indent}`
    ...
    function resolveNode(doc, node) {
      ...
      const { comments, hasAnchor, hasTag } = resolveNodeProps(
        doc.errors,
        node
      );
      if (hasAnchor) {
          ...
          case PlainValue.Type.MAP_VALUE:
            {
              ...
              if (
                ...
                doc.errors.push(
                  new PlainValue.YAMLSemanticError(item.node, msg)
                );
              }
              ...
              if (!valueNode && item.props.length > 0) {
                ...
                if (typeof item.range.origStart === "number") {
                  ...
                  valueNode.valueRange.origStart =
                    valueNode.valueRange.origEnd = origPos;
                }
              }
  ...
  "node_modules/yaml/dist/Schema-88e323a7.js"(exports2) {
    ...
    var yaml11 = failsafe.concat(
      [
        ...
        },
        {
          ...
          test: /^[-+]?(?:[0-9][0-9_]*)?\.([0-9_]*)$/,
          resolve(str, frac) {
            const node = new resolveSeq.Scalar(
    ...
    function createNode(value, tagName, ctx) {
      ...
      if (!tagObj) {
        ...
        tagObj =
          value instanceof Map ? map : value[Symbol.iterator] ? seq : map;
      }
      if (onTagObj) {
        onTagObj(tagObj);
        delete ctx.onTagObj;
...
var require_Document_9b4560a1 = __commonJS({
  "node_modules/yaml/dist/Document-9b4560a1.js"(exports2) {
    ...
    function stringify(item, ctx, onComment, onChompKeep) {
      ...
      if (!props) return str;
      return item instanceof resolveSeq.Scalar ||
        str[0] === "{" ||
        str[0] === "["
        ? `${props} ${str}`
        : `${props}
...
var require_path_type = __commonJS({
  "node_modules/path-type/index.js"(exports2) {
    ...
    exports2.isSymlinkSync = isTypeSync.bind(
      null,
      "lstatSync",
      "isSymbolicLink"
    );
  ...
  "node_modules/cosmiconfig/dist/Explorer.js"(exports2) {
    ...
    var Explorer = class extends _ExplorerBase.ExplorerBase {
      ...
      async search(searchFrom = process.cwd()) {
        const startDirectory = await (0, _getDirectory.getDirectory)(
          searchFrom
        );
      ...
      async createCosmiconfigResult(filepath, content) {
        ...
        const result = this.loadedContentToCosmiconfigResult(
          filepath,
          fileContent
        );
        return result;
