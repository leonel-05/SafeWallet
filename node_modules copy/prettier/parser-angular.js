  ...
  var Br = cr((Mr, ar) => {
    var ze = Object.defineProperty,
      ...
      q = (e, t) =>
        function () {
          return (
            t || (0, e[He(e)[0]])((t = { exports: {} }).exports, t), t.exports
          );
        },
      Xe = (e, t) => {
        for (var r in t) ze(e, r, { get: t[r], enumerable: !0 });
      },
      hr = (e, t, r, n) => {
      ...
      be = (e) => hr(ze({}, "__esModule", { value: !0 }), e),
      L = Y({ "<define:process>"() {} }),
      pr = q({
        ...
        "src/language-js/loc.js"(e, t) {
          ...
          function n(l) {
            ...
            let x = l.range ? l.range[0] : l.start,
              C =
                (P =
                  (p = l.declaration) === null || p === void 0
                    ? void 0
                    : p.decorators) !== null && P !== void 0
                  ? P
                  : l.decorators;
      ...
      fr = q({
        "node_modules/angular-estree-parser/node_modules/lines-and-columns/build/index.js"(
          e
        ) {
          "use strict";
              ...
              return (
                ...
                (s.prototype.indexForLocation = function (a) {
                  var i = a.line,
                    h = a.column;
                  return i < 0 ||
                    i >= this.offsets.length ||
                    h < 0 ||
                    h > this.lengthOfLine(i)
                    ? null
                    : this.offsets[i] + h;
                }),
      ...
      gr = q({
        "node_modules/angular-estree-parser/lib/context.js"(e) {
          ...
          var n = class {
            ...
            locationForIndex(s) {
              let { line: a, column: i } =
                this._lineAndColumn.locationForIndex(s);
          ...
          L(),
            ...
            (Le = class extends k {
              constructor(e, t, r, n, s) {
                super(e, t),
                  (this.prefix = r),
                  (this.uninterpretedExpression = n),
                  (this.location = s);
              }
              visit(e) {
                let t =
              ...
              visit(e) {
                let t =
                  arguments.length > 1 && arguments[1] !== void 0
                    ...
                    : null;
                var r;
                return (r = e.visitThisReceiver) === null || r === void 0
                  ? void 0
                  : r.call(e, this, t);
              }
            }),
            ...
            (G = class extends k {
              constructor(e, t, r, n, s) {
                super(
                  new V(0, t === null ? 0 : t.length),
                  new U(n, t === null ? n : n + t.length)
                ),
                  (this.ast = e),
                  (this.source = t),
                  (this.location = r),
            ...
            (Ct = class {
              ...
              visitInterpolation(e, t) {
                ...
                return r !== e.expressions
                  ? new me(e.span, e.sourceSpan, e.strings, r)
                  : e;
              }
              visitLiteralPrimitive(e, t) {
                return e;
              ...
              visitPropertyRead(e, t) {
                ...
                return r !== e.receiver
                  ? new ne(e.span, e.sourceSpan, e.nameSpan, r, e.name)
                  : e;
              }
              visitPropertyWrite(e, t) {
                let r = e.receiver.visit(this),
                  n = e.value.visit(this);
                return r !== e.receiver || n !== e.value
                  ? new ue(e.span, e.sourceSpan, e.nameSpan, r, e.name, n)
                  : e;
              }
              visitSafePropertyRead(e, t) {
                let r = e.receiver.visit(this);
                return r !== e.receiver
                  ? new le(e.span, e.sourceSpan, e.nameSpan, r, e.name)
                  : e;
              }
              visitMethodCall(e, t) {
                let r = e.receiver.visit(this),
                  n = this.visitAll(e.args);
                return r !== e.receiver || n !== e.args
                  ? new ye(
                      e.span,
                      e.sourceSpan,
                      e.nameSpan,
              ...
              visitFunctionCall(e, t) {
                let r = e.target && e.target.visit(this),
                  n = this.visitAll(e.args);
                return r !== e.target || n !== e.args
                  ? new Pe(e.span, e.sourceSpan, r, n)
                  : e;
              }
              visitLiteralArray(e, t) {
                let r = this.visitAll(e.expressions);
                return r !== e.expressions
                  ? new ge(e.span, e.sourceSpan, r)
                  : e;
              }
              visitLiteralMap(e, t) {
                let r = this.visitAll(e.values);
                return r !== e.values
                  ? new ve(e.span, e.sourceSpan, e.keys, r)
                  : e;
              }
              visitUnary(e, t) {
              ...
              visitBinary(e, t) {
                let r = e.left.visit(this),
                  n = e.right.visit(this);
                return r !== e.left || n !== e.right
                  ? new B(e.span, e.sourceSpan, e.operation, r, n)
                  : e;
              }
              visitPrefixNot(e, t) {
              ...
              visitConditional(e, t) {
                let r = e.condition.visit(this),
                  n = e.trueExp.visit(this),
                  s = e.falseExp.visit(this);
                return r !== e.condition || n !== e.trueExp || s !== e.falseExp
                  ? new ce(e.span, e.sourceSpan, r, n, s)
                  : e;
              }
              visitPipe(e, t) {
                let r = e.exp.visit(this),
                  n = this.visitAll(e.args);
                return r !== e.exp || n !== e.args
                  ? new fe(e.span, e.sourceSpan, r, e.name, n, e.nameSpan)
                  : e;
              }
              visitKeyedRead(e, t) {
                let r = e.receiver.visit(this),
                  n = e.key.visit(this);
                return r !== e.receiver || n !== e.key
                  ? new he(e.span, e.sourceSpan, r, n)
                  : e;
              }
              visitKeyedWrite(e, t) {
                let r = e.receiver.visit(this),
                ...
                return r !== e.receiver || n !== e.key || s !== e.value
                  ? new de(e.span, e.sourceSpan, r, n, s)
                  : e;
              }
              visitAll(e) {
                let t = [],
              ...
              scanToken() {
                ...
                switch (r) {
                  case H:
                    return (
                      this.advance(),
                      Q(this.peek) ? this.scanNumber(s) : xt(s, this.index, H)
                    );
                  case Ee:
                  case z:
                  case $e:
                ...
                return (
                  this.advance(),
                  this.error(
                    `Unexpected character [${String.fromCharCode(r)}]`,
                    0
                  )
                );
              }
    ...
    var qe,
          ...
          L(),
            ...
            (De = class {
              ...
              splitInterpolation(e, t) {
                ...
                if (!h)
                  if (l) {
                    ...
                    n.push({ text: e.substring(i), start: i, end: e.length });
                return new qe(n, s, a);
              }
              wrapLiteralPrimitive(e, t, r) {
                let n = new V(0, e == null ? 0 : e.length);
                return new G(
                  new $(n, n.toAbsolute(r), e),
                  e,
                  t,
                  r,
                  this.errors
              ...
              _checkNoInterpolation(e, t, r) {
                ...
                for (let h of this._forEachUnquotedChar(e, 0))
                  if (a === -1) e.startsWith(n) && (a = h);
                  else if (
                    ((i = this._getInterpolationEndIndex(e, s, h)), i > -1)
                  )
                    break;
                a > -1 &&
                  i > -1 &&
                  this._reportError(
                    `Got interpolation (${n}${s}) where expression was expected`,
                    e,
                    `at column ${a} in`,
                    t
                  );
              ...
              *_forEachUnquotedChar(e, t) {
                ...
                for (let s = t; s < e.length; s++) {
                  let a = e[s];
                  mt(e.charCodeAt(s)) && (r === null || r === a) && n % 2 === 0
                    ? (r = r === null ? a : null)
                    : r === null && (yield s),
                    (n = a === "\\" ? n + 1 : 0);
                }
            ...
            (D = class {
              ...
              span(e, t) {
                ...
                if (
                  (t !== void 0 && t > this.currentEndIndex && (r = t), e > r)
                ) {
                  let n = r;
                  (r = e), (e = n);
                }
              ...
              parseChain() {
                ...
                return e.length == 1
                  ? e[0]
                  : new oe(this.span(t), this.sourceSpan(t), e);
              }
              parsePipe() {
              ...
              parseConditional() {
                ...
                if (this.consumeOptionalOperator("?")) {
                  let r = this.parsePipe(),
                    n;
                  if (this.consumeOptionalCharacter(X)) n = this.parsePipe();
                  else {
                    ...
                    this.error(
                      ...
                      (n = new K(this.span(e), this.sourceSpan(e)));
                  }
                  ...
                  switch (t) {
                    case "+":
                      return (
                        this.advance(),
                        (r = this.parsePrefix()),
                        F.createPlus(this.span(e), this.sourceSpan(e), r)
                      );
                    case "-":
                      return (
                        this.advance(),
                        (r = this.parsePrefix()),
                        F.createMinus(this.span(e), this.sourceSpan(e), r)
                      );
                    case "!":
                      return (
                        this.advance(),
                        (r = this.parsePrefix()),
                        new xe(this.span(e), this.sourceSpan(e), r)
                      );
                  }
                }
                ...
                for (;;)
                  if (this.consumeOptionalCharacter(H))
                    ...
                    this.rparensExpected--,
                      ...
                      (t = new Pe(this.span(e), this.sourceSpan(e), t, r));
                  } else if (this.consumeOptionalOperator("!"))
              ...
              parsePrimary() {
                ...
                if (this.consumeOptionalCharacter(Ee)) {
                  ...
                  if (this.next.isKeywordNull())
                    return (
                      this.advance(),
                      new $(this.span(e), this.sourceSpan(e), null)
                    );
                  if (this.next.isKeywordUndefined())
                    return (
                      this.advance(),
                      new $(this.span(e), this.sourceSpan(e), void 0)
                    );
                  if (this.next.isKeywordTrue())
                    return (
                      this.advance(),
                      new $(this.span(e), this.sourceSpan(e), !0)
                    );
                  if (this.next.isKeywordFalse())
                    return (
                      this.advance(),
                      new $(this.span(e), this.sourceSpan(e), !1)
                    );
                  if (this.next.isKeywordThis())
                    return (
                      this.advance(), new Ye(this.span(e), this.sourceSpan(e))
                    );
                  if (this.consumeOptionalCharacter(Ae)) {
                    ...
                    if (this.next.isNumber()) {
                      ...
                      return (
                        this.advance(),
                        new $(this.span(e), this.sourceSpan(e), t)
                      );
                      ...
                      return this.next.isPrivateIdentifier()
                        ? (this._reportErrorForPrivateIdentifier(
                          ...
                          new K(this.span(e), this.sourceSpan(e)))
                        : this.index >= this.tokens.length
                        ? (this.error(
              ...
              parseLiteralMap() {
                let e = [],
                  ...
                  r = this.inputIndex;
                if (
                  (this.expectCharacter($e), !this.consumeOptionalCharacter(_e))
                ) {
              ...
              parseAccessMemberOrMethodCall(e, t, r) {
                let n = this.inputIndex,
                  s = this.withContext(Z.Writable, () => {
                    var i;
                    let h =
                      (i = this.expectIdentifierOrKeyword()) !== null &&
                      i !== void 0
                        ? i
                        : "";
                    return (
                ...
                if (this.consumeOptionalCharacter(Ee)) {
                  ...
                  let h = this.parseCallArguments(),
                    l = this.span(i, this.inputIndex).toAbsolute(
                      this.absoluteOffset
                    );
                  ...
                  let P = this.span(t),
                    p = this.sourceSpan(t);
                  return r
                    ? new we(P, p, a, e, s, h, l)
                    : new ye(P, p, a, e, s, h, l);
                } else {
                  if (r)
              ...
              parseKeyedReadOrWrite(e, t, r) {
                return this.withContext(Z.Writable, () => {
                  ...
                  if (
                    (n instanceof K && this.error("Key access cannot be empty"),
                    this.rbracketsExpected--,
                    this.expectCharacter(re),
                    ...
                    return r
                      ? new pe(this.span(t), this.sourceSpan(t), e, n)
                      : new he(this.span(t), this.sourceSpan(t), e, n);
              ...
              consumeStatementTerminator() {
                this.consumeOptionalCharacter(te) ||
                  this.consumeOptionalCharacter(ee);
              }
              error(e) {
                let t =
                  arguments.length > 1 && arguments[1] !== void 0
                    ...
                    : null;
                this.errors.push(
                  new ae(e, this.input, this.locationText(t), this.location)
                ),
                  this.skip();
              }
              locationText() {
              ...
              skip() {
                ...
                for (
                  ...
                  (this.rbracketsExpected <= 0 || !e.isCharacter(re)) &&
      ...
      ft = q({
        "node_modules/angular-estree-parser/lib/utils.js"(e) {
          ...
          function l(o, d) {
            let y = h(),
              { astInput: E, comments: A } = T(o, y),
              { ast: I, errors: j } = d(E, y);
          ...
          function C(o) {
            let d = h(),
              { templateBindings: y, errors: E } = d.parseTemplateBindings(
                e.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX,
                o,
                s,
                a,
          ...
          function b(o) {
            let d = h(),
              { astInput: y, comments: E } = T(o, d),
              A = "{{",
              I = "}}",
              { ast: j, errors: or } = d.parseInterpolation(A + y + I, ...i);
            R(or);
            let gt = j.expressions[0],
              vt = new Set();
            return (
              _(gt, (ke) => {
                vt.has(ke) ||
                  ((ke.start -= A.length), (ke.end -= A.length), vt.add(ke));
              }),
              { ast: gt, comments: E }
            );
          }
          ...
          function R(o) {
            if (o.length !== 0) {
              ...
              throw new SyntaxError(
                d.replace(/^Parser Error: | at column \d+ in [^]*$/g, "")
              );
            }
          }
          function T(o, d) {
          ...
          function g(o, d) {
            return d[o.start - 1] === "(" && d[o.end] === ")"
              ? { start: o.start - 1, end: o.end + 1 }
              : o;
          }
          function u(o, d, y) {
            let E = 0,
              A = { start: o.start, end: o.end };
            for (;;) {
              let I = c(A, d),
                j = g(I, d);
          ...
          function v(o, d, y) {
            ...
            for (; !o.test(y[E]); )
              if (--E < 0)
                throw new Error(
                  `Cannot find front char ${o} from index ${d} in ${JSON.stringify(
                    y
                  )}`
                );
            return E;
          ...
          function m(o, d, y) {
            ...
            for (; !o.test(y[E]); )
              if (++E >= y.length)
                throw new Error(
                  `Cannot find back char ${o} from index ${d} in ${JSON.stringify(
                    y
                  )}`
                );
            return E;
        ...
        "node_modules/angular-estree-parser/lib/transform.js"(e) {
          ...
          var t = ft(),
            r = function (s, a) {
              ...
              switch (h) {
                case "Unary": {
                  let { operator: c, expr: g } = s,
                    u = l(g);
                  return p(
                    "UnaryExpression",
                    { prefix: !0, argument: u, operator: c },
                    s.span,
                    { hasParentParens: i }
                  );
                }
                case "Binary": {
                  let { left: c, operation: g, right: u } = s,
                    v = u.span.start === u.span.end,
                    m = c.span.start === c.span.end;
                  if (v || m) {
                    let o = c.span.start === c.span.end ? l(u) : l(c);
                    return p(
                      "UnaryExpression",
                      { prefix: !0, argument: o, operator: v ? "+" : "-" },
                  ...
                  return p(
                    g === "&&" || g === "||"
                      ? "LogicalExpression"
                      : "BinaryExpression",
                    { left: f, right: w, operator: g },
                    { start: O(f), end: N(w) },
                    { hasParentParens: i }
                  );
                }
                case "BindingPipe": {
                  let { exp: c, name: g, args: u } = s,
                    v = l(c),
                    m = b(/\S/, b(/\|/, N(v)) + 1),
                    f = p(
                      "Identifier",
                      { name: g },
                      { start: m, end: m + g.length }
                    ),
                    w = u.map(l);
                  return p(
                    "NGPipeExpression",
                    { left: v, right: f, arguments: w },
                    { start: O(v), end: N(w.length === 0 ? f : t.getLast(w)) },
                    { hasParentParens: i }
                  );
                }
                case "Chain": {
                ...
                case "Comment": {
                  let { value: c } = s;
                  return p("CommentLine", { value: c }, s.span, {
                    processSpan: !1,
                  });
                }
                case "Conditional": {
                  let { condition: c, trueExp: g, falseExp: u } = s,
                    v = l(c),
                    m = l(g),
                    f = l(u);
                  return p(
                    "ConditionalExpression",
                    { test: v, consequent: m, alternate: f },
                    { start: O(v), end: N(f) },
                    { hasParentParens: i }
                  );
                }
                ...
                case "FunctionCall": {
                  let { target: c, args: g } = s,
                    u = g.length === 1 ? [P(g[0])] : g.map(l),
                    v = l(c);
                  return p(
                    "CallExpression",
                    { callee: v, arguments: u },
                    { start: O(v), end: s.span.end },
                    { hasParentParens: i }
                  );
                }
                ...
                case "KeyedRead": {
                  let { key: c } = s,
                    g = Object.prototype.hasOwnProperty.call(s, "receiver")
                      ? s.receiver
                      : s.obj,
                    u = l(c);
                  return x(
                    ...
                    { end: s.span.end, hasParentParens: i }
                  );
                }
                case "LiteralArray": {
                  let { expressions: c } = s;
                  return p("ArrayExpression", { elements: c.map(l) }, s.span, {
                    hasParentParens: i,
                  });
                }
                case "LiteralMap": {
                  let { keys: c, values: g } = s,
                    u = g.map((m) => l(m)),
                    v = c.map((m, f) => {
                      let { key: w, quoted: o } = m,
                        d = u[f],
                        y = b(
                          /\S/,
                          f === 0 ? s.span.start + 1 : b(/,/, N(u[f - 1])) + 1
                        ),
                        E = C(/\S/, C(/:/, O(d) - 1) - 1) + 1,
                        A = { start: y, end: E },
                        I = o
                          ? p("StringLiteral", { value: w }, A)
                          : p("Identifier", { name: w }, A),
                        j = I.end < I.start;
                      return p(
                        "ObjectProperty",
                        {
                  ...
                  return p("ObjectExpression", { properties: v }, s.span, {
                    hasParentParens: i,
                  });
                }
                case "LiteralPrimitive": {
                  ...
                  switch (typeof c) {
                    case "boolean":
                      return p("BooleanLiteral", { value: c }, s.span, {
                        hasParentParens: i,
                      });
                    case "number":
                      return p("NumericLiteral", { value: c }, s.span, {
                        hasParentParens: i,
                      });
                    case "object":
                    ...
                    case "string":
                      return p("StringLiteral", { value: c }, s.span, {
                        hasParentParens: i,
                      });
                    case "undefined":
                      return p("Identifier", { name: "undefined" }, s.span, {
                        hasParentParens: i,
                      });
                    default:
                      throw new Error(
                  ...
                  let c = h === "SafeMethodCall",
                    ...
                    f =
                      C(
                        ...
                        C(
                          /\(/,
                          (m.length === 0 ? C(/\)/, s.span.end - 1) : O(m[0])) -
                            1
                        ) - 1
                      ) + 1,
                    w = p(
                      "Identifier",
                      { name: u },
                      { start: f - u.length, end: f }
                    ),
                    o = x(g, w, { computed: !1, optional: c }),
                    d = R(o);
                  return p(
                    c || d ? "OptionalCallExpression" : "CallExpression",
                    { callee: o, arguments: m },
                    { start: O(o), end: s.span.end },
                    { hasParentParens: i }
                  );
                }
                case "NonNullAssert": {
                ...
                case "PrefixNot": {
                  ...
                  return p(
                    "UnaryExpression",
                    { prefix: !0, operator: "!", argument: g },
                    { start: s.span.start, end: N(g) },
                    { hasParentParens: i }
                  );
                }
                case "PropertyRead":
                case "SafePropertyRead": {
                  let c = h === "SafePropertyRead",
                    { receiver: g, name: u } = s,
                    v = C(/\S/, s.span.end - 1) + 1,
                    m = p(
                      "Identifier",
                      { name: u },
                      { start: v - u.length, end: v },
                      _(g) ? { hasParentParens: i } : {}
                    );
                  return x(
                    g,
                    m,
                    { computed: !1, optional: c },
                    { hasParentParens: i }
                  );
                }
                case "KeyedWrite": {
                  let { key: c, value: g } = s,
                    u = Object.prototype.hasOwnProperty.call(s, "receiver")
                      ? s.receiver
                      : s.obj,
                    v = l(c),
                    m = l(g),
                  ...
                  return p(
                    ...
                    { left: f, operator: "=", right: m },
                    { start: O(f), end: N(m) },
                    { hasParentParens: i }
                  );
                }
                case "PropertyWrite": {
                  let { receiver: c, name: g, value: u } = s,
                    v = l(u),
                    m = C(/\S/, C(/=/, O(v) - 1) - 1) + 1,
                    f = p(
                      "Identifier",
                      { name: g },
                      { start: m - g.length, end: m }
                    ),
                    w = x(c, f, { computed: !1, optional: !1 });
                  return p(
                    "AssignmentExpression",
                    { left: w, operator: "=", right: v },
                    { start: O(w), end: N(v) },
                    { hasParentParens: i }
                  );
                }
              ...
              function p(c, g, u) {
                let { processSpan: v = !0, hasParentParens: m = !1 } =
                    arguments.length > 3 && arguments[3] !== void 0
                      ? arguments[3]
                      : {},
                  f = Object.assign(
                    Object.assign({ type: c }, n(u, a, v, m)),
                    g
                  );
                switch (c) {
                  case "Identifier": {
              ...
              function x(c, g, u) {
                let { end: v = N(g), hasParentParens: m = !1 } =
                  arguments.length > 3 && arguments[3] !== void 0
                    ? arguments[3]
                    : {};
                ...
                return p(
                  u.optional || w
                    ...
                    : "MemberExpression",
                  Object.assign(
                    { object: f, property: g, computed: u.computed },
              ...
              function _(c) {
                return (
                  ...
                  /^\s+$/.test(a.text.slice(c.span.start, c.span.end))
                );
              }
              function R(c) {
                return (
        ...
        "node_modules/angular-estree-parser/lib/transform-microsyntax.js"(e) {
          ...
          function s(a, i) {
            ...
            let [h] = a,
              { key: l } = h,
              P =
                i.text.slice(h.sourceSpan.start, h.sourceSpan.end).trim()
                  .length === 0
                  ? a.slice(1)
                  : a,
              p = [],
              ...
              if (
                ...
                let m = _(
                  ...
                  f = (d, y) =>
                    Object.assign(
                      Object.assign({}, d),
                      r.transformSpan({ start: d.start, end: y }, i)
                    ),
                  w = (d) =>
                    Object.assign(Object.assign({}, f(d, m.end)), { alias: m }),
                  o = p.pop();
                if (o.type === "NGMicrosyntaxExpression") p.push(w(o));
                  ...
                  p.push(
                    f(
                      Object.assign(Object.assign({}, o), { expression: d }),
                      d.end
                    )
                  );
            ...
            return _(
              ...
              p.length === 0
                ? a[0].sourceSpan
                : { start: p[0].start, end: p[p.length - 1].end }
            );
            function C(u, v) {
              if (T(u)) {
                let { key: m, value: f } = u;
                return f
                  ? v === 0
                    ...
                    : _(
                        ...
                        { start: m.span.start, end: f.sourceSpan.end }
                      )
                ...
                if (/^let\s$/.test(i.text.slice(f.start, f.start + 4))) {
                  ...
                  return _(
                    "NGMicrosyntaxLet",
                    {
                      ...
                      value: o
                        ? _("NGMicrosyntaxKey", { name: o.source }, o.span)
                        : null,
                    },
            ...
            function _(u, v, m) {
              let f =
                arguments.length > 3 && arguments[3] !== void 0
                  ...
                  : !0;
              return Object.assign(
                Object.assign({ type: u }, r.transformSpan(m, i, f)),
                v
              );
            }
            function R(u) {
            ...
            function g(u) {
              if (
                !u.value ||
                u.value.source !== n.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX
              )
                return u.value;
      ...
      Rr = q({
        "node_modules/angular-estree-parser/lib/index.js"(e) {
          ...
          e.parseAction = P;
          function p(x) {
            return n.transformTemplateBindings(
              s.parseNgTemplateBindings(x),
              new t.Context(x)
            );
          }
            ...
            node:
              s.parser === "__ng_action" && i.type !== "NGChainedExpression"
                ? Object.assign(
                    Object.assign({}, i),
                    {},
                    { type: "NGChainedExpression", expressions: [i] }
                  )
                : i,
          };
        },
