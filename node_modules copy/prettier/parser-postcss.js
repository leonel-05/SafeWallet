(function (e) {
  ...
  var Cr = U((Rp, dn) => {
    var Rr = typeof document == "object" && document.all,
      ja = typeof Rr > "u" && Rr !== void 0;
    dn.exports = { all: Rr, IS_HTMLDDA: ja };
  });
  var he = U((Cp, mn) => {
    var vn = Cr(),
      Ma = vn.all;
    mn.exports = vn.IS_HTMLDDA
      ? function (e) {
  ...
  var In = U((Lp, Pn) => {
    ...
    qn &&
      ((de = qn.split(".")),
      (sr = de[0] > 0 && de[0] < 4 ? 1 : +(de[0] + de[1])));
    !sr &&
      jr &&
      ((de = jr.match(/Edge\/(\d+)/)),
      (!de || de[1] >= 74) &&
        ((de = jr.match(/Chrome\/(\d+)/)), de && (sr = +de[1])));
    Pn.exports = sr;
  });
  var Mr = U((zp, Cn) => {
    var Rn = In(),
  ...
  var $n = U((Vp, Un) => {
    ...
    Un.exports = function (e, n) {
      var i, u;
      if (
        (n === "string" && Br((i = e.toString)) && !Fr((u = zr(i, e)))) ||
        (Br((i = e.valueOf)) && !Fr((u = zr(i, e)))) ||
        (n !== "string" && Br((i = e.toString)) && !Fr((u = zr(i, e))))
      )
        return u;
  ...
  var or = U((Hp, Hn) => {
    ...
    Hn.exports = function (e, n) {
      try {
        tu(Gn, e, { value: n, configurable: !0, writable: !0 });
      } catch {
        Gn[e] = n;
      }
      return n;
  ...
  var fi = U((eh, li) => {
    ...
    li.exports = function (e, n) {
      ...
      if (i) {
        if (
          (n === void 0 && (n = "default"), (u = _u(i, e, n)), !ui(u) || ci(u))
        )
          return u;
  ...
  var Gr = U((nh, mi) => {
    ...
    mi.exports =
      ...
      !Iu(function () {
        return (
          Object.defineProperty(Ru("div"), "a", {
            get: function () {
              return 7;
            },
          }).a != 7
  ...
  var $i = U((vh, Ui) => {
    var wc = be(),
      ...
      Oc =
        at &&
        !wc(function () {
          return hr(function () {}, "length", { value: 8 }).length !== 8;
        }),
      ...
      Ec = (Ui.exports = function (e, n, i) {
        String(n).slice(0, 7) === "Symbol(" &&
          ...
          i && i.getter && (n = "get " + n),
          i && i.setter && (n = "set " + n),
          (!pr(e, "name") || (bc && e.name !== n)) &&
            (at ? hr(e, "name", { value: n, configurable: !0 }) : (e.name = n)),
          Oc &&
            i &&
            pr(i, "arity") &&
            e.length !== i.arity &&
            hr(e, "length", { value: i.arity });
        try {
          i && pr(i, "constructor") && i.constructor
            ? at && hr(e, "prototype", { writable: !1 })
            : e.prototype && (e.prototype = void 0);
        } catch {}
        var u = Sc(e);
        return (
          pr(u, "source") ||
            (u.source = Tc.join(typeof n == "string" ? n : "")),
          e
        );
      });
  ...
  var ns = U((xh, ts) => {
    ...
    ts.exports = { includes: rs(!0), indexOf: rs(!1) };
  });
  var os = U((Sh, ss) => {
    var Wc = xe(),
      ct = Te(),
      ...
      if (
        ...
        for (p in n) {
          if (
            ((c = n[p]),
            e.dontCallGetSet
              ? ((t = hl(l, p)), (m = t && t.value))
              : (m = l[p]),
            (h = yl(u ? p : i + (o ? "." : "#") + p, e.forced)),
            !h && m !== void 0)
          ) {
  ...
  var xs = U(() => {
    var wl = bs(),
      ft = pe();
    wl({ global: !0, forced: ft.globalThis !== ft }, { globalThis: ft });
  });
  var Ss = U(() => {
    xs();
  });
  var gp = U((Fh, wa) => {
    ...
    var Et = Object.defineProperty,
      ...
      P = (e, n) =>
        function () {
          return (
            n || (0, e[qt(e)[0]])((n = { exports: {} }).exports, n), n.exports
          );
        },
      At = (e, n) => {
        for (var i in n) Et(e, i, { get: n[i], enumerable: !0 });
      },
      xl = (e, n, i, u) => {
      ...
      Pt = (e) => xl(Et({}, "__esModule", { value: !0 }), e),
      A = Le({ "<define:process>"() {} }),
      Sl = P({
      ...
      Al = P({
        "node_modules/jest-docblock/build/index.js"(e) {
          ...
          function v(d) {
            ...
            for (; (I = t.exec(d)); ) {
              let W = I[2].replace(p, "");
              typeof x[I[1]] == "string" || Array.isArray(x[I[1]])
                ? (x[I[1]] = a.concat(x[I[1]], W))
                : (x[I[1]] = W);
            }
            return { comments: N, pragmas: x };
          }
          function y(d) {
            let { comments: _ = "", pragmas: k = {} } = d,
...
`);
      ...
      Rl = P({
        "src/language-js/pragma.js"(e, n) {
          "use strict";
          A();
          var { parseWithComments: i, strip: u, extract: o, print: h } = Al(),
            { normalizeEndOfLine: l } = Pl(),
            p = Il();
          function m(r) {
            let a = p(r);
            a && (r = r.slice(a.length + 1));
            let s = o(r),
              { pragmas: f, comments: g } = i(s);
          ...
          function t(r) {
            let { shebang: a, text: s, pragmas: f, comments: g } = m(r),
              v = u(s),
              y = h({
...
`,
      ...
      no = P({
        "src/language-css/loc.js"(e, n) {
          "use strict";
          A();
          var { skipEverythingButNewLine: i } = Nl(),
            u = Us(),
            o = jl();
          function h(s, f) {
            return typeof s.sourceIndex == "number"
              ? s.sourceIndex
              : s.source
              ? o(s.source.start, f) - 1
              : null;
          }
          function l(s, f) {
            ...
            return (
              g && s.source && !s.source.end && (s = g),
              s.source && s.source.end ? o(s.source.end, f) : null
            );
          }
          function p(s, f) {
            s.source &&
              ((s.source.startOffset = h(s, f)),
              (s.source.endOffset = l(s, f)));
            for (let g in s) {
              let v = s[g];
              g === "source" ||
                !v ||
                ...
                (v.type === "value-root" || v.type === "value-unknown"
                  ? m(v, c(s), v.text || v.value)
                  : p(v, f));
            }
          }
          function m(s, f, g) {
            s.source &&
              ((s.source.startOffset = h(s, g) + f),
              (s.source.endOffset = l(s, g) + f));
            for (let v in s) {
              let y = s[v];
            ...
            return (
              ...
              s.type === "css-atrule" &&
                ...
                (f +=
                  1 +
                  s.name.length +
                  s.raws.afterName.match(/^\s*:?\s*/)[0].length),
              s.type !== "css-atrule" &&
                s.raws &&
                typeof s.raws.between == "string" &&
                (f += s.raws.between.length),
              f
            );
          }
          function t(s) {
        ...
        "src/language-css/utils/stringify-node.js"(e, n) {
          ...
          function i(u) {
            ...
            if (u.groups) {
              var p, m, c;
              let y =
                  ((p = u.open) === null || p === void 0 ? void 0 : p.value) ||
                  "",
                w = u.groups
                  .map((_) => i(_))
                  .join(
                    ((m = u.groups[0]) === null || m === void 0
                      ? void 0
                      : m.type) === "comma_group"
                      ? ","
                      : ""
                ...
                d =
                  ((c = u.close) === null || c === void 0 ? void 0 : c.value) ||
                  "";
              return y + w + d;
            }
            let t =
                ((o = u.raws) === null || o === void 0 ? void 0 : o.before) ||
                "",
              r =
                ((h = u.raws) === null || h === void 0 ? void 0 : h.quote) ||
                "",
              a = u.type === "atword" ? "@" : "",
              s = u.value || "",
              f = u.unit || "",
              g = u.group ? i(u.group) : "",
              v =
                ((l = u.raws) === null || l === void 0 ? void 0 : l.after) ||
                "";
...
`
            ...
            u = class extends i {
              ...
              insertAfter(o, h) {
                ...
                for (let m in this.indexes)
                  (p = this.indexes[m]),
                    l <= p && (this.indexes[m] = p + this.nodes.length);
                return this;
              }
              insertBefore(o, h) {
                let l = this.index(o),
    ...
    function Hl() {
      !Ne ||
        !Ce ||
        ((Ne = !1),
        Ce.length ? (me = Ce.concat(me)) : (We = -1),
        me.length && _o());
    }
    function _o() {
      if (!Ne) {
    ...
    function Zl(e) {
      var n = xo.call(Ie) * 0.001,
        i = Math.floor(n),
        u = Math.floor((n % 1) * 1e9);
      return (
        e && ((i = i - e[0]), (u = u - e[1]), u < 0 && (i--, (u += 1e9))),
        [i, u]
      );
    }
    function ef() {
      ...
      rf = Le({
        "node-modules-polyfills:process"() {
          A(),
            (Se = go),
            (ke = yo),
            typeof globalThis.setTimeout == "function" && (Se = setTimeout),
            typeof globalThis.clearTimeout == "function" && (ke = clearTimeout),
            (me = []),
            (Ne = !1),
            (We = -1),
    ...
    function wr(e) {
      ...
      for (
        var i = 1,
          u = arguments,
          o = u.length,
          h = String(e).replace(Ro, function (p) {
            if (p === "%%") return "%";
            if (i >= o) return p;
            switch (p) {
              case "%s":
    ...
    function nf(e, n) {
      var i = ye.styles[n];
      return i
        ? "\x1B[" + ye.colors[i][0] + "m" + e + "\x1B[" + ye.colors[i][1] + "m"
        : e;
    }
    function sf(e, n) {
      return e;
    ...
    function mr(e, n, i) {
      ...
      if (
        ...
        He(n) && (h.indexOf("message") >= 0 || h.indexOf("description") >= 0))
      )
        return ht(n);
      if (h.length === 0) {
        if (Je(n)) {
      ...
      if (
        (Ge(n) && (m = " " + RegExp.prototype.toString.call(n)),
        gr(n) && (m = " " + Date.prototype.toUTCString.call(n)),
        He(n) && (m = " " + ht(n)),
        h.length === 0 && (!c || n.length == 0))
      )
        return t[0] + m + t[1];
      if (i < 0)
        return Ge(n)
    ...
    function xt(e, n, i, u, o, h) {
      var l, p, m;
      if (
        ((m = Object.getOwnPropertyDescriptor(n, o) || { value: n[o] }),
        m.get
          ? m.set
            ? (p = e.stylize("[Getter/Setter]", "special"))
            : (p = e.stylize("[Getter]", "special"))
          : m.set && (p = e.stylize("[Setter]", "special")),
        Io(u, o) || (l = "[" + o + "]"),
        p ||
          (e.seen.indexOf(m.value) < 0
            ? (Ke(i) ? (p = mr(e, m.value, null)) : (p = mr(e, m.value, i - 1)),
              p.indexOf(`
`) > -1 &&
                (h
                  ? (p = p
          ...
          var i = class extends Error {
            constructor(u) {
              super(u),
                ...
                (this.message = u || "An error ocurred while tokzenizing."),
                typeof Error.captureStackTrace == "function"
                  ? Error.captureStackTrace(this, this.constructor)
                  : (this.stack = new Error(u).stack);
            }
          };
          n.exports = i;
        },
...
`.charCodeAt(0),
          ...
          n.exports = function (Q, K) {
            ...
            for (; S < Y; ) {
              switch (
                ((q = M.charCodeAt(S)), q === y && ((G = S), (E += 1)), q)
              ) {
                case y:
                case w:
                case _:
                ...
                case d:
                  ...
                  J.push(["space", M.slice(S, T), E, S - G, E, T - G, S]),
                    (S = T - 1);
                  break;
                case a:
                  (T = S + 1),
                    J.push(["colon", M.slice(S, T), E, S - G, E, T - G, S]),
                    (S = T - 1);
                  break;
                case r:
                  (T = S + 1),
                    J.push(["comma", M.slice(S, T), E, S - G, E, T - G, S]),
                    (S = T - 1);
                  break;
                case i:
                ...
                case p:
                  ...
                  do
                    for (
                      ...
                      (oe -= 1), (ne = !ne);
                  while (ne);
                  J.push(["string", M.slice(S, T + 1), E, S - G, E, T - G, S]),
                    (S = T);
                  break;
                case x:
                  (V.lastIndex = S + 1),
                ...
                case m:
                  (T = S),
                    ...
                    ue &&
                      ...
                      q !== d &&
                      (T += 1),
                    J.push(["word", M.slice(S, T + 1), E, S - G, E, T - G, S]),
                    (S = T);
                  break;
                case g:
                case f:
                case s:
                  ...
                  if (q === f && ie.charCodeAt(0) === f) {
                    T++,
                      J.push(["word", M.slice(S, T), E, S - G, E, T - G, S]),
                      (S = T - 1);
                    break;
                  }
                  J.push(["operator", M.slice(S, T), E, S - G, E, T - G, S]),
                    (S = T - 1);
                  break;
                default:
                  if (
...
`)),
                      (ee = z.length - 1),
                      ee > 0
                        ? ((le = E + ee), (re = T - z[ee].length))
                        : ((le = E), (re = G)),
                      J.push(["comment", te, E, S - G, le, T - re, S]),
                      (G = re),
                      (E = le),
                      (S = T);
                  } else if (q === v && !j.test(M.slice(S + 1, S + 2)))
                    (T = S + 1),
                      J.push(["#", M.slice(S, T), E, S - G, E, T - G, S]),
                      (S = T - 1);
      ...
      Do = P({
        "node_modules/uniq/uniq.js"(e, n) {
          ...
          function u(h) {
            for (
              var l = 1, p = h.length, m = h[0], c = h[0], t = 1;
              t < p;
              ++t, c = m
            )
              if (((c = m), (m = h[t]), m !== c)) {
        ...
        "node_modules/postcss-values-parser/lib/errors/ParserError.js"(e, n) {
          ...
          var i = class extends Error {
            constructor(u) {
              super(u),
                (this.name = this.constructor.name),
                (this.message = u || "An error ocurred while parsing."),
                typeof Error.captureStackTrace == "function"
                  ? Error.captureStackTrace(this, this.constructor)
                  : (this.stack = new Error(u).stack);
            }
        ...
        "node_modules/postcss-values-parser/lib/parser.js"(e, n) {
          ...
          n.exports = class {
            ...
            colon() {
              ...
              this.newNode(
                new h({
                  value: x[1],
                  source: {
                    start: { line: x[2], column: x[3] },
                    end: { line: x[4], column: x[5] },
                  },
                  sourceIndex: x[6],
                })
              ),
            ...
            parenOpen() {
              ...
              if (
                (x && this.error("Expected closing parenthesis", I),
                (W = this.current.last),
                W &&
                  W.type === "func" &&
                  W.unbalanced < 0 &&
                  ((W.unbalanced = 0), (this.current = W)),
                this.current.unbalanced++,
                this.newNode(
                  new r({
                    value: I[1],
                    source: {
                      start: { line: I[2], column: I[3] },
                      end: { line: I[4], column: I[5] },
                    },
                    sourceIndex: I[6],
                  })
                ),
              ...
              this.newNode(
                ...
                !(
                  ...
                  this.current.unbalanced < 0 &&
                    this.error("Expected opening parenthesis", x),
                  !this.current.unbalanced &&
                    this.cache.length &&
                  ...
                  if (~$.indexOf(D))
                    j = new o({
                      ...
                      source: {
                        start: {
                          line: this.currToken[2],
                          column: this.currToken[3] + D,
                        },
                        end: {
                          line: this.currToken[4],
                          column: this.currToken[3] + (B - 1),
                        },
                      },
                      sourceIndex: this.currToken[6] + H[V],
                    });
            ...
            string() {
              let x = this.currToken,
                ...
                $ = "",
                H;
              W && (($ = N.match(I)[0]), (N = N.slice(1, N.length - 1))),
                (H = new a({
                  value: N,
                  source: {
                    start: { line: x[2], column: x[3] },
            ...
            newNode(x) {
              return (
                this.spaces &&
                  ((x.raws.before += this.spaces), (this.spaces = "")),
                this.current.append(x)
              );
            }
            get currToken() {
            ...
            return (
              ...
              (f.prototype.split = function (v) {
                ...
                return this.reduce(function (d, _, k) {
                  ...
                  return (
                    w.push(_),
                    x ? (d.push(w), (w = [])) : k === y.length - 1 && d.push(w),
                    d
                  );
                }, []);
              }),
              ...
              (r.prototype.toString = function () {
                ...
                return (
                  ...
                  this.raws.insensitive
                    ? s.push(this.raws.insensitive)
                    : this.insensitive && s.push(" i"),
                  s.push("]"),
        ...
        "node_modules/postcss-selector-parser/dist/tokenize.js"(e, n) {
          ...
          function H(D) {
            for (
              ...
              switch (
                ((O = B.charCodeAt(b)), O === l && ((E = b), (S += 1)), O)
              ) {
                case l:
                case p:
                case c:
                ...
                case f:
                  ...
                  V.push(["combinator", B.slice(b, j), S, b - E, b]),
                    (b = j - 1);
                  break;
                case k:
                  V.push(["*", "*", S, b - E, b]);
                ...
                case u:
                  ...
                  do
                    for (
                      ...
                      (Y -= 1), (M = !M);
                  while (M);
                  V.push(["string", B.slice(b, j + 1), S, b - E, S, j - E, b]),
                    (b = j);
                  break;
                case I:
                  (W.lastIndex = b + 1),
                ...
                case o:
                  ...
                  (O = B.charCodeAt(j + 1)),
                    Q &&
                      ...
                      O !== m &&
                      (j += 1),
                    V.push(["word", B.slice(b, j + 1), S, b - E, S, j - E, b]),
                    (b = j);
                  break;
                default:
                  O === h && B.charCodeAt(b + 1) === k
                    ? ((j = B.indexOf("*/", b + 2) + 1),
                      j === 0 && L("comment", "*/"),
                      (Z = B.slice(b, j + 1)),
                      (R = Z.split(`
`)),
                      (X = R.length - 1),
                      X > 0
                        ? ((K = S + X), (J = j - R[X].length))
                        : ((K = S), (J = E)),
                      V.push(["comment", Z, S, b - E, K, j - J, b]),
                      (E = J),
                      (S = K),
                      (b = j))
                    : (($.lastIndex = b + 1),
        ...
        "node_modules/postcss-selector-parser/dist/parser.js"(e, n) {
          ...
          var G = (function () {
            function E(S) {
              Y(this, E),
                (this.input = S),
                (this.lossy = S.options.lossless === !1),
                (this.position = 0),
              ...
              return (
                ...
                (this.current = b),
                this.lossy
                  ? (this.tokens = (0, Z.default)({
                      safe: S.safe,
                      css: S.css.trim(),
                    }))
                  : (this.tokens = (0, Z.default)(S)),
                this.loop()
              );
            }
            return (
              (E.prototype.attribute = function () {
                ...
                if (
                  ...
                  var ee = T[2].split(/(\s+i\s*?)$/),
                    te = ee[0].trim();
                  (L.value = this.lossy ? te : ee[0]),
                    ee[1] &&
                      ((L.insensitive = !0),
                      this.lossy || (L.raws.insensitive = ee[1])),
                    (L.quoted = te[0] === "'" || te[0] === '"'),
                    (L.raws.unquoted = L.quoted ? te.slice(1, -1) : te);
                }
              ...
              (E.prototype.combinator = function () {
                ...
                for (
                  ...
                  this.nextToken && this.nextToken[0] === "combinator"
                    ...
                    : this.currToken[0] === "space" &&
                      (b.value = this.parseSpace(this.currToken[1], " ")),
                    this.position++;
                    ...
                    this.currToken[0] === "(" && T++,
                      ...
                      T
                        ...
                        : ((L.parent.source.end.line = this.currToken[2]),
                          ...
                          this.position++);
                  T && this.error("Expected closing parenthesis."),
                    (this.current = q);
                } else {
                  var F = 1;
                  for (
                    this.position++, b.value += "(";
                    this.position < this.tokens.length && F;
              ...
              (E.prototype.space = function () {
                ...
                this.prevToken[0] === "("
                  ...
                  : this.position === this.tokens.length - 1 ||
                    this.nextToken[0] === "," ||
                    this.nextToken[0] === ")"
                  ? ((this.current.last.spaces.after = this.parseSpace(b[1])),
                    this.position++)
                  : this.combinator();
              }),
              (E.prototype.string = function () {
                ...
                this.newNode(
                  new x.default({
                    value: this.currToken[1],
                    source: {
                      start: { line: b[2], column: b[3] },
                      end: { line: b[4], column: b[5] },
                    },
                    sourceIndex: b[6],
                  })
                ),
              ...
              (E.prototype.splitWord = function (b, L) {
                for (
                  var q = this, T = this.nextToken, F = this.currToken[1];
                  T && T[0] === "word";
                  ...
                  if (((F += z), z.lastIndexOf("\\") === z.length - 1)) {
                    ...
                    ee &&
                      ee[0] === "space" &&
                      ((F += this.parseSpace(ee[1], " ")), this.position++);
                  }
                  T = this.nextToken;
                }
                var te = (0, l.default)(F, "."),
                  ...
                  le = (0, l.default)(F, "#{");
                le.length &&
                  (ue = ue.filter(function (ne) {
                    return !~le.indexOf(ne);
                  }));
                var re = (0, R.default)(
                  (0, m.default)((0, o.default)([[0], te, ue]))
                );
              ...
              (E.prototype.newNode = function (b, L) {
                return (
                  ...
                  this.spaces &&
                    ((b.spaces.before = this.spaces), (this.spaces = "")),
        ...
        "node_modules/postcss-media-query-parser/dist/nodes/Container.js"(e) {
          ...
          function o(h) {
            ...
            this.constructor(h),
              ...
              this.before === void 0 &&
                (this.before =
                  this.nodes.length > 0 ? this.nodes[0].before : ""),
          ...
          (o.prototype = Object.create(i.default.prototype)),
            ...
            (o.prototype.walk = function (l, p) {
              for (
                var m = typeof l == "string" || l instanceof RegExp,
                  c = m ? p : l,
                  t = typeof l == "string" ? new RegExp(l) : l,
                  r = 0;
                r < this.nodes.length;
                r++
              ) {
                var a = this.nodes[r],
                  s = m ? t.test(a.type) : !0;
                if (
                  (s && c && c(a, r, this.nodes) === !1) ||
                  (a.nodes && a.walk(l, p) === !1)
                )
                  return !1;
              }
              return !0;
        ...
        "node_modules/postcss-media-query-parser/dist/parsers.js"(e) {
          ...
          function l(c) {
            ...
            return (
              ...
              a.push(f),
              g !== null && ((g.before = f.after), a.push(g)),
              v !== null && a.push(v),
              a
            );
          }
          function p(c) {
            ...
            for (var v = 0; v < c.length; v++) {
              ...
              s
                ...
                : y.search(/\s/) !== -1
                ? (f.before += y)
                : (y === "(" && ((f.type = "media-feature-expression"), a++),
                  (f.value = y),
                  (f.sourceIndex = t + v),
                  (s = !0)),
                s &&
                  ...
                  (y === ")" ||
                    v === c.length - 1 ||
                    c[v + 1].search(/\s/) !== -1) &&
                  (["not", "only", "and"].indexOf(f.value) !== -1 &&
                    (f.type = "keyword"),
                  f.type === "media-feature-expression" &&
                    (f.nodes = l(f.value, f.sourceIndex)),
                  r.push(
                    Array.isArray(f.nodes) ? new o.default(f) : new i.default(f)
                  ),
                  (f = g()),
                  (s = !1));
            }
              ...
              if (
                ...
                if (w > 0) {
                  ...
                  r[w - 1].type === "media-type" &&
                    (r[w + 1]
                      ? (f.type =
                          r[w + 1].type === "media-feature-expression"
                            ? "keyword"
                ...
                if (w === 0) {
                  ...
                  if (
                    r[w + 3] &&
                    r[w + 3].type === "media-feature-expression"
                  ) {
                    (f.type = "keyword"),
                      (r[w + 1].type = "media-type"),
                      (r[w + 2].type = "keyword");
          ...
          var s = (function (g) {
              ...
              function v(w, d, _, k, x, N) {
                ...
                return (
                  ...
                  typeof d < "u" &&
                    ...
                    ((I.line = d), (I.column = _)),
                  I.setMessage(),
                  Error.captureStackTrace && Error.captureStackTrace(h(I), v),
                  I
                );
              }
              var y = v.prototype;
              return (
                ...
                (y.showSourceCode = function (d) {
                  ...
                  var k = this.source;
                  u.default &&
                    (typeof d > "u" && (d = i.default.isColorSupported),
                    d && (k = (0, u.default)(k)));
                  var x = k.split(/\r?\n/),
                    ...
                    W = String(I).length;
                  function $(D) {
                    return d && i.default.red
                      ? i.default.red(i.default.bold(D))
                      : D;
                  }
                  function H(D) {
                  ...
                  return x.slice(N, I).map(function (D, V) {
                    ...
                    if (B === _.line) {
                      var j =
                        H(O.replace(/\d/g, " ")) +
                        D.slice(0, _.column - 1).replace(/[^\t]/g, " ");
                      return (
                        $(">") +
                        H(O) +
                        D +
            ...
            c = (function () {
              function r(s, f) {
                if (
                  ...
                  s === null ||
                    typeof s > "u" ||
                    (typeof s == "object" && !s.toString))
                )
                  throw new Error(
                    "PostCSS received " + s + " instead of CSS string"
                  );
                (this.css = s.toString()),
                ...
                this.file || ((m += 1), (this.id = "<input css " + m + ">")),
                  this.map && (this.map.file = this.from);
              }
              var a = r.prototype;
              return (
                (a.error = function (f, g, v, y) {
                  y === void 0 && (y = {});
                  var w,
                    d = this.origin(g, v);
                  return (
                    ...
                    (w.input = { line: g, column: v, source: this.css }),
                ...
                (a.origin = function (f, g) {
                  ...
                  var v = this.map.consumer(),
                    y = v.originalPositionFor({ line: f, column: g });
              ...
              return (
                ...
                (p.body = function (c) {
                  for (
                    ...
                    t -= 1;
                  for (
                    var r = this.raw(c, "semicolon"), a = 0;
                    a < c.nodes.length;
                    a++
                  ) {
                    var s = c.nodes[a],
                ...
                (p.raw = function (c, t, r) {
                  ...
                  if (
                    r === "before" &&
                    (!s || (s.type === "root" && s.first === c))
                  )
                    return "";
                  if (!s) return i[r];
                  var f = c.root();
                  if (
                    (f.rawCache || (f.rawCache = {}),
                    typeof f.rawCache[r] < "u")
                  )
                    return f.rawCache[r];
                  if (r === "before" || r === "after")
          ...
          var p = (function () {
              ...
              return (
                ...
                (t.replaceWith = function () {
                  if (this.parent) {
                    for (
                      var a = arguments.length, s = new Array(a), f = 0;
                      f < a;
                      f++
                    )
                      s[f] = arguments[f];
                ...
                (t.toJSON = function () {
                  ...
                  for (var s in this)
                    if (this.hasOwnProperty(s) && s !== "parent") {
                      var f = this[s];
                      f instanceof Array
                        ? (a[s] = f.map(function (g) {
                            return typeof g == "object" && g.toJSON
                              ? g.toJSON()
                              : g;
                          }))
                ...
                switch (
                  ...
                  case s:
                    if (
                      ...
                      (E = ["brackets", D.slice(q, O + 1), L, q - b, L, O - b]),
                        (q = O);
                    } else
                      (O = D.indexOf(")", q + 1)),
                        (X = D.slice(q, O + 1)),
...
`)),
                  ...
                  case o:
                    ...
                    break;
                  default:
                    B === h && D.charCodeAt(q + 1) === w
                      ? ((O = D.indexOf("*/", q + 2) + 1),
                        O === 0 && (V || ne ? (O = D.length) : ee("comment")),
                        (X = D.slice(q, O + 1)),
                        (C = X.split(`
`)),
                        (R = C.length - 1),
      ...
      Pf = P({
        "node_modules/postcss/lib/list.js"(e, n) {
          ...
          A(), (e.__esModule = !0), (e.default = void 0);
          var i = {
              split: function (h, l, p) {
                for (
                  var m = [], c = "", t = !1, r = 0, a = !1, s = !1, f = 0;
                  f < h.length;
                  f++
                ) {
                  var g = h[f];
                  a
                    ...
                    : g === ")"
                    ? r > 0 && (r -= 1)
                    : r === 0 && l.indexOf(g) !== -1 && (t = !0),
                    t
                      ? (c !== "" && m.push(c.trim()), (c = ""), (t = !1))
                      : (c += g);
                }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          var s = (function (g) {
              ...
              return (
                ...
                (y.append = function () {
                  for (
                    var d = arguments.length, _ = new Array(d), k = 0;
                    k < d;
                    k++
                  )
                    _[k] = arguments[k];
                ...
                (y.prepend = function () {
                  ...
                  for (var x = l(_), N; !(N = x()).done; ) {
                    for (
                      var I = N.value,
                        W = this.normalize(I, this.first, "prepend").reverse(),
                        $ = l(W),
                        H;
                      !(H = $()).done;
                ...
                (y.insertBefore = function (d, _) {
                  ...
                  for (
                    var k = d === 0 ? "prepend" : !1,
                      x = this.normalize(_, this.nodes[d], k).reverse(),
                      N = l(x),
                      I;
                    !(I = N()).done;
                  ...
                  for (var H in this.indexes)
                    ($ = this.indexes[H]),
                      d <= $ && (this.indexes[H] = $ + x.length);
                  return this;
                }),
                (y.insertAfter = function (d, _) {
                  d = this.index(d);
                  for (
                    var k = this.normalize(_, this.nodes[d]).reverse(),
                      x = l(k),
                      N;
                    !(N = x()).done;
              ...
              return (
                (c.append = function () {
                  ...
                  for (
                    ...
                    s[f] = arguments[f];
                  return (r = p.prototype.append).call.apply(
                    r,
                    [this].concat(s)
                  );
                }),
                (c.prepend = function () {
                  ...
                  for (
                    ...
                    s[f] = arguments[f];
                  return (r = p.prototype.prepend).call.apply(
                    r,
                    [this].concat(s)
                  );
                }),
              ...
              return (
                ...
                (y.handleError = function (d, _) {
                  try {
                    if (
                      ((this.error = d),
                      d.name === "CssSyntaxError" && !d.plugin)
                    )
                      (d.plugin = _.postcssPlugin), d.setMessage();
                    else if (_.postcssVersion && !1) var k, x, N, I, W;
                  } catch ($) {
                ...
                (y.async = function () {
                  ...
                  return this.processed
                    ? new Promise(function (_, k) {
                        d.error ? k(d.error) : _(d.stringify());
                      })
                    : this.processing
                    ? this.processing
                    : ((this.processing = new Promise(function (_, k) {
                ...
                (y.sync = function () {
                  ...
                  for (
                    var d = m(this.result.processor.plugins), _;
                    !(_ = d()).done;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          var p = (function () {
              function c(r) {
                r === void 0 && (r = []),
                  (this.version = "7.0.39"),
                  (this.plugins = this.normalize(r));
              }
              var t = c.prototype;
              return (
                (t.use = function (a) {
                  return (
                    (this.plugins = this.plugins.concat(this.normalize([a]))),
                    this
                  );
                }),
...
https://github.com/postcss/postcss/wiki/PostCSS-8-for-end-users`
                    ...
                    if (
                      ...
                      !(typeof v == "object" && (v.parse || v.stringify))
                    )
              ...
              return (
                ...
                (a.normalize = function (f, g, v) {
                  ...
                  if (g) {
                    if (v === "prepend")
                      this.nodes.length > 1
                        ? (g.raws.before = this.nodes[1].raws.before)
                        : delete g.raws.before;
        ...
        "node_modules/postcss/lib/parser.js"(e, n) {
          ...
          var c = (function () {
            ...
            return (
              ...
              (r.other = function (s) {
                for (
                  var f = !1, g = null, v = !1, y = null, w = [], d = [], _ = s;
                  _;
              ...
              (r.decl = function (s) {
                ...
                var g = s[s.length - 1];
                for (
                  g[0] === ";" && ((this.semicolon = !0), s.pop()),
                    g[4]
                      ? (f.source.end = { line: g[4], column: g[5] })
                      : (f.source.end = { line: g[2], column: g[3] });
                  s[0][0] !== "word";

                )
                  s.length === 1 && this.unknownWord(s),
                    (f.raws.before += s.shift()[1]);
                for (
                  f.source.start = { line: s[0][2], column: s[0][3] },
                    f.prop = "";
                  s.length;
                ...
                for (var w = s.length - 1; w > 0; w--) {
                  if (((y = s[w]), y[1].toLowerCase() === "!important")) {
                    ...
                    (d = this.spacesFromEnd(s) + d),
                      d !== " !important" && (f.raws.important = d);
                    break;
                    ...
                    k.trim().indexOf("!") === 0 &&
                      ((f.important = !0), (f.raws.important = k), (s = _));
                  }
                  if (y[0] !== "space" && y[0] !== "comment") break;
                }
                this.raw(f, "value", s),
                  f.value.indexOf(":") !== -1 && this.checkMissedSemicolon(s);
              }),
              (r.atrule = function (s) {
                var f = new h.default();
                (f.name = s[1].slice(1)),
                  f.name === "" && this.unnamedAtrule(f, s),
                  this.init(f, s[2], s[3]);
                for (
                  var g, v, y = !1, w = !1, d = [];
                  ...
                  if (((s = this.tokenizer.nextToken()), s[0] === ";")) {
                    (f.source.end = { line: s[2], column: s[3] }),
                      (this.semicolon = !0);
                    break;
                  } else if (s[0] === "{") {
                    w = !0;
              ...
              (r.end = function (s) {
                this.current.nodes &&
                  ...
                  (this.spaces = ""),
                  this.current.parent
                    ? ((this.current.source.end = { line: s[2], column: s[3] }),
              ...
              (r.spacesFromEnd = function (s) {
                for (
                  var f, g = "";
                  s.length && ((f = s[s.length - 1][0]), f === "space");
      ...
      Uf = P({
        "node_modules/postcss-less/lib/LessParser.js"(e, n) {
          ...
          n.exports = class extends u {
            ...
            atrule(r) {
              h.bind(this)(r) ||
                (super.atrule(r), p(this.lastNode), m(this.lastNode));
            }
            decl() {
            ...
            inlineComment(r) {
              ...
              if (
                (this.init(a, r[2], r[3]),
                (a.source.end = { line: r[4], column: r[5] }),
                (a.inline = !0),
                (a.raws.begin = "//"),
                /^\s*$/.test(s))
              )
            ...
            mixin(r) {
              ...
              if (y.length) {
                let [d] = y,
                  ...
                  x = [d[2], d[3]],
                  N = [k[4], k[5]],
                  W = ["word", y.map(($) => $[1]).join("")].concat(x, N);
            ...
            rule(r) {
              ...
              if (
                s[0] === "at-word" &&
                a[0] === "{" &&
                (this.tokenizer.back(a), h.bind(this)(s))
              ) {
        ...
        "node_modules/postcss-less/lib/LessStringifier.js"(e, n) {
          ...
          n.exports = class extends i {
            atrule(o, h) {
              ...
              let p = `${o.function ? "" : o.raws.identifier || "@"}${o.name}`,
                m = o.params ? this.rawValue(o, "params") : "",
                c = o.raws.important || "";
              if (
                (o.variable && (m = o.value),
...
`)),
                        (Q = Z.length - 1),
                        Q > 0
                          ? ((M = F + Q), (Y = R - Z[Q].length))
                          : ((M = F), (Y = T)),
                        (b = ["brackets", K, F, z - T, M, R - Y]),
                        (T = Y),
                        (F = M),
                        (z = R);
                    } else
...
`)),
                      ...
                      Q > 0
                        ? ((M = F + Q), (Y = R - Z[Q].length))
                        : ((M = F), (Y = T)),
                      (b = ["string", O.slice(z, R + 1), F, z - T, M, R - Y]),
                      (T = Y),
                      (F = M),
                      (z = R);
                    break;
                  case _:
                    (N.lastIndex = z + 1),
                      ...
                      N.lastIndex === 0
                        ? (R = O.length - 1)
                        : (R = N.lastIndex - 2),
                      (b = ["at-word", O.slice(z, R + 1), F, z - T, F, R - T]),
                      (z = R);
                    break;
                  case o:
                    ...
                    (b = ["word", O.slice(z, R + 1), F, z - T, F, R - T]),
                      (z = R);
                    break;
                  default:
                    (S = O.charCodeAt(z + 1)),
...
`)),
                          ...
                          Q > 0
                            ? ((M = F + Q), (Y = R - Z[Q].length))
                            : ((M = F), (Y = T)),
                          (b = ["word", K, F, z - T, M, R - Y]),
                          (T = Y),
                          (F = M),
                          (z = R))
                        : C === h && S === w
                        ? ((R = O.indexOf("*/", z + 2) + 1),
                          R === 0 && (j ? (R = O.length) : ue("comment")),
                          (K = O.slice(z, R + 1)),
                          (Z = K.split(`
`)),
                          (Q = Z.length - 1),
                        ...
                        ? ((H.lastIndex = z + 1),
                          ...
                          H.lastIndex === 0
                            ...
                            : (R = H.lastIndex - 2),
                          (K = O.slice(z, R + 1)),
                          (b = ["comment", K, F, z - T, F, R - T, "inline"]),
                          (z = R))
                        : ((I.lastIndex = z + 1),
                          I.test(O),
                          I.lastIndex === 0
...
`) !== -1
                  ...
                  if (!s || g.trim() === "" || /^[a-zA-Z-:#]/.test(g))
                    ...
                    for (
                      x[4]
                        ? (k.source.end = { line: x[4], column: x[5] })
                        : (k.source.end = { line: x[2], column: x[3] });
                      a[0][0] !== "word";

                    )
                      k.raws.before += a.shift()[1];
                    for (
                      k.source.start = { line: a[0][2], column: a[0][3] },
                        k.prop = "";
                      a.length;
                    ...
                    (k.prop[0] === "_" || k.prop[0] === "*") &&
                      ((k.raws.before += k.prop[0]),
                      (k.prop = k.prop.slice(1))),
                      (k.raws.between += this.spacesAndCommentsFromStart(a)),
                      this.precheckMissedSemicolon(a);
                    for (var W = a.length - 1; W > 0; W--) {
                      if (((I = a[W]), I[1] === "!important")) {
                        k.important = !0;
                        var $ = this.stringFrom(a, W);
                        ($ = this.spacesFromEnd(a) + $),
                          $ !== " !important" && (k.raws.important = $);
                        break;
                        ...
                        D.trim().indexOf("!") === 0 &&
                          ((k.important = !0), (k.raws.important = D), (a = H));
                      }
                      if (I[0] !== "space" && I[0] !== "comment") break;
                    }
                    this.raw(k, "value", a),
                      k.value.indexOf(":") !== -1 &&
                        this.checkMissedSemicolon(a),
                      (this.current = k);
                  }
                }),
                (t.comment = function (a) {
                  if (a[6] === "inline") {
                    ...
                    this.init(s, a[2], a[3]),
                      (s.raws.inline = !0),
                      (s.source.end = { line: a[4], column: a[5] });
                    var f = a[1].slice(2);
                    if (/^\s*$/.test(f))
    ...
    var Xf = Sl(),
      ...
      Zf = $s(),
      { hasPragma: ep } = Cl(),
      { locStart: rp, locEnd: tp } = no(),
      { calculateLoc: np, replaceQuotesInInlineComments: ip } = no(),
      sp = Dl(),
      op = Ll(),
      gt = zl(),
      da = Bl(),
    ...
    function pp(e, n) {
      let { nodes: i } = e,
        u = { open: null, close: null, groups: [], type: "paren_group" },
        o = [u],
        h = u,
      ...
      for (let m = 0; m < i.length; ++m) {
        ...
        if (c.type === "paren" && c.value === "(")
          (u = { open: c, close: null, groups: [], type: "paren_group" }),
            o.push(u),
            (l = { groups: [], type: "comma_group" }),
            p.push(l);
        else if (c.type === "paren" && c.value === ")") {
          if (
            (l.groups.length > 0 && u.groups.push(l),
            (u.close = c),
            p.length === 1)
          )
    ...
    function vr(e) {
      return (e.type === "paren_group" &&
        ...
        ? Object.assign(Object.assign({}, e), {}, { groups: e.groups.map(vr) })
        : e;
    }
    function Xe(e, n, i) {
    ...
    function ma(e, n) {
      if (e && typeof e == "object") {
        for (let i in e)
          i !== "parent" &&
            (ma(e[i], n),
            i === "nodes" && ((e.group = vr(pp(e, n))), delete e[i]));
        delete e.parent;
      }
      return e;
    }
    ...
    function ga(e, n) {
      if (e && typeof e == "object") {
        ...
        if (typeof e.selector == "string") {
          var i;
          (h = e.raws.selector
            ? (i = e.raws.selector.scss) !== null && i !== void 0
              ? i
              : e.raws.selector.raw
            : e.selector),
            e.raws.between &&
        ...
        if (typeof e.value == "string") {
          var u;
          (l = e.raws.value
            ? (u = e.raws.value.scss) !== null && u !== void 0
              ? u
              : e.raws.value.raw
            : e.value),
            (l = l.trim()),
        ...
        if (typeof e.params == "string") {
          var o;
          (p = e.raws.params
            ? (o = e.raws.params.scss) !== null && o !== void 0
              ? o
              : e.raws.params.raw
            : e.params),
            e.raws.afterName &&
              e.raws.afterName.trim().length > 0 &&
              (p = e.raws.afterName + p),
            e.raws.between &&
              e.raws.between.trim().length > 0 &&
              (p = p + e.raws.between),
            (p = p.trim()),
        ...
        if (h.trim().length > 0)
          return h.startsWith("@") && h.endsWith(":")
            ...
            : e.mixin
            ? ((e.selector = Pe(h, n)), e)
            : (ap(e) && (e.isSCSSNesterProperty = !0), (e.selector = Re(h)), e);
        if (l.length > 0) {
          let m = l.match(dp);
          m &&
            ((l = l.slice(0, m.index)),
            (e.scssDefault = !0),
            m[0].trim() !== "!default" && (e.raws.scssDefault = m[0]));
          let c = l.match(vp);
          if (
            (c &&
              ((l = l.slice(0, c.index)),
              (e.scssGlobal = !0),
              c[0].trim() !== "!global" && (e.raws.scssGlobal = c[0])),
            l.startsWith("progid:"))
          )
        ...
        if (
          (gt(n) &&
            ...
            e.extend &&
              !e.selector &&
              (delete e.value, (e.selector = Re(l.slice(7, -1))))),
          e.type === "css-atrule")
        ) {
          if (gt(n)) {
            if (e.mixin) {
              let m =
                e.raws.identifier + e.name + e.raws.afterName + e.raws.params;
          ...
          if (n.parser === "css" && e.name === "custom-selector") {
            ...
            return (
              (e.customSelector = m),
              (e.selector = Re(e.params.slice(m.length).trim())),
              delete e.params,
              e
            );
          }
        ...
        if (e.type === "css-atrule" && p.length > 0) {
          ...
          return m === "warn" || m === "error"
            ? ((e.params = { type: "media-unknown", value: p }), e)
            : m === "extend" || m === "nest"
            ? ((e.selector = Re(p)), delete e.params, e)
            : m === "at-root"
            ? (/^\(\s*(?:without|with)\s*:.+\)$/s.test(p)
                ? (e.params = Pe(p, n))
                : ((e.selector = Re(p)), delete e.params),
              e)
            : lp(c)
            ? ((e.import = !0), delete e.filename, (e.params = Pe(p, n)), e)
            : [
                "namespace",
                "supports",
                "if",
            ...
            ? ((p = p.replace(/(\$\S+?)(\s+)?\.{3}/, "$1...$2")),
              (p = p.replace(/^(?!if)(\S+)(\s+)\(/, "$1($2")),
              (e.value = Pe(p, n)),
              delete e.params,
              e)
            : ["media", "custom-media"].includes(c)
            ? p.includes("#{")
              ? { type: "media-unknown", value: p }
              : ((e.params = hp(p)), e)
            : ((e.params = p), e);
        }
      }
    ...
    function ya(e, n, i) {
      ...
      try {
        ...
        throw typeof c != "number"
          ? l
          : Xf(`${p}: ${m}`, { start: { line: c, column: t } });
      }
      return (
        (h = ga(Xe(h, "css-"), i)),
        np(h, n),
        o &&
          ((o.source = { startOffset: 0, endOffset: o.raw.length }),
          h.nodes.unshift(o)),
        h
      );
    }
    ...
    wa.exports = {
      parsers: {
        css: Object.assign(Object.assign({}, yt), {}, { parse: mp }),
        less: Object.assign(Object.assign({}, yt), {}, { parse: Ot }),
        scss: Object.assign(Object.assign({}, yt), {}, { parse: Tt }),
      },
    };
  });
  return gp();
