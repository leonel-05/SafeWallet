(function (e) {
  ...
  var nr = S((Sc, Cu) => {
    var tr = typeof document == "object" && document.all,
      zs = typeof tr > "u" && tr !== void 0;
  ...
  var Iu = S((Nc, qu) => {
    var Ou = ee(),
      ...
      Bu = Ou.process,
      bu = Ou.Deno,
      wu = (Bu && Bu.versions) || (bu && bu.version),
      Nu = wu && wu.v8,
      ue,
      Pe;
    Nu &&
  ...
  var he = S((Xc, nt) => {
    var bi = ee(),
      ...
      ce = bi.Symbol,
      ut = ce && ce.for,
      Oi = tt ? ce : (ce && ce.withoutSetter) || Ni;
  ...
  var ot = S((Hc, at) => {
    ...
    at.exports = function (e, r) {
      ...
      if (u) {
        if (
          (r === void 0 && (r = "default"), (n = qi(u, e, r)), !st(n) || it(n))
        )
          return n;
        throw Pi("Can't convert object to primitive value");
      }
  ...
  var St = S((r2, _t) => {
    var yr = ae(),
      ...
      pa = yr && Object.getOwnPropertyDescriptor,
      Tr = ha(vt, "name"),
      fa = Tr && function () {}.name === "something",
      da = Tr && (!yr || (yr && pa(vt, "name").configurable));
  ...
  var $t = S((a2, Lt) => {
    var Oa = se(),
      ...
      ka =
        Ir &&
        !Oa(function () {
          return He(function () {}, "length", { value: 8 }).length !== 8;
        }),
      La = String(String).split("String"),
      $a = (Lt.exports = function (e, r, u) {
  ...
  var Dc = S((W2, Os) => {
    ...
    var el = Object.create,
      ...
      ds = (e) => fs(Je({}, "__esModule", { value: !0 }), e),
      Te,
      q = Ee({
        "<define:process>"() {
          Te = { env: {}, argv: [] };
          ...
          var j = class {
            ...
            addDirective(p) {
              this.directivesSet.has(p.reference) ||
                (this.directivesSet.add(p.reference), this.directives.push(p));
            }
    ...
    var cl = Ee({
      ...
      hl = I({
        "node_modules/semver/internal/re.js"(e, r) {
          q();
          var { MAX_SAFE_COMPONENT_LENGTH: u } = Fs(),
            n = gs();
          e = r.exports = {};
          var D = (e.re = []),
            s = (e.src = []),
      ...
      dl = I({
        "node_modules/semver/classes/semver.js"(e, r) {
          q();
          var u = gs(),
            { MAX_LENGTH: n, MAX_SAFE_INTEGER: D } = Fs(),
            { re: s, t: i } = hl(),
            f = pl(),
            { compareIdentifiers: c } = fl(),
            F = class {
              constructor(a, l) {
      ...
      Hr = I({
        "node_modules/semver/functions/compare.js"(e, r) {
          q();
          var u = dl(),
            n = (D, s, i) => new u(D, i).compare(new u(s, i));
          r.exports = n;
        },
      }),
      El = I({
      ...
      Fl = I({
        "node_modules/outdent/lib/index.js"(e, r) {
          ...
          function C(g, N, R) {
            ...
            N && (g = g.slice(1));
            var k = R.newline,
              $ = R.trimLeadingNewline,
              t = R.trimTrailingNewline,
              o = typeof k == "string",
              E = g.length,
              p = g.map(function (A, P) {
                return (
                  (A = A.replace(x, "$1")),
                  P === 0 && $ && (A = A.replace(c, "")),
        ...
        "src/main/support.js"(e, r) {
          ...
          function i() {
            let {
                ...
                : {},
              h = D.split("-", 1)[0],
              C = c.flatMap((g) => g.languages || []).filter(m),
              d = n(
                Object.assign(
                  {},
                  ...c.map((g) => {
            ...
            for (let h of F)
              if (h.parsers) {
                for (let C of h.parsers)
                  if (!l.has(C)) {
                    l.add(C);
                    let d = a.find((T) => T.parsers && T.parsers[C]),
                      m = h.name;
...
`);
          ...
          function t(v, y) {
            let B = { quote: '"', regex: /"/g, escaped: "&quot;" },
              b = { quote: "'", regex: /'/g, escaped: "&apos;" },
              L = y === "'" ? b : B,
              U = L === b ? B : b,
              G = L;
            if (v.includes(L.quote) || v.includes(U.quote)) {
              let W = (v.match(L.regex) || []).length,
                ne = (v.match(U.regex) || []).length;
              G = W > ne ? U : L;
            }
            return G;
          }
          ...
          function J(v) {
            let y = v.type || v.kind || "(unknown type)",
              B = String(
                v.name ||
      ...
      Ml = I({
        "src/language-html/utils/html-elements-attributes.js"(e, r) {
          "use strict";
          q();
          var { htmlElementAttributes: u } = Ll(),
            n = $l(),
            D = Ts(),
            s = n(u, D);
          r.exports = s;
              ...
              constructor() {
                let i =
                  arguments.length > 0 && arguments[0] !== void 0
                    ? arguments[0]
                    : {};
                for (let f of new Set([...n, ...Object.keys(i)]))
...
`,
      ...
      bs = I({
        "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(
          ...
          function h(d) {
            let m = d.sourceSpan.start.offset,
              T = d.sourceSpan.end.offset;
            return (
              d instanceof f &&
                (d.endSourceSpan
...
`
          ...
          var x = class {
            ...
            k = class extends x {
              ...
              decodeHexDigits(t, o) {
                let E = this.input.substr(t.internalState.offset, o),
                  p = parseInt(E, 16);
                if (isNaN(p))
                  throw (
        ...
        "node_modules/angular-html-parser/lib/compiler/src/ml_parser/parser.js"(
          ...
          var f = class {
            ...
            parse(a, l, h) {
              let C =
                ...
                T = C ? this.getTagDefinition : m(this.getTagDefinition),
                w = (x) => T(x).contentType,
                g = C ? d : m(d),
                N = d
                  ? (x, k, $, t) => {
                  ...
                  : w,
                R = n.tokenize(a, l, N, h),
                j = (h && h.canSelfClose) || !1,
                _ = (h && h.allowHtmComponentClosingTags) || !1,
                O = new c(R.tokens, T, j, _, C).build();
          ...
          var c = class {
            ...
            _consumeCdata(a) {
              let l = this._advance(),
                h = this._getText(l),
                C = this._advanceIf(n.TokenType.CDATA_END);
              this._addToParent(
                new u.CDATA(
                  h,
            ...
            _consumeComment(a) {
              let l = this._advanceIf(n.TokenType.RAW_TEXT),
                h = this._advanceIf(n.TokenType.COMMENT_END),
                C = l != null ? l.parts[0].trim() : null,
            ...
            _consumeDocType(a) {
              let l = this._advanceIf(n.TokenType.RAW_TEXT),
                h = this._advanceIf(n.TokenType.DOC_TYPE_END),
                C = l != null ? l.parts[0].trim() : null,
                d = new r.ParseSourceSpan(
                  a.sourceSpan.start,
                  (h || l || a).sourceSpan.end
            ...
            _parseExpansionCase() {
              ...
              let l = this._advance(),
                h = this._collectExpansionExpTokens(l);
              if (!h) return null;
              let C = this._advance();
              ...
              let m = new r.ParseSourceSpan(
                ...
                T = new r.ParseSourceSpan(l.sourceSpan.start, C.sourceSpan.end);
            ...
            _collectExpansionExpTokens(a) {
              let l = [],
                h = [n.TokenType.EXPANSION_CASE_EXP_START];
              for (;;) {
                if (
                  ((this._peek.type === n.TokenType.EXPANSION_FORM_START ||
...
`
            ...
            _consumeStartTag(a) {
              ...
              let d = this._getElementFullName(l, h, this._getParentElement()),
                m = !1;
              ...
              let T = this._peek.sourceSpan.start,
                w = new r.ParseSourceSpan(a.sourceSpan.start, T),
                g = new r.ParseSourceSpan(
                  a.sourceSpan.start.moveBy(1),
                  a.sourceSpan.end
                ),
                N = new u.Element(d, C, [], w, w, void 0, g);
              this._pushElement(N),
            ...
            _popElement(a) {
              for (let l = this._elementStack.length - 1; l >= 0; l--) {
                ...
                if (
                  ...
                  return (
                    this._elementStack.splice(l, this._elementStack.length - l),
                    !0
                  );
                if (!this.getTagDefinition(h.name).closedByParent) return !1;
              }
              return !1;
            }
            _consumeAttr(a) {
              let l = D.mergeNsAndName(a.parts[0], a.parts[1]),
                h = a.sourceSpan.end,
                C = "",
                d,
                m;
            ...
            _getElementFullName(a, l, h) {
              return (
                a === "" &&
                  ((a = this.getTagDefinition(l).implicitNamespacePrefix || ""),
    ...
    q();
    var { ParseSourceSpan: Qe, ParseLocation: cs, ParseSourceFile: Kl } = Be(),
      Jl = ol(),
      Zl = Cs(),
      ec = Dl(),
      { inferParserByLanguage: rc } = xl(),
      uc = kl(),
      Vr = Ml(),
      hs = jl(),
      { hasPragma: tc } = Ul(),
      { Node: nc } = Gl(),
      { parseIeConditionalComment: sc } = Vl(),
      { locStart: ic, locEnd: ac } = Xl();
    function oc(e, r, u) {
      let {
          canSelfClose: n,
          normalizeTagName: D,
        ...
        F = ws(),
        { RecursiveVisitor: a, visitAll: l } = bs(),
        { ParseSourceSpan: h } = Be(),
        { getHtmlTagDefinition: C } = Bs(),
        { rootNodes: d, errors: m } = F.parse(e, {
          canSelfClose: n,
          allowHtmComponentClosingTags: i,
          isTagNameCaseSensitive: f,
          getTagContentType: c,
      ...
      if (u.parser === "vue")
        if (
          ...
          let O = (x) => {
            if (!x || x.type !== "element" || x.name !== "template") return !1;
            let k = x.attrs.find((t) => t.name === "lang"),
              $ = k && k.value;
            return !$ || rc($, u) === "html";
          };
          if (d.some(O)) {
            ...
            for (let o = 0; o < d.length; o++) {
              let E = d[o],
                { endSourceSpan: p, startSourceSpan: A } = E;
      ...
      let T = (_) => {
          let O = _.name.startsWith(":") ? _.name.slice(1).split(":")[0] : null,
            x = _.nameSpan.toString(),
            k = O !== null && x.startsWith(`${O}:`),
            $ = k ? x.slice(O.length + 1) : x;
        ...
        N = (_) => {
          if (
            ...
            let O = Vr[_.name] || Object.create(null);
    ...
    function Ns(e, r, u) {
      let n =
        ...
        { frontMatter: D, content: s } = n
          ? Jl(e)
          : { frontMatter: null, content: e },
        i = new Kl(e, r.filepath),
        f = new cs(i, 0, 0, 0),
        c = f.moveBy(e.length),
        F = { type: "root", sourceSpan: new Qe(f, c), children: oc(s, u, r) };
      if (D) {
        let h = new cs(i, 0, 0, 0),
          C = h.moveBy(D.raw.length);
        (D.sourceSpan = new Qe(h, C)), F.children.unshift(D);
      }
      let a = new nc(F),
        l = (h, C) => {
          let { offset: d } = C,
            m = e.slice(0, d).replace(/[^\n\r]/g, " "),
            w = Ns(m + h, r, u, !1);
