...
function decode(ab, opts) {
  ...
  function parseVersion() {
    ...
    if (
      byteArrayEq(_helperWasmBytecode["default"].moduleVersion, version) ===
      false
    ) {
  ...
  function parseExportSection(numberOfExport) {
    ...
    for (var i = 0; i < numberOfExport; i++) {
      ...
      if (_helperWasmBytecode["default"].exportTypes[typeIndex] === "Func") {
        ...
        _helperWasmBytecode["default"].exportTypes[typeIndex] === "Memory"
      ) {
  ...
  function parseInstructionBlock(code) {
    while (true) {
      ...
      if (instruction.name === "loop") {
        ...
        eatBytes(1);
        var blocktype =
          _helperWasmBytecode["default"].blockTypes[blocktypeByte];
        ...
        eatBytes(1);
        var _blocktype =
          _helperWasmBytecode["default"].blockTypes[_blocktypeByte];
  ...
  function parseTableType(index) {
    ...
    var elementType =
      _helperWasmBytecode["default"].tableTypes[elementTypeByte];
  ...
  function parseSection(sectionIndex) {
    ...
    switch (sectionId) {
      case _helperWasmBytecode["default"].sections.type: {
        ...
        var metadata = t.sectionMetadata(
          "type",
          startOffset,
