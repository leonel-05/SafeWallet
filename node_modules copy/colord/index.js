...
var r = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) },
  ...
  h = function (r) {
    ...
    return { h: 60 * (s < 0 ? s + 6 : s), s: o ? (a / o) * 100 : 0, v: (o / 255) * 100, a: u };
  },
  b = function (r) {
    var t = r.h,
      n = r.s,
  ...
  $ = (function () {
    ...
    return (
      ...
      (r.prototype.invert = function () {
        return j({ r: 255 - (r = this.rgba).r, g: 255 - r.g, b: 255 - r.b, a: r.a });
        var r;
      }),
      ...
      (r.prototype.lighten = function (r) {
        return void 0 === r && (r = 0.1), j(H(this.rgba, r));
      }),
      ...
      (r.prototype.hue = function (r) {
        var t = p(this.rgba);
        return "number" == typeof r ? j({ h: r, s: t.s, l: t.l, a: t.a }) : n(t.h);
      }),
