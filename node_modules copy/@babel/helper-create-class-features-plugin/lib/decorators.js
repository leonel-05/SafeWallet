      ...
      switch (elementNode.type) {
        ...
        default:
          if (elementNode.static) {
            ...
            (_staticInitLocal = staticInitLocal) != null
              ? _staticInitLocal
            ...
            var _protoInitLocal;
            (_protoInitLocal = protoInitLocal) != null
              ? _protoInitLocal
    ...
    for (const decorator of decorators) {
      ...
      if (
        ...
        if (_core.types.isSuper(expression.object)) {
          ...
          (_decoratorReceiverId = decoratorReceiverId) != null
            ? _decoratorReceiverId
  ...
  applyDecsBody.push(
    _core.types.expressionStatement(
      createLocalsAssignment(
        ...
        classLocals,
        elementDecorations,
        (_classDecorationsId = classDecorationsId) != null
          ? _classDecorationsId
          : _core.types.arrayExpression(classDecorations),
