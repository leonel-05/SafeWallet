...
var _default = (exports.default = (0, _helperPluginUtils.declare)(
  (api, options, dirname) => {
    ...
    }
    {
      ...
      var supportsCJSDefault = (0, _helpers.hasMinVersion)(
        DUAL_MODE_RUNTIME,
        runtimeVersion
      );
    }
    ...
    }
    {
      ...
      var esModules =
        useESModules === "auto"
          ? api.caller(
              (caller) => !!(caller != null && caller.supportsStaticESM)
            )
          : useESModules;
    }
    {
    ...
    return {
      ...
      inherits: _index2.createPolyfillPlugins(
        options,
        runtimeVersion,
        absoluteRuntime
      ),
      pre(file) {
        ...
        file.set("helperGenerator", (name) => {
          ...
          (_modulePath = modulePath) != null
            ? _modulePath
            : (modulePath = (0, _index.default)(
                (_ref =
                  moduleName != null
                    ? moduleName
                    : file.get("runtimeHelpersModuleName")) != null
                  ? _ref
                  : "@babel/runtime",
                dirname,
                absoluteRuntime
            ...
            if (
              ...
              if (name === "regeneratorRuntime") {
                return _core.types.arrowFunctionExpression(
                  [],
                  _core.types.identifier("regeneratorRuntime")
                );
              }
              return;
            }
          ...
          if (absoluteRuntime)
            helperPath = (0, _index.resolveFSPath)(helperPath);
