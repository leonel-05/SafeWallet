...
class Client {
  ...
  getVersion() {
    ...
    return (_classPrivateFieldGet2 = _classPrivateFieldGet(_vCache, this)) !=
      null
      ? _classPrivateFieldGet2
      : _classPrivateFieldSet(
          _vCache,
          this,
          _classPrivateFieldGet(_send, this).call(
            this,
            ACTIONS.GET_VERSION,
            undefined
          )
  ...
  getTypesInfo() {
    ...
    return (_classPrivateFieldGet3 = _classPrivateFieldGet(_tiCache, this)) !=
      null
  ...
  getVisitorKeys() {
    ...
    return (_classPrivateFieldGet4 = _classPrivateFieldGet(_vkCache, this)) !=
      null
  ...
  getTokLabels() {
    ...
    return (_classPrivateFieldGet5 = _classPrivateFieldGet(_tlCache, this)) !=
      null
...
class WorkerClient extends Client {
  constructor() {
    super((action, payload) => {
      ...
      const subChannel = new (_get_worker_threads(
        WorkerClient
      ).MessageChannel)();
      ...
      const { message } = _get_worker_threads(
        WorkerClient
    ...
    _classPrivateFieldInitSpec(
      this,
      _worker,
      new (_get_worker_threads(WorkerClient).Worker)(
...
function _get_worker_threads(_this) {
  ...
  return (_worker_threads_cache2 = _worker_threads_cache._) != null
    ? _worker_threads_cache2
    : (_worker_threads_cache._ = require("worker_threads"));
}
...
};
{
  ...
  exports.LocalClient =
    ((_LocalClient = class LocalClient extends Client {
      constructor() {
        var _assertClassBrand$_;
        (_assertClassBrand$_ = _assertClassBrand(
          _LocalClient,
          LocalClient,
          _handleMessage
        )._) != null
          ? _assertClassBrand$_
          : (_handleMessage._ = _assertClassBrand(
              _LocalClient,
              LocalClient,
