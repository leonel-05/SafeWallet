...
var _default = (exports.default = (0, _helperPluginUtils.declarePreset)(
  (api, opts) => {
    api.assertVersion(7);
...
`);
    ...
    const transformTargets =
      forceAllTransforms || hasUglifyTarget ? {} : targets;
    ...
    (0, _filterItems.removeUnnecessaryItems)(
      pluginNames,
      _pluginsCompatData.overlappingPlugins
    );
